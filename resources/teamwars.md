---
doc_id: "mta-wiki:3482"
title: "Resource : Teamwars"
source_title: "Resource:Teamwars"
source_url: "https://wiki.multitheftauto.com/wiki/Resource%3ATeamwars"
revision_id: 14068
language: "en"
categories: []
...
Each team has a starting point, and will have to capture one more capture points to win the round. When a point is captured, the spawn point can change.
You have to capture the points in order.

Green house: Defend this point
Red house: Capture this point
...
For example, press F8 to open the console, then type: **bind r reload**
*This will bind /reload to your '**r'** key*

**Happy gaming!**

Get the latest **official** version from [http://www.teamwars.net/](http://www.teamwars.net/)
