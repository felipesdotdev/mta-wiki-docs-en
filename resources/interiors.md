...
This function retrieves the [marker](mta://reference/misc/marker.md) element associated to the interior.  This will allow you to modify the visibility of interior markers using the [setElementVisibleTo](mta://scripting/server/functions/setelementvisibleto.md) function.
