...
Returns an integer of the channel ID they are in, or a [team](mta://reference/misc/team.md) element if they have been assigned to a team channel, or the [root](mta://scripting/shared/functions/getrootelement.md) element if they are not in a specific channel.
