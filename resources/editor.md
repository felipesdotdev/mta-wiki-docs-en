---
doc_id: "mta-wiki:4389"
title: "Resource : Editor"
source_title: "Resource:Editor"
source_url: "https://wiki.multitheftauto.com/wiki/Resource%3AEditor"
revision_id: 78918
language: "en"
categories: ["Resource"]
generated_at: "2026-07-26T16:17:12.111513+00:00"
---
...
- Save the map you're working on.

- Save your map under a different name.

- Alter general map editor settings.

- Undo the last action.

- Restore the last undone action.

- Stored game world locations. The editor comes with a great list of San Andreas Interior locations but you can also add your own interior and non-interior locations to the list.
...
- Load [editor definition files (EDF)](mta://resources/editor-edf.md) that you want to use.
...
- Create a new object (buildings, roads and other scenery).

- Create a new pickup (health, armor, weapons and custom).

- Create a new marker (checkpoint, ring, cylinder, arrow and corona).

- Select world object.

- Delete world object.

Additionally, if you have [editor definitions loaded](mta://resources/editor-edf.md), you can roll the mousewheel in this menu to bring up custom elements.
...
Please use the official [github issues](https://github.com/multitheftauto/mtasa-resources/issues) for reporting bugs.  Feel free to also join us on [Discord](http://www.mtasa.com/discord).
