---
doc_id: "mta-wiki:5204"
title: "MTA 0.5 Installation"
source_title: "0.5 Installation"
source_url: "https://wiki.multitheftauto.com/wiki/0.5_Installation"
revision_id: 42667
language: "en"
categories: ["MTA_0.5"]
generated_at: "2026-07-26T16:11:20.044794+00:00"
---

# MTA 0.5 Installation
...
Hit the Next button, read the [EULA](mta://reference/misc/mta-0-5-eula.md) and click "I Agree"
...
Once you're in-game it should be quite self explanatory. You can chat using by pressing the "T" key and typing and you can show the scoreboard using the F11 key. These keys can be changed in the config.cfg file in your game folder or via the "/bind" command in-game (read the MTA 0.5 Manual link in the Start Menu for details). If you have any problems, check the [MTA 0.5 Known Issues](mta://reference/misc/mta-0-5-known-issues.md), ask someone else when you're in a server, or post on our [forums](http://forum.multitheftauto.com/viewforum.php?f=50).
