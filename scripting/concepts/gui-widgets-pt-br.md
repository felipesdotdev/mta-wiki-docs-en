---
doc_id: "mta-wiki:12825"
title: "PT-BR/GUI widgets"
source_title: "GUI widgets/PT-BR"
source_url: "https://wiki.multitheftauto.com/wiki/GUI_widgets/PT-BR"
revision_id: 69390
language: "en"
categories: []
generated_at: "2026-07-26T16:15:05.128453+00:00"
---

# PT-BR/GUI widgets

Uso de diferentes widgets GUI do painel Admin

Widgets GUI são uma parte muito importante dos scripts do lado do cliente. Eles são usados quando criamos uma interface GUI para o servidor. Os widgets GUI pertencem somente ao lado cliente, eles não podem ser criados em script de lado servidor. Veja um tutorial de criação de interface GUI na página [Introdução ao GUI scripting](https://wiki.multitheftauto.com/wiki/PT-BR/Introduc%C3%A3o_ao_GUI_scripting).
