---
doc_id: "mta-wiki:2483"
title: "Client Scripting Events"
source_title: "Client Scripting Events"
source_url: "https://wiki.multitheftauto.com/wiki/Client_Scripting_Events"
revision_id: 82801
language: "en"
categories: []
generated_at: "2026-07-26T16:10:33.619830+00:00"
---

# Client Scripting Events

This page lists all **client-side** scripting [events](mta://reference/misc/event.md) that have been implemented and are available in the Deathmatch mod.

To request a event, create an issue in [our GitHub repository.](https://github.com/multitheftauto/mtasa-blue/issues)

**Server-side scripting events can be found here: [Server Scripting Events](mta://scripting/concepts/server-scripting-events.md)**
