---
doc_id: "mta-wiki:5026"
title: "Scripting the GUI - Tutorial 3"
source_title: "Scripting the GUI - Tutorial 3"
source_url: "https://wiki.multitheftauto.com/wiki/Scripting_the_GUI_-_Tutorial_3"
revision_id: 60346
language: "en"
categories: ["GUI_Tutorials"]
generated_at: "2026-07-26T16:16:36.453916+00:00"
---

# Scripting the GUI - Tutorial 3
...
While this may seem like a tricky thing to do, it is made very easy with the function [guiLabelGetTextExtent](mta://scripting/client/functions/guilabelgettextextent.md).
...
To do this, we will introduce a new event: [onClientRender](mta://scripting/client/events/onclientrender.md).
As stated on the [onClientRender](mta://scripting/client/events/onclientrender.md) wiki page, this event is called every time GTA renders a new frame (ie: very often).
...
For our purposes, [onClientRender](mta://scripting/client/events/onclientrender.md) has one main advantage over, for example, [setTimer](mta://scripting/shared/functions/settimer.md).
...
For ideas on what is possible, browse the [MTA GUI functions](mta://scripting/concepts/client-scripting-functions.md).
...
To set the alpha, use [guiSetAlpha](mta://scripting/client/functions/guisetalpha.md) and pass a value between 1 and 0; 1 being fully opaque and 0 being fully transparent.
...
To set the font, use [guiSetFont](mta://scripting/client/functions/guisetfont.md) and pass the string name of the font you want to use (available to see on the [Standard GUI Font Names](mta://scripting/concepts/standard-gui-font-names.md) page).
...
To set the colour, use [guiLabelSetColor](mta://scripting/client/functions/guilabelsetcolor.md) and pass the individual red,green and blue values.
