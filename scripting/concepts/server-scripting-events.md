---
doc_id: "mta-wiki:1300"
title: "Server Scripting Events"
source_title: "Server Scripting Events"
source_url: "https://wiki.multitheftauto.com/wiki/Server_Scripting_Events"
revision_id: 77335
language: "en"
categories: []
generated_at: "2026-07-26T16:16:36.903549+00:00"
---

# Server Scripting Events

This page lists all **server-side** scripting [events](mta://reference/misc/event.md) that have been implemented and are available in the Deathmatch mod.

To request a event, create an issue in [our GitHub repository.](https://github.com/multitheftauto/mtasa-blue/issues)

**Client-side scripting events can be found here: [Client Scripting Events](mta://scripting/concepts/client-scripting-events.md)**

## Account events

- [onAccountDataChange](mta://scripting/server/events/onaccountdatachange.md)
