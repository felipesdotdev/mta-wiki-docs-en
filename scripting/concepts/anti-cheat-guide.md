---
doc_id: "mta-wiki:6044"
title: "Anti-cheat guide"
source_title: "Anti-cheat guide"
source_url: "https://wiki.multitheftauto.com/wiki/Anti-cheat_guide"
revision_id: 80712
language: "en"
categories: ["Support"]
generated_at: "2026-07-26T16:11:34.332182+00:00"
---

# Anti-cheat guide

Note: this page doesn't contain any information about the MTA AC, but just about customizing additional anti-cheat features. If you are interested, read general information at [https://forum.mtasa.com/topic/66858-bounty-for-finding-security-flaws-and-working-cheats-in-mta/](https://forum.mtasa.com/topic/66858-bounty-for-finding-security-flaws-and-working-cheats-in-mta/) (including the spoiler) and also refer there for other things like reporting a vulnerability/working cheat.

**This guide explains how you can fine-tune MTA's anti-cheat on your server** using [**mtaserver.conf**](mta://reference/misc/server-mtaserver-conf.md). It does not allow players to modify their own AC settings.

An anti-cheat helper resource, **acpanel**, is included as a default resource. This shows the current anti-cheat status of your server, along with an option to keep your clients up to date and a basic implementation of [onPlayerModInfo](mta://scripting/server/events/onplayermodinfo.md) to block modified img files.
...
**DISCLAIMER**:
Please note that disableac will only void the AC # kick for using GTA singleplayer cheats and some very basic, outdated and patched MP cheats (such as s0beit). Hacks & cheats designed for MTA or other general hacking tools may still trigger a Global ban or kick.
...
- "data/handling.cfg" - this is unavailable because MTA always ignores this file so that [setVehicleHandling](mta://scripting/shared/functions/setvehiclehandling.md) works correctly. [Click here](mta://reference/misc/handling-cfg.md)*if you want to load custom handling.cfg files.*
