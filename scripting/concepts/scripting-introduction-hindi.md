...
language: "en"
categories: []
generated_at: "2026-07-26T16:16:36.186443+00:00"
---
...
अगले हम खिलाड़ियों को अपनी स्थिति के बगल में एक वाहन के अंडे के लिए उपयोग कर सकते हैं कि आपकी स्क्रिप्ट के लिए एक कमांड जोड़ देंगे। आप इसे छोड़ और के साथ और अधिक उन्नत पटकथा बाहर की जाँच कर सकते हैं [Map Manager](mta://mapping/map-manager.md) इस ट्यूटोरियल जारी है, जो। इस ट्यूटोरियल से एक और शाखा, आप एमटीए में यूजर इंटरफेस खींचा और पटकथा है कि कैसे ग्राफिकल यह देखने के लिए अनुसरण कर सकते हैं [Introduction to Scripting GUI](mta://scripting/concepts/introduction-to-scripting-gui.md) है।
