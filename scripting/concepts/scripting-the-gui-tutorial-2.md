...
generated_at: "2026-07-26T16:16:36.408710+00:00"
---
...
**Note that this tutorial assumes you are familiar with all the content covered in the [GUI Scripting Introduction](mta://scripting/concepts/introduction-to-scripting-gui.md).**
...
To begin, open up a clientside lua file (if you have been following the [GUI Scripting Introduction](mta://scripting/concepts/introduction-to-scripting-gui.md), this is gui.lua) to work with.
...
*If you are unsure of map file syntax, please see the [Writing Gamemodes Tutorial](mta://mapping/writing-gamemodes.md) or check the [Object](mta://reference/misc/object.md) page for help.*
