...
generated_at: "2026-07-26T16:16:20.575954+00:00"
---

# OnClientVehicleExit

This event gets fired when a [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md) gets out of a vehicle.
...
- **thePed:** the [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) element that exited the vehicle
