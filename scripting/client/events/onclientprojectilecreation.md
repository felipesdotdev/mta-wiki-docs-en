...
generated_at: "2026-07-26T16:16:20.245176+00:00"
---

# OnClientProjectileCreation

This event is triggered when a [projectile](mta://reference/misc/projectile.md) is created.
...
The [source](mta://reference/misc/event-system.md) of this event is the [projectile](mta://reference/misc/projectile.md) that was created.
