...
generated_at: "2026-07-26T16:16:18.985417+00:00"
---
...
- **hitPlayer:** the [player](mta://reference/misc/player.md) that hit the [marker](mta://reference/misc/marker.md).

- **matchingDimension:** *true* if the [player](mta://reference/misc/player.md) is in the same [dimension](mta://reference/misc/dimension.md) as the hit [marker](mta://reference/misc/marker.md).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [marker](mta://reference/misc/marker.md) that got hit by the player.
