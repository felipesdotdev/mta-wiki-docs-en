---
doc_id: "mta-wiki:12782"
title: "OnDgsMediaStop"
source_title: "OnDgsMediaStop"
source_url: "https://wiki.multitheftauto.com/wiki/OnDgsMediaStop"
revision_id: 68916
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:22.154587+00:00"
---

# OnDgsMediaStop

This event is fired when a dgs media browser stops.

## Parameters

- **currentTime**: The timestamp of the video/audio.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the dgs media browser who stops.
...
media = DGS:dgsCreateMediaBrowser(600,600)

function onStop(timestamp)
	outputChatBox("Paused "..timestamp)
end
addEventHandler("onDgsMediaStop",media,onStop)

image = DGS:dgsCreateImage(0,0,800,500,media,false)
DGS:dgsMediaLoadMedia(media ,"example.webm","VIDEO") -- Give a video file PLZ! (Only .webm file)
DGS:dgsMediaPlay(media)
setTimer(function()
	DGS:dgsMediaStop(media)
end,5000,1)
```
