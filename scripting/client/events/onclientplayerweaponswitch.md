...
generated_at: "2026-07-26T16:16:20.212037+00:00"
---

# OnClientPlayerWeaponSwitch

This event is triggered whenever the local player's equipped **[weapon slot](mta://reference/misc/weapon.md)** changes. This means giveWeapon and takeWeapon will trigger this event if the equipped slot is forced to change.
...
- **previousWeaponSlot**: An integer representing the previous [weapon slot](mta://reference/misc/weapon.md) the player had before he switched.

- **currentWeaponSlot**: An integer representing the new [weapon slot](mta://reference/misc/weapon.md) the player has after he switched.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who switched their weapon (Local player only)
