...
generated_at: "2026-07-26T16:16:19.604279+00:00"
---
...
- **attacker**: A [player](mta://reference/misc/player.md) [element](mta://reference/misc/element.md) representing the attacker or [vehicle](mta://reference/misc/vehicle.md) [element](mta://reference/misc/element.md) (when being run over or falling off a bike).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that got damaged. (Streamed in players only)
