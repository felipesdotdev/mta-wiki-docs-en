---
doc_id: "mta-wiki:12779"
title: "OnDgsSelectorSelect"
source_title: "OnDgsSelectorSelect"
source_url: "https://wiki.multitheftauto.com/wiki/OnDgsSelectorSelect"
revision_id: 68911
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:23.456170+00:00"
---

# OnDgsSelectorSelect

This event is fired when the selected item of a DGS selector is changed.
...
The [source](mta://reference/misc/event-system.md) of this event is the dgs selector element that got its selected item changed.
...
```
DGS = exports.dgs
selector = DGS:dgsCreateSelector(400,500,100,20,false)
for i=1,5000 do
...
addEventHandler("onDgsSelectorSelect",getRootElement(),onSelected)
```
