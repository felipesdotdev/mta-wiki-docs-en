...
generated_at: "2026-07-26T16:16:17.056282+00:00"
---
...
- **isBlocked:** if the [browser](mta://reference/misc/browser.md) was created with **isLocal** set to **true**, and the browser tried to load a remote page, this would be set to **true** (and vice-versa).
