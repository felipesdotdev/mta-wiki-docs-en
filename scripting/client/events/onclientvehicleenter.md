...
generated_at: "2026-07-26T16:16:20.559810+00:00"
---

# OnClientVehicleEnter

This event gets fired when a [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) enters a vehicle.
...
- **thePed:** the [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) that entered the vehicle

- **seat:** the number of the seat that the ped is now sitting on. 0 = driver, higher numbers are passenger seats.

## Source

The [source](mta://reference/misc/event-system.md) of the event is the [vehicle](mta://reference/misc/vehicle.md) that the ped entered.
