---
doc_id: "mta-wiki:12691"
title: "OnDgsMouseMultiClick"
source_title: "OnDgsMouseMultiClick"
source_url: "https://wiki.multitheftauto.com/wiki/OnDgsMouseMultiClick"
revision_id: 69032
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:22.810400+00:00"
---
...
The [source](mta://reference/misc/event-system.md) of this event is the DGS element that was multi clicked.
...
addEventHandler( "onDgsMouseMultiClick", button, function(button, state, x, y, times)
	if button == 'left' and state == 'up' then
		outputChatBox("You clicked " .. times .." times")
	end
end)
```
