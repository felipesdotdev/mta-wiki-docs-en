---
doc_id: "mta-wiki:9993"
title: "OnDgsFocus"
source_title: "OnClientDgsDxFocus"
source_url: "https://wiki.multitheftauto.com/wiki/OnClientDgsDxFocus"
revision_id: 53768
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:17.439895+00:00"
---
...
The [source](mta://reference/misc/event-system.md) of this event is the DGS element which just gained input focus.
...
When a widget in a window that didn't have focus before receives focus, *onDgsFocus* is triggered first for the window and then for the child widget.
When the window already had focus, *onDgsFocus* is only triggered for the newly focused child widget.
