---
doc_id: "mta-wiki:10008"
title: "OnDgsElementScroll"
source_title: "OnClientDgsDxScrollBarScrollPositionChange"
source_url: "https://wiki.multitheftauto.com/wiki/OnClientDgsDxScrollBarScrollPositionChange"
revision_id: 67721
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:18.214041+00:00"
---
...
The [source](mta://reference/misc/event-system.md) of this event is the dgs element that got scrolled (can be scroll pane, grid list, combo box, memo and scroll bar).
...
addEventHandler("onDgsElementScroll",root,OnScroll)
```
