---
doc_id: "mta-wiki:10915"
title: "OnDgsElementRender"
source_title: "OnDgsElementRender"
source_url: "https://wiki.multitheftauto.com/wiki/OnDgsElementRender"
revision_id: 59911
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:21.598826+00:00"
---

# OnDgsElementRender

This event is triggered every time after a dgs element renders with property [renderEventCall](mta://reference/misc/dgs-general-basic-properties.md).
...
The source is the dgs element that renders.

## Example

```
DGS = exports.dgs
window = DGS:dgsCreateWindow(200,200,500,200,"test",false)
dgsSetProperty(window,"renderEventCall",true)

function drawAboveWindow ()
	local x,y = DGS:dgsGetPosition(window,false)
	dxDrawRectangle(x,y,500,200,tocolor(0,0,0,200),true) -- POSTGUI is always set to true
end
addEventHandler ( "onDgsElementRender", window, drawAboveWindow )
```
