---
doc_id: "mta-wiki:10712"
title: "OnDgsMouseWheel"
source_title: "OnDgsMouseWheel"
source_url: "https://wiki.multitheftauto.com/wiki/OnDgsMouseWheel"
revision_id: 58142
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:23.001286+00:00"
---

# OnDgsMouseWheel

This event is triggered each time the user scrolls his mouse scroll on top of a DGS element.
...
- **upOrDown**: An [integer](mta://reference/misc/int.md) representing whether the scroll was scrolled up or down. This can be either **1** (mouse was scrolled up) or **-1** (mouse was scrolled down).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the DGS element on which the mouse scroll was scrolled.

## Example

The example tells player in which direction wheel was scrolled (UP or DOWN) and also the type of the DGS element that wheel was scrolled on.

```
addEventHandler( "onDgsMouseWheel", root,
    function ( up_down )
