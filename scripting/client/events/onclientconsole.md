---
doc_id: "mta-wiki:2576"
title: "OnClientConsole"
source_title: "OnClientConsole"
source_url: "https://wiki.multitheftauto.com/wiki/OnClientConsole"
revision_id: 82023
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:17.225384+00:00"
---

# OnClientConsole

This event is triggered when the local player enters text in the console. Note that, if you want to add custom console commands, it is easier to use the [addCommandHandler](mta://scripting/shared/functions/addcommandhandler.md) function.
