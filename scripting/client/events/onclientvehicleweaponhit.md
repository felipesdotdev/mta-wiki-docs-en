...
generated_at: "2026-07-26T16:16:20.680028+00:00"
---
...
- **hitElement**: The [vehicle](mta://reference/misc/vehicle.md), [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md) that was hit by the weapon sometimes *false*.
...
The [source](mta://reference/misc/event-system.md) of this event is the [vehicle](mta://reference/misc/vehicle.md) that fired the weapon.
