---
doc_id: "mta-wiki:13889"
title: "OnDgsElementLeave"
source_title: "OnDgsElementLeave"
source_url: "https://wiki.multitheftauto.com/wiki/OnDgsElementLeave"
revision_id: 77866
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:21.496677+00:00"
---

# OnDgsElementLeave

This event is fired when the user moves the mouse away from a DGS element even this DGS element is blocked by other DGS elements. This function is different from [onDgsMouseLeave](mta://scripting/client/events/ondgsmouseleave.md).

**You have to set property [enableFullEnterLeaveCheck](mta://reference/misc/dgs-general-basic-properties.md) of the DGS element to *true* to use this event** because full enter leave check is a little bit costly for cpu resource.
...
The [source](mta://reference/misc/event-system.md) of this event is the DGS element that was moved away from.
