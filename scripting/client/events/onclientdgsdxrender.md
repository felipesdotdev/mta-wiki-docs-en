---
doc_id: "mta-wiki:9995"
title: "OnDgsRender"
source_title: "OnClientDgsDxRender"
source_url: "https://wiki.multitheftauto.com/wiki/OnClientDgsDxRender"
revision_id: 53772
language: "en"
categories: ["Client_events"]
generated_at: "2026-07-26T16:16:18.154801+00:00"
---

# OnDgsRender

This event is triggered every time after dgs renders.
...
This example shows that we can draw a rectangle above dgs gui.

```
DGS = exports.dgs
edit = DGS:dgsCreateEdit(200,200,500,200,"test",false)

function drawAboveDGS ()
	dxDrawRectangle(200,200,500,200,tocolor(0,0,0,200),true) -- POSTGUI is always set to true
end
addEventHandler ( "onDgsRender", root, drawAboveDGS )
```
