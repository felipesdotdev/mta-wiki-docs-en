---
doc_id: "mta-wiki:13281"
title: "DgsGridListSetItemFont"
source_title: "DgsGridListSetItemFont"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetItemFont"
revision_id: 71599
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:36.106779+00:00"
---

# DgsGridListSetItemFont

This function changes the font of an item of a dgs grid list.

## Syntax

```
bool dgsGridListSetItemFont( element gridList, int rowIndex, int columnIndex, string/dx-font font )
```
...
function createPlayerList ()
	...
	if ( column ) then --If the column has been created, fill it with players
		for id, player in ipairs(getElementsByType("player")) do
			...
			DGS:dgsGridListSetItemFont ( playerList, row, column, "default-bold" )
		end
	end
end
createPlayerList ()
