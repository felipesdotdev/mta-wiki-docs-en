---
doc_id: "mta-wiki:13840"
title: "DgsTooltipRemoveFrom"
source_title: "DgsTooltipRemoveFrom"
source_url: "https://wiki.multitheftauto.com/wiki/DgsTooltipRemoveFrom"
revision_id: 75808
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:37.796687+00:00"
---

# DgsTooltipRemoveFrom

This function removes tooltip from a DGS element.

## Syntax

```
bool dgsTooltipRemoveFrom( element targetElement )
```

### Required Arguments

- **targetElement:** A DGS element that you want to remove the tooltip from.
...
local label = DGS:ddgsCreateLabel(200,200,200,50,"test tooltip",false)
local tooltip = DGS:ddgsCreateToolTip()
DGS:ddgsTooltipApplyTo(tooltip,label,"this a demo tooltip")
DGS:dgsTooltipRemoveFrom(label)
```
