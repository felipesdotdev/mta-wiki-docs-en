---
doc_id: "mta-wiki:12366"
title: "DgsGridListGetItemSelectable"
source_title: "DgsGridListGetItemSelectable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetItemSelectable"
revision_id: 66693
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:26.032425+00:00"
---

# DgsGridListGetItemSelectable

This function gets whether the item is selectable.

## Syntax

```
bool dgsGridListGetItemSelectable( element gridlist, int row, int column )
```
...
- **column:** The row index of the grid list.
...
for id, player in ipairs(getElementsByType("player")) do
	...
	iprint(DGS:dgsGridListGetItemSelectable(playerList, row, column))
end
```
