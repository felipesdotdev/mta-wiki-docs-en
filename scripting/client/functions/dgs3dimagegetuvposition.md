---
doc_id: "mta-wiki:13160"
title: "Dgs3DImageGetUVPosition"
source_title: "Dgs3DImageGetUVPosition"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageGetUVPosition"
revision_id: 70833
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:26.803559+00:00"
---

# Dgs3DImageGetUVPosition

This function gets the UV positon of a DGS 3d image (Only available when there is a texture loaded in DGS 3d image).

## Syntax

```
float, float dgs3DImageGetUVPosition ( element dgs3DImage, bool relative )
```

### Required Arguments

- **dgs3DImage**: The dgs 3d image of which you wish to retrieve the UV position.
...
Returns floats representing the *U* and *V* position of the 3d image, or false if the position could not be retrieved.
...
local texture = dxCreateTexture("test.png") -- Example File
local image = DGS:dgsCreate3DImage(0,0,4,texture,tocolor(255,255,255,255),10,10)
local UPos,VPos = DGS:dgs3DImageGetUVPosition(image,false)
DGS:dgs3DImageSetUVPosition(image,UPos+10,VPos+10,false)
```
