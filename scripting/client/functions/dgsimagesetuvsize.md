---
doc_id: "mta-wiki:10985"
title: "DgsImageSetUVSize"
source_title: "DgsImageSetUVSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsImageSetUVSize"
revision_id: 70774
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:44.030559+00:00"
---

# DgsImageSetUVSize

This function sets the UV size of a DGS image (Only available when there is a texture loaded in DGS image).

## Syntax

```
bool dgsImageSetUVSize ( element dgsImage, float UPos, float VPos, bool relative )
```

### Required Arguments

- **dgsImage**: The dgs image of which you want to set the UV size.

- **UPos**: A float of the U size of image.

- **VPos**: A float of the V size of image.
...
local UPos,VPos = DGS:dgsImageGetUVSize(image,false)
DGS:dgsImageSetUVSize(image,UPos+10,VPos+10,false)
```
