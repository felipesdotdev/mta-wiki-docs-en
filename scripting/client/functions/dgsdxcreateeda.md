---
doc_id: "mta-wiki:9912"
title: "DgsCreateEDA"
source_title: "DgsDxCreateEDA"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxCreateEDA"
revision_id: 65441
language: "en"
categories: ["Client_functions", "Deprecated", "Utility_templates"]
generated_at: "2026-07-26T16:13:04.330894+00:00"
---
...
| --- | --- |
| Please use dgsCreateDetectArea instead. |  |

This function creates an ellipse detect area.

## Syntax

```
element dgsCreateEDA ( float x, float y, float width, float height, bool relative, [element parent = nil ] )
```
...
- **width:** A float of the width of the image. This is affected by the *relative* argument ( Can be regarded as major axis length of ellipse ).

- **height:** A float of the height of the image. This is affected by the *relative* argument ( Can be regarded as minor axis length of ellipse ).
...
Returns [element](mta://reference/misc/element.md) if ellipse detect area was created successfully, *false* otherwise.
...
This example will create circle detect area and set to debug mode to display a ellipse on the player's screen.

```
DGS = exports.dgs
eda = DGS:dgsCreateEDA(400,300,200,200,false) -- minor axis equals to major axis
DGS:dgsEDASetDebugModeEnabled(eda,true)  --Set debug mode so that we can see where it is and how it looks like.
```
