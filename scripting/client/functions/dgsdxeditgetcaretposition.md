---
doc_id: "mta-wiki:9927"
title: "DgsEditGetCaretPosition"
source_title: "DgsDxEditGetCaretPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxEditGetCaretPosition"
revision_id: 53534
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:08.476850+00:00"
---

# DgsEditGetCaretPosition

This function gets the current position of the caret (the text cursor) within the edit box.

## Syntax

```
int dgsEditGetCaretPosition ( element theElement )
```

### Required Arguments

- **theElement:** The edit box to get from.

### Returns

Returns an *integer* indicating the index of the caret.
...
index = DGS:dgsEditGetCaretPosition(edit)
outputChatBox("Caret Position: Index ("..index..")")
```
