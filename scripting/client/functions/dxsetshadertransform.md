...
generated_at: "2026-07-26T16:14:51.368325+00:00"
---

# DxSetShaderTransform

This function applies a 3D transformation to a [shader](mta://reference/misc/shader.md) element when it is drawn with [dxDrawImage](mta://scripting/client/functions/dxdrawimage.md).
...
**Method**: *[shader](mta://reference/misc/shader.md):setTransform(...)*
