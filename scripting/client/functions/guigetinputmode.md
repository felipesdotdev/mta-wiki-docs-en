---
doc_id: "mta-wiki:5465"
title: "GuiGetInputMode"
source_title: "GuiGetInputMode"
source_url: "https://wiki.multitheftauto.com/wiki/GuiGetInputMode"
revision_id: 82607
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:35.179564+00:00"
---

# GuiGetInputMode

This function returns the current input mode as set by [guiSetInputMode](mta://scripting/client/functions/guisetinputmode.md).
Default mode is *"allow_binds"*.

This function is **not** a replacement of [guiGetInputEnabled](mta://scripting/client/functions/guigetinputenabled.md), indeed for the mode *"no_binds_when_editing"* the actual state of binds depends on the currently focused GUI widget. However:
...
**Method**: *[GuiElement](mta://scripting/concepts/gui-widgets.md).getInputMode(...)*

**Variable**: *.inputMode*

**Counterpart**: *[guiSetInputMode](mta://scripting/client/functions/guisetinputmode.md)*
