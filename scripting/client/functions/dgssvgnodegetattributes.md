---
doc_id: "mta-wiki:13629"
title: "DgsSVGNodeGetAttributes"
source_title: "DgsSVGNodeGetAttributes"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSVGNodeGetAttributes"
revision_id: 81338
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:19.244346+00:00"
---

# DgsSVGNodeGetAttributes

This function gets [xmlnode](mta://reference/misc/xmlnode.md) attributes value.

## Syntax

```
table dgsSVGNodeGetAttributes( xmlnode xmlNode [, table attributes ] )
```

### Required Arguments

- **xmlNode**: [xmlnode](mta://reference/misc/xmlnode.md) That you want to get its attributes and value .

### Optional Arguments

- **attributes**: An array includes the attributes that you want to get.

### Returns

- Returns a table with key as attribute and value as attribute vlue if succeed, *false* otherwise.
...
local attributes = dgsSVGNodeGetAttributes(rect)
outputChatBox("Get All Attributes:")
for attribute, value in pairs(attributes) do
	outputChatBox(attribute.." = "..tostring(value))
end

outputChatBox("Get 2 Attributes:")
local attributes = dgsSVGNodeGetAttributes(rect, {"stroke","fill"} )
for attribute, value in pairs(attributes) do
	outputChatBox(attribute.." = "..tostring(value))
end
```
