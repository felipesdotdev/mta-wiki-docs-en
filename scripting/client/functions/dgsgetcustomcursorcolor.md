---
doc_id: "mta-wiki:12776"
title: "DgsGetCustomCursorColor"
source_title: "DgsGetCustomCursorColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetCustomCursorColor"
revision_id: 68920
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:11.283589+00:00"
---

# DgsGetCustomCursorColor

This function gets the color of DGS custom cursor.

## Syntax

```
int dgsGetCustomCursorColor( )
```

### Returns

Returns an *integer* indicates the color of the curstom cursor if successful, *false* otherwise.
...
outputChatBox(DGS:dgsGetCustomCursorColor()) --The default color
```
