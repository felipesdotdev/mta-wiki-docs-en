...
generated_at: "2026-07-26T16:16:44.994309+00:00"
---

# SetSoundPaused

This function is used to either pause or unpause the playback of the specified [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](mta://reference/misc/sound.md):setPaused(...)*
...
- **theSound:** the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) which you want to pause/unpause.
...
Returns *true* if the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) was successfully paused, *false* otherwise.
