...
generated_at: "2026-07-26T16:15:30.987811+00:00"
---
...
- **thePed:** A [ped](mta://reference/misc/ped.md) element.

- **weapon:** A whole number integer that refers to a [Weapon](mta://reference/misc/weapon.md) ID. Click [here](mta://reference/misc/weapon.md) for a list of possible weapon IDs.
