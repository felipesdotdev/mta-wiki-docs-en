...
generated_at: "2026-07-26T16:16:47.871239+00:00"
---

# SetVehicleNitroCount

This function sets how many times a player can activate the nitro on a specified [vehicle](mta://reference/misc/vehicle.md).
...
- **theVehicle**: the [vehicle](mta://reference/misc/vehicle.md) which you want to modify how many times a player can use its nitro.

- **count**: how many times should the player be able to use the nitro of this [vehicle](mta://reference/misc/vehicle.md) (from 0-100 times; 0 means that it can't be used and 101 means that it can be used infinite times).
