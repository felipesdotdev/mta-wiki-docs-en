...
generated_at: "2026-07-26T16:14:56.736562+00:00"
---
...
The returned [DFF](mta://reference/misc/dff.md) element is an element in the element tree, just like vehicles and objects. When the dff is destroyed, ie on resource unload or using [destroyElement](mta://scripting/shared/functions/destroyelement.md), any elements that use the DFF, such as vehicles or objects will be reset.
...
**Method**: *[EngineDFF](mta://reference/misc/dff.md)(...)*
...
Returns a [DFF](mta://reference/misc/dff.md) element if the dff file loaded, *false* otherwise.
