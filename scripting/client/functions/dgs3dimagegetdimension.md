---
doc_id: "mta-wiki:13166"
title: "Dgs3DImageGetDimension"
source_title: "Dgs3DImageGetDimension"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageGetDimension"
revision_id: 70830
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:25.449058+00:00"
---

# Dgs3DImageGetDimension

This function gets the dimension (-1~65535) of the DGS 3D Image.

## Syntax

```
int dgs3DImageGetDimension( element image3D )
```

### Required Arguments

- **image3D:** The DGS 3D Image element.( Dimension -1 means 3d image is visible in any dimension )

### Returns

Returns an *int* if successful, *false* otherwise.
...
outputChatBox(DGS:dgs3DImageGetDimension(image)) --Default is -1
```
