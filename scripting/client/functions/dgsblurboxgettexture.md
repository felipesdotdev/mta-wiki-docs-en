---
doc_id: "mta-wiki:12852"
title: "DgsBlurBoxGetTexture"
source_title: "DgsBlurBoxGetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsBlurBoxGetTexture"
revision_id: 69610
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:48.500057+00:00"
---

# DgsBlurBoxGetTexture

This function gets the texture that is used in blur box.

## Syntax

```
texture dgsBlurBoxGetTexture( element blurbox )
```
...
Returns a *texture* there is a texture used in blur box, *false* otherwise.
...
setTimer(function()
	local texture = DGS:dgsBlurBoxGetTexture(blurbox)  --Get texture
	destroyElement(texture) --Release
	DGS:dgsBlurBoxSetTexture(blurbox)  --Remove
end,5000,1)
```
