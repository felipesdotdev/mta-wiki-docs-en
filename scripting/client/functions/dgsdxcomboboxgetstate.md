---
doc_id: "mta-wiki:9972"
title: "DgsComboBoxGetState"
source_title: "DgsDxComboBoxGetState"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxComboBoxGetState"
revision_id: 53678
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:20.287598+00:00"
---

# DgsComboBoxGetState

This function gets the state of combo box ( true:Drop Down; false:Take Back ).

## Syntax

```
bool dgsComboBoxGetState( element comboBox )
```

### Required Arguments

- **comboBox:** the combo box you want to get the state from.

### Returns

Returns a bool if the state of combo box has been got successfully.
...
dropState = DGS:dgsComboBoxGetState(combobox)
outputChatBox("Combo Box State: "..(dropState and "Dropped Down" or "Taken Back"))
```
