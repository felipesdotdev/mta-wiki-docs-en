---
doc_id: "mta-wiki:13861"
title: "DgsLineGetItemWidth"
source_title: "DgsLineGetItemWidth"
source_url: "https://wiki.multitheftauto.com/wiki/DgsLineGetItemWidth"
revision_id: 75996
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:49.965921+00:00"
---

# DgsLineGetItemWidth

This function gets the width of an item of DGS Line.

## Syntax

```
float dgsLineGetItemWidth( element line, int index )
```
...
Returns a *float* indicates the width of the item if successful, *false* otherwise
...
local width = DGS:dgsLineGetItemWidth(line, 1)
outputChatBox("Width: "..width)
```
