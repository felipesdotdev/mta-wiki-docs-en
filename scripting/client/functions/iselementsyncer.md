...
generated_at: "2026-07-26T16:15:55.638756+00:00"
---

# IsElementSyncer

This function checks whether an [element](mta://reference/misc/element.md) is synced by the local player or not. Accepted elements are [peds](mta://reference/misc/ped.md) and [vehicles](mta://reference/misc/vehicle.md).
