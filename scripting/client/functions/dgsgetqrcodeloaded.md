---
doc_id: "mta-wiki:11964"
title: "DgsGetQRCodeLoaded"
source_title: "DgsGetQRCodeLoaded"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetQRCodeLoaded"
revision_id: 65060
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:16.129143+00:00"
---

# DgsGetQRCodeLoaded

This function gets whether the DGS QRCode is loaded or not.

## Syntax

```
bool dgsGetQRCodeLoaded( element QRCode )
```

### Required Arguments

- **QRCode :** A dgs-dxqrcode element.

### Returns

Returns *true* if the QRCode is loaded, *false* otherwise.
