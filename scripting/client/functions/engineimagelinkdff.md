---
doc_id: "mta-wiki:14038"
title: "EngineImageLinkDFF"
source_title: "EngineImageLinkDFF"
source_url: "https://wiki.multitheftauto.com/wiki/EngineImageLinkDFF"
revision_id: 79937
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:14:56.476575+00:00"
---
...
This function links DFF file with an IMG container. This function does not change a model immediately. You should use [engineRestreamWorld](mta://scripting/client/functions/enginerestreamworld.md) to reload models. 
...
**Method**: *[img](https://wiki.multitheftauto.com/index.php?title=Img&action=edit&redlink=1):linkDFF(...)*

### Required Arguments

- **img_file**: The [IMG](https://wiki.multitheftauto.com/index.php?title=IMG&action=edit&redlink=1) file you want to link.

- **file_path**: Path to the [DFF](mta://reference/misc/dff.md) file you want to link.
