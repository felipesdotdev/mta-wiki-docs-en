---
doc_id: "mta-wiki:9952"
title: "DgsScrollPaneGetScrollBar"
source_title: "DgsDxScrollPaneGetScrollBar"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxScrollPaneGetScrollBar"
revision_id: 53611
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:15.042219+00:00"
---

# DgsScrollPaneGetScrollBar

This function gets two scroll bars of dgs scroll pane.

## Syntax

```
table dgsScrollPaneGetScrollBar( element scrollPane )
```

### Required Arguments

- **scrollPane :** The dgs scroll pane element to be got from.

### Returns

Returns a table which includes two scroll bars {vertical,horizontal} if scroll bars are got successfully, *false* otherwise.
...
function clientsideResourceStart ()
	...
	local testList = DGS:dgsCreateScrollPane ( 0.45, 0.45, 0.15, 0.15, true ) 
	-- Get the Scroll Bar
	local scrollBars = DGS:dgsScrollPaneGetScrollBar( theList )
	DGS:dgsSetVisible(scrollBars[1],true) -- set the vertical scroll bar visible
end
