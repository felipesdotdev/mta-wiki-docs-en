...
generated_at: "2026-07-26T16:16:41.854463+00:00"
---

# SetPedAnalogControlState

Sets an analog state of a specified [ped](mta://reference/misc/ped.md)'s control, as if they pressed or released it.

This function only works on [peds](mta://reference/misc/ped.md), to change the analog control state for a player, please use [setAnalogControlState](mta://scripting/client/functions/setanalogcontrolstate.md).
