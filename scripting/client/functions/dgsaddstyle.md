---
doc_id: "mta-wiki:13208"
title: "DgsAddStyle"
source_title: "DgsAddStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsAddStyle"
revision_id: 71099
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:44.974099+00:00"
---

# DgsAddStyle

This function adds a style into dgs, which is needed for external resource. This function is unncessary if you load the style from DGS style system.

## Syntax

```
bool dgsAddStyle( string styleName, string stylePath [, resource-data/string bindResource = resource ] )
```

### Required Arguments

- **styleName**: A string of the style name that you want to add.

- **stylePath**: A string of the style path.

### Optional Arguments

- **bindResource**:  A resource-data you want to bind to. For DGS global, use string "**global**". Leave this to *nil* to use **resource**([getThisResource](mta://scripting/shared/functions/getthisresource.md)). [Note: When resource stops, the style will also be unloaded]
