---
doc_id: "mta-wiki:9985"
title: "DgsCreateProgressBar"
source_title: "DgsDxCreateProgressBar"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxCreateProgressBar"
revision_id: 65590
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:13:23.592913+00:00"
---
...
```
element dgsCreateProgressBar ( float x, float y, float width, float height, bool relative [, element parent = nil, texture bgImage = nil, int bgColor = nil, texture indicatorImage = nil, int indicatorColor = nil, bool indicatorMode = false ] )
```

### Required Arguments

 
Example dx progress bar.
...
- **parent:** This is the parent that the DGS progress bar is attached to.  If the *relative* argument is true, sizes and positioning will be made relative to this parent. If the *relative* argument is false, positioning will be the number of offset pixels from the parent's origin. If no parent is passed, the parent will become the screen - causing positioning and sizing according to screen positioning.

- **bgImage:** An image element of the background of the progress bar.

- **bgColor:** An int of the color of the background of the progress bar.

- **indicatorImage:** An image element of the background of the indicator of the progress bar.

- **indicatorColor:** An int of the color of the background of the indicator of the progress bar.

- **indicatorMode:** A bool of the mode of the indicator of progress bar. (true:the image of bar of progress bar will be relative ;false:the image of bar of progress bar will be absolute )

### Returns

Returns [element](mta://reference/misc/element.md) of the progress bar if it was created successfully, *false* otherwise.
