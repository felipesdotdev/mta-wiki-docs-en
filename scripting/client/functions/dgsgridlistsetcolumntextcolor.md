---
doc_id: "mta-wiki:13825"
title: "DgsGridListSetColumnTextColor"
source_title: "DgsGridListSetColumnTextColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetColumnTextColor"
revision_id: 76033
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:34.358054+00:00"
---

# DgsGridListSetColumnTextColor

This function changes the color of a gridlist column title.

## Syntax

```
bool dgsGridListSetColumnTextColor( element gridList, int columnIndex, int color )
```
...
```
bool dgsGridListSetColumnTextColor( element gridList, int columnIndex, int r, int g, int b [, int a = 255 ] )
```
...
function createGridList()
    local gridlist = dgsCreateGridList(0.3, 0.3, 0.4, 0.4, true)
    dgsGridListAddColumn(gridlist, "Column 1", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 1, tocolor(255, 0, 0))

    dgsGridListAddColumn(gridlist, "Column 2", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 2, tocolor(0, 255, 0))

    dgsGridListAddColumn(gridlist, "Column 3", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 3, tocolor(0, 0, 255))

    dgsGridListAddColumn(gridlist, "Column 4", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 4, tocolor(255, 255, 0))

    for i = 1, 100 do
        local row = dgsGridListAddRow(gridlist)
        dgsGridListSetItemText(gridlist, row, 1, "Row " .. i)
        dgsGridListSetItemText(gridlist, row, 2, "Row " .. i)
        dgsGridListSetItemText(gridlist, row, 3, "Row " .. i)
        dgsGridListSetItemText(gridlist, row, 4, "Row " .. i)
    end
end
createGridList()
```
...
function createGridList()
    ...
    local gridlist = dgsCreateGridList(0.3, 0.3, 0.4, 0.4, true)
    dgsGridListAddColumn(gridlist, "Column 1", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 1, 255, 0, 0)

    dgsGridListAddColumn(gridlist, "Column 2", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 2, 0, 255, 0)

    dgsGridListAddColumn(gridlist, "Column 3", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 3, 0, 0, 255)

    dgsGridListAddColumn(gridlist, "Column 4", 0.25)
    dgsGridListSetColumnTextColor(gridlist, 4, 255, 255, 0, 180)
