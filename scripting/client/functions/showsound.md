---
doc_id: "mta-wiki:13362"
title: "ShowSound"
source_title: "ShowSound"
source_url: "https://wiki.multitheftauto.com/wiki/ShowSound"
revision_id: 81317
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:16:50.772605+00:00"
---

# ShowSound

Prints world [sound](mta://reference/misc/sound.md) IDs in the debug output window to help when writing scripts with [setWorldSoundEnabled](mta://scripting/client/functions/setworldsoundenabled.md).

| [[{{{image}}}\|link=\|]] | Note: This function only works in development mode. |
| --- | --- |
|  |  |
...
- **state:** A [boolean](mta://reference/misc/boolean.md) indicating if the world sound IDs should be printed in the debug window or not.
