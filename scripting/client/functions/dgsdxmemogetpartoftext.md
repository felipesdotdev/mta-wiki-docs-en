---
doc_id: "mta-wiki:9942"
title: "DgsMemoGetPartOfText"
source_title: "DgsDxMemoGetPartOfText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoGetPartOfText"
revision_id: 61904
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:12.473721+00:00"
---

# DgsMemoGetPartOfText

This function returns a part of text from the memo by index and line.

## Syntax

```
string dgsMemoGetPartOfText ( element theElement [, int startIndex = 0, int startLine = 1, int endIndex, int endLine, bool deleteText = false ] )
```
...
- **startIndex:** An integer indicated where the text of the memo is selected from ( the text index of current 'startLine'. start from 0 ).

- **startLine:** An integer indicated which line of the text of the memo is selected from ( start from 1 ).

- **endIndex:** An integer indicated where the text of the memo is selected to ( the text index of current 'endLine'. start from 0 ).

- **endLine:** An integer indicated which line of the text of the memo is selected to ( start from 1 ).

- **deleteText:** A bool indicated whether the selected text will be deleted after calling this function.

### Returns

Returns a string of the selected text if successful, *false* otherwise.
...
text = DGS:dgsMemoGetPartOfText(memo,1,1,1,3)
outputChatBox(text)
```
