---
doc_id: "mta-wiki:10725"
title: "DgsMediaGetMediaPath"
source_title: "DgsMediaGetMediaPath"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMediaGetMediaPath"
revision_id: 58398
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:53.965375+00:00"
---

# DgsMediaGetMediaPath

This function returns file path of the media in the ([dgsCreateMediaBrowser](mta://scripting/client/functions/dgscreatemediabrowser.md)) element.

## Syntax

```
string dgsMediaGetMediaPath ( element media )
```

### Required Arguments

- **media:** The element media that you want it's file path.

### Returns

Returns file path of the loaded media of media browser element, false if there's no media.

## Example

This example loads a local gif image and outputs the file path to chatBox.
...
if browser then -- Check if browser exists
    path = dgsMediaGetMediaPath
        if path then -- Check if path extracted
            outputChatBox("The playing file path is: "..path) -- then output to chatbox
        end
    end
end
```
