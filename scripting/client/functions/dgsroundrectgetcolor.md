---
doc_id: "mta-wiki:11245"
title: "DgsRoundRectGetColor"
source_title: "DgsRoundRectGetColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectGetColor"
revision_id: 77575
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:14.955590+00:00"
---

# DgsRoundRectGetColor

This function gets the color of the dgs rounded rectangle.

## Syntax

```
int dgsRoundRectGetColor( element rndRect )
```
...
Returns an *int* value of the color if successful, *false* otherwise.
...
function fromcolor(int)  --from color
	local a,r,g,b
	b = int%256
	local int = (int-b)/256
	g = int%256
...
local r,g,b,a = fromcolor(DGS:dgsRoundRectGetColor(rndRect))
