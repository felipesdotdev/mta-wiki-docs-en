---
doc_id: "mta-wiki:2690"
title: "GetElementDistanceFromCentreOfMassToBaseOfModel"
source_title: "GetElementDistanceFromCentreOfMassToBaseOfModel"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementDistanceFromCentreOfMassToBaseOfModel"
revision_id: 78648
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:11.384812+00:00"
---

# GetElementDistanceFromCentreOfMassToBaseOfModel

This function is used to retrieve the distance between a [element](mta://reference/misc/element.md)'s centre of mass to the base of the model. This can be used to calculate the position the [element](mta://reference/misc/element.md) has to be set to, to have it on ground level.

| [[{{{image}}}\|link=\|]] | Note: The distance value is only available when the element is streamed in, otherwise 0 is returned. If you create an element at the player's position which is going to be streamed in, call the function in the next frame to obtain the correct value (with setTimer 0ms, for example). |
| --- | --- |
|  |  |
...
**Method**: *[element](mta://reference/misc/element.md):getDistanceFromCentreOfMassToBaseOfModel(...)*
