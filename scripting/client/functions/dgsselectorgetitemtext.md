---
doc_id: "mta-wiki:12873"
title: "DgsSelectorGetItemText"
source_title: "DgsSelectorGetItemText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorGetItemText"
revision_id: 69745
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:27.056300+00:00"
---

# DgsSelectorGetItemText

This function retrieves the text from a specific selector item.

## Syntax

```
string dgsSelectorGetItemText ( element selector, int item )
```

### Required Arguments

- **selector:** the gridlist containing the item you're interested in

- **item:** the index of the item

### Returns

Returns the text of the item if the arguments are correct, *false* otherwise.
...
addEventHandler ( "onDgsSelectorSelect", selector, function ( selected )
	local output = DGS:dgsSelectorGetItemText(selector,selected)
