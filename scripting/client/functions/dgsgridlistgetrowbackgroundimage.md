---
doc_id: "mta-wiki:10739"
title: "DgsGridListGetRowBackGroundImage"
source_title: "DgsGridListGetRowBackGroundImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetRowBackGroundImage"
revision_id: 58519
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:27.594756+00:00"
---

# DgsGridListGetRowBackGroundImage

This function gets the row background image from the grid list.

## Syntax

```
texture/nil, texture/nil, texture/nil dgsGridListGetRowBackGroundImage( element gridList, int rowIndex )
```
...
local a,b,c = DGS:dgsGridListGetRowBackGroundImage(gridlist, 2)
outputChatBox(tostring(a)) -- default is nil XD
```
