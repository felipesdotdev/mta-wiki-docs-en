---
doc_id: "mta-wiki:10983"
title: "DgsImageGetUVPosition"
source_title: "DgsImageGetUVPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsImageGetUVPosition"
revision_id: 70776
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:42.955133+00:00"
---

# DgsImageGetUVPosition

This function gets the UV positon of a DGS image (Only available when there is a texture loaded in DGS image).

## Syntax

```
float, float dgsImageGetUVPosition ( element dgsImage, bool relative )
```

### Required Arguments

- **dgsImage**: The dgs image of which you wish to retrieve the UV position.
...
Returns floats representing the *U* and *V* position of the image, or false if the position could not be retrieved.
...
local image = DGS:dgsCreateImage(400,400,400,400,texture,false)
local UPos,VPos = DGS:dgsImageGetUVPosition(image,false)
DGS:dgsImageSetUVPosition(image,UPos+10,VPos+10,false)
```
