---
doc_id: "mta-wiki:13853"
title: "Dgs3DLineGetItemPosition"
source_title: "Dgs3DLineGetItemPosition"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DLineGetItemPosition"
revision_id: 75994
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:37.788637+00:00"
---

# Dgs3DLineGetItemPosition

This function gets the position of the specified item of DGS 3D Line.

## Syntax

```
float/nil, float/nil, float/nil, float, float, float dgs3DLineGetItemPosition( element line3D, int index )
```
...
Returns 6 *float*s indicates start position x, y, z and end position x, y, z of the item. Or 3 *nil*s and 3 *float*s if using end position of previous item as start position of current item, *false* otherwise.
...
local sx,sy,sz,ex,ey,ez = DGS:dgs3DLineGetItemPosition(line,1)
outputChatBox("startX:"..sx..";startY:"..sy..";startZ:"..sz..";endX:"..ex..";endY:"..ey..";endZ:"..ez)
```
