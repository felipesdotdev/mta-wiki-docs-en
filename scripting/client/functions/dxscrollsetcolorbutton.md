---
doc_id: "mta-wiki:14437"
title: "DxScrollSetColorButton"
source_title: "DxScrollSetColorButton"
source_url: "https://wiki.multitheftauto.com/wiki/DxScrollSetColorButton"
revision_id: 80651
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:51.022874+00:00"
---

# DxScrollSetColorButton

Esta funcion modifica el color del boton para la barra de desplazamiento ya creada [dxScroll](mta://scripting/client/functions/dxscroll.md).
...
```
bool dxScrollSetColor(element element, int r, int g, int b, int a)
```
...
dxScrollSetColor(scrollH, 50, 50, 250, 255)
dxScrollSetColor(scrollV, 0, 50, 0, 255)
```
