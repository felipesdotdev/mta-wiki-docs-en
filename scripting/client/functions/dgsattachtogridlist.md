---
doc_id: "mta-wiki:12369"
title: "DgsAttachToGridList"
source_title: "DgsAttachToGridList"
source_url: "https://wiki.multitheftauto.com/wiki/DgsAttachToGridList"
revision_id: 71126
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:46.559725+00:00"
---

# DgsAttachToGridList

This function allows you to attach a specific dgs element to a dgs gridlist. This function will force to set the parent of dgs element to the grid list.

## Syntax

```
bool dgsAttachToGridList( element dgsElement, element gridList, int rowIndex, int columnIndex )
```
...
- **gridList:** A dgs gridList you want to attach to
...
This example attach label to a gridlist

```
DGS = exports.dgs

gridlist= DGS:dgsCreateGridList(50,50,100,100,false) -- create a gridlist
row = DGS:dgsGridListAddRow(gridlist) -- create a row for the gridlist
column = DGS:dgsGridListAddColumn(gridlist,"Title",1) -- create a column for the gridlist
label = DGS:dgsCreateLabel(0,10,100,100,"label", false) -- create a label
DGS:dgsAttachToGridList(label,gridlist,row,column) -- attach label to gridlist
```
