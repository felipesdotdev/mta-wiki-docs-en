---
doc_id: "mta-wiki:9937"
title: "DgsMemoGetCaretPosition"
source_title: "DgsDxMemoGetCaretPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoGetCaretPosition"
revision_id: 53569
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:11.208738+00:00"
---

# DgsMemoGetCaretPosition

This function gets the current position of the caret (the text cursor) within the memo.

## Syntax

```
int int dgsMemoGetCaretPosition ( element theElement )
```

### Required Arguments

- **theElement:** The memo to get from.

### Returns

Returns two *integers* indicating the position of the caret, index and line respectively.
...
index,line = DGS:dgsMemoGetCaretPosition(memo)
outputChatBox("Caret Position: Index ("..index..")  Line ("..line..")")
```
