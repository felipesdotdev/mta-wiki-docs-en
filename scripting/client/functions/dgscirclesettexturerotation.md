---
doc_id: "mta-wiki:13386"
title: "DgsCircleSetTextureRotation"
source_title: "DgsCircleSetTextureRotation"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleSetTextureRotation"
revision_id: 77584
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:58.139610+00:00"
---

# DgsCircleSetTextureRotation

This function changes the texture rotation of the dgs circle. Texture rotation will be affect by rotation [dgsCircleSetRotation](mta://scripting/client/functions/dgscirclesetrotation.md).

## Syntax

```
bool dgsCircleSetTextureRotation( element circle, float rotDegree [, float rotCenterX = rotCenterX, float rotCenterY = rotCenterY ] )
```

### Required Arguments

- **circle**: A dgs-dxcircle plugin that you want to change.

- **rotDegree**: A float that indicates the rotation in degree.

### Optional Arguments

- **rotCenterX**: Rotation Origin X.

- **rotCenterY**: Rotation Origin Y.
...
local t = dxCreateTexture("exampleTexture.png")
local img = DGS:dgsCreateImage(300,200,200,200,c,false)
DGS:dgsCircleSetTexture(c,t)
DGS:dgsCircleSetTextureRotation(c,45,0.5,0.5) -- Rotate 45° from center.
```
