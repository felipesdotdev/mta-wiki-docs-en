---
doc_id: "mta-wiki:10142"
title: "DgsImportFunction"
source_title: "DgsImportFunction"
source_url: "https://wiki.multitheftauto.com/wiki/DgsImportFunction"
revision_id: 55298
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:44.312982+00:00"
---
...
When you load dgs API with dgsImportFunction, there will be some predefine functions/variables

- **Variable:**

- dgsRoot : DGS resource root element

## Syntax

```
string dgsImportFunction( [ string functionName ] )
```
...
- **functionName :** The specific function you want to load by its name.
...
loadstring(exports.dgs:dgsImportFunction())()
local label = dgsCreateLabel(0,0,1,1,"DGS",true)
dgsSetProperty(label,"rightbottom",{"center","center"})
dgsSetProperty(label,"shadow",{1,1,tocolor(0,0,0,255)})
```
