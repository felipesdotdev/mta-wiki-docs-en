---
doc_id: "mta-wiki:13687"
title: "DxGridList"
source_title: "DxGridList"
source_url: "https://wiki.multitheftauto.com/wiki/DxGridList"
revision_id: 74656
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:49.794534+00:00"
---

# DxGridList

Esta función crea una lista de cuadrícula basado en dxDrawing.
...
```
element dxGridList( int x, int y, int w, int h, [ element parent = nil] )
```
...
- **w**: Un entero que representa el ancho del dxGridList.

- **h**: Un entero que representa la altura del dxGridList.

### Argumentos Opcionales

- **parent**: Este es el padre el cual la [gridlist](https://wiki.multitheftauto.com/wiki/dxGridList) se adjunta.
