---
doc_id: "mta-wiki:12565"
title: "DgsSelectorRemoveItem"
source_title: "DgsSelectorRemoveItem"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorRemoveItem"
revision_id: 67796
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:27.643289+00:00"
---

# DgsSelectorRemoveItem

This function removes the selected item from a dgs selector.

## Syntax

```
bool dgsSelectorRemoveItem( element selector, int item )
```

### Required Arguments

- **selector:** the dgs selector you want to remove an item from
...
addEventHandler("onClientResourceStart", resourceRoot, function()
    ...
    DGS:dgsSelectorRemoveItem(selector,5) //Remove the '5'
    showCursor(true) 
end)
```
