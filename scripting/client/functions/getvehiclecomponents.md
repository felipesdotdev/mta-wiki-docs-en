...
generated_at: "2026-07-26T16:15:27.278522+00:00"
---

# GetVehicleComponents

This function gets a table of the components currently on a [vehicle](mta://reference/misc/vehicle.md).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getComponents(...)*

**Variable**: *.components*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) you wish to get the [components](mta://reference/misc/vehicle-components.md) of.
