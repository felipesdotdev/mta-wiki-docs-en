---
doc_id: "mta-wiki:12325"
title: "DgsGetRemoteImageLoadState"
source_title: "DgsGetRemoteImageLoadState"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetRemoteImageLoadState"
revision_id: 66489
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:16.402571+00:00"
---

# DgsGetRemoteImageLoadState

This function gets whether the DGS Remote Image is loaded or not.

## Syntax

```
bool dgsGetRemoteImageLoadState( element imageTexture )
```

### Required Arguments

- **imageTexture :** A dgs-dxremoteimage element.

### Returns

Returns *true* if the remote image is loaded, *false* otherwise.
