---
doc_id: "mta-wiki:12235"
title: "DgsComboBoxSetEditEnabled"
source_title: "DgsComboBoxSetEditEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxSetEditEnabled"
revision_id: 66053
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:07.190485+00:00"
---

# DgsComboBoxSetEditEnabled

This function allows you to make combo box editable.

## Syntax

```
bool dgsComboBoxSetEditEnabled( element comboBox, bool enabled )
```

### Required Arguments

- **comboBox:** The dgs combo box that you want to apply.

- **enabled:** A boolean value indicating whether the combo box is editable or not.
...
This example allows you to edit comboBox text in game

```
DGS = exports.dgs 
addEventHandler("onClientResourceStart", resourceRoot, function()
	combobox = DGS:dgsCreateComboBox(0.29, 0.30, 0.44, 0.04, "test", true)
	DGS:dgsComboBoxSetEditEnabled(combobox, true)
	showCursor(true) 
end)
```
