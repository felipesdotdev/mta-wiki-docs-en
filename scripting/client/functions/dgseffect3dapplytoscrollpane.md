---
doc_id: "mta-wiki:11914"
title: "DgsEffect3DApplyToScrollPane"
source_title: "DgsEffect3DApplyToScrollPane"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEffect3DApplyToScrollPane"
revision_id: 64878
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:08.864060+00:00"
---

# DgsEffect3DApplyToScrollPane

This function applies dgs effect 3d to a scroll pane.

## Syntax

```
bool dgsEffect3DApplyToScrollPane( element effect3d, element scrollpane )
```

### Required Arguments

- **effect3d:** A dgs-dxeffect3d element (DGS Plugin Type)

- **scrollpane:** A dgs-dxscrollpane element.
...
local effect3d = dgsCreateEffect3D(20)  --Create the 3D effect plugin
local sp = dgsCreateScrollPane(300,300,500,500,false)  --Create a scroll pane
local img = dgsCreateImage(0,0,1,1,_,true,sp,tocolor(0,0,0,180))  --Create an image
dgsEffect3DApplyToScrollPane(effect3d,sp)  --Apply the plugin to scroll pane
