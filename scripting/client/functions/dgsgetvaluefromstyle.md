---
doc_id: "mta-wiki:13215"
title: "DgsGetValueFromStyle"
source_title: "DgsGetValueFromStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetValueFromStyle"
revision_id: 71109
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:18.512710+00:00"
---

# DgsGetValueFromStyle

This function returns the value from a **loaded** style( current style if not specified ) from DGS global or a specific resource.

## Syntax

```
mixed dgsGetValueFromStyle( string elementType, string key [, string styleName = dgsGetStyle(), resource-data/string bindResource = resource ] )
```

### Required Arguments

- **elementType**: A string of the DGS element type you want to get.

- **key**: A string of the key (or it is also called *property*) you want to get.

### Optional Arguments

- **styleName**: A string of the style name that you want to get from.

- **bindResource**:  A resource-data you want to get from. For DGS global, use string "**global**". Leave this to *nil* to use **resource**([getThisResource](mta://scripting/shared/functions/getthisresource.md)). [Note: When resource stops, the style will also be unloaded]
...
DGS:dgsAddStyle("myStyle", "styleFolder/myStyle")
DGS:dgsLoadStyle("myStyle")

outputChatBox(DGS:dgsGetValueFromStyle("edit","bgColor","myStyle"))
```
