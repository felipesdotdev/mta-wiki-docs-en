---
doc_id: "mta-wiki:9898"
title: "DgsGridListAddRow"
source_title: "DgsDxGridListAddRow"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListAddRow"
revision_id: 55990
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:00.316874+00:00"
---

# DgsGridListAddRow

Adds a row to a grid list, and optionally add simple text items with your rows.  Use [dgsGridListSetItemText](mta://scripting/client/functions/dgsgridlistsetitemtext.md) to add row headers.
...
- **pos:** Row ID of the row you want to insert the new row at (different from [guiGridListInsertRowAfter](mta://scripting/client/functions/guigridlistinsertrowafter.md)).
