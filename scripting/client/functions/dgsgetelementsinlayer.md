---
doc_id: "mta-wiki:9915"
title: "DgsGetElementsInLayer"
source_title: "DgsGetElementsInLayer"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetElementsInLayer"
revision_id: 74340
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:13.952028+00:00"
---

# DgsGetElementsInLayer

This function gets the dgs elements which don't have parents from a specific layer.

## Syntax

```
table dgsGetElementsInLayer( [ string layer = "center" ] )
```
...
- **layer**: A string of the layer that you want to retrieve dgs elements from. The available values are as follows:
...
Returns a table if succeeded, *false* otherwise.
...
local button = DGS:dgsCreateButton(500,500,200,80,"test",false)
outputChatBox("There are "..(#DGS:dgsGetElementsInLayer("center")).." DGS Elements that in 'center' layer and don't have parent")
```
