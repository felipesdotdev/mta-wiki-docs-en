---
doc_id: "mta-wiki:12239"
title: "DgsScrollBarGetCursorLength"
source_title: "DgsScrollBarGetCursorLength"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollBarGetCursorLength"
revision_id: 66083
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:20.219243+00:00"
---

# DgsScrollBarGetCursorLength

This function gets the length of scroll bar cursor.

## Syntax

```
bool dgsScrollBarGetCursorLength( element scrollBar [, bool relative ] )
```

### Required Arguments

- **scrollBar:** The scroll bar whose cursor value is to be returned.

### Optional Arguments

- **relative:** This is whether sizes and positioning are relative. If this is true, then all width,height floats must be between 0 and 1, representing sizes relative to the scroll bar.

### Returns

Returns an *int* or a *float* indicates the length of the cursor of the scroll bar, *false* otherwise.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	...
	outputChatBox(DGS:dgsScrollBarGetCursorLength(scrollBar)) -- output cursor length
end)
```
