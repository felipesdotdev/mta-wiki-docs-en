---
doc_id: "mta-wiki:12015"
title: "PhysicsRemoveChildShape"
source_title: "PhysicsRemoveChildShape"
source_url: "https://wiki.multitheftauto.com/wiki/PhysicsRemoveChildShape"
revision_id: 65159
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:16:28.843897+00:00"
---
...
```
physics-rigid-body physicsRemoveChildShape( physics-shape theShape, int index)
```

### Required Arguments

- **theShape :** the shape, must be compound

- **index:** index of child shape, starts from 1

### Returns

True if shape got removed, false otherwise.
