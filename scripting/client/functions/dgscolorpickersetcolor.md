---
doc_id: "mta-wiki:11592"
title: "DgsColorPickerSetColor"
source_title: "DgsColorPickerSetColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsColorPickerSetColor"
revision_id: 64477
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:00.284591+00:00"
---

# DgsColorPickerSetColor

This function sets the color of the color picker.

## Syntax

```
bool dgsColorPickerSetColor( element colorPicker [, int color1, int color2, int color3, int alpha, string colorType = "RGB" ] )
```
...
- **color1:** This is the first color argument, depends on "colorType"

- **color2:** This is the second color argument, depends on "colorType"

- **color3:** This is the third color argument, depends on "colorType"

- **alpha:** This is the alpha color argument, doesn't depend on "colorType"
...
DGS:dgsColorPickerSetColor(cp,20,50,50,255,"HSV")
```
