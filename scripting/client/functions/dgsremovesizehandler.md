---
doc_id: "mta-wiki:10839"
title: "DgsRemoveSizeHandler"
source_title: "DgsRemoveSizeHandler"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRemoveSizeHandler"
revision_id: 71031
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:13.448450+00:00"
---

# DgsRemoveSizeHandler

This function removes size handler from dgs element.
...
```
bool dgsRemoveSizeHandler( element dgsElement )
```

**DGS OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**:  *DGSElement:removeSizeHandler(...)*

**Counterpart**: *[dgsAddSizeHandler](mta://scripting/client/functions/dgsaddsizehandler.md)*

### Required Arguments

- **dgsElement:** The dgs element you want to remove size handler from.
...
DGS:dgsRemoveSizeHandler(button)
```
