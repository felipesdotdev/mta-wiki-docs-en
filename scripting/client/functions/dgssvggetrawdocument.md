---
doc_id: "mta-wiki:13630"
title: "DgsSVGGetRawDocument"
source_title: "DgsSVGGetRawDocument"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSVGGetRawDocument"
revision_id: 81339
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:18.532884+00:00"
---

# DgsSVGGetRawDocument

Gets the raw xml data from an svg or an svg node.

## Syntax

```
string dgsSVGGetRawDocument( mixed svgNode )
```

### Required Arguments

- **svgNode:** The [svg](mta://reference/misc/svg.md) element or the svg node you want to get the raw data from.
...
--Try to paste to a notepad, and you can see the raw data of the svg.
```
