---
doc_id: "mta-wiki:12491"
title: "DgsMemoSetMaxLength"
source_title: "DgsMemoSetMaxLength"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoSetMaxLength"
revision_id: 67365
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:02.522658+00:00"
---

# DgsMemoSetMaxLength

This function sets the maximum text length that can be typed into a memo.

## Syntax

```
bool dgsMemoSetMaxLength ( element theElement, int length )
```

### Required Arguments

- **theElement:** The dgs-dxmemo to be changed.

- **length:** An integer indicating the maximum number of characters that can be typed into the memo.
...
This example creates an memo with a limit on text length.

```
DGS = exports.dgs
memo = DGS:dgsCreateMemo( 0.3, 0.1, 0.4, 0.5, "Type your message here!", true )
-- set a maximum text length of 128 characters
DGS:dgsMemoSetMaxLength ( memo, 128 )
```
