---
doc_id: "mta-wiki:11190"
title: "DgsGridListGetColumnFont"
source_title: "DgsGridListGetColumnFont"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetColumnFont"
revision_id: 62091
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:22.347933+00:00"
---

# DgsGridListGetColumnFont

This function is used to get the font of a dgs gridlist column.

## Syntax

```
dx-font/string dgsGridListGetColumnFont( element dgsGridlist, int columnIndex )
```

### Required Arguments

- **dgsGridlist:** The dgs grid list you want to get the column font from

- **columnIndex:** Column ID

### Returns

Returns a dx-font element or a string if succeed, *false* otherwise.
...
outputChatBox( tostring(DGS:dgsGridListGetColumnFont(list, column)) ) --By default, it is "default"
```
