---
doc_id: "mta-wiki:13694"
title: "DxGridListGetScrollHV"
source_title: "DxGridListGetScrollHV"
source_url: "https://wiki.multitheftauto.com/wiki/DxGridListGetScrollHV"
revision_id: 74649
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:49.993073+00:00"
---

# DxGridListGetScrollHV

Esta función sirve para extraer el scroll horizontal y vertical de una [dxGridList](mta://scripting/client/functions/dxgridlist.md).
...
```
element element dxGridListGetScrollHV( element element )
```
...
-- Agregamos varias filas de items, hay 3 valores en cada sub-tabke porque solamente se crearon 3 columnas ↑
for _, v in ipairs({{'Infernus', 'Claw', '50000'}, {'Sultan', 'Pand', '500000'}, {'Towtruck', 'Bert', '5000200'},{'Infernus', 'Claw', '50000'}, {'Sultan', 'Pand', '500000'}, {'Towtruck', 'Bert', '5000200'},{'Infernus', 'Claw', '50000'}, {'Sultan', 'Pand', '500000'}, {'Towtruck', 'Bert', '5000200'}}) do
   dxGridListAddItem(lista, unpack(v))
end

--extramos las scroll
scrollH, scrollV = dxGridListGetScrollHV(lista)

--Le cambiamos el boton de las scroll a rojo.
dxScrollSetColorButton(scrollH, 255, 0, 0, 255)
dxScrollSetColorButton(scrollV, 255, 0, 0, 255)
```
