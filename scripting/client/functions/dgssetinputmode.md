---
doc_id: "mta-wiki:11523"
title: "DgsSetInputMode"
source_title: "DgsSetInputMode"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetInputMode"
revision_id: 71018
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:31.609635+00:00"
---

# DgsSetInputMode

This function is a replica of [guiSetInputMode](mta://scripting/client/functions/guisetinputmode.md). In order to satisfy the needs of developers, the function exists here. DGS elements will also be affected by guiSetInputMode.

## Syntax

```
bool dgsSetInputMode ( string mode )
```

**DGS OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**:  ***dgsRootInstance**:setInputMode(...)*

**Counterpart**: *[dgsGetInputMode](mta://scripting/client/functions/dgsgetinputmode.md)*
