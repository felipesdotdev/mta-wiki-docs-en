---
doc_id: "mta-wiki:14132"
title: "DgsCircleGetTextureRotation"
source_title: "DgsCircleGetTextureRotation"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleGetTextureRotation"
revision_id: 77571
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:56.143118+00:00"
---

# DgsCircleGetTextureRotation

This function gets the texture rotation from the dgs circle.

## Syntax

```
float, float, float dgsCircleGetTextureRotation( element circle )
```
...
Returns 3 *floats* indicates **rotation degree**, **rotation center x** and **rotation center y** if successful, *false* otherwise.
...
local rot,rotX,rotY = DGS:dgsCircleGetTextureRotation(c)
outputChatBox(rot)
outputChatBox(rotX)
outputChatBox(rotY)
```
