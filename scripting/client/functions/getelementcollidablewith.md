---
doc_id: "mta-wiki:5195"
title: "IsElementCollidableWith"
source_title: "GetElementCollidableWith"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementCollidableWith"
revision_id: 78742
language: "en"
categories: ["Client_functions", "Changes_in_1.4.0", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:11.074060+00:00"
---
...
- [Player](mta://reference/misc/player.md)
...
**Method**: *[element](mta://reference/misc/element.md):isCollidableWith(...)*

**Counterpart**: *[setElementCollidableWith](mta://scripting/client/functions/setelementcollidablewith.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) which colliding you want to get

- **withElement:** The other [element](mta://reference/misc/element.md) which colliding with the first entity you want to get
