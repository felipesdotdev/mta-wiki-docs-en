---
doc_id: "mta-wiki:3652"
title: "IsElementStreamable"
source_title: "IsElementStreamable"
source_url: "https://wiki.multitheftauto.com/wiki/IsElementStreamable"
revision_id: 66719
language: "en"
categories: ["Client_functions", "Changes_in_1.4.0", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:55.579706+00:00"
---

# IsElementStreamable

This function checks whether an [element](mta://reference/misc/element.md) is streamable as set by [setElementStreamable](mta://scripting/client/functions/setelementstreamable.md) or not.
...
**Method**: *[element](mta://reference/misc/element.md):isStreamable(...)*

**Variable**: *.streamable*

**Counterpart**: *[setElementStreamable](mta://scripting/client/functions/setelementstreamable.md)*

### Required Arguments

- **theElement**: The [element](mta://reference/misc/element.md) to check the streamability of.
