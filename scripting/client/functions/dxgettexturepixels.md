...
generated_at: "2026-07-26T16:14:49.743904+00:00"
---

# DxGetTexturePixels

This function fetches the [pixels](mta://reference/misc/texture-pixels.md) from a [texture](mta://reference/misc/texture.md) element. It can be used with a standard texture, render target or screen source.
...
**Method**: *[texture](mta://reference/misc/texture.md):getPixels(...)*
