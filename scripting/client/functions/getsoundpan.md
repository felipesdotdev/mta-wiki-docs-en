...
generated_at: "2026-07-26T16:15:25.541918+00:00"
---

# GetSoundPan

This function is used to get the pan level of the specified [sound](mta://reference/misc/sound.md) element.
...
**Method**: *[sound](mta://reference/misc/sound.md):getPan(...)*
...
- **theSound:** the [sound](mta://reference/misc/sound.md) element which pan you want to get.
