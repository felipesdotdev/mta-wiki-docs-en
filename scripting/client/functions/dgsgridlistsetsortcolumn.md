---
doc_id: "mta-wiki:10053"
title: "DgsGridListSetSortColumn"
source_title: "DgsGridListSetSortColumn"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetSortColumn"
revision_id: 54057
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:41.129678+00:00"
---

# DgsGridListSetSortColumn

This function chooses which column to be sorted by ( Must works with [dgsGridListSetSortFunction](mta://scripting/client/functions/dgsgridlistsetsortfunction.md) ).

## Syntax

```
bool dgsGridListSetSortColumn( element gridlist, int sortedColumn )
```

### Required Arguments

- **gridlist:** The grid list which you want to set the sorted column to.

- **sortedColumn :** An integer of the specific column to be sorted by.
