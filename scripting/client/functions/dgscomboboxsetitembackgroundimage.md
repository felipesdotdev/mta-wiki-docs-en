---
doc_id: "mta-wiki:14111"
title: "DgsComboBoxSetItemBackGroundImage"
source_title: "DgsComboBoxSetItemBackGroundImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxSetItemBackGroundImage"
revision_id: 77492
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:07.779997+00:00"
---

# DgsComboBoxSetItemBackGroundImage

This function sets the background texture of a specific item of the combo box.

## Syntax

```
bool dgsComboBoxSetItemBackGroundImage( element comboBox, int itemIndex, texture imageDefault, texture imageHoving, texture imageSelected )
```

### Required Arguments

- **comboBox:** the combo box that you want to operate.

- **itemIndex:** A texture of the item index.

- **imageDefault:** A texture element of the color of the item (Default State).

- **imageHoving:** A texture element of the color of the item (Hoving State).

- **imageSelected:** A texture element of the color of the item (Selected State).
...
texture = dxCreateTexture("example.png") --Example
combobox = DGS:dgsCreateComboBox(200,50,600,50,false)
for i=1,30 do
	DGS:dgsComboBoxAddItem(combobox,randomLetter(10)..tostring(i).." Test DGS")
	DGS:dgsComboBoxSetItemBackGroundImage(combobox,i,texture,texture,texture)
end
```
