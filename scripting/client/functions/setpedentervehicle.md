...
generated_at: "2026-07-26T16:16:42.655228+00:00"
---

# SetPedEnterVehicle

This function makes a [ped](mta://reference/misc/ped.md) enter a [vehicle](mta://reference/misc/vehicle.md), similar to the enter_exit control state.
...
- **thePed:** The [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) to enter the vehicle.
...
- **vehicle:** The [vehicle](mta://reference/misc/vehicle.md) to enter. If no vehicle is set, the ped will enter the nearest vehicle within 20 m.
...
- The ped has an active TASK_PRIMARY [task](mta://reference/misc/task.md). Use [getPedTask](mta://scripting/client/functions/getpedtask.md) to monitor what the ped is doing.

## Example

Make [ped](mta://reference/misc/ped.md) Sweet enter his car:
