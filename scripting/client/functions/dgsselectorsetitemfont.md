---
doc_id: "mta-wiki:13282"
title: "DgsSelectorSetItemFont"
source_title: "DgsSelectorSetItemFont"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorSetItemFont"
revision_id: 71600
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:27.922358+00:00"
---

# DgsSelectorSetItemFont

This function changes the font of an item of a dgs selector.

## Syntax

```
bool dgsSelectorSetItemFont( element selector, int itemId, string/dx-font font )
```

### Required Arguments

- **selector:** The dgs selector

- **itemId:** the index of the item

- **font:** Either a custom dx font element or the name of a built-in dx font (see here [Standard_DGS_Font_Names](mta://reference/misc/standard-dgs-font-names.md))

### Returns

Returns *true* if the item font was set successfully, *false* otherwise.
...
local selector = DGS:dgsCreateSelector ( 0.473, 0.462, 0.052, 0.018, true )
for i=1,5 do
	DGS:dgsSelectorAddItem ( selector, i )
	DGS:dgsSelectorSetItemFont ( selector, i, "default-bold" )
end
```
