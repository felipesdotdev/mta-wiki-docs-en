---
doc_id: "mta-wiki:10135"
title: "DgsGridListGetRowBackGroundColor"
source_title: "DgsGridListGetRowBackGroundColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetRowBackGroundColor"
revision_id: 58518
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:27.335721+00:00"
---

# DgsGridListGetRowBackGroundColor

This function gets the row background color from the grid list.

## Syntax

```
int, int, int  dgsGridListGetRowBackGroundColor( element gridList, int rowIndex )
```
...
Returns 3 integer are **colorDefault**, **colorHoving**, **colorSelected** correspondingly if get successfully, *false* if one of the arguments was invalid.
...
local a,b,c = DGS:dgsGridListGetRowBackGroundColor(gridlist, 2)
outputChatBox(a) -- Get the default color
```
