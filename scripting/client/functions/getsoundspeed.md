---
doc_id: "mta-wiki:5130"
title: "GetSoundSpeed"
source_title: "GetSoundSpeed"
source_url: "https://wiki.multitheftauto.com/wiki/GetSoundSpeed"
revision_id: 73185
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:25.607288+00:00"
---

# GetSoundSpeed

This function is used to return the playback speed of the specified [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](mta://reference/misc/sound.md):getSpeed(...)*

**Variable**: *.speed*

**Counterpart**: *[setSoundSpeed](mta://scripting/client/functions/setsoundspeed.md)*

### Required Arguments

- **theSound:** the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) which playback speed you want to return.

### Returns

Returns an [float](mta://reference/misc/float.md) value indicating the playback speed of the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md). Default sound playback speed is **1.0**.
