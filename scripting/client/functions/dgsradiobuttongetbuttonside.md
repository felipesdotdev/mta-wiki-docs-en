---
doc_id: "mta-wiki:13885"
title: "DgsRadioButtonGetButtonSide"
source_title: "DgsRadioButtonGetButtonSide"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRadioButtonGetButtonSide"
revision_id: 76173
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:09.391672+00:00"
---

# DgsRadioButtonGetButtonSide

This function gets the side of the button of a dgs radio button.

## Syntax

```
string dgsRadioButtonGetButtonSide ( dgsRadioButton [, string side = "left" ] )
```
...
Returns a *string* indicates side of the button if successful, *false* otherwise. Valid type strings are:

- "left": The dgs radio button will be placed in the left side of the text.

- "right": The dgs radio button will be placed in the right side of the text.
...
local side = DGS:dgsRadioButtonGetButtonSide( rb )
outputChatBox( side ) -- "left" by default
```
