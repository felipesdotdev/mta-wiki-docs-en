...
generated_at: "2026-07-26T16:10:23.703159+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):areLightsOn(...)*

**Variable**: *.lightsOn*

### Required Arguments

- **theVehicle**: the [vehicle](mta://reference/misc/vehicle.md) you wish to retrieve the lights state of.
