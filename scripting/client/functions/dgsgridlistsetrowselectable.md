---
doc_id: "mta-wiki:12344"
title: "DgsGridListSetRowSelectable"
source_title: "DgsGridListSetRowSelectable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetRowSelectable"
revision_id: 66650
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:39.754871+00:00"
---

# DgsGridListSetRowSelectable

This function sets whether the row is selectable, which has higer priority than [dgsGridListSetItemSelectable](mta://scripting/client/functions/dgsgridlistsetitemselectable.md).

## Syntax

```
bool dgsGridListSetRowSelectable( element gridlist, int row, boolean state )
```
...
for id, player in ipairs(getElementsByType("player")) do
	...
	DGS:dgsGridListSetRowSelectable(playerList, row, false)
end
```
