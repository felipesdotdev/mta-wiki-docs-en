---
doc_id: "mta-wiki:12246"
title: "DgsEditGetAutoComplete"
source_title: "DgsEditGetAutoComplete"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditGetAutoComplete"
revision_id: 66115
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:59.911205+00:00"
---

# DgsEditGetAutoComplete

This function gets auto complete table from the dgs edit.

## Syntax

```
table dgsEditGetAutoComplete( element edit )
```

### Required Arguments

- **edit:** A dgs edit you wish to get the auto complete table from.

### Return

Returns a *table* of the auto complete list, *false* otherwise.
...
local autoCompleteTable = DGS:dgsEditGetAutoComplete(edit)
iprint(autoCompleteTable)
```
