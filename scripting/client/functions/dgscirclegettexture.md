---
doc_id: "mta-wiki:13385"
title: "DgsCircleGetTexture"
source_title: "DgsCircleGetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleGetTexture"
revision_id: 72889
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:55.871125+00:00"
---

# DgsCircleGetTexture

This function gets the texture from the dgs circle.

## Syntax

```
element dgsCircleGetTexture( element circle )
```

### Required Arguments

- **circle**: A dgs-dxcircle plugin that you want to get from.

### Returns

Returns a texture element if there was a texture applied to the dgs circle, *false* otherwise.
...
local theTexture = DGS:dgsCircleGetTexture(c)
if theTexture == t then
	outputChatBox("Same")
end
```
