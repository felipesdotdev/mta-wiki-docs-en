---
doc_id: "mta-wiki:10054"
title: "DgsGridListGetSortColumn"
source_title: "DgsGridListGetSortColumn"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetSortColumn"
revision_id: 54056
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:30.278849+00:00"
---

# DgsGridListGetSortColumn

This function gets the column to be sorted by.

## Syntax

```
int dgsGridListGetSortColumn( element gridlist )
```

### Required Arguments

- **gridlist:** The grid list from which you wish to get the sorted column.

### Returns

Returns an integer if exists, false otherwise.
...
outputChatBox(DGS:dgsGridListGetSortColumn(gridlist)) -- returns 2 which we just set
```
