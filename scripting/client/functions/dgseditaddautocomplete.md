---
doc_id: "mta-wiki:12249"
title: "DgsEditAddAutoComplete"
source_title: "DgsEditAddAutoComplete"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditAddAutoComplete"
revision_id: 78879
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:58.537245+00:00"
---
...
```
bool dgsEditAddAutoComplete( bool editBox, string/table str [, bool isSensitive = false, bool isAdvanced = false ] )
```

### Required Arguments

- **edit:** A dgs edit you wish to add auto complete.

- **str:** A string/table you want to set to auto complete.

### Optional Arguments

- **isSensitive:** A bool indicates whether the auto complete text is capital sensitive or not.

- **isAdvanced:** A bool indicates whether the auto complete text is advanced for [parameter function](mta://scripting/client/functions/dgseditautocompleteaddparameterfunction.md) usage.
...
```
DGS = exports.dgs
edit2 = DGS:dgsCreateEdit(0.3,0.6,0.2,0.05,"",true)
DGS:dgsEditAddAutoComplete(edit2,"You know what? I am an idiot!",false)
```
