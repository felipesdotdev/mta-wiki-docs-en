---
doc_id: "mta-wiki:13280"
title: "DgsScrollBarGetCursorWidth"
source_title: "DgsScrollBarGetCursorWidth"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollBarGetCursorWidth"
revision_id: 71598
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:20.472939+00:00"
---

# DgsScrollBarGetCursorWidth

This function gets the width of cursor.

## Syntax

```
float dgsScrollBarGetCursorWidth( element scrollBar [, bool relative ] )
```
...
- **scrollBar:** The dgs scrollbar you want to get cursor width from.

### Optional Arguments

- **relative:** This is whether sizes and positioning are relative. If this is true, then width must be between 0 and 1, representing sizes relative to the scroll bar.

### Returns

Returns a float indicates the cursor width if successful, *false* otherwise.

## Example

```
DGS = exports.dgs
scrollbar= DGS:dgsCreateScrollBar(0.29, 0.30, 0.44, 0.04, true, true)
local width = DGS:dgsScrollBarGetCursorWidth(scrollbar,true)
outputChatBox(width)
```
