---
doc_id: "mta-wiki:9918"
title: "DgsEditGetCaretStyle"
source_title: "DgsDxEditGetCaretStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxEditGetCaretStyle"
revision_id: 53515
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:06.011026+00:00"
---

# DgsEditGetCaretStyle

This function is to get the caret style of dgs edit ( 0 is "|"; 1 is "_" ).
...
```
int dgsEditGetCaretStyle( element dgsElement )
```

### Required Arguments

- **dgsElement:** The dgs edit which you want to get caret style from.

### Returns

This function returns an integer indicates which kind of caret style, *false* otherwise.

## Example

```
DGS = exports.dgs
edit = DGS:dgsCreateEdit(200,200,300,100,"text",false)
caretStyle = DGS:dgsEditGetCaretStyle(edit)
outputChatBox(caretStyle)
```
