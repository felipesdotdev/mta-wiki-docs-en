---
doc_id: "mta-wiki:9953"
title: "DgsCreateScrollBar"
source_title: "DgsDxCreateScrollBar"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxCreateScrollBar"
revision_id: 73860
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:15.309989+00:00"
---

# DgsCreateScrollBar

This function allows creation of a DGS Scroll Bar.

## Syntax

```
element dgsCreateScrollBar( float x, float y, float width, float height, bool isHorizontal, bool relative [, element parent = nil, element arrowImage = nil, element troughImage = nil, element cursorImage = nil, int normalArrowColor = 0xAARRGGBB , int hoveringArrowColor = 0xAARRGGBB, int clickedArrowColor = 0xAARRGGBB, int troughColor = 0xAARRGGBB, int normalCursorColor = 0xAARRGGBB, int hoveringCursorColor = 0xAARRGGBB, int clickedCursorColor = 0xAARRGGBB ] )
```

### Required Arguments

- **x:** A float of the 2D x position of the DGS scroll bar on a player's screen.  This is affected by the *relative* argument.

- **y:** A float of the 2D y position of the DGS scroll bar on a player's screen. This is affected by the *relative* argument.

- **width:** A float of the width of the DGS scroll bar. This is affected by the *relative* argument.

- **height:** A float of the height of the DGS scroll bar. This is affected by the *relative* argument. Note: height must be enough to fit the drop down menu, else the drop down won't appear.

- **isHorizontal:** whether this scroll bar is horizontal (*true*) or vertical (*false*).

- **relative:** This is whether sizes and positioning are relative.  If this is *true*, then all x,y,width,height floats must be between 0 and 1, representing sizes relative to the parent.

### Optional Arguments

- **parent:** This is the parent that the DGS scroll bar is attached to.  If the *relative* argument is true, sizes and positioning will be made relative to this parent. If the *relative* argument is false, positioning will be the number of offset pixels from the parent's origin. If no parent is passed, the parent will become the screen - causing positioning and sizing according to screen positioning.

- **arrowImage:** A texture element of the background of the arrow of the scroll bar.

- **troughImage:** A texture element of the background of the trough of the scroll bar.

- **cursorImage:** A texture element of the background of the cursor of the scroll bar.

- **normalArrowColor:** An int of the color of the background of the arrow of the scroll bar ( not hovering on or clicked ).

- **hoveringArrowColor:** An int of the color of the background of the arrow of the scroll bar ( hovering on ).

- **clickedArrowColor:** An int of the color of the background of the arrow of the scroll bar ( clicked ).

- **troughColor:** An int of the color of the background of the trough of the scroll bar.

- **normalCursorColor:** An int of the color of the background of the cursor of the scroll bar ( not hovering on or clicked ).

- **hoveringCursorColor:** An int of the color of the background of the cursor of the scroll bar ( hovering on ).

- **clickedCursorColor:** An int of the color of the background of the cursor of the scroll bar ( clicked ).

## Example

This example creates a scroll bar on the screen.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	...
	showCursor(true) 
	addEventHandler("onDgsElementScroll", scrollBar, function(scb,new,old)
...
- [dgsScrollPaneSetScrollBarState](mta://scripting/client/functions/dgsscrollpanesetscrollbarstate.md)
