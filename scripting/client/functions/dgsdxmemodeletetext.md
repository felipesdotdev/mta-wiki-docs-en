---
doc_id: "mta-wiki:9931"
title: "DgsMemoDeleteText"
source_title: "DgsDxMemoDeleteText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoDeleteText"
revision_id: 61908
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:09.584817+00:00"
---

# DgsMemoDeleteText

This function deletes a part of text from the memo by index and line.

## Syntax

```
bool dgsMemoDeleteText ( element theElement, int fromindex, int fromline, int toindex, int toline [, bool noAffectCaret = false ] )
```
...
- **noAffectCaret:** A bool indicated whether this operation will affect the position of caret.

### Returns

Returns *true* if the text was successfully deleted, *false* otherwise.
...
setTimer(function()
	DGS:dgsMemoDeleteText(memo,1,1,1,3)
end,500,10)
```
