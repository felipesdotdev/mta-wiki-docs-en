---
doc_id: "mta-wiki:4286"
title: "GetSoundVolume"
source_title: "GetSoundVolume"
source_url: "https://wiki.multitheftauto.com/wiki/GetSoundVolume"
revision_id: 72762
language: "en"
categories: ["Client_functions", "Changes_in_1.3.2"]
generated_at: "2026-07-26T16:15:25.635503+00:00"
---

# GetSoundVolume

This function is used to return the volume level of the specified [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](mta://reference/misc/sound.md):getVolume(...)*

**Variable**: *.volume*

**Counterpart**: *[setSoundVolume](mta://scripting/client/functions/setsoundvolume.md)*

### Required Arguments

- **theSound:** the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) which volume you want to return.

### Returns

Returns a [float](mta://reference/misc/float.md) representing the volume level of the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md), *false* if invalid arguments were passed.
