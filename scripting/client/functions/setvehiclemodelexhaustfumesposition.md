---
doc_id: "mta-wiki:9678"
title: "SetVehicleModelExhaustFumesPosition"
source_title: "SetVehicleModelExhaustFumesPosition"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleModelExhaustFumesPosition"
revision_id: 55691
language: "en"
categories: ["Client_functions", "Changes_in_1.5.5", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:16:47.697470+00:00"
---

# SetVehicleModelExhaustFumesPosition

This function sets the position of the exhaust fumes the vehicle model emits. Use [setVehicleComponentPosition](mta://scripting/client/functions/setvehiclecomponentposition.md) to adjust the exhaust position.
...
**Method**: *[Vehicle](mta://reference/misc/vehicle.md).setModelExhaustFumesPosition(...)*

**Counterpart**: *[getVehicleModelExhaustFumesPosition](mta://scripting/client/functions/getvehiclemodelexhaustfumesposition.md)*
