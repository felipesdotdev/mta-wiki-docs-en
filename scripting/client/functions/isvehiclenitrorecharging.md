...
generated_at: "2026-07-26T16:16:02.295056+00:00"
---

# IsVehicleNitroRecharging

This function checks if nitro is recharging on the [vehicle](mta://reference/misc/vehicle.md).
...
- **theVehicle** The [vehicle](mta://reference/misc/vehicle.md), which you want to check for recharging.
