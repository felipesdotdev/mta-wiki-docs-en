---
doc_id: "mta-wiki:12365"
title: "DgsGridListSetItemSelectable"
source_title: "DgsGridListSetItemSelectable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetItemSelectable"
revision_id: 66692
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:36.900444+00:00"
---

# DgsGridListSetItemSelectable

This function sets whether the item is selectable, which has a lower priority than [dgsGridListSetRowSelectable](mta://scripting/client/functions/dgsgridlistsetrowselectable.md).

## Syntax

```
bool dgsGridListSetItemSelectable( element gridlist, int row, int column, boolean state )
```
...
- **state:** Whether the row of grid list is selectable.
...
for id, player in ipairs(getElementsByType("player")) do
	...
	DGS:dgsGridListSetItemSelectable(playerList, row, column, false)
end
```
