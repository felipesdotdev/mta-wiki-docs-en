---
doc_id: "mta-wiki:13688"
title: "DxGridListAddItem"
source_title: "DxGridListAddItem"
source_url: "https://wiki.multitheftauto.com/wiki/DxGridListAddItem"
revision_id: 74655
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:49.891322+00:00"
---

# DxGridListAddItem

Esta función sirve para agregar un articulo/ítem a una [dxGridList](mta://scripting/client/functions/dxgridlist.md).
...
```
bool dxGridListAddItem( element element, columna1, columna2, ... )
```
...
- **...**: El numero sin fin de artículos/ítems a agregar según la cantidad de columnas.
