---
doc_id: "mta-wiki:13690"
title: "DxGridListAddColumn"
source_title: "DxGridListAddColumn"
source_url: "https://wiki.multitheftauto.com/wiki/DxGridListAddColumn"
revision_id: 74653
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:49.841711+00:00"
---

# DxGridListAddColumn

Esta función sirve para agregar una columna a una [dxGridList](mta://scripting/client/functions/dxgridlist.md).
...
```
bool dxGridListAddColumn( element element, string name, float size )
```
...
- **size**: Un flotante que representa el tamaño de separación entre la columna actual y la siguiente.
