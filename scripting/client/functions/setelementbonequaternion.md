---
doc_id: "mta-wiki:14423"
title: "SetElementBoneQuaternion"
source_title: "SetElementBoneQuaternion"
source_url: "https://wiki.multitheftauto.com/wiki/SetElementBoneQuaternion"
revision_id: 81369
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:16:39.756523+00:00"
---
...
[Cayley Q8 graph](https://en.wikipedia.org/wiki/Cayley_graph) showing the six cycles of multiplication by **i**, **j** and **k**.

### Required Arguments

- **ped:** The [element](mta://reference/misc/element.md) (ped or player) on which the bone's rotation will be set.
...
The use of [updateElementRpHAnim](mta://scripting/client/functions/updateelementrphanim.md) is necessary here as it applies the rotation.
