---
doc_id: "mta-wiki:13814"
title: "DgsButtonGetTextExtent"
source_title: "DgsButtonGetTextExtent"
source_url: "https://wiki.multitheftauto.com/wiki/DgsButtonGetTextExtent"
revision_id: 75644
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:50.562456+00:00"
---

# DgsButtonGetTextExtent

This function returns the extent, or width, of the current text inside a DGS button.

## Syntax

```
float dgsButtonGetTextExtent ( element theButton )
```

### Required Arguments

- **theButton:** The button to get the text extent from.

### Returns

Returns the absolute width of the current text inside the button if the function is successful, *false* otherwise.

## Example

This example creates a window, a button, gets the text extent and font height, and sets the button size according to these values.

```
DGS = exports.dgs
-- create the window (the container for our button)
local myWindow = DGS:dgsCreateWindow ( 0, 0, 0.5, 0.4, "Information", true )

-- create the button
local myButton = DGS:dgsCreateButton ( 10, 10, 0, 0, "This is my text container", false, myWindow )

-- get the (absolute) text extent and font height, and use these to size the button
DGS:dgsSetSize ( myButton, DGS:dgsButtonGetTextExtent ( myButton ), DGS:dgsButtonGetFontHeight ( myButton ), false )
```
