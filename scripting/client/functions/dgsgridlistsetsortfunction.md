---
doc_id: "mta-wiki:10052"
title: "DgsGridListSetSortFunction"
source_title: "DgsGridListSetSortFunction"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetSortFunction"
revision_id: 54050
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:41.635258+00:00"
---

# DgsGridListSetSortFunction

This function sets and loads the specific and custom sorting function ( Must works with [dgsGridListSetSortColumn](mta://scripting/client/functions/dgsgridlistsetsortcolumn.md) ).

## Syntax

```
bool dgsGridListSetSortFunction( dgsElement gridlist, string func )
```

### Required Arguments

- **gridlist:** The grid list which you want to set the sorting function to.

- **func:** A string of the function to be loaded.

### Returns

Returns *true* if sorting function set and loaded successfully, false otherwise.
