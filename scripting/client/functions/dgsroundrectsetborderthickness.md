---
doc_id: "mta-wiki:12278"
title: "DgsRoundRectSetBorderThickness"
source_title: "DgsRoundRectSetBorderThickness"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectSetBorderThickness"
revision_id: 66292
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:15.961553+00:00"
---

# DgsRoundRectSetBorderThickness

This function sets border thickness of an unfilled round rectangle.

This function only works with unfilled round rectangle, make sure the round rectangle is "borderOnly".

## Syntax

```
bool dgsRoundRectSetBorderThickness( element rndRect, float horizontal [, float vertical = horizontal ] )
```
...
- **horizontal:** A flaot of the horizontal thickness.

### Optional Arguments

- **vertical :** A float of the vertical thickness.
...
local rndRect = DGS:dgsCreateRoundRect(5,false,tocolor(0,0,0,150), nil, nil, true)  --Create Rounded Rectangle with 5 pixels radius and border only
local image1 = DGS:dgsCreateImage(200,200,400,100,rndRect,false)  --Apply it to the dgs image
DGS:dgsRoundRectSetBorderThickness(rndRect,0.1,0.1) -- Set border radius thickness
```
