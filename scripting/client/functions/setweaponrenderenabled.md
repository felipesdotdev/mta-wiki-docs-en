...
generated_at: "2026-07-26T16:16:49.775790+00:00"
---
...
This function allows you to completely disable/enable GTA weapon rendering for [ped](mta://reference/misc/ped.md) and [player](mta://reference/misc/player.md). It is particularly useful for creating custom weapon systems, where singular weapon ID could have many different models/variations, or to simply get rid of one frame delay when switching weapons. 
