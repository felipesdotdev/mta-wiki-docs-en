---
doc_id: "mta-wiki:9903"
title: "DgsGridListGetSelectedItem"
source_title: "DgsDxGridListGetSelectedItem"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListGetSelectedItem"
revision_id: 76736
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:01.664272+00:00"
---
...
```
int, int dgsGridListGetSelectedItem ( element gridList )
```
...
Returns two integers of the row and column of the selected item if the specified grid list is valid and has a selected item, *-1*  if nothing is selected, *false* otherwise.
...
addEventHandler ( "onDgsMouseClick", root, function ( button, state  )
	if source == gridlist then 
		...
		if selectedRow ~= -1 then 
			local output = DGS:dgsGridListGetItemText( gridlist, selectedRow, selectedColumn )
