---
doc_id: "mta-wiki:11163"
title: "DgsEditReplaceText"
source_title: "DgsEditReplaceText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditReplaceText"
revision_id: 61912
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:04.493434+00:00"
---

# DgsEditReplaceText

This function replaces a part of text from the edit by index.

## Syntax

```
bool dgsEditReplaceText ( element theElement, int startIndex, int endIndex, string text [, bool noAffectCaret = false ] )
```

### Required Arguments

- **theElement:** The edit to be changed.

- **startIndex:** An integer indicated where the text of the edit is selected from ( start from 0 ).

- **endIndex:** An integer indicated where the text of the edit is selected to ( start from 0 ).

- **text:** A string used to replace.
...
Returns *true* if the text was successfully replaced, *false* otherwise.

## Example

```
DGS = exports.dgs
edit = DGS:dgsCreateEdit(500,200,200,300,"This is a dgs-dxedit",false)
setTimer(function()
	DGS:dgsEditReplaceText(edit,0,6,"I am")
end,500,10)
```
