---
doc_id: "mta-wiki:13248"
title: "DgsEditSetTypingSoundVolume"
source_title: "DgsEditSetTypingSoundVolume"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditSetTypingSoundVolume"
revision_id: 73180
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:07.831783+00:00"
---

# DgsEditSetTypingSoundVolume

This function changes the volume of the typing sound to a dgs edit.

## Syntax

```
bool dgsEditSetTypingSoundVolume( element edit, float volume )
```

### Required Arguments

- **edit:** The dgs-dxedit you want to set.

- **volume:** A float representing the desired typing sound volume level. Range is from 0.0 to 1.0. This can go above 1.0 for amplification.
...
DGS:dgsEditSetTypingSoundVolume(edit,0.5) --Lower
```
