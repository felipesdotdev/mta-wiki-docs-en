---
doc_id: "mta-wiki:9936"
title: "DgsMemoSetCaretPosition"
source_title: "DgsDxMemoSetCaretPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoSetCaretPosition"
revision_id: 68266
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:10.935014+00:00"
---
...
```
bool dgsMemoSetCaretPosition ( element theElement, int index [, int line = 0, bool selectText = false, bool noChangeLine = false ] )
```
...
- **index:** An integer referring to the desired index within the memo.

### Optional Arguments

- **line:** An integer referring to the desired line within the memo.
...
setTimer(function()
	DGS:dgsMemoSetCaretPosition(memo,10)
end,500,10)
```
