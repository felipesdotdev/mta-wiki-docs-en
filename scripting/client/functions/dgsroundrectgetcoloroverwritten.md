---
doc_id: "mta-wiki:11637"
title: "DgsRoundRectGetColorOverwritten"
source_title: "DgsRoundRectGetColorOverwritten"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectGetColorOverwritten"
revision_id: 77583
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:15.209030+00:00"
---

# DgsRoundRectGetColorOverwritten

This function gets whether the color of rounded rectangle will overwrite the color of dx functions.

## Syntax

```
bool dgsRoundRectGetColorOverwritten( element rndRect )
```
...
Returns *true* if the round rectangle was set to overwritten, *false* otherwise.
...
local image = DGS:dgsCreateImage(200,200,400,100,rndRect,false,tocolor(255,0,0,255))  --Apply it to the dgs image
setTimer(function()
	DGS:dgsRoundRectSetColorOverwritten(rndRect,not DGS:dgsRoundRectGetColorOverwritten(rndRect))
end,100,0)
```
