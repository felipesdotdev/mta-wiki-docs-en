...
generated_at: "2026-07-26T16:16:00.386432+00:00"
---

# IsSoundLooped

This function is used to return the current loop state of the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](mta://reference/misc/sound.md):isLooped(...)*

**Counterpart**: *[setSoundLooped](mta://scripting/client/functions/setsoundlooped.md)*

### Required Arguments

- **theSound:** The [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) which you want to get the loop state.

### Returns

Returns *true* if the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) is looped, *false* otherwise.

## Example

This will create a [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) and change its state to looped, with a command to switch the loop state and output its state:
