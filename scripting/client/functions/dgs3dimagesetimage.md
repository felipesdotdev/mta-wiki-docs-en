---
doc_id: "mta-wiki:13176"
title: "Dgs3DImageSetImage"
source_title: "Dgs3DImageSetImage"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageSetImage"
revision_id: 70839
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:27.656430+00:00"
---

# Dgs3DImageSetImage

This function allows you to change the image in DGS 3d image element to another one.
...
- If you **don't** want to use **texture element**, please use *dgsSetProperty ( your3DImage, "image" ,yourPath )*

## Syntax

```
bool dgs3DImageSetImage ( element image3D, element/string texture )
```

### Required Arguments

- **image3D:** The 3d image element to be changed.

- **texture:** A texture/shader/render target/screen source/image path that you want to set.

### Returns

Returns *true* if the image in the 3d image element was successfully changed, *false* otherwise.
...
local image = DGS:dgsCreate3DImage(0,0,4,_,tocolor(255,255,255,255),10,10)
DGS:dgs3DImageSetImage ( texture )
```
