...
**Method**: *[shader](mta://reference/misc/shader.md):applyToWorldTexture(...)*
...
- **targetElement:** The element to restrict applying the shader to. If this is not set the shader will be applied to everything using the texture name. Valid element types for targetElement are [vehicles](mta://reference/misc/vehicle.md), [objects](mta://reference/misc/object.md) and [peds](mta://reference/misc/ped.md).
