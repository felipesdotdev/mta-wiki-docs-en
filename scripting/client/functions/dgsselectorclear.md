---
doc_id: "mta-wiki:13022"
title: "DgsSelectorClear"
source_title: "DgsSelectorClear"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorClear"
revision_id: 76220
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:26.817637+00:00"
---

# DgsSelectorClear

This function removes all the items from a dgs selector.

## Syntax

```
bool dgsSelectorClear ( element selector )
```

### Required Arguments

- **selector:** The dgs selector element to be cleared

### Returns

Returns *true* if the dgs selector element is valid and has been cleared successfully, *false* otherwise.

## Example

This example creates a selector with all server vehicles on it, with a command to clear the selector.
...
function ( )
	...
	for index, vehicle in ipairs ( getElementsByType ( "vehicle" ) ) do -- We loop through all vehicles.
		DGS:dgsSelectorAddItem ( selector, getVehicleName ( vehicle ) ) -- We add the vehicle name to our selector.
	end
end)

addCommandHandler ( "clear",
function ( )
	DGS:dgsSelectorClear ( selector ) -- We clear our selector items.
end)
```
