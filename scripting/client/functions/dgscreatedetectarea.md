---
doc_id: "mta-wiki:12096"
title: "DgsCreateDetectArea"
source_title: "DgsCreateDetectArea"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCreateDetectArea"
revision_id: 68288
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:12:15.920022+00:00"
---

# DgsCreateDetectArea

This function creates a custom detect area for any kind of shapes.

**DGS Detect Area Tutorial:** [https://www.youtube.com/watch?v=9kxKI1epzWI](https://www.youtube.com/watch?v=9kxKI1epzWI)

## Syntax

```
element dgsCreateDetectArea ( float x, float y, float width, float height, bool relative [, element parent = nil ] )
```

### Required Arguments

- **x:** A float of the 2D x position of the detect area on a player's screen. This is affected by the *relative* argument.

- **y:** A float of the 2D y position of the detect area on a player's screen. This is affected by the *relative* argument.

- **width:** A float of the width of the detect area. This is affected by the *relative* argument.

- **height:** A float of the height of the detect area. This is affected by the *relative* argument.
...
- **parent:** This is the parent that the detect area is attached to. If the *relative* argument is true, sizes and positioning will be made relative to this parent. If the *relative* argument is false, positioning will be the number of offset pixels from the parent's origin. If no parent is passed, the parent will become the screen - causing positioning and sizing according to screen positioning.

### Returns

Returns dgs-dxdetectarea element if detect area was created successfully, *false* otherwise.

## Example

This example will create a ellipse detect area using detect area and set to debug mode to display a ellipse on the player's screen.

```
DGS = exports.dgs
da = DGS:dgsCreateDetectArea (400,300,400,200,false) -- Create Detect Area
DGS:dgsDetectAreaSetFunction(da,[[
	if (mxRlt-0.5)^2+(myRlt-0.5)^2 < 0.5 then
		return true
	end
]]) --Custom Detect Area function
DGS:dgsDetectAreaSetDebugModeEnabled(da,true)  --Set debug mode so that we can see where it is and how it looks like.
```
