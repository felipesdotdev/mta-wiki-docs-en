---
doc_id: "mta-wiki:14502"
title: "KillPedTask"
source_title: "KillPedTask"
source_url: "https://wiki.multitheftauto.com/wiki/KillPedTask"
revision_id: 81534
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:16:03.879166+00:00"
---

# KillPedTask

[BETA](mta://reference/misc/beta-features.md): NEW FEATURE (BUILD: 1.6.0 [r22837](https://buildinfo.mtasa.com/?Author=&Branch=&Revision=22837))
...
- **taskType:** The task type given **primary** or **secondary**, for more info see [Tasks](mta://reference/misc/tasks.md).

- **taskNumber** the task slot number for reference see [Tasks](mta://reference/misc/tasks.md).
