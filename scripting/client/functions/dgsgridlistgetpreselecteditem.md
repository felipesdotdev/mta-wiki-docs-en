---
doc_id: "mta-wiki:13153"
title: "DgsGridListGetPreselectedItem"
source_title: "DgsGridListGetPreselectedItem"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetPreselectedItem"
revision_id: 70761
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:27.101500+00:00"
---

# DgsGridListGetPreselectedItem

This function returns the row and colum indexes of the hovering item in a grid list.

## Syntax

```
int, int dgsGridListGetPreselectedItem( element gridList )
```

### Required Arguments

- **gridList:** the grid list you want to know the preselected row index of

### Returns

Returns the row of the preselected item if the specified grid list is valid and has a preselected item, (-1) if no item is preselected, *false* otherwise.
...
setTimer(function()
	local hovering = DGS:dgsGridListGetPreselectedItem(GridList)
	outputChatBox("Hovering "..hovering)
end,200,0)
```
