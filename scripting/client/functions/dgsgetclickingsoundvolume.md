---
doc_id: "mta-wiki:13421"
title: "DgsGetClickingSoundVolume"
source_title: "DgsGetClickingSoundVolume"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetClickingSoundVolume"
revision_id: 73179
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:10.716271+00:00"
---

# DgsGetClickingSoundVolume

This function gets the volume of the clicking sound of a dgs element

## Syntax

```
float dgsGetClickingSoundVolume( element dgsElement )
```
...
Returns a *float* indicates the volume of the clicking sound if succeed, *false* otherwise.
...
outputhatBox(DGS:dgsGetClickingSoundVolume(btn)) --Default is 1
```
