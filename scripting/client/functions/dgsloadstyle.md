---
doc_id: "mta-wiki:13209"
title: "DgsLoadStyle"
source_title: "DgsLoadStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsLoadStyle"
revision_id: 71098
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:51.255353+00:00"
---

# DgsLoadStyle

This function loads an existing style into memory.

## Syntax

```
bool dgsLoadStyle( string styleName [, resource-data/string bindResource = resource ] )
```

### Required Arguments

- **styleName**: A string of the style name that you want to load.

### Optional Arguments

- **bindResource**:  A resource-data you want to load from. For DGS global, use string "**global**". Leave this to *nil* to use **resource**([getThisResource](mta://scripting/shared/functions/getthisresource.md)). [Note: When resource stops, the style will also be unloaded]
