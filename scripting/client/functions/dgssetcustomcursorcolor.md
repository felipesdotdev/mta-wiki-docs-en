---
doc_id: "mta-wiki:12777"
title: "DgsSetCustomCursorColor"
source_title: "DgsSetCustomCursorColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetCustomCursorColor"
revision_id: 74057
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:30.479479+00:00"
---

# DgsSetCustomCursorColor

This function sets the color of DGS custom cursor.

## Syntax

```
bool dgsSetCustomCursorColor( int color )
```

### Required Arguments

- **color:** An integer of color (0-‭4294967295‬), use [tocolor](mta://scripting/shared/functions/tocolor.md) for converting RGBA to color number.
...
DGS:dgsGetCustomCursorColor( tocolor (255,0,0,255) ) --You will get a bloody red cursor
```
