---
doc_id: "mta-wiki:11243"
title: "DgsRoundRectGetRadius"
source_title: "DgsRoundRectGetRadius"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectGetRadius"
revision_id: 77579
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:15.446822+00:00"
---

# DgsRoundRectGetRadius

This function gets the radius of the corner of the dgs rounded rectangle.

## Syntax

```
float dgsRoundRectGetRadius( element rndRect )
```
...
Returns a *float* value if successful, *false* otherwise.
...
local newRadius = DGS:dgsRoundRectGetRadius(rndRect)-25
DGS:dgsRoundRectSetRadius(rndRect,newRadius)
```
