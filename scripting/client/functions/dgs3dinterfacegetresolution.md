---
doc_id: "mta-wiki:11640"
title: "Dgs3DInterfaceGetResolution"
source_title: "Dgs3DInterfaceGetResolution"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceGetResolution"
revision_id: 63574
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:31.672484+00:00"
---

# Dgs3DInterfaceGetResolution

This function returns the width and height of the render target of 3D interface.

## Syntax

```
float, float dgs3DInterfaceGetResolution( element dgsElement )
```

### Required Arguments

- **dgsElement:** The DGS 3D interface of which you wish to retrieve the resolution.

### Returns

Returns width and height of the render target of 3D interface.
...
function panelPosition()
    ...
    if dgs3dPanel then -- if Panel exists 
        width, height = DGS:dgs3DInterfaceGetResolution( dgs3dPanel ) -- Gets the render target size
        outputChatBox("Width: "..width.." Height: "..height) -- outputs to ChatBox
    end
end
```
