---
doc_id: "mta-wiki:9989"
title: "DgsCmdClearText"
source_title: "DgsDxCmdClearText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxCmdClearText"
revision_id: 53733
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:24.725389+00:00"
---

# DgsCmdClearText

This function Clear Text in  cmd window .

## Syntax

```
bool dgsCmdClearText ( element cmd )
```

## Required Arguments

- **cmd:**  The cmd you want to clear.
...
for i=1,10 do
	DGS:outputCmdMessage(myCmd,tostring(i))
end
setTimer(function()
	DGS:dgsCmdClearText(myCmd)
end,1000,1)
```
