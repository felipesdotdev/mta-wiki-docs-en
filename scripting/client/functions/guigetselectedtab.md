---
doc_id: "mta-wiki:4437"
title: "GuiGetSelectedTab"
source_title: "GuiGetSelectedTab"
source_url: "https://wiki.multitheftauto.com/wiki/GuiGetSelectedTab"
revision_id: 55041
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:35.622250+00:00"
---

# GuiGetSelectedTab

This function returns the currently selected tab in the specified [tab panel](mta://scripting/concepts/element-gui-tab-panel.md).
...
**Method**: *[GuiTabPanel](mta://scripting/concepts/element-gui-tab-panel.md):getSelectedTab(...)*

**Variable**: *.selectedTab*

**Counterpart**: *[guiSetSelectedTab](mta://scripting/client/functions/guisetselectedtab.md)*

### Required Arguments

- **tabPanel:** The [tab panel](mta://scripting/concepts/element-gui-tab-panel.md) which current tab you want to retrieve.

### Returns

Returns an [element](mta://reference/misc/element.md) of the [tab](mta://scripting/concepts/element-gui-tab.md) if a tab was selected or [nil](mta://reference/misc/nil.md) if no tab was selected. If passed arguments were invalid or something went wrong, the function will return *false*.
