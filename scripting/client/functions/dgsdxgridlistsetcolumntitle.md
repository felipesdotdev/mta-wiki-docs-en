---
doc_id: "mta-wiki:9897"
title: "DgsGridListSetColumnTitle"
source_title: "DgsDxGridListSetColumnTitle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListSetColumnTitle"
revision_id: 53433
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:00.022255+00:00"
---

# DgsGridListSetColumnTitle

This function is used to change the column title of a dgs gridlist column.

## Syntax

```
bool dgsGridListSetColumnTitle( element dgsGridlist, int columnIndex, string title )
```

### Required Arguments

- **dgsGridlist**: The dgs grid list you want to change the column title from
...
```
DGS = exports.dgs
local gridlist = DGS:dgsCreateGridList ( 332, 195, 286, 249, false ) 
local column = DGS:dgsGridListAddColumn(gridlist, "title", 0.5)

addCommandHandler("setTitle",function(cmd, title)
	if title then 
		DGS:dgsGridListSetColumnTitle(gridlist ,column, title)	
