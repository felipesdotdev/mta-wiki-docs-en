---
doc_id: "mta-wiki:13695"
title: "DxImage"
source_title: "DxImage"
source_url: "https://wiki.multitheftauto.com/wiki/DxImage"
revision_id: 74647
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:50.210875+00:00"
---

# DxImage

Esta función crea una imagen basada en [dxCreateTexture](mta://scripting/client/functions/dxcreatetexture.md) + dxDrawing.
...
- **parent**: Este es el padre el cual la [imagen](https://wiki.multitheftauto.com/wiki/dxImage) se adjunta.

- **textureformat**: Formatos validos ***"argb"*** ***"dxt1"*** ***"dxt3"*** ***"dxt5"*** ; ***Para mas información véase [dxCreateTexture](mta://scripting/client/functions/dxcreatetexture.md)!***

- **mipmaps**: Un booleano (true o false) ; ***Para mas información véase [dxCreateTexture](mta://scripting/client/functions/dxcreatetexture.md)!***

- **textureType**: Formatos validos ***"wrap"*** ***"clamp"*** ***"mirror"*** ; ***Para mas información véase [dxCreateTexture](mta://scripting/client/functions/dxcreatetexture.md)!***
