---
doc_id: "mta-wiki:13815"
title: "DgsButtonGetFontHeight"
source_title: "DgsButtonGetFontHeight"
source_url: "https://wiki.multitheftauto.com/wiki/DgsButtonGetFontHeight"
revision_id: 75645
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:50.247330+00:00"
---

# DgsButtonGetFontHeight

This function returns the height of the font currently used in a DGS button.

## Syntax

```
float dgsButtonGetFontHeight ( element theButton )
```

### Required Arguments

- **theButton:** The button to get the font height from.

### Returns

Returns the absolute height of the font currently used in the button if the function is successful, *false* otherwise.

## Example

This example creates a window, a button, gets the extent and font height, and sets the button size according to these values.
