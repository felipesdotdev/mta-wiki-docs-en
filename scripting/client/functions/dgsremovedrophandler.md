---
doc_id: "mta-wiki:13249"
title: "DgsRemoveDropHandler"
source_title: "DgsRemoveDropHandler"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRemoveDropHandler"
revision_id: 71396
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:12.806287+00:00"
---

# DgsRemoveDropHandler

This function removes the **Drop** handler from a dgs element.

## Syntax

```
bool dgsRemoveDropHandler( element dgsElement )
```

### Required Arguments

- **dgsElement :** The dgs element that you want to remove drop handler.
...
local buttonA = DGS:dgsCreateButton(200,200,200,200,"Button1",false)
DGS:dgsAddDragHandler(buttonA,{"From Button A"})
local buttonB = DGS:dgsCreateButton(200,500,200,200,"Button2",false)
DGS:dgsAddDragHandler(buttonB,{"From Button B"})
local buttonC = DGS:dgsCreateButton(500,500,200,200,"Receive",false)
DGS:dgsAddDropHandler(buttonC)
addEventHandler("onDgsDrop",buttonC,function(data)
	iprint("Drop","Data:",data)
end,false)

DGS:dgsRemoveDropHandler(buttonC) --Remove
```
