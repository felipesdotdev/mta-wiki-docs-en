---
doc_id: "mta-wiki:13858"
title: "Dgs3DLineGetItemWidth"
source_title: "Dgs3DLineGetItemWidth"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DLineGetItemWidth"
revision_id: 75984
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:38.105181+00:00"
---

# Dgs3DLineGetItemWidth

This function gets the width of the specified item of DGS 3D Line.

## Syntax

```
bool dgs3DLineGetItemWidth( element line3D, int index )
```
...
Returns an *float* indicates the width of the item if successful, *false* otherwise.
...
local width = DGS:dgs3DLineGetItemWidth(line,1)
outputChatBox(width)
```
