---
doc_id: "mta-wiki:13626"
title: "DgsSVGNodeSetAttribute"
source_title: "DgsSVGNodeSetAttribute"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSVGNodeSetAttribute"
revision_id: 82391
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:19.487554+00:00"
---
...
```
bool dgsSVGNodeSetAttribute( xmlnode xmlNode, string attributeName, string value)
```

### Required Arguments

- **xmlNode:** The [xmlnode](mta://reference/misc/xmlnode.md) you want to change their attribute value.
...
- Returns [xmlnode](mta://reference/misc/xmlnode.md) if created successfully, *false* otherwise.
...
dgsSVGNodeSetAttribute(rect,'fill', 'rgb(255,0,255)') -- Change node 'fill' attribute value to 'rgb(255,0,255)'
```
