---
doc_id: "mta-wiki:13597"
title: "DgsLineSetItemPosition"
source_title: "DgsLineSetItemPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsLineSetItemPosition"
revision_id: 74052
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:50.727939+00:00"
---

# DgsLineSetItemPosition

This function sets the position of an item of dgs line.

## Syntax

```
bool dgsLineSetItemPosition (element line, int index, float startX = previousEndX, float startY = previousEndY, float endX, float endY [, float relative = false ] )
```
...
- **startX:** A float of the 2D x position of start position of the line on a player's screen, set to nil to use the end position of previous item.  This is affected by the *relative* argument.

- **startY:** A float of the 2D y position of start position of the line on a player's screen, set to nil to use the end position of previous item.  This is affected by the *relative* argument.
...
DGS:dgsLineSetItemPosition(line,101,_,_,0,0,true)
```
