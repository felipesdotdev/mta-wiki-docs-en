---
doc_id: "mta-wiki:9913"
title: "DgsEDAGetDebugModeEnabled"
source_title: "DgsDxEDAGetDebugModeEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxEDAGetDebugModeEnabled"
revision_id: 65460
language: "en"
categories: ["Client_functions", "Deprecated"]
generated_at: "2026-07-26T16:13:04.609208+00:00"
---
...
This function gets the debug mode state of an ellipse detect area.

## Syntax

```
bool dgsEDAGetDebugModeEnabled ( element eda )
```

### Required Arguments

- **eda:** The ellipse detect area that you want to get the debug mode state from.
...
addCommandHandler("eda",function()
	local state = DGS:dgsEDAGetDebugModeEnabled(eda)  --Get debug mode state
	DGS:dgsEDASetDebugModeEnabled(eda,not state)  --Set debug mode state
end)
```
