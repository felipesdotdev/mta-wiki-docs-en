---
doc_id: "mta-wiki:12851"
title: "DgsRoundRectGetTexture"
source_title: "DgsRoundRectGetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectGetTexture"
revision_id: 77577
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:15.708577+00:00"
---

# DgsRoundRectGetTexture

This function gets the texture that is used in rounded rectangle.

## Syntax

```
texture dgsRoundRectGetTexture( element rndRect )
```
...
Returns a *texture* there is a texture used in rounded rectangle if successful, *false* otherwise.
...
DGS:dgsRoundRectSetTexture(rndRect,dxCreateTexture("example.png"))  --Set texture
setTimer(function()
	local texture = DGS:dgsRoundRectGetTexture(rndRect)  --Get texture
	destroyElement(texture) --Release
	DGS:dgsRoundRectSetTexture(rndRect)  --Remove
end,5000,1)
```
