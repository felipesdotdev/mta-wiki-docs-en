---
doc_id: "mta-wiki:10984"
title: "DgsImageGetUVSize"
source_title: "DgsImageGetUVSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsImageGetUVSize"
revision_id: 70789
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:43.194561+00:00"
---

# DgsImageGetUVSize

This function gets the UV size of a DGS image (Only available when there is a texture loaded in DGS image).

## Syntax

```
float, float dgsImageGetUVSize ( element dgsImage, bool relative )
```

### Required Arguments

- **dgsImage**: The dgs image of which you want to get the UV size.
...
Returns the DGS image size *U* and *V* if the function has been successful, *false* otherwise.
...
local USize,VSize = DGS:dgsImageGetUVSize(image,false)
DGS:dgsImageSetUVSize(image,USize+10,VSize+10,false)
```
