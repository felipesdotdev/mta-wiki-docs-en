---
doc_id: "mta-wiki:11972"
title: "DgsObjectPreviewGetHandleByID"
source_title: "DgsObjectPreviewGetHandleByID"
source_url: "https://wiki.multitheftauto.com/wiki/DgsObjectPreviewGetHandleByID"
revision_id: 65069
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:06.243539+00:00"
---

# DgsObjectPreviewGetHandleByID

This function gets the **DGS handled** object prreview element by element ID.

## Syntax

```
element dgsObjectPreviewGetHandleByID( string elementID )
```
...
Returns an DGS handled SOVElement if success, *false* otherwise.
...
veh1 = createVehicle(411,0,0,3)  -- Create a vehicle
objPrev = DGS:dgsCreateObjectPreviewHandle(veh,0,0,0)  -- Create object preview handle
veh2 = createVehicle(411,0,0,3)  -- Create a vehicle
o_objPrev = exports.object_preview:createObjectPreview(veh2,0,0,0,50,50,200,200,...)
local DGSObjPrevID = getElementID(objPrev)
local OriObjPrevID = getElementID(o_objPrev)
outputChatBox(tostring(DGS:dgsObjectPreviewGetHandleByID(DGSObjPrevID)).." , "..tostring(DGS:dgsObjectPreviewGetHandleByID(OriObjPrevID)))
```
