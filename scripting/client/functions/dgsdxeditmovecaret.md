---
doc_id: "mta-wiki:9926"
title: "DgsEditMoveCaret"
source_title: "DgsDxEditMoveCaret"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxEditMoveCaret"
revision_id: 53532
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:08.239496+00:00"
---

# DgsEditMoveCaret

This function sets the current position of the caret (the text cursor) within the edit box by offsets.

## Syntax

```
bool dgsEditMoveCaret ( element theElement, int indexoffset [, bool selectText = false ] )
```
