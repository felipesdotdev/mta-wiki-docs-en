---
doc_id: "mta-wiki:13632"
title: "DgsLabelGetTextSize"
source_title: "DgsLabelGetTextSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsLabelGetTextSize"
revision_id: 74286
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:47.818280+00:00"
---

# DgsLabelGetTextSize

This function retrieves the theoretical width and height (in pixels) of a certain piece of text of dgs label.

## Syntax

```
float, float dgsLabelGetTextSize( element theLabel )
```

### Required Arguments

- **theLabel:** The label of whose text you wish to retrieve the width and height.
...
This example creates a text label, gets the text width and height, and creates a background for the label.

```
DGS = exports.dgs

local myLabel = DGS:dgsCreateLabel ( 200, 200, 100, 100, "OK. This is a dgs label of which you want to get the text width and height", false )
DGS:dgsSetProperty(myLabel,"wordBreak",true)
local width,height = DGS:dgsLabelGetTextSize( myLabel )
