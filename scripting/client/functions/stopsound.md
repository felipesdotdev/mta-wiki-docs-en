---
doc_id: "mta-wiki:4279"
title: "StopSound"
source_title: "StopSound"
source_url: "https://wiki.multitheftauto.com/wiki/StopSound"
revision_id: 82677
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:16:52.573258+00:00"
---

# StopSound

Stops the sound playback for specified [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md). The sound element is also destroyed.
...
**Method**: *[sound](mta://reference/misc/sound.md):stop(...)*

### Required Arguments

- **theSound:** the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) you want to stop playing.
