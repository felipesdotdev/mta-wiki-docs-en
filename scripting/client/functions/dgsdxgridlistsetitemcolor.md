---
doc_id: "mta-wiki:9905"
title: "DgsGridListSetItemColor"
source_title: "DgsDxGridListSetItemColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListSetItemColor"
revision_id: 68992
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:02.246205+00:00"
---
...
```
bool dgsGridListSetItemColor ( element gridList, int rowIndex, int columnIndex, int/table color )
```
...
- **columnIndex:** Column index. *( if passing a nil value into this argument, the color will be set to all the items of this row. )*

- **color:**  The color of the text. If passing a table, there should be "**{ normalColor, hoveringColor, selectedColor }**" ( If leaving a specific position to *nil*, row text color will be used ).
