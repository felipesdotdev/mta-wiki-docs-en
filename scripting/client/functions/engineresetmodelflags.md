---
doc_id: "mta-wiki:14045"
title: "EngineResetModelFlags"
source_title: "EngineResetModelFlags"
source_url: "https://wiki.multitheftauto.com/wiki/EngineResetModelFlags"
revision_id: 76709
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:14:57.522598+00:00"
---
...
```
boolean engineResetModelFlags( int modelID )
```

**OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**: *Engine.resetModelFlags(...)*

### Required Arguments

- **modelID**: ID of the model you want to reset.

### Returns

Returns *true* if model flags was successfully restored, *false* otherwise.
