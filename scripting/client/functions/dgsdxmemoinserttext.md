---
doc_id: "mta-wiki:9930"
title: "DgsMemoInsertText"
source_title: "DgsDxMemoInsertText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoInsertText"
revision_id: 61909
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:09.297180+00:00"
---
...
```
bool dgsMemoInsertText ( element theElement, int index, int line, string text )
```
...
- **index:** An integer indicated where the text will be inserted into the memo ( the text index of current 'line'. start from 0 ).

- **line:** An integer indicated which line of the text will be inserted into the memo ( start from 1 ).

- **text:** A string that you want to insert into the memo.
...
DGS:dgsMemoInsertText(memo,1,1,"Here is DGS")
```
