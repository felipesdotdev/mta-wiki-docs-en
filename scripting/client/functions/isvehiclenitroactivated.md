...
generated_at: "2026-07-26T16:16:02.249091+00:00"
---

# IsVehicleNitroActivated

This function checks if nitro is activated on the [vehicle](mta://reference/misc/vehicle.md).
...
- **theVehicle** The [vehicle](mta://reference/misc/vehicle.md), which you want to check for an activation.
