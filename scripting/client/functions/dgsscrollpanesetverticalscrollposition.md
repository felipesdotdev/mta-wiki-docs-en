---
doc_id: "mta-wiki:11674"
title: "DgsScrollPaneSetVerticalScrollPosition"
source_title: "DgsScrollPaneSetVerticalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollPaneSetVerticalScrollPosition"
revision_id: 63774
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:26.334162+00:00"
---
...
```
bool dgsScrollPaneSetVerticalScrollPosition ( element dgsScrollPane, float position )
```
...
This example sets the position of a scroll pane called "myScrollPane" created with [dgsCreateScrollPane](mta://scripting/client/functions/dgscreatescrollpane.md), and outputs it to the chatbox.
...
if ( myScrollPane ) then -- if the scroll pane exist then
	-- set the position
        DGS:dgsScrollPaneSetVerticalScrollPosition( myScrollPane, 33.3 ) -- 1/3 from the upside
        -- get the position
	local position = DGS:dgsScrollPaneGetVerticalScrollPosition( myScrollPane )
