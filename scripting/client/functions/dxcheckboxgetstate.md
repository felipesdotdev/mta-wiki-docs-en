---
doc_id: "mta-wiki:13684"
title: "DxCheckBoxGetState"
source_title: "DxCheckBoxGetState"
source_url: "https://wiki.multitheftauto.com/wiki/DxCheckBoxGetState"
revision_id: 74660
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:43.431164+00:00"
---

# DxCheckBoxGetState

Esta función sirve para obtener el estado de un [dxCheckBox](mta://scripting/client/functions/dxcheckbox.md).
...
En el siguiente ejemplo veremos como al darle click al boton imprime el estado del [dxCheckBox](mta://scripting/client/functions/dxcheckbox.md).
...
addEventHandler ( "onClick", button,
   function()
      print(dxCheckBoxSetState(checkB))
   end
)
```
