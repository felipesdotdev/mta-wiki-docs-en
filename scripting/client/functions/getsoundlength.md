---
doc_id: "mta-wiki:4282"
title: "GetSoundLength"
source_title: "GetSoundLength"
source_url: "https://wiki.multitheftauto.com/wiki/GetSoundLength"
revision_id: 80331
language: "en"
categories: ["Client_functions", "Changes_in_1.3.2"]
generated_at: "2026-07-26T16:15:25.416719+00:00"
---

# GetSoundLength

This function is used to return the playback length of the specified [sound](mta://reference/misc/sound.md) element.
...
**Method**: *[sound](mta://reference/misc/sound.md):getLength(...)*

**Variable**: *.length*

### Required Arguments

- **theSound:** the [sound](mta://reference/misc/sound.md) element which length you want to return.

### Returns

Returns an [float](mta://reference/misc/float.md) value indicating the playback length of the [sound](mta://reference/misc/sound.md) element in seconds.
