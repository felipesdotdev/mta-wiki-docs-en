---
doc_id: "mta-wiki:10982"
title: "DgsImageSetUVPosition"
source_title: "DgsImageSetUVPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsImageSetUVPosition"
revision_id: 70779
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:43.745683+00:00"
---

# DgsImageSetUVPosition

This function sets the UV positon of a DGS image (Only available when there is a texture loaded in DGS image).

## Syntax

```
bool dgsImageSetUVPosition ( element dgsImage, float UPos, float VPos, bool relative )
```

### Required Arguments

- **dgsImage**: The dgs image of which you wish to set the UV position.

- **UPos**: A float of the U position of image.

- **VPos**: A float of the V position of image.
