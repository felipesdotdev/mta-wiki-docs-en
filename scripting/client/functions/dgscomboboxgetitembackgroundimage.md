---
doc_id: "mta-wiki:14112"
title: "DgsComboBoxGetItemBackGroundImage"
source_title: "DgsComboBoxGetItemBackGroundImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetItemBackGroundImage"
revision_id: 77488
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:02.490919+00:00"
---

# DgsComboBoxGetItemBackGroundImage

This function gets the background texture from a specific item of the combo box.

## Syntax

```
texture/nil, texture/nil, texture/nil dgsComboBoxGetItemBackGroundImage( element comboBox, int itemIndex )
```
...
- **itemIndex:** An integer of the item index.

### Returns

Returns 3 textures if exist are **imageDefault**, **imageHoving**, **imageSelected** correspondingly if get successfully, *false* if one of the arguments was invalid.
...
local a,b,c = DGS:dgsComboBoxGetItemBackGroundImage(combobox, 2)
