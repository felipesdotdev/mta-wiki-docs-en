---
doc_id: "mta-wiki:11159"
title: "DgsEditClearText"
source_title: "DgsEditClearText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditClearText"
revision_id: 61898
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:59.054408+00:00"
---

# DgsEditClearText

This function clears the whole text of the edit.

## Syntax

```
bool dgsEditClearText ( element theElement )
```

### Required Arguments

- **theElement:** The edit to be cleared.

### Returns

Returns *true* if the text was successfully cleared, *false* otherwise.
...
setTimer(function()
	DGS:dgsEditClearText(edit) --Now it is cleared.
end,500,10)
```
