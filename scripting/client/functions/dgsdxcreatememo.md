---
doc_id: "mta-wiki:9932"
title: "DgsCreateMemo"
source_title: "DgsDxCreateMemo"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxCreateMemo"
revision_id: 68291
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:13:09.863480+00:00"
---

# DgsCreateMemo

This function creates a new DGS memo.  This is a multiline edit box in which the user can input text.

## Syntax

```
element dgsCreateMemo ( float x, float y, float width, float height, string text, bool relative [, element parent = nil, int textColor = 0x000000FF, int scaleX = 1, int scaleY = 1, element bgImage = nil, int bgColor = 0xFFFFFFFF ] )
```
...
- **x:** A float of the 2D x position of the DGS memo on a player's screen.  This is affected by the *relative* argument.

- **y:** A float of the 2D y position of the DGS memo on a player's screen. This is affected by the *relative* argument.

- **width:** A float of the width of the DGS memo. This is affected by the *relative* argument.

- **height:** A float of the height of the DGS memo. This is affected by the *relative* argument.
...
- **textColor:** An integer of the color of the text.

- **scaleX:** A float of the width of the text scale.

- **scaleY:** A float of the height of the text scale.

- **bgImage:** A texture element of the back ground image of the memo.

- **bgColor:** An integer of the back ground color of the memo.

### Element Type

The Element Type of this element is dgs-dxmemo.

### Returns

Returns a dgs-dxmemo element of the created memo if it was successfully created, false otherwise.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	Window = DGS:dgsCreateWindow(0.3664,0.2764,0.3508,0.3477,"DGS Window",true)
	DGS:dgsCreateMemo(17,79,414,246,"",false,Window)
end)
```
