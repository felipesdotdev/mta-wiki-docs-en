---
doc_id: "mta-wiki:13817"
title: "DgsWindowGetTextSize"
source_title: "DgsWindowGetTextSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsWindowGetTextSize"
revision_id: 75648
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:41.027263+00:00"
---

# DgsWindowGetTextSize

This function retrieves the theoretical width and height (in pixels) of a certain piece of title text of dgs window.

## Syntax

```
float, float dgsWindowGetTextSize( element theWindow )
```

### Required Arguments

- **theWindow:** The window of whose text you wish to retrieve the width and height.
...
This example creates a text window, gets the title text width and height, and adjust the window width and title height according to the title text.

```
DGS = exports.dgs

local myWindow = DGS:dgsCreateWindow ( 200, 200, 200, 200, "This a window with its title.\n This is the second line", false )
DGS:dgsSetProperty(myWindow,"wordBreak",true)
local width,height = DGS:dgsWindowGetTextSize( myWindow )
DGS:dgsSetSize ( myWindow, width, _, false )
DGS:dgsSetProperty ( myWindow, "titleHeight", height )
```
