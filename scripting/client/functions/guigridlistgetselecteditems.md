---
doc_id: "mta-wiki:4440"
title: "GuiGridListGetSelectedItems"
source_title: "GuiGridListGetSelectedItems"
source_url: "https://wiki.multitheftauto.com/wiki/GuiGridListGetSelectedItems"
revision_id: 60523
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:37.408309+00:00"
---

# GuiGridListGetSelectedItems

This function returns the items selected in the specified [grid list](mta://scripting/concepts/element-gui-gridlist.md).
...
**Method**: *[GuiGridList](mta://scripting/concepts/element-gui-gridlist.md):getSelectedItems(...)*

**Variable**: *.selectedItems*

### Required Arguments

- **gridList:** The [grid list](mta://scripting/concepts/element-gui-gridlist.md) which selected items you want to retrieve.

### Returns

Returns a table over the selected items in the [grid list](mta://scripting/concepts/element-gui-gridlist.md) in this format:
