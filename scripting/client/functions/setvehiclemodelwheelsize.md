...
**Method**: *[Vehicle](mta://reference/misc/vehicle.md).setModelWheelSize(...)*

**Counterpart**: *[getVehicleModelWheelSize](mta://scripting/client/functions/getvehiclemodelwheelsize.md)*
