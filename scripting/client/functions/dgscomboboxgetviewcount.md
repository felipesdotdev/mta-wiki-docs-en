---
doc_id: "mta-wiki:12490"
title: "DgsComboBoxGetViewCount"
source_title: "DgsComboBoxGetViewCount"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetViewCount"
revision_id: 67360
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:05.633314+00:00"
---

# DgsComboBoxGetViewCount

This function gets the viewed items count of the drop-down box of combo box.

## Syntax

```
bool dgsComboBoxGetViewCount( element comboBox )
```
...
Returns the numbers of viewed items count if [dgsComboBoxSetViewCount](mta://scripting/client/functions/dgscomboboxsetviewcount.md) has been used, false otherwise.
...
DGS:dgsComboBoxSetViewCount(combo,5)

outputChatBox ("viewCount is: "..DGS:dgsComboBoxGetViewCount(combo))
```
