---
doc_id: "mta-wiki:3419"
title: "GuiSetFont"
source_title: "GuiSetFont"
source_url: "https://wiki.multitheftauto.com/wiki/GuiSetFont"
revision_id: 61325
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:41.082206+00:00"
---

# GuiSetFont

This function sets the font of a [GUI element](mta://scripting/concepts/gui-widgets.md) to be used when drawing text.
...
**Method**: *[GuiElement](mta://scripting/concepts/gui-widgets.md):setFont(...)*

**Variable**: *.font*

**Counterpart**: *[guiGetFont](mta://scripting/client/functions/guigetfont.md)*

### Required Arguments

- **guiElement:** The GUI element you wish to change the font of

- **font:** Either a custom [GUI font](mta://scripting/concepts/gui-font.md) element or the name of a built-in GUI font. See [Standard GUI Font Names](mta://scripting/concepts/standard-gui-font-names.md)
