---
doc_id: "mta-wiki:12309"
title: "Dgs3DTextSetPosition"
source_title: "Dgs3DTextSetPosition"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DTextSetPosition"
revision_id: 66417
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:44.105032+00:00"
---

# Dgs3DTextSetPosition

This function sets a new position for 3D text.

## Syntax

```
bool dgs3DTextSetPosition( element text3D, float x, float y, float z )
```
...
setTimer(function() -- move text after 3 seconds 
        DGS:dgs3DTextSetPosition(text,0,5,1) -- set new text postion to 0, 5, 4
end, 3000, 0)
```
