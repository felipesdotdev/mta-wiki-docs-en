---
doc_id: "mta-wiki:14438"
title: "DxScrollGetCurrentPosition"
source_title: "DxScrollGetCurrentPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DxScrollGetCurrentPosition"
revision_id: 80652
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:50.973056+00:00"
---

# DxScrollGetCurrentPosition

Esta funcion obtiene la posición de la barra de desplazamiento ya creada [dxScroll](mta://scripting/client/functions/dxscroll.md).
...
```
bool dxScrollGetCurrentPosition(element element)
```
...
-- Creamos la barra de desplazamiento (Horizontal en este caso).
scrollH = dxScroll(302, 317, 317, false, win, true)

-- Aplicamos la función y obtenemos su resultado.
resultado = dxScrollGetCurrentPosition(scrollH)
