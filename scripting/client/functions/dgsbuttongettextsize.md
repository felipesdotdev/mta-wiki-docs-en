---
doc_id: "mta-wiki:13813"
title: "DgsButtonGetTextSize"
source_title: "DgsButtonGetTextSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsButtonGetTextSize"
revision_id: 75643
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:50.846046+00:00"
---

# DgsButtonGetTextSize

This function retrieves the theoretical width and height (in pixels) of a certain piece of text of dgs button.

## Syntax

```
float, float dgsButtonGetTextSize( element theButton )
```

### Required Arguments

- **theButton:** The button of whose text you wish to retrieve the width and height.
...
This example creates a text button, gets the text width and height, and creates a background for the button.

```
DGS = exports.dgs

local myButton = DGS:dgsCreateButton ( 200, 200, 100, 100, "OK. This is a dgs button of which you want to get the text width and height", false )
DGS:dgsSetProperty(myButton,"wordBreak",true)
local width,height = DGS:dgsButtonGetTextSize( myButton )
local background = DGS:dgsCreateImage(200, 200, width, height, _, false, _, tocolor(0,0,0,100))
```
