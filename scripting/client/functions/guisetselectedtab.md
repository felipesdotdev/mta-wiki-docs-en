---
doc_id: "mta-wiki:4438"
title: "GuiSetSelectedTab"
source_title: "GuiSetSelectedTab"
source_url: "https://wiki.multitheftauto.com/wiki/GuiSetSelectedTab"
revision_id: 82636
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:41.532060+00:00"
---

# GuiSetSelectedTab

This function is used to change the currently selected [tab](mta://scripting/concepts/element-gui-tab.md) in a [tab panel](mta://scripting/concepts/element-gui-tab-panel.md).
...
- **tabPanel:** The [tab panel](mta://scripting/concepts/element-gui-tab-panel.md) which current tab you want to change.

- **theTab:** The [tab](mta://scripting/concepts/element-gui-tab.md) which will be the new active tab.
