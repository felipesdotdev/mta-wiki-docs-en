---
doc_id: "mta-wiki:14128"
title: "DgsCircleGetRotation"
source_title: "DgsCircleGetRotation"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleGetRotation"
revision_id: 77568
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:55.586420+00:00"
---

# DgsCircleGetRotation

This function gets the rotation from dgs circle.

## Syntax

```
float dgsCircleGetRotation( element circle )
```
...
Returns a *float* indicates the rotation of dgs circle in degrees if successful, *false* otherwise.
...
DGS:dgsCircleSetRotation(c,DGS:dgsCircleGetRotation(c)+20)
```
