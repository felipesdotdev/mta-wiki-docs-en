---
doc_id: "mta-wiki:13886"
title: "DgsRadioButtonGetButtonAlign"
source_title: "DgsRadioButtonGetButtonAlign"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRadioButtonGetButtonAlign"
revision_id: 76171
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:09.136515+00:00"
---

# DgsRadioButtonGetButtonAlign

This function gets the alignment of the button of a dgs radio button.

## Syntax

```
string dgsRadioButtonGetButtonAlign ( dgsRadioButton )
```

### Required Arguments

- **radioButton:** The dgs radio button.

### Returns

Returns a *string* indicates the alignment of the button of a dgs radio button if successful, *false* otherwise. Valid type strings are:

- - "left": The dgs radio button will be aligned to the left between bounding box to text.

- "right": The dgs radio button will be aligned to the right between bounding box to text.

## Example

```
DGS = exports.dgs
local rb = DGS:dgsCreateRadioButton(500,500,200,30,"aaaa",false)
local alignment = DGS:dgsRadioButtonGetButtonAlign( rb )
outputChatBox(alignment) --"left" by default
```
