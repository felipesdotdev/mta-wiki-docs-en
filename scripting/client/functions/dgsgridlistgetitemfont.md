---
doc_id: "mta-wiki:14088"
title: "DgsGridListGetItemFont"
source_title: "DgsGridListGetItemFont"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetItemFont"
revision_id: 77212
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:25.071646+00:00"
---

# DgsGridListGetItemFont

With this function you can retrieve the font of an item in a dgs grid list.

## Syntax

```
var dgsGridListGetItemFont ( element gridList, int rowIndex, int columnIndex )
```
...
Returns the font of the specified item if successful, *false* if one of the arguments was invalid.

## Example

This example gets a random item from the gridlist.
...
function clientsideResourceStart ()
    ...
    if ( column ) then
        ...
        local myItemFont = DGS:dgsGridListGetItemData ( numberList, row, column ) -- item Font
    end
end
