---
doc_id: "mta-wiki:12229"
title: "DgsProgressBarSetStyle"
source_title: "DgsProgressBarSetStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsProgressBarSetStyle"
revision_id: 74382
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:08.863066+00:00"
---

# DgsProgressBarSetStyle

This function changes the style of a dgs progress bar.

## Syntax

```
bool dgsProgressBarSetStyle( element progressbar, string style [, table settingTable ] )
```
...
- **progressbar:** A progress bar you want to set style

- **style:** Name of the style

### Optional Arguments

- **settingTable:** Optional arguments for progress bar ([Progress Bar Style Properties](mta://reference/misc/dgs-dxprogressbar.md))

### Returns

Return *true* if style was set successfully, *false* otherwise.
...
**Example 1: Progress bar with ring-round style**
...
**Example 2: Progress bar with ring-round style and optional arguments**
...
**Example 3: Progress bar with normal style**

```
DGS = exports.dgs
local pbNormal = DGS:dgsCreateProgressBar(300,200,600,100,false)
DGS:dgsProgressBarSetProgress(pbNormal, 50)
DGS:dgsProgressBarSetStyle(pbNormal,"normal-horizontal")
```
