---
doc_id: "mta-wiki:9877"
title: "DgsGetEnabled"
source_title: "DgsDxGUIGetEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGUIGetEnabled"
revision_id: 70994
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:55.931659+00:00"
---

# DgsGetEnabled

This function determines if a DGS element is enabled.

## Syntax

```
bool dgsGetEnabled ( element guiElement )
```

**DGS OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**:  *DGSElement:getEnabled(...)*

**Variable**: *.enabled*

**Counterpart**: *[dgsSetEnabled](mta://scripting/client/functions/dgssetenabled.md)*
