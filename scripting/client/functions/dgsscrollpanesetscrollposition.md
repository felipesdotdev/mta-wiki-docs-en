---
doc_id: "mta-wiki:10039"
title: "DgsScrollPaneSetScrollPosition"
source_title: "DgsScrollPaneSetScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollPaneSetScrollPosition"
revision_id: 54022
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:26.061322+00:00"
---

# DgsScrollPaneSetScrollPosition

This function set scroll position of dgs scroll pane.

## Syntax

```
bool dgsScrollPaneSetScrollPosition( element scrollPane[, float vertical = nil, float horizontal = nil ] )
```

### Required Arguments

- **scrollPane:** The dgs scroll pane element to set.

### Optional Arguments

- **vertical:** The vertical scroll bar position. If set to nil, nothing will happen ( remain the position ).

- **horizontal:** The horizontal scroll bar position. If set to nil, nothing will happen ( remain the position ).
...
DGS:dgsScrollPaneSetScrollPosition(scrollPane,50)
```
