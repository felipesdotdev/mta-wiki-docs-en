---
doc_id: "mta-wiki:11755"
title: "Dgs3DInterfaceSetAttachedOffsets"
source_title: "Dgs3DInterfaceSetAttachedOffsets"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceSetAttachedOffsets"
revision_id: 76192
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:33.382163+00:00"
---
...
```
bool dgs3DInterfaceSetAttachedOffsets( element dgsElement [, float offsetX = offsetX, float offsetY = offsetY, float offsetZ = offsetZ, float offsetFaceX = offsetFaceX, float offsetFaceY = offsetFaceY, float offsetFaceZ = offsetFaceZ ] )
```
...
- **offsetX:** A float of the offset of the 3D x coordinate.

- **offsetY:** A float of the offset of the 3D y coordinate.

- **offsetZ:** A float of the offset of the 3D z coordinate.

- **offsetFaceX:** A float of the 3D x direction that the DGS 3D Interface faces to relative to attached element.

- **offsetFaceY:** A float of the 3D Y direction that the DGS 3D Interface faces to relative to attached element.

- **offsetFaceZ:** A float of the 3D Z direction that the DGS 3D Interface faces to relative to attached element.
