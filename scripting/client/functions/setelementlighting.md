...
generated_at: "2026-07-26T16:16:40.155839+00:00"
---
...
This function changes the lighting value for the specified [element](mta://reference/misc/element.md). This can be a [player](mta://reference/misc/player.md), [ped](mta://reference/misc/ped.md), [vehicle](mta://reference/misc/vehicle.md), [object](mta://reference/misc/object.md), [weapon](mta://reference/misc/element-weapon.md). 
...
**Method**: *[element](mta://reference/misc/element.md):setLighting(...)*

**Variable**: *.lighting*

**Counterpart**: *[getElementLighting](mta://scripting/client/functions/getelementlighting.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) whose lighting you want to change.
