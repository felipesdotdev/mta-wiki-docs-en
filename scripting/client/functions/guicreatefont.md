...
generated_at: "2026-07-26T16:15:32.984653+00:00"
---

# GuiCreateFont

This function creates a [GUI font](mta://scripting/concepts/gui-font.md) element that can be used in [guiSetFont](mta://scripting/client/functions/guisetfont.md). Successful font creation is not guaranteed, and may fail due to hardware or memory limitations.
...
Returns a [GUI font](mta://scripting/concepts/gui-font.md) element if successful, *false* if invalid arguments were passed to the function, or there is insufficient resources available.
