---
doc_id: "mta-wiki:12643"
title: "GetRoofPosition"
source_title: "GetRoofPosition"
source_url: "https://wiki.multitheftauto.com/wiki/GetRoofPosition"
revision_id: 81280
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:23.877288+00:00"
---
...
- **x**: A [float](mta://reference/misc/float.md) representing the X world coordinate of the point.

- **y**: A [float](mta://reference/misc/float.md) representing the Y world coordinate of the point.

- **z**: A [float](mta://reference/misc/float.md) representing the Z world coordinate of the point.

### Returns

Returns a [float](mta://reference/misc/float.md) with the lowest roof-level Z coord if parameters are valid, *false* if the point you tried to test is outside the loaded world map.
