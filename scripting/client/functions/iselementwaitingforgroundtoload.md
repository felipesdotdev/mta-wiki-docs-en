...
generated_at: "2026-07-26T16:15:55.692373+00:00"
---
...
- **theElement:** the element to check its frozen waiting for custom map objects to load status. It can be a [vehicle](mta://reference/misc/vehicle.md), [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md).
...
The next code snippet outputs a message when a vehicle respawns far away from players, above an [object](mta://reference/misc/object.md).
