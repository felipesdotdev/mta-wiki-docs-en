---
doc_id: "mta-wiki:13812"
title: "DgsWindowGetTextExtent"
source_title: "DgsWindowGetTextExtent"
source_url: "https://wiki.multitheftauto.com/wiki/DgsWindowGetTextExtent"
revision_id: 75646
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:40.786804+00:00"
---

# DgsWindowGetTextExtent

This function returns the extent, or width, of the current title text of a DGS window.

## Syntax

```
float dgsWindowGetTextExtent ( element theWIndow )
```

### Required Arguments

- **theWIndow:** The window to get the title text extent from.

### Returns

Returns the absolute width of the the current title text of a DGS window if the function is successful, *false* otherwise.
