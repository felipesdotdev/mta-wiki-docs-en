---
doc_id: "mta-wiki:11676"
title: "DgsMemoSetVerticalScrollPosition"
source_title: "DgsMemoSetVerticalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoSetVerticalScrollPosition"
revision_id: 65354
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:04.113254+00:00"
---

# DgsMemoSetVerticalScrollPosition

This function is used to set the vertical scroll position from a memo

## Syntax

```
bool dgsMemoSetVerticalScrollPosition( element dgsMemo, float position )
```

**OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**: *[dgsMemo](https://wiki.multitheftauto.com/index.php?title=Element/DGS/Memo&action=edit&redlink=1):setVerticalScrollPosition(...)*

**Variable**: *.verticalScrollPosition*

**Counterpart**: *[dgsMemoGetVerticalScrollPosition](mta://scripting/client/functions/dgsmemogetverticalscrollposition.md)*

### Required Arguments

- **dgsMemo**: The memo you want to set the vertical scroll position from
...
if (memo) then -- if the grid list exist then
    DGS:dgsMemoSetVerticalScrollPosition (memo,50) -- in the middle
    local postion = DGS:dgsMemoGetVerticalScrollPosition(memo) -- get the vertical scroll position
