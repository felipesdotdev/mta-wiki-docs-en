---
doc_id: "mta-wiki:12670"
title: "DgsRemoteImageGetTexture"
source_title: "DgsRemoteImageGetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRemoteImageGetTexture"
revision_id: 68300
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:12.081682+00:00"
---

# DgsRemoteImageGetTexture

This function gets the texture of loaded dgs remote image.

## Syntax

```
texture dgsRemoteImageGetTexture( element remoteImage )
```

### Required Arguments

- **remoteImage :** An element of remote image you want to get the texture from

### Returns

Returns *true* if the remote image is valid and loaded, *false* otherwise.
...
addEventHandler("onDgsRemoteImageLoad",remoteImage, function()
	local texture = DGS:dgsRemoteImageGetTexture(remoteImage) --Get the texture from remote image
	print(texture)
end,false)
```
