---
doc_id: "mta-wiki:8121"
title: "GetNearClipDistance"
source_title: "GetNearClipDistance"
source_url: "https://wiki.multitheftauto.com/wiki/GetNearClipDistance"
revision_id: 43107
language: "en"
categories: ["Client_functions", "Changes_in_1.4.1", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:15.732354+00:00"
---

# GetNearClipDistance

This function gets the distance from the [camera](mta://scripting/client/functions/camera.md) at which the world starts rendering. For more information about this please refer to [setNearClipDistance](mta://scripting/client/functions/setnearclipdistance.md).
...
This function returns a *[float](mta://reference/misc/float.md)* containing the actual near clip distance.
