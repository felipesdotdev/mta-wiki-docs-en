---
doc_id: "mta-wiki:12774"
title: "DgsGetCustomCursorSize"
source_title: "DgsGetCustomCursorSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetCustomCursorSize"
revision_id: 68922
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:12.197603+00:00"
---

# DgsGetCustomCursorSize

This function gets the size of DGS custom cursor.

## Syntax

```
float dgsGetCustomCursorSize( )
```

### Returns

Returns a *float* indicates the size of the curstom cursor if successful, *false* otherwise.
...
outputChatBox(DGS:dgsGetCustomCursorSize()) --The default size
```
