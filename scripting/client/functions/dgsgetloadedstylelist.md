---
doc_id: "mta-wiki:13213"
title: "DgsGetLoadedStyleList"
source_title: "DgsGetLoadedStyleList"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetLoadedStyleList"
revision_id: 71107
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:14.955387+00:00"
---

# DgsGetLoadedStyleList

This function get the loaded style list from DGS global or a specific resource.

## Syntax

```
bool dgsGetLoadedStyleList( [ bool includeGlobal = false, resource-data/string bindResource = resource ] )
```

### Optional Arguments

- **includeGlobal**: A bool indicates whether the returning table includes loaded styles of "global".
...
Returns a *table* includes the name of loaded style, *false* otherwise.
...
DGS:dgsLoadStyle("myStyle") --Load

for name in ipairs(DGS:dgsGetLoadedStyleList())
	outputChatBox(name) 
end
```
