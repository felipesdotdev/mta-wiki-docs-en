---
doc_id: "mta-wiki:11597"
title: "DgsColorPickerGetComponentSelectorValue"
source_title: "DgsColorPickerGetComponentSelectorValue"
source_url: "https://wiki.multitheftauto.com/wiki/DgsColorPickerGetComponentSelectorValue"
revision_id: 63464
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:59.986246+00:00"
---

# DgsColorPickerGetComponentSelectorValue

This function gets the value in component selector ranges from 0 to 100.

## Syntax

```
float dgsColorPickerGetComponentSelectorValue( element componentSelector )
```

### Required Arguments

- **componentSelector :** The component selector you want to get the value from.

### Returns

Returns a float ranges from 0 to 100 if successful, *false* otherwise
...
outputChatBox(DGS:dgsColorPickerGetComponentSelectorValue(Hedit1))
```
