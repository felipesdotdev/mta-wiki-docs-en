---
doc_id: "mta-wiki:9911"
title: "DgsGridListGetColumnRelative"
source_title: "DgsGridListGetColumnRelative"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetColumnRelative"
revision_id: 53482
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:23.120069+00:00"
---

# DgsGridListGetColumnRelative

This function get whether the columns' length are relative .

## Syntax

```
bool dgsGridListGetColumnRelative( element gridList )
```
...
Returns *true* if the columns' length are relative, *false* otherwise.
...
local relative = DGS:dgsGridListGetColumnRelative( list )
outputChatBox("Column Relative: "..tostring(relative))
```
