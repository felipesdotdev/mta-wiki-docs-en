---
doc_id: "mta-wiki:12775"
title: "DgsGetCustomCursorType"
source_title: "DgsGetCustomCursorType"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetCustomCursorType"
revision_id: 68910
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:12.445671+00:00"
---

# DgsGetCustomCursorType

This function gets the current type of cursor. **This function also works when custom cursor is not enabled.**
...
```
string dgsGetCustomCursorType( )
```

### Returns

Returns a *string* indicates the type of the curstom cursor if successful, *false* otherwise.
...
addEventHandler("onClientRender",root,function()
	outputChatBox(DGS;dgsGetCustomCursorType())
end)
```
