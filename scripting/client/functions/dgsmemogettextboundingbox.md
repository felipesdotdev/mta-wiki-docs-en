---
doc_id: "mta-wiki:12863"
title: "DgsMemoGetTextBoundingBox"
source_title: "DgsMemoGetTextBoundingBox"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoGetTextBoundingBox"
revision_id: 74264
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:59.388999+00:00"
---

# DgsMemoGetTextBoundingBox

This function gets the bounding box of the text inside DGS Memo.

## Syntax

```
float, float dgsMemoGetTextBoundingBox( element dgsMemo [, bool excludePadding = false ]  )
```

### Required Arguments

- **dgsMemo:** The dgs-dxmemo.

### Optional Arguments

- **excludePadding:** A bool indicates whether the bounding include **padding**. (For setting memo size, we *should* include **padding**)

### Returns

Returns two floats represent for width and height in absolute size of the text bounding box if succeed, *false* otherwise.
...
memo = DGS:dgsCreateMemo(200, 200, 600, 600, "Test DGS Memo", false)
setTimer(function()
	local w,h = DGS:dgsMemoGetTextBoundingBox(memo)
	DGS:dgsSetSize(memo,w,h)
end,1000,1)
```
