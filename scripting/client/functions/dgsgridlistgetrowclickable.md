---
doc_id: "mta-wiki:12350"
title: "DgsGridListGetRowHoverable"
source_title: "DgsGridListGetRowClickable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetRowClickable"
revision_id: 66646
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:27.824565+00:00"
---

# DgsGridListGetRowHoverable

This function returns whether the row is hoverable.

## Syntax

```
string dgsGridListGetRowHoverable( element gridlist, int row )
```
...
Returns true if the row is hoverable, *false* otherwise.
...
for id, player in ipairs(getElementsByType("player")) do
    ...
    iprint(DGS:dgsGridListGetRowHoverable(playerList, row))
end
```
