---
doc_id: "mta-wiki:12772"
title: "DgsGetCustomCursorImage"
source_title: "DgsGetCustomCursorImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetCustomCursorImage"
revision_id: 68919
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:11.827260+00:00"
---

# DgsGetCustomCursorImage

This function gets the image that has applied to a specific type.

## Syntax

```
material dgsGetCustomCursorImage( string cursorType )
```
...
Returns a *material* element if there is an image that is used in the specific cursor type, *false* otherwise.
...
outputChatBox(tostring(DGS:dgsGetCustomCursorImage("arrow")))
```
