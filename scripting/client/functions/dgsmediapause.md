---
doc_id: "mta-wiki:10727"
title: "DgsMediaPause"
source_title: "DgsMediaPause"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMediaPause"
revision_id: 58456
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:54.698952+00:00"
---

# DgsMediaPause

This function pauses media in media browser.
...
```
bool dgsMediaPause( element multiMediaBrowser )
```
...
addCommandHandler("pausemedia", function() -- Add pause media command
    if dgsMediaPause then
        outputChatBox("Media Paused")
    end
end)
```
