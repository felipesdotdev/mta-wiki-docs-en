---
doc_id: "mta-wiki:11524"
title: "DgsGetInputMode"
source_title: "DgsGetInputMode"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetInputMode"
revision_id: 71016
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:14.350573+00:00"
---

# DgsGetInputMode

This function is a replica of [guiGetInputMode](mta://scripting/client/functions/guigetinputmode.md). In order to satisfy the needs of developers, the function exists here.

## Syntax

```
string dgsGetInputMode ( )
```

**DGS OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**:  ***dgsRootInstance**:getInputMode(...)*

**Counterpart**: *[dgsSetInputMode](mta://scripting/client/functions/dgssetinputmode.md)*
