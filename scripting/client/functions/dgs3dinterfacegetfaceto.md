---
doc_id: "mta-wiki:11778"
title: "Dgs3DInterfaceGetFaceTo"
source_title: "Dgs3DInterfaceGetFaceTo"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceGetFaceTo"
revision_id: 64595
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:30.834699+00:00"
---

# Dgs3DInterfaceGetFaceTo

This function gets the position that the DGS 3D interface faces to.

## Syntax

```
float, float, float, string dgs3DInterfaceGetFaceTo ( element dgsElement )
```

### Required Arguments

- **dgsElement:** The DGS 3D interface of which you wish to get the facing position from.

### Returns

Returns 3 *float* and 1 *string*, indicates the x,y,z that DGS 3D interface faces to and the relativity option.
...
function panelPosition()
	...
	local x,y,z,rlt = DGS:dgs3DInterfaceGetFaceTo(dgs3dPanel)
	outputChatBox("X:"..x..";Y:"..y..";Z:"..z..";Relative To:"..rlt)
end
```
