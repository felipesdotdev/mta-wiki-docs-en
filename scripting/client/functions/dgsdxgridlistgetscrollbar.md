---
doc_id: "mta-wiki:9891"
title: "DgsGridListGetScrollBar"
source_title: "DgsDxGridListGetScrollBar"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListGetScrollBar"
revision_id: 76706
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:58.224001+00:00"
---

# DgsGridListGetScrollBar

This function retrieves the scroll bars of a DGS grid list.

## Syntax

```
table dgsGridListGetScrollBar( element gridList )
```

### Required Arguments

- **gridList:** The DGS grid list element to retrieve the scroll bars from.

### Returns

This function returns a table containing the vertical and horizontal scroll bars of the specified DGS grid list. *false* otherwise.
...
function clientsideResourceStart ()
    ...
    local testList = dgsCreateGridList ( 0.45, 0.45, 0.15, 0.15, true ) 
    -- Force scroll bars to be visible
    dgsGridListSetScrollBarState ( testList, true, true )
    -- Get the scorllbars of the grid list
    local scrollBars = dgsGridListGetScrollBar ( testList )
    -- Lock the vertical scroll bar
    dgsScrollBarSetLocked( scrollBars[1], true )
    -- Lock the horizontal scroll bar
    dgsScrollBarSetLocked( scrollBars[2], true )
end
