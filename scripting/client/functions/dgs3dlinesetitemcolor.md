---
doc_id: "mta-wiki:13855"
title: "Dgs3DLineSetItemColor"
source_title: "Dgs3DLineSetItemColor"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DLineSetItemColor"
revision_id: 75974
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:39.280674+00:00"
---

# Dgs3DLineSetItemColor

This function sets the color of the specified item of DGS 3D Line.

## Syntax

```
bool dgs3DLineSetItemColor( element line3D, int index, int color )
```

### Required Arguments

- **line3D**: The DGS 3D Line element.

- **index**: The item index of DGS 3D Line.

- **color:** An integer of color (0-‭4294967295‬), use tocolor for converting RGBA to color number. If not set, default color of DGS 3D Line will be used.
...
local itemColor = DGS:dgs3DLineGetItemColor(line,1)
DGS:dgs3DLineSetItemColor(line,100,titemColor)
```
