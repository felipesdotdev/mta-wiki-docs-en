---
doc_id: "mta-wiki:14090"
title: "DgsComboBoxSetItemImage"
source_title: "DgsComboBoxSetItemImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxSetItemImage"
revision_id: 77255
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:09.086323+00:00"
---

# DgsComboBoxSetItemImage

This function sets the image on a combo box item.

## Syntax

```
bool dgsComboBoxSetItemImage( element comboBox, int itemIndex, element texture [, int color = 0xFFFFFFFF, float offsetX = 0, float offsetY = 0, float width, float height, bool relative ] )
```

### Required Arguments

- **comboBox:** the combo box containing the item you're interested in.

- **itemIndex:** An integer of the index of the item.
...
- **relative:** This is whether sizes and positioning are relative. If this is true, then all offestX, offestY, width and height floats must be between 0 and 1, representing sizes relative to the item.
...
combobox = DGS:dgsCreateComboBox(300,200,300,400,"Select an item",false)
DGS:dgsSetProperty(combobox,"itemHeight",30) -- make it thicker to see the image clearer
for i=1,10 do
	local item = DGS:dgsComboBoxAddItem(combobox)
	DGS:dgsComboBoxSetItemImage(combobox,item,texture,tocolor(255,255,255,255),10,5,25,20,false)
end
```
