---
doc_id: "mta-wiki:11192"
title: "DgsGridListGetNavigationEnabled"
source_title: "DgsGridListGetNavigationEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetNavigationEnabled"
revision_id: 62103
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:26.846454+00:00"
---

# DgsGridListGetNavigationEnabled

This function get the state of navigation of dgs grid list.

What is navigation/navigate?

There is a grid list you are focus on.
...
```
bool dgsGridListGetNavigationEnabled( element gridList )
```

### Required Arguments

- **gridList:** the dgs grid list you want to get navigation state from.

### Returns

Returns *true* if navigation enabled, *false* otherwise.
...
outputChatBox( tostring ( DGS:dgsGridListGetNavigationEnabled( gridlist ) )--Default is true (enabled)
```
