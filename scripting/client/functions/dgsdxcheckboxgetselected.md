---
doc_id: "mta-wiki:9959"
title: "DgsCheckBoxGetSelected"
source_title: "DgsDxCheckBoxGetSelected"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxCheckBoxGetSelected"
revision_id: 53638
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:16.427062+00:00"
---
...
```
bool dgsCheckBoxGetSelected ( element theCheckbox )
```
...
DGS = exports.dgs
stateTable = {}
stateTable[nil] = "indeterminate"
stateTable[true] = "selected"
stateTable[false] = "unselected"

indeterminateBox = DGS:dgsCreateCheckBox(20,30,150,20,"Indeterminate checkbox",nil,false)
uncheckedBox = DGS:dgsCreateCheckBox(20,30,150,20,"UnChecked checkbox",false,false)
state1 = DGS:dgsCheckBoxGetSelected(indeterminateBox)
state2 = DGS:dgsCheckBoxGetSelected(uncheckedBox)
outputChatBox("Indeterminate Box state:"..stateTable[state1])
outputChatBox("unchecked Box state:"..stateTable[state2])
```
