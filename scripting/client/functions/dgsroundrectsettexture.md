---
doc_id: "mta-wiki:11241"
title: "DgsRoundRectSetTexture"
source_title: "DgsRoundRectSetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectSetTexture"
revision_id: 77576
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:16.994047+00:00"
---

# DgsRoundRectSetTexture

This function sets the source texture of dgs rounded rectangle that will be cut into rounded rectangle.

## Syntax

```
bool dgsRoundRectSetTexture( element rndRect, texture sourceTexture )
```
...
- **sourceTexture:** A texture element of the source texture of the rounded rectangle which will be cut into rounded rectangle.
...
DGS:dgsRoundRectSetTexture(rndRect,texture)  --Set background texture
setTimer(function()
	DGS:dgsRoundRectSetTexture(rndRect)  --Also, you can remove it
end,5000,1)
```
