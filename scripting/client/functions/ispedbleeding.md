...
generated_at: "2026-07-26T16:15:57.874984+00:00"
---

# IsPedBleeding

This function gets the state of a [player's](mta://reference/misc/player.md) or [ped's](mta://reference/misc/ped.md) bleeding effect.
...
**Method**: *[ped](mta://reference/misc/ped.md):isBleeding(...)*
...
- **thePed:** The [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) whose bleeding effect state you want to get.

### Returns

Returns *true* if the [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) is bleeding, *false* otherwise.
