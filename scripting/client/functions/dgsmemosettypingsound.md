---
doc_id: "mta-wiki:11216"
title: "DgsMemoSetTypingSound"
source_title: "DgsMemoSetTypingSound"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoSetTypingSound"
revision_id: 62191
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:03.576476+00:00"
---

# DgsMemoSetTypingSound

This function applies a typing sound to a dgs memo.

## Syntax

```
bool dgsMemoSetTypingSound( element dxMemo, string soundPath )
```

### Required Arguments

- **dxMemo:** The dgs-dxmemo you want to set.

- **soundPath :** A string of the path of the sound ( url is supported ) or **nil for disabled**
