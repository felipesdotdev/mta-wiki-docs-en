---
doc_id: "mta-wiki:13587"
title: "Dgs3DInterfaceSetRoll"
source_title: "Dgs3DInterfaceSetRotation"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceSetRotation"
revision_id: 74017
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:35.758142+00:00"
---

# Dgs3DInterfaceSetRoll

This function sets the roll rotation of dgs 3d interface

## Syntax

```
bool dgs3DInterfaceSetRoll( element dgsElement, float rollRotation )
```

### Required Arguments

- **dgsElement:** The DGS 3D interface of which you wish to set the roll rotation.

- **rollRotation:** A float of the roll rotation of the dgs 3d interface
...
function panelPosition()
    ...
    if dgs3dPanel then -- if Panel exists
        setTimer(function()
            local rot = DGS:dgs3DInterfaceGetRoll( dgs3dPanel ) -- Get the rotation
            DGS:dgs3DInterfaceSetRoll( dgs3dPanel, rot + 18 ) -- Set the rotation + 18
        end,50,10)
    end
end
```
