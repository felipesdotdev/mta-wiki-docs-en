---
doc_id: "mta-wiki:10040"
title: "DgsMemoGetScrollPosition"
source_title: "DgsMemoGetScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoGetScrollPosition"
revision_id: 54006
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:59.120563+00:00"
---

# DgsMemoGetScrollPosition

This function get scroll position of dgs memo.

## Syntax

```
float,float dgsMemoGetScrollPosition( element memo  )
```

### Required Arguments

- **memo:** The dgs memo element to get from.
...
local memo = DGS:dgsCreateMemo ( 0.45, 0.45, 0.15, 0.15, text, true ) 
local vertical,horizontal = DGS:dgsMemoGetScrollPosition(memo)
