---
doc_id: "mta-wiki:12214"
title: "DgsSwitchButtonSetState"
source_title: "DgsSwitchButtonSetState"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSwitchButtonSetState"
revision_id: 65965
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:36.243519+00:00"
---

# DgsSwitchButtonSetState

This function sets the state of switch button.

## Syntax

```
bool dgsSwitchButtonSetState( element switchButton, bool state )
```
...
- **state:** A bool of the state you want to set ( *true* for *ON* and *false* for *OFF* ).
...
addCommandHandler("switch", function()
    DGS:dgsSwitchButtonSetState(button, true)
end)
```
