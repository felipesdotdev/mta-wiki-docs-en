---
doc_id: "mta-wiki:14506"
title: "SetVehicleRotorState"
source_title: "SetVehicleRotorState"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleRotorState"
revision_id: 82317
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:16:48.415328+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setRotorState(...)*

**Variable**: *.rotorState*

**Counterpart**: *[getVehicleRotorState](mta://scripting/client/functions/getvehiclerotorstate.md)*
...
- **stopRotor:** Specifies whether the rotor should be stopped after being turned off. If false, the rotor will continue spinning at a constant speed (it won't slow down or accelerate). It will also not be able to lift off the ground. You can also use [setVehicleRotorSpeed](mta://scripting/client/functions/setvehiclerotorspeed.md) to manage the rotor speed.
