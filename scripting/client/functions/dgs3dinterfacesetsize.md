---
doc_id: "mta-wiki:10905"
title: "Dgs3DInterfaceSetSize"
source_title: "Dgs3DInterfaceSetSize"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceSetSize"
revision_id: 63577
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:36.034697+00:00"
---

# Dgs3DInterfaceSetSize

This function sets the width and height of 3D interface in the world.

## Syntax

```
bool dgs3DInterfaceSetSize ( element dgsElement, float width, float height )
```
...
- **width:** The float of 3D width of the DGS 3D interface.

- **height:** The float of 3D height of the DGS 3D interface.
...
function panelPosition()
    ...
    if dgs3dPanel then -- if Panel exists 
        DGS:dgs3DInterfaceSetSize( dgs3dPanel, 4, 4 ) -- Sets the panel size
    end
end
```
