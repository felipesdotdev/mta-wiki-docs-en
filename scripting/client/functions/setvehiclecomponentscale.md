...
generated_at: "2026-07-26T16:16:46.176250+00:00"
---
...
This function sets the component scale of a [vehicle](mta://reference/misc/vehicle.md).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setComponentScale(...)*

**Counterpart**: *[getVehicleComponentScale](mta://scripting/client/functions/getvehiclecomponentscale.md)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) you wish to set component scale.
