---
doc_id: "mta-wiki:13598"
title: "DgsLineGetItemPosition"
source_title: "DgsLineGetItemPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsLineGetItemPosition"
revision_id: 75991
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:49.731712+00:00"
---

# DgsLineGetItemPosition

This function gets the position of an item of dgs line.

## Syntax

```
float/nil, float/nil, float, float, bool dgsLineGetItemPosition (element line, int index )
```
...
Returns 4 *float*s and a *bool* indicates start position x and y, end position x and y, and relative. Or 2 *nil*s, 2 *float*s and a *bool* if using end position of previous item as start position of current item, *false* otherwise.
...
local sx, sy, ex, ey, relative = DGS:dgsLineGetItemPosition(line,101)
outputChatBox("StartXY ("..(sx or "lastEndX")..", "..(sy or "lastEndY").."); EndXY ("..ex..", "..ey.."); Relative: "..(relative and "true" or "false"))
```
