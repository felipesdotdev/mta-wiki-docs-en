---
doc_id: "mta-wiki:11917"
title: "DgsGridListSetColumnHeight"
source_title: "DgsGridListSetColumnHeight"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetColumnHeight"
revision_id: 71601
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:33.640578+00:00"
---

# DgsGridListSetColumnHeight

This function is used to set the height of a dgs gridlist column.

## Syntax

```
bool dgsGridListSetColumnHeight( element dgsGridlist, int height )
```

### Required Arguments

- **dgsGridlist:** The dgs grid list you want to set the column height to

- **height:** The column height you want to set.
...
DGS:dgsGridListSetColumnHeight(list,50) --Set column height to 50
```
