---
doc_id: "mta-wiki:13420"
title: "DgsSetClickingSoundVolume"
source_title: "DgsSetClickingSoundVolume"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetClickingSoundVolume"
revision_id: 73182
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:30.204621+00:00"
---

# DgsSetClickingSoundVolume

This function changes the volume of the clicking sound to a dgs element.

## Syntax

```
bool dgsSetClickingSoundVolume( element dgsElement, float volume )
```

### Required Arguments

- **dgsElement:** The dgs element you want to set.

- **volume:** A float representing the desired clicking sound volume level. Range is from 0.0 to 1.0. This can go above 1.0 for amplification.
...
btn = DGS:dgsCreateButton(0.29, 0.30, 0.44, 0.04, "Click me", true)
DGS:dgsSetClickingSound(btn,"test.wav") --You can add a sound file for test
DGS:dgsSetClickingSoundVolume(btn,0.5) --Lower
```
