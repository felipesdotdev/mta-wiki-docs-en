---
doc_id: "mta-wiki:10046"
title: "DgsComboBoxGetScrollPosition"
source_title: "DgsComboBoxGetScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetScrollPosition"
revision_id: 55398
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:04.424281+00:00"
---

# DgsComboBoxGetScrollPosition

This function get scroll position of dgs combo box.

## Syntax

```
float dgsComboBoxGetScrollPosition( element comboBox )
```

### Required Arguments

- **comboBox:** The dgs combo box element to get from.

### Returns

Returns a float value indicate vertical scroll position, false otherwise
...
local vertical = DGS:dgsComboBoxGetScrollPosition(comboBox)
outputChatBox("vertical:"..vertical)
```
