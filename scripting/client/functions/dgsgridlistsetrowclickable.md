---
doc_id: "mta-wiki:12351"
title: "DgsGridListSetRowHoverable"
source_title: "DgsGridListSetRowClickable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetRowClickable"
revision_id: 66651
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:39.077237+00:00"
---

# DgsGridListSetRowHoverable

This function sets whether the row is hoverable, which has higer priority than [dgsGridListSetItemHoverable](mta://scripting/client/functions/dgsgridlistsetitemhoverable.md).

## Syntax

```
string dgsGridListSetRowHoverable( element gridlist, int row, boolean state )
```
