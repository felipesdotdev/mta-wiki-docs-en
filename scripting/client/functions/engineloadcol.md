...
generated_at: "2026-07-26T16:14:56.683653+00:00"
---
...
For vehicles, please omit this function by embedding your [COL](mta://reference/misc/col.md) file into your [DFF](mta://reference/misc/dff.md) file. This way, you can be sure that the COL file is correctly (and automatically) loaded when calling [engineLoadDFF](mta://scripting/client/functions/engineloaddff.md).
...
**Method**: *[EngineCOL](mta://reference/misc/col.md)(...)*

### Required Arguments

- **col_file / raw_data:** The [filepath](mta://reference/misc/filepath.md) to the [COL](mta://reference/misc/col.md) file you want to load or whole data buffer of the COL file.

### Returns

Returns a [COL](mta://reference/misc/col.md) if the file was loaded, *false* otherwise.
