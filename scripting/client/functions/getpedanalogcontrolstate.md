...
generated_at: "2026-07-26T16:15:16.741108+00:00"
---

# GetPedAnalogControlState

This function retrieves the analog control state of a [ped](mta://reference/misc/ped.md), as set by [setPedAnalogControlState](mta://scripting/client/functions/setpedanalogcontrolstate.md).
...
- **rawValue:** A [bool](mta://reference/misc/bool.md) indicating if it should return the raw player input value (will always return script value for non-player peds).
