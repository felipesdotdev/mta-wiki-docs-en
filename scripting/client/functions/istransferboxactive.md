---
doc_id: "mta-wiki:3658"
title: "IsTransferBoxActive"
source_title: "IsTransferBoxActive"
source_url: "https://wiki.multitheftauto.com/wiki/IsTransferBoxActive"
revision_id: 67448
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:16:01.009628+00:00"
---
...
It's important to note that resources aren't started on the client until they're completely downloaded, so a resource cannot use this function to detect if it's own files are downloaded. A client-side resource triggers the [onClientResourceStart](mta://scripting/client/events/onclientresourcestart.md) event when the files it requires are downloaded.
...
**Method**: *[GuiElement](mta://scripting/concepts/gui-widgets.md).isTransferBoxActive(...)*
