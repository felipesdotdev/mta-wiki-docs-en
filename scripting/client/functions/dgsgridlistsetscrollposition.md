---
doc_id: "mta-wiki:10037"
title: "DgsGridListSetScrollPosition"
source_title: "DgsGridListSetScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetScrollPosition"
revision_id: 62546
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:40.018682+00:00"
---

# DgsGridListSetScrollPosition

This function set scroll position of dgs grid list.

## Syntax

```
bool dgsGridListSetScrollPosition( element gridList[, float vertical = nil, float horizontal = nil ] )
```

### Required Arguments

- **gridList:** The dgs grid list element to set.

### Optional Arguments

- **vertical:** The vertical scroll bar position ( 0 ~ 100 ). If set to nil, nothing will happen ( remain the position ).

- **horizontal:** The horizontal scroll bar position ( 0 ~ 100 ). If set to nil, nothing will happen ( remain the position ).
...
DGS:dgsGridListAddColumn(testList,"test",0.5)
for i=1,100 do
    local row = DGS:dgsGridListAddRow(testList)
    DGS;dgsGridListSetItemText(testList,i,1,i)
end
DGS:dgsGridListSetScrollPosition(testList,50)
```
