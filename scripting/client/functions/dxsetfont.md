---
doc_id: "mta-wiki:13677"
title: "DxSetFont"
source_title: "DxSetFont"
source_url: "https://wiki.multitheftauto.com/wiki/DxSetFont"
revision_id: 74667
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:51.236323+00:00"
---

# DxSetFont

Esta funcion sirve para cambiar la fuente de un elemento de la [Modern-Library](mta://reference/misc/modern-library.md) .
...
```
bool dxSetFont(string fontName, float size)
```

### Argumentos requeridos

- **fontName**: El nombre de la fuente sin su extension, *Ejemplo* en ves de ***Basic-Regular.ttf*** colocar ***Basic-Regular***
...
**NOTA**: *El tamaño de la fuente en caso de ser una fuente local recuerda ver bien los tamaños y colocar uno existente, en caso de ser una fuente personaliza*
recuerda colocar el tamaño que especificaste en*[dxFont](https://wiki.multitheftauto.com/wiki/DxFont)*
...
dxSetFont(win, 'Comforta_regular', 12) -- le damos la fuente Comforta_regular a la ventana
