---
doc_id: "mta-wiki:12320"
title: "DgsMaskSetTexture"
source_title: "DgsMaskSetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMaskSetTexture"
revision_id: 66443
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:52.661338+00:00"
---

# DgsMaskSetTexture

This function sets the texture that is used as source texture of dgs mask.

## Syntax

```
bool dgsMaskSetTexture( element mask, element texture )
```

### Required Arguments

- **mask**: The dgs mask you want to check.

- **texture:** The texture you want to set as source texture of dgs mask.
...
local maskTex2 = dxCreateTexture("tex3.png")  -- Your Mask ( You'd better use black&white texture )
local mask = DGS:dgsCreateMask(sourceTex,maskTex)
local image = DGS:dgsCreateImage(300,300,200,200,mask,false)
DGS:dgsMaskSetTexture(mask,maskTex2) --Change the source texture
```
