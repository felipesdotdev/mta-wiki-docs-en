---
doc_id: "mta-wiki:9532"
title: "DgsGetSize"
source_title: "DgsGetSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetSize"
revision_id: 70981
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:17.285250+00:00"
---
...
- toVector: **size.toVector** [returns a [Vector](mta://reference/misc/vector-vector2.md), use `size.toVector.x` (for width) and `size.toVector.y` (for height)]**

**Method**:  *DGSElement:getSize(...)*

**Variable**: *.size*

**Counterpart**: *[dgsSetSize](mta://scripting/client/functions/dgssetsize.md)*
