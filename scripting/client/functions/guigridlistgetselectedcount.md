---
doc_id: "mta-wiki:4439"
title: "GuiGridListGetSelectedCount"
source_title: "GuiGridListGetSelectedCount"
source_url: "https://wiki.multitheftauto.com/wiki/GuiGridListGetSelectedCount"
revision_id: 60521
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:37.064542+00:00"
---

# GuiGridListGetSelectedCount

This function returns the amount of options selected in the specified [grid list](mta://scripting/concepts/element-gui-gridlist.md).
...
**Method**: *[GuiGridList](mta://scripting/concepts/element-gui-gridlist.md):getSelectedCount(...)*

**Variable**: *.selectedCount*

### Required Arguments

- **gridList:** The [grid list](mta://scripting/concepts/element-gui-gridlist.md) which amount of selected items you want to retrieve.

### Returns

Returns an [integer](mta://reference/misc/int.md) representing the amount of selected options if everything was successful or *false* if invalid arguments were passed.
