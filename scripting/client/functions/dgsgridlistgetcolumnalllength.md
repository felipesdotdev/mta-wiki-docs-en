---
doc_id: "mta-wiki:10226"
title: "DgsGridListGetColumnAllWidth"
source_title: "DgsGridListGetColumnAllLength"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetColumnAllLength"
revision_id: 68262
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:21.548932+00:00"
---

# DgsGridListGetColumnAllWidth

This function is used to get the total width from 1 to specific column index of dgs gridlist.

## Syntax

```
float dgsGridListGetColumnAllWidth( element dgsGridlist, int columnIndex [, bool relative = false, bool fastFind = false ] )
```

### Required Arguments

- **dgsGridlist**: The dgs grid list you want to get the column width from

- **columnIndex**: End Column ID

### Optional Arguments

- **relative:** This is whether sizes and positioning are relative. If this is true, then all x,y,width,height floats must be between 0 and 1, representing sizes relative to the parent.

- **fastFind:** Whether to enable fast find ( best performance but may be incorrect due to bugs ) or exactly find ( won't be any bug but low performance ).

### Returns

Returns a float if succeed, *false* otherwise.

## Example

```
DGS = exports.dgs
list = DGS:dgsCreateGridList(0.80, 0.10, 0.15, 0.60, true) -- Create the grid list
c1= DGS:dgsGridListAddColumn(list, "New column", 0.9) -- Create a new column in the grid list
c2= DGS:dgsGridListAddColumn(list, "New column", 0.9) -- Create a new column in the grid list
c3= DGS:dgsGridListAddColumn(list, "New column", 0.9) -- Create a new column in the grid list
c4= DGS:dgsGridListAddColumn(list, "New column", 0.9) -- Create a new column in the grid list
width = DGS:dgsGridListGetColumnAllWidth(list, c4, true)
outputChatBox(width) --returns 3.6
```
