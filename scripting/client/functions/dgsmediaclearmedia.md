---
doc_id: "mta-wiki:10726"
title: "DgsMediaClearMedia"
source_title: "DgsMediaClearMedia"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMediaClearMedia"
revision_id: 58400
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:52.928003+00:00"
---

# DgsMediaClearMedia

This function clears the media in the ([dgsCreateMediaBrowser](mta://scripting/client/functions/dgscreatemediabrowser.md)) element.

## Syntax

```
bool dgsMediaClearMedia ( element media )
```

### Required Arguments

- **media:** The media element that you want cleared.
...
if dgsMediaClearMedia(browser) then
    outputChatBox("Media element cleared.")
else
