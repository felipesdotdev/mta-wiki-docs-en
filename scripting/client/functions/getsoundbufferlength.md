...
generated_at: "2026-07-26T16:15:25.248051+00:00"
---

# GetSoundBufferLength

This function gets the buffer playback length of the specified [sound](mta://reference/misc/sound.md). Works only with streams.
...
**Method**: *[sound](mta://reference/misc/sound.md):getBufferLength(...)*

**Variable**: *.bufferLength*

### Required Arguments

- **theSound:** the [sound](mta://reference/misc/sound.md) element which buffer length you want to get.

### Returns

- A [float](mta://reference/misc/float.md) value indicating the buffer playback length of the [sound](mta://reference/misc/sound.md) in seconds.
