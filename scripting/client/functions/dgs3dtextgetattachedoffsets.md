---
doc_id: "mta-wiki:11209"
title: "Dgs3DTextGetAttachedOffsets"
source_title: "Dgs3DTextGetAttachedOffsets"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DTextGetAttachedOffsets"
revision_id: 62141
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:41.615786+00:00"
---

# Dgs3DTextGetAttachedOffsets

This function gets the attached offsets of the attached DGS 3D Text

## Syntax

```
float, float, float dgs3DTextGetAttachedOffsets( element text3D )
```

### Required Arguments

- **text3D:** The DGS 3D Text element.

### Returns

Returns 3 *floats* indicates the offsets(X,Y,Z) of the DGS 3D Text if the DGS 3D Text is attached, *false* otherwise.
...
DGS:dgs3DTextAttachToElement(text,localPlayer,0,5,0)
local offsetX,offsetY,offsetZ = DGS:dgs3DTextGetAttachedOffsets(text)
DGS:dgs3DTextSetAttachedOffsets(text,offsetX+1,offsetY-2,offsetZ+2)
```
