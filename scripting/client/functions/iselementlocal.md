---
doc_id: "mta-wiki:2753"
title: "IsElementLocal"
source_title: "IsElementLocal"
source_url: "https://wiki.multitheftauto.com/wiki/IsElementLocal"
revision_id: 72965
language: "en"
categories: ["Client_functions", "Changes_in_1.4.0"]
generated_at: "2026-07-26T16:15:55.013805+00:00"
---

# IsElementLocal

This function checks whether a clientside [element](mta://reference/misc/element.md) is local to the client (doesn't exist in the server) or not.
...
**Method**: *[element](mta://reference/misc/element.md):isLocal(...)*

**Variable**: *.localElement*

### Required Arguments

- **theElement**: The [element](mta://reference/misc/element.md) that we want to check.
