---
doc_id: "mta-wiki:13595"
title: "DgsScrollBarGetArrowSize"
source_title: "DgsScrollBarGetArrowSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollBarGetArrowSize"
revision_id: 74045
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:19.971728+00:00"
---

# DgsScrollBarGetArrowSize

This function gets the size of arrow.

## Syntax

```
float dgsScrollBarGetArrowSize( element scrollBar [, bool relative ] )
```
...
- **scrollBar:** The dgs scrollbar you want to get arrow size from.
...
Returns a float indicates the arrow size if successful, *false* otherwise.
...
local width = DGS:dgsScrollBarGetArrowWidth(scrollbar,true)
outputChatBox(width)
```
