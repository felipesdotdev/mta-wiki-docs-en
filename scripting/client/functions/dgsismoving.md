---
doc_id: "mta-wiki:9716"
title: "DgsIsMoving"
source_title: "DgsIsMoving"
source_url: "https://wiki.multitheftauto.com/wiki/DgsIsMoving"
revision_id: 53823
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:46.184396+00:00"
---

# DgsIsMoving

This function allow us to check whether the position of dgs element is being changed by [dgsMoveTo](mta://scripting/client/functions/dgsmoveto.md).

## Syntax

```
table dgsIsMoving ( element dgsElement )
```
...
setTimer(function()
	if DGS:dgsIsMoving(parent) then
