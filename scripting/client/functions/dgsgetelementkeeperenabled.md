---
doc_id: "mta-wiki:13142"
title: "DgsGetElementKeeperEnabled"
source_title: "DgsGetElementKeeperEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetElementKeeperEnabled"
revision_id: 71040
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:13.371830+00:00"
---

# DgsGetElementKeeperEnabled

**This function only works with [dgsImportFunction](mta://scripting/client/functions/dgsimportfunction.md) and [dgsImportOOPClass](mta://scripting/client/functions/dgsimportoopclass.md)**

This function gets whether current resource enables DGS element keeper.
...
```
bool dgsGetElementKeeperEnabled( )
```

**DGS OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**:  ***dgsRootInstance**:getElementKeeperEnabled(...)*

**Counterpart**: *[dgsSetElementKeeperEnabled](mta://scripting/client/functions/dgssetelementkeeperenabled.md)*

### Returns

Returns *true* if element keeper is enabled, *false* otherwise
...
print(dgsGetElementKeeperEnabled()) --Returns true
```
