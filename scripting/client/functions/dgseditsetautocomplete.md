---
doc_id: "mta-wiki:12248"
title: "DgsEditSetAutoComplete"
source_title: "DgsEditSetAutoComplete"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditSetAutoComplete"
revision_id: 66120
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:05.039882+00:00"
---

# DgsEditSetAutoComplete

This function sets auto complete table to the dgs edit.

## Syntax

```
bool dgsEditSetAutoComplete( element edit, table autoCompleteTable )
```

### Required Arguments

- **edit:** A dgs edit you wish to set the auto complete table to.

- **autoCompleteTable:** A table of the auto complete list, the structure is as follows:

```
autoCompleteTable = {
 [string1] = isCapitalSensitive,
 [string2] = isCapitalSensitive,
 ……
}
```
...
local autoCompleteTable = {
 ["DGS Edit AutoComplete"] = false,  --Auto Complete String: "DGS Edit AutoComplete" with Capital sensitive disabled.
}
DGS:dgsEditSetAutoComplete(edit,autoCompleteTable)
```
