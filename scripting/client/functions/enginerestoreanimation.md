...
generated_at: "2026-07-26T16:14:57.736128+00:00"
---

# EngineRestoreAnimation

This function restores internal (default) animations that were replaced using [engineReplaceAnimation](mta://scripting/client/functions/enginereplaceanimation.md) function. This function only affects a specific [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) just like [engineReplaceAnimation](mta://scripting/client/functions/enginereplaceanimation.md).

If only 1st parameter ([ped](mta://reference/misc/ped.md)) is provided to this function, all replaced animations are restored. 
...
- **thePed:** the [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) you want to restore an animation(s) for.
