---
doc_id: "mta-wiki:10207"
title: "DgsGetRootElement"
source_title: "DgsGetRootElement"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetRootElement"
revision_id: 55383
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:16.699001+00:00"
---

# DgsGetRootElement

This function gets the resource root element of dgs, just like guiRoot.

## Syntax

```
element dgsGetRootElement ( )
```
...
Returns a resource root element if succeed, false otherwise

## Example

```
DGS = exports.dgs
dgsRoot = DGS:dgsGetRootElement()
local button = DGS:dgsCreateButton(0.2,0.2,0.2,0.1,"test",true)

addEventHandler("onDgsMouseClick",dgsRoot,function(button,state)
	if button == "left" and state == "down" and source == button then
		outputChatBox("clicked")
	end
end)
```

dgsRoot will be predefined if using [dgsImportFunction](mta://scripting/client/functions/dgsimportfunction.md)

```
loadstring(exports.dgs:dgsImportFunction())
local button = dgsCreateButton(0.2,0.2,0.2,0.1,"test",true)
