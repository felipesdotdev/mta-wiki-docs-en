---
doc_id: "mta-wiki:14114"
title: "DgsComboBoxSetItemBackGroundColor"
source_title: "DgsComboBoxSetItemBackGroundColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxSetItemBackGroundColor"
revision_id: 78579
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:07.492335+00:00"
---

# DgsComboBoxSetItemBackGroundColor

This function sets the background color of a specific item of the combo box.

## Syntax

```
bool dgsComboBoxSetItemBackGroundColor( element comboBox, int itemIndex, int imageDefault, int imageHoving, int imageSelected )
```
...
- **colorDefault:** An integer of the color of the item (Default State).
...
for i=1,30 do
	...
	DGS:dgsComboBoxSetItemBackGroundColor(combobox,i,tocolor(255,255,255,255),tocolor(0,0,255,255),tocolor(255,0,0,255))
end
```
