...
generated_at: "2026-07-26T16:16:46.604966+00:00"
---

# SetVehicleDummyPosition

This function sets the position of the dummy for the given [vehicle](mta://reference/misc/vehicle.md).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setDummyPosition(...)*

**Counterpart**: *[getVehicleDummyPosition](mta://scripting/client/functions/getvehicledummyposition.md)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) you want to set the dummy position for.
