---
doc_id: "mta-wiki:10011"
title: "DgsGridListSetSelectionMode"
source_title: "DgsGridListSetSelectionMode"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetSelectionMode"
revision_id: 54060
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:40.821065+00:00"
---

# DgsGridListSetSelectionMode

This function sets the selection mode of a dgs gridlist.  For example, the MTA *server browser* selects a whole row, while the *Controls* dialog selects a single cell.

## Syntax

```
bool dgsGridListSetSelectionMode ( element gridlist, int mode )
```
