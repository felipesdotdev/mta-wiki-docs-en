---
doc_id: "mta-wiki:10056"
title: "DgsGridListGetSortEnabled"
source_title: "DgsGridListGetSortEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetSortEnabled"
revision_id: 54058
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:30.514790+00:00"
---

# DgsGridListGetSortEnabled

This function gets whether the sort which activated by clicking the column of grid list enabled.

## Syntax

```
bool dgsGridListGetSortEnabled( element gridlist )
```

### Required Arguments

- **gridlist:** The grid list from which you wish to get the state.

### Returns

Returns *true* if sort enabled, false otherwise.
...
local state = DGS:dgsGridListGetSortEnabled(gridlist)
outputChatBox(tostring(state)) -- Shows 'true' that is the default setting.
```
