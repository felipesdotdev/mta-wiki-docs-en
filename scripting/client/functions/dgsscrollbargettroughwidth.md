---
doc_id: "mta-wiki:13584"
title: "DgsScrollBarGetTroughWidth"
source_title: "DgsScrollBarGetTroughWidth"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollBarGetTroughWidth"
revision_id: 74001
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:21.839304+00:00"
---

# DgsScrollBarGetTroughWidth

This function gets the width of trough.

## Syntax

```
float dgsScrollBarGetTroughWidth( element scrollBar [, bool relative ] )
```
...
- **scrollBar:** The dgs scrollbar you want to get trough width from.
...
Returns a float indicates the trough width if successful, *false* otherwise.
...
local width = DGS:dgsScrollBarGetTroughWidth(scrollbar,true)
outputChatBox(width)
```
