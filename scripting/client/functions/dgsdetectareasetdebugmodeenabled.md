---
doc_id: "mta-wiki:12097"
title: "DgsDetectAreaSetDebugModeEnabled"
source_title: "DgsDetectAreaSetDebugModeEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDetectAreaSetDebugModeEnabled"
revision_id: 65459
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:26.428366+00:00"
---

# DgsDetectAreaSetDebugModeEnabled

This function set the debug mode of the detect area.

For using non-texture based detecting function, it will generate the debug view itself.

## Syntax

```
bool dgsDetectAreaSetDebugModeEnabled( element da, bool state )
```
...
- **state :** A bool indicates whether to enable the debug mode.
...
This example will create detect area and set to debug mode to display a ellipse on the player's screen.
