---
doc_id: "mta-wiki:10227"
title: "DgsGridListGetColumnWidth"
source_title: "DgsGridListGetColumnLength"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetColumnLength"
revision_id: 55501
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:22.876173+00:00"
---

# DgsGridListGetColumnWidth

This function is used to get the width of a dgs gridlist column.

## Syntax

```
float dgsGridListGetColumnWidth( element dgsGridlist, int columnIndex [, bool relative = false ] )
```
...
length = DGS:dgsGridListGetColumnWidth(list, column, true)
outputChatBox(length) --returns 0.9
```
