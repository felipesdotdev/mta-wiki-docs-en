---
doc_id: "mta-wiki:12439"
title: "DgsSelectorGetSelectedItem"
source_title: "DgsSelectorGetSelectedItem"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorGetSelectedItem"
revision_id: 67051
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:27.329631+00:00"
---

# DgsSelectorGetSelectedItem

This function returns the index of the selected dgs selector item.

## Syntax

```
int dgsSelectorGetSelectedItem( element selector )
```

### Required Arguments

- **selector:** the dgs selector you want to know the selected item index of

### Returns

Returns the index of the selected item if the specified dgs selector is valid and has a selected item, *-1* if no item is selected, *false* or *nil* otherwise.

## Example

This example outputs selected item text.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
    ...
    for i = 1, 10 do
        DGS:dgsSelectorAddItem(selector, i )
    end
   outputChatBox(DGS:dgsSelectorGetSelectedItem(selector))
