---
doc_id: "mta-wiki:9973"
title: "DgsComboBoxSetState"
source_title: "DgsDxComboBoxSetState"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxComboBoxSetState"
revision_id: 53680
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:20.537502+00:00"
---

# DgsComboBoxSetState

This function sets the state of combo box (true:Drop Down; false:Take Back).

## Syntax

```
bool dgsComboBoxSetState( element comboBox, bool state )
```

### Required Arguments

- **comboBox:** the combo box you want to set the state to.

- **state:** the state you want to set ( true : Drop Down; false : Take Back ).

### Returns

Returns *true* if the state of combo box has been changed successfully, *false* otherwise.
...
DGS:dgsComboBoxAddItem(combobox,"Test1") --Add items to combobox
DGS:dgsComboBoxAddItem(combobox,"Test2")
DGS:dgsComboBoxSetState(combobox,true)--Take down the list.
```
