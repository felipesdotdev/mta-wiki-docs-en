...
generated_at: "2026-07-26T16:16:03.358101+00:00"
---

# IsVehicleWheelOnGround

This function returns a [boolean](mta://reference/misc/boolean.md) whether the [vehicle](mta://reference/misc/vehicle.md)'s wheel is on ground (true) or in air (false).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):isWheelOnGround(...)*

### Required Arguments

- **theVehicle** The [vehicle](mta://reference/misc/vehicle.md), which you want to check.
