---
doc_id: "mta-wiki:13880"
title: "DgsCheckBoxGetButtonAlign"
source_title: "DgsCheckBoxGetButtonAlign"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCheckBoxGetButtonAlign"
revision_id: 76167
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:51.221396+00:00"
---

# DgsCheckBoxGetButtonAlign

This function gets the alignment of the button of a dgs check box.

## Syntax

```
string dgsCheckBoxGetButtonAlign ( dgsCheckBox )
```

### Required Arguments

- **checkBox:** The dgs check box.

### Returns

Returns a *string* indicates the alignment of the button of a dgs check box if successful, *false* otherwise. Valid type strings are:

- - "left": The dgs check box will be aligned to the left between bounding box to text.

- "right": The dgs check box will be aligned to the right between bounding box to text.

## Example

```
DGS = exports.dgs
local cb = DGS:dgsCreateCheckBox(500,500,200,30,"aaaa",false)
local alignment = DGS:dgsCheckBoxGetButtonAlign( cb )
