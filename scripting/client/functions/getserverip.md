---
doc_id: "mta-wiki:8075"
title: "GetServerIp"
source_title: "GetServerIp"
source_url: "https://wiki.multitheftauto.com/wiki/GetServerIp"
revision_id: 81681
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:24.683519+00:00"
---
...
| [[{{{image}}}\|link=\|]] | Note: On server-side there is the getServerIpFromMasterServer function, which might return the server IP under certain conditions. You should consider using a third-party service via fetchServerIp (not an MTA function) if the previous function is unreliable for you. |
| --- | --- |
|  |  |
