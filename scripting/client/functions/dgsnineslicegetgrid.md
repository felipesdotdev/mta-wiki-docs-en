---
doc_id: "mta-wiki:12049"
title: "DgsNineSliceGetGrid"
source_title: "DgsNineSliceGetGrid"
source_url: "https://wiki.multitheftauto.com/wiki/DgsNineSliceGetGrid"
revision_id: 68275
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:05.767385+00:00"
---

# DgsNineSliceGetGrid

This function gets the grid position of DGS nine slice plugin.

## Syntax

```
float, float, float, float dgsNineSliceGetGrid( element nineSlice [, relative = false ] )
```
...
- **relative:** A bool of whether the position of grid is ranging from 0 to 1 or just absolute pixels

### Returns

Returns 4 *float* indifates the **Left Grid**,**Right Grid**,**Top Grid** and **Bottom Grid**.
...
gridXLeft,gridXRight,gridYTop,gridYBottom = DGS:dgsNineSliceGetGrid( nSlice, true )
outputChatBox("Left Grid:"..gridXLeft..";"Right Grid:"..gridXRight..";"Top Grid:"..gridYTop..";"Bottom Grid:"..gridYBottom)
```
