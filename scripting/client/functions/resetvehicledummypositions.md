...
generated_at: "2026-07-26T16:16:33.997306+00:00"
---

# ResetVehicleDummyPositions

This function resets the [vehicle](mta://reference/misc/vehicle.md) dependent dummy positions to the vehicle's current model dummy positions.
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):resetDummyPositions(...)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) to reset the dummy positions.
