---
doc_id: "mta-wiki:13638"
title: "DgsRetrieveDragNDropData"
source_title: "DgsRetrieveDragNDropData"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRetrieveDragNDropData"
revision_id: 74356
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:14.180231+00:00"
---

# DgsRetrieveDragNDropData

This function retrieves the Drag&Drop data that is holding on cursor.

## Syntax

```
mixed dgsRetrieveDragNDropData ( [ bool retainData = false ] )
```
...
- **retainData**: A bool indicates whether the data will be retain holding or just cleared.

### Returns

Returns the data may be in any type if successful, *false* otherwise
...
local sender = dgsCreateButton(200,200,200,200,"Sender",false)
local receiver = dgsCreateButton(500,500,200,200,"Receiver",false)

addEventHandler("onDgsDrag",sender,function(data)
	local theTimer = setTimer(function()
		local data = dgsRetrieveDragNDropData()
		outputChatBox("Data Sending Timedout: "..inspect(data))
	end,2000,1)
	dgsSendDragNDropData({"From SenderA",getTickCount(),theTimer})
end,false)
