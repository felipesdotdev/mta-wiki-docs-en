---
doc_id: "mta-wiki:9715"
title: "DgsAlphaTo"
source_title: "DgsAlphaTo"
source_url: "https://wiki.multitheftauto.com/wiki/DgsAlphaTo"
revision_id: 76244
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:35.472003+00:00"
---
...
Change alpha of dgs elements with animation effect.

## Syntax

```
number/table dgsAlphaTo ( element/table dgsElement, float targetAlpha, string easing = "Linear", float duration [, int delay = 0 ] )
```
...
- **targetAlpha:** Target alpha of dgs element.

- **easing:** The easing function to use for the interpolation (For More Detail :[Easing](mta://reference/misc/easing.md)), or your own easing function created by [dgsAddEasingFunction](mta://scripting/client/functions/dgsaddeasingfunction.md).
...
DGS:dgsAlphaTo(parent,1,"OutQuad",2000)  --set alpha with animation effect.
```
