---
doc_id: "mta-wiki:12230"
title: "DgsProgressBarGetStyle"
source_title: "DgsProgressBarGetStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsProgressBarGetStyle"
revision_id: 66087
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:08.026025+00:00"
---

# DgsProgressBarGetStyle

This function get style name from a progress bar.

## Syntax

```
string dgsProgressBarGetStyle ( element progressbar )
```
...
Returns a string indicates the style name of the progress bar if successfully, *false* otherwise.
...
outputChatBox(DGS:dgsProgressBarGetStyle(pbRound))
```
