---
doc_id: "mta-wiki:14091"
title: "DgsComboBoxGetItemImage"
source_title: "DgsComboBoxGetItemImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetItemImage"
revision_id: 77256
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:03.587089+00:00"
---

# DgsComboBoxGetItemImage

This function gets the image from a combo box item.

## Syntax

```
texture, int, float, float, float, float dgsComboBoxGetItemImage( element comboBox, int itemIndex )
```
...
Returns texture, Color, PosX, PosY, Width, Height if success , *false* otherwise.
...
Image, Color, PosX, PosY, Width, Height = DGS:dgsComboBoxGetItemImage(combobox,2,1)
