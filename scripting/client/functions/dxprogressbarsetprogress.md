---
doc_id: "mta-wiki:14433"
title: "DxProgressBarSetProgress"
source_title: "DxProgressBarSetProgress"
source_url: "https://wiki.multitheftauto.com/wiki/DxProgressBarSetProgress"
revision_id: 80645
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:50.727760+00:00"
---

# DxProgressBarSetProgress

Esta funcion modifica la posición de la barra de progreso actual del elemento [dxProgressBar](mta://scripting/client/functions/dxprogressbar.md).
...
```
bool dxProgressBarSetProgress(element element, int progress)
```
...
- **progress**: Un valor numerico al cual se lo va a posicionar (**0**-**100**).
...
-- Creamos la barra
progress_test = dxProgressBar( 312, 596, 270, 38, win )

-- Asignamos la función actual para aplicar su posicionamiento. (minimo 0, max 100)
dxProgressBarSetProgress(progress_test, 50)
```
