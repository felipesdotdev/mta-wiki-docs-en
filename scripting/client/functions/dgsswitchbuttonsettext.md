---
doc_id: "mta-wiki:12215"
title: "DgsSwitchButtonSetText"
source_title: "DgsSwitchButtonSetText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSwitchButtonSetText"
revision_id: 65963
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:36.511485+00:00"
---

# DgsSwitchButtonSetText

This function sets the text of switch button.
...
- **switchButton:** Switch Button you wish to change the text of.

- **textOn:** A string of the text of state *on*.

- **textOff:** A string of the text of state *off*.
...
addCommandHandler("switch", function()
    DGS:dgsSwitchButtonSetText(button, "Running", "Stopped")
end)
```
