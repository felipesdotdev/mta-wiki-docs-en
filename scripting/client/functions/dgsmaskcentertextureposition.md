---
doc_id: "mta-wiki:12050"
title: "DgsMaskCenterTexturePosition"
source_title: "DgsMaskCenterTexturePosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMaskCenterTexturePosition"
revision_id: 65316
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:51.976698+00:00"
---

# DgsMaskCenterTexturePosition

This function center the source texture of DGS mask.

## Syntax

```
bool dgsMaskCenterTexturePosition( element mask, int w, int h )
```

### Required Arguments

- **mask:** The DGS mask you want to operate.

- **w:** A number of the width of the texture.( See [dxGetMaterialSize](mta://scripting/client/functions/dxgetmaterialsize.md) )

- **h:** A number of the width of the texture.( See [dxGetMaterialSize](mta://scripting/client/functions/dxgetmaterialsize.md) )
...
local sourceTex = dxCreateTexture( "yourTexture.png" )  -- Your Texture
local mask = DGS:dgsCreateMask( sourceTex, "circle" ) --Use built-in mask (circle)
local tw,th = dxGetMaterialSize( sourceTex )
DGS:dgsMaskCenterTexturePosition( mask, tw,th ) --Move the texture to the center
DGS:dgsMaskAdaptTextureSize( mask, tw,th ) --Auto adapt the size
