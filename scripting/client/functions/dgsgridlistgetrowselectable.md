---
doc_id: "mta-wiki:12345"
title: "DgsGridListGetRowSelectable"
source_title: "DgsGridListGetRowSelectable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetRowSelectable"
revision_id: 66635
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:28.566319+00:00"
---

# DgsGridListGetRowSelectable

This function gets whether the row is selectable.

## Syntax

```
bool dgsGridListGetRowSelectable( element gridlist, int row )
```
...
for id, player in ipairs(getElementsByType("player")) do
	...
	iprint(DGS:dgsGridListGetRowSelectable(playerList, row))
end
```
