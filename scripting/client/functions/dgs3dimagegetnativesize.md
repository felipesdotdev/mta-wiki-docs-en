---
doc_id: "mta-wiki:13163"
title: "Dgs3DImageGetNativeSize"
source_title: "Dgs3DImageGetNativeSize"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageGetNativeSize"
revision_id: 70835
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:26.246972+00:00"
---

# Dgs3DImageGetNativeSize

This function gets the size of the texture that is loaded in DGS 3d image.

## Syntax

```
int, int dgs3DImageGetNativeSize( element dgs3DImage)
```

### Required Arguments

- **dgs3DImage**: The dgs 3d image of which you want to get the native size.

### Returns

Returns the two *integer* indicates the width and height of the size of the texture that is loaded in DGS 3d image, *false* otherwise.
...
local width,height = DGS:dgs3DImageGetNativeSize(image,false)
outputChatBox(width.."x"..height)
```
