---
doc_id: "mta-wiki:12364"
title: "DgsGridListGetItemHoverable"
source_title: "DgsGridListGetItemHoverable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetItemHoverable"
revision_id: 66691
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:25.334335+00:00"
---

# DgsGridListGetItemHoverable

This function returns whether the item is hoverable.

## Syntax

```
string dgsGridListGetItemHoverable( element gridlist, int row, int column )
```

### Required Arguments

- **gridlist:** The dgs grid list you want to get.
...
Returns true if the column is hoverable, *false* otherwise.
...
for id, player in ipairs(getElementsByType("player")) do
    ...
    DGS:dgsGridListSetRowHoverable( playerList, row, false )
    iprint(DGS:dgsGridListGetItemHoverable(playerList, row, column))
end
```
