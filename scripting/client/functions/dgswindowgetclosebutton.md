---
doc_id: "mta-wiki:10547"
title: "DgsWindowGetCloseButton"
source_title: "DgsWindowGetCloseButton"
source_url: "https://wiki.multitheftauto.com/wiki/DgsWindowGetCloseButton"
revision_id: 57372
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:38.981536+00:00"
---

# DgsWindowGetCloseButton

This function allows you get the close button of window

## Syntax

```
element dgsWindowGetCloseButton( element dgsWindow)
```

### Required Arguments

- **dgsWindow:** The window you want to get the close button from.
...
button = DGS:dgsWindowGetCloseButton ( window )
dgsSetText(button,":P")
```
