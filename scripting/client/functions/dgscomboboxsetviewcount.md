---
doc_id: "mta-wiki:12489"
title: "DgsComboBoxSetViewCount"
source_title: "DgsComboBoxSetViewCount"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxSetViewCount"
revision_id: 68286
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:10.512234+00:00"
---

# DgsComboBoxSetViewCount

This function sets how many items will be viewed on the drop-down box of combo box.

**Note**: After using this function you won't be able to change the drop-down box height. if you want to pass false in the second argument

## Syntax

```
bool dgsComboBoxSetViewCount( element comboBox [, int viewCount ] )
```

### Required Arguments

- **comboBox:** the combo box you want to set to.

- **viewCount:** how many items will be viewed.

### Returns

Returns *true* if view count of drop-down menu box of combo box has been changed successfully, *false* otherwise.

## Example

```
DGS = exports.dgs
local combo = DGS:dgsCreateComboBox (200,30,200,30,"Text")
for i=1,35 do
	DGS:dgsComboBoxAddItem(combo,"# - "..tostring(i))
end
DGS:dgsComboBoxSetViewCount(combo,5) -- we can see 5 items on the drop-box now
```
