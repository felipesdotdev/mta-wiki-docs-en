---
doc_id: "mta-wiki:9921"
title: "DgsEditSetReadOnly"
source_title: "DgsDxEditSetReadOnly"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxEditSetReadOnly"
revision_id: 53521
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:06.949186+00:00"
---

# DgsEditSetReadOnly

This function allows you to set or remove read-only status for a dgs edit box. If read-only is set to *true*, the box is not editable.

## Syntax

```
bool dgsEditSetReadOnly ( element edit, bool status )
```

### Required Arguments

- **edit:** The dgs-dxedit that you want to apply.
