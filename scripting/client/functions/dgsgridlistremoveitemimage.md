---
doc_id: "mta-wiki:10050"
title: "DgsGridListRemoveItemImage"
source_title: "DgsGridListRemoveItemImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListRemoveItemImage"
revision_id: 77253
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:31.513341+00:00"
---

# DgsGridListRemoveItemImage

This function remove the image from the grid list item.

## Syntax

```
bool dgsGridListRemoveItemImage( element gridList, int rowIndex, int columnIndex )
```
...
setTimer(function()
	DGS:dgsGridListRemoveItemImage(gridlist,1,1) --Remove after 1 sec
end,1000,1)
```
