---
doc_id: "mta-wiki:11160"
title: "DgsEditInsertText"
source_title: "DgsEditInsertText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditInsertText"
revision_id: 61906
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:03.627730+00:00"
---
...
```
bool dgsEditInsertText ( element theElement, int index, string text )
```
...
- **index:** An integer indicated where the text will be inserted into the edit ( start from 0 ).

- **text:** A string that you want to insert into the edit.

### Returns

Returns *true* if the text is inserted into the edit successfully, *false* otherwise.
...
DGS:dgsEditInsertText(edit,1,"Here is DGS")
```
