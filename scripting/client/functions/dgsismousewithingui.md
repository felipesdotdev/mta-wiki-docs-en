---
doc_id: "mta-wiki:12667"
title: "DgsIsMouseWithinGUI"
source_title: "DgsIsMouseWithinGUI"
source_url: "https://wiki.multitheftauto.com/wiki/DgsIsMouseWithinGUI"
revision_id: 75738
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:45.677449+00:00"
---

# DgsIsMouseWithinGUI

This function returns whether the mouse is in a specific dgs element.

## Syntax

```
bool/table dgsIsMouseWithinGUI( element/table withinElement )
```

### Required Arguments

- **withinElement:** A dgs element or a table of dgs elements that you want to check whether the mouse is within the dgs element(s).

### Returns

Returns *true* if mouse is within the specific dgs element, *false* otherwise. Or a table of dgs elements that the mouse is within if passing a table of dgs elements into  **withinElement**.
...
addEventHandler("onClientRender",root,function()
	local str = "within the button :"
	local result = DGS:dgsIsMouseWithinGUI ( button )
	dxDrawText(str..(result and "true" or "false"),400,400)
end)
```
...
DGS = exports.dgs
-- create our button
button1 = DGS:dgsCreateButton( 0.6, 0.1, 0.2, 0.1, "Output!", true )
button2 = DGS:dgsCreateButton( 0.7, 0.1, 0.2, 0.1, "Output!", true )
buttonTable = {button1,button2}

addEventHandler("onClientRender",root,function()
	local str = "within the buttons :"
	local result = DGS:dgsIsMouseWithinGUI ( buttonTable  )
	for index, button in ipairs(buttonTable) do
		str = str.."\n"..tostring(result[button] and true or false)
	end
	dxDrawText(str,400,400)
end)
```
