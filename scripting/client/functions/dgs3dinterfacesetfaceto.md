---
doc_id: "mta-wiki:11777"
title: "Dgs3DInterfaceSetFaceTo"
source_title: "Dgs3DInterfaceSetFaceTo"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceSetFaceTo"
revision_id: 76195
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:34.278476+00:00"
---
...
>>>Note: If the DGS 3D interface is attached to an element, please use [dgs3DInterfaceSetAttachedOffsets](mta://scripting/client/functions/dgs3dinterfacesetattachedoffsets.md) instead<<<
...
- **x:** A float of the x position that the DGS 3D interface faces to (Depends on *relativeTo*). If **x**,**y**,**z** are nil, DGS 3D interface will always face to camera.

- **y:** A float of the y position that the DGS 3D interface faces to (Depends on *relativeTo*). If **x**,**y**,**z** are nil, DGS 3D interface will always face to camera.

- **z:** A float of the z position that the DGS 3D interface faces to (Depends on *relativeTo*). If **x**,**y**,**z** are nil, DGS 3D interface will always face to camera.
...
- **world:** Relative to the world, **faceTo = absoluteWorldPosition**.
