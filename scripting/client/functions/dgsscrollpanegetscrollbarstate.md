---
doc_id: "mta-wiki:11198"
title: "DgsScrollPaneGetScrollBarState"
source_title: "DgsScrollPaneGetScrollBarState"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollPaneGetScrollBarState"
revision_id: 62118
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:24.672825+00:00"
---

# DgsScrollPaneGetScrollBarState

This function get the force state of the scroll bar of the scroll pane

## Syntax

```
bool/nil, bool/nil dgsScrollPaneGetScrollBarState( element scrollPane )
```

### Required Arguments

- **scrollPane:** The dgs scroll pane to get from.

### Returns

Returns two bool/nil indicate the state of scroll bar of the scroll pane.
...
local vertical, horizontal = DGS:dgsScrollPaneGetScrollBarState(scrollPane)
outputChatBox("State:"..tostring(vertical)..","..tostring(horizontal))
```
