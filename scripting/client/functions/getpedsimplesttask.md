---
doc_id: "mta-wiki:3972"
title: "GetPedSimplestTask"
source_title: "GetPedSimplestTask"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedSimplestTask"
revision_id: 73073
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:18.033969+00:00"
---

# GetPedSimplestTask

This function is used to get the name of a specified ped's current simplest [task](mta://reference/misc/task.md).
...
- **thePed**: The [ped](mta://reference/misc/ped.md) whose [task](mta://reference/misc/task.md) you want to retrieve.

### Returns

Returns a string representing the name of the ped's simplest, active [task](mta://reference/misc/task.md).
