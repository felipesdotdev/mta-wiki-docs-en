---
doc_id: "mta-wiki:10153"
title: "DgsRoundUp"
source_title: "DgsRoundUp"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundUp"
revision_id: 54950
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:17.284889+00:00"
---

# DgsRoundUp

This function returns rounded number from the input value.
...
- **input:** The number you want to round up.

### Optional Arguments

- **point:** The decimal point where the rounding up start to calculate. This can be changed by [dgsSetRoundUpPoints](https://wiki.multitheftauto.com/index.php?title=DgsSetRoundUpPoints&action=edit&redlink=1).

### Returns

This function returns an integer or float value if succeed, *false* otherwise.
...
local num1 = DGS:dgsRoundUp(3.1)
outoutChatBox(num1)  -- returns 3
local num2 = DGS:dgsRoundUp(3.5)
outoutChatBox(num2)  -- returns 4
local num3 = DGS:dgsRoundUp(3.52,2)
outoutChatBox(num3)  -- returns 3.5
local num4 = DGS:dgsRoundUp(326.52,-1)
outoutChatBox(num4)  -- returns 330
```
