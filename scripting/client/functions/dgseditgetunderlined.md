---
doc_id: "mta-wiki:12244"
title: "DgsEditGetUnderlined"
source_title: "DgsEditGetUnderlined"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditGetUnderlined"
revision_id: 66105
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:03.021987+00:00"
---

# DgsEditGetUnderlined

This function get whether the underline of edit is enabled or not.

## Syntax

```
bool dgsEditGetUnderlined( element edit )
```

### Required Arguments

- **edit:** A dgs edit you wish to get under line state.
...
```
DGS = exports.dgs
edit = DGS:dgsCreateEdit(100,100,50,50, "DGS is shit")
DGS:dgsEditSetUnderlined(edit, true)
if DGS:dgsEditSetUnderlined(edit) then
   outputChatBox("Under line is set to true")
end
```
