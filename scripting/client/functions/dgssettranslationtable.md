---
doc_id: "mta-wiki:10784"
title: "DgsSetTranslationTable"
source_title: "DgsSetTranslationTable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetTranslationTable"
revision_id: 65793
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:33.724366+00:00"
---

# DgsSetTranslationTable

This function sets translation table.

## Syntax

```
bool dgsSetTranslationTable ( string name, table translationTable )
```
...
DGS:dgsSetTranslationTable("Locale",TranslationTable.EN) --Use "TranslationTable.EN" as global translation table
DGS:dgsSetAttachTranslation("Locale") --Set global translation table, make sure the DGS elements created after uses "Locale"
button = DGS:dgsCreateButton(200,200,200,100,{"login"},false) --Create a button that uses "login" with translation interface "Locale"

function changeLanguage(language) --Change the language
	DGS:dgsSetTranslationTable("Locale",TranslationTable[language]) --Change the languageof "Locale"
end

setTimer(function()
	changeLanguage("CN") --For example, I need to change the language to "CN"
end,1000,1)
```
