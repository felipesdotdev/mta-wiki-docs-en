---
doc_id: "mta-wiki:12099"
title: "DgsDetectAreaSetFunction"
source_title: "DgsDetectAreaSetFunction"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDetectAreaSetFunction"
revision_id: 65455
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:26.730796+00:00"
---

# DgsDetectAreaSetFunction

This function set the detecting function of the detect area.

*For texture detecting function:*

- Black field means going through.

- White field means area to be detected.

## Syntax

```
bool dgsDetectAreaSetFunction( element da, string/texture detectingFnc )
```
...
- **detectingFnc :** A string/texture that is used to act as detecting function
...
This example will create detect area.
...
This example will create detect area with texture detecting function.

```
DGS = exports.dgs
tex = dxCreateTexture("yourTexture")
da = DGS:dgsCreateDetectArea (400,300,400,200,false) -- Create Detect Area
DGS:dgsDetectAreaSetFunction(da,tex) --Custom Detect Area function
DGS:dgsDetectAreaSetDebugModeEnabled(da,true)  --Set debug mode so that we can see where it is and how it looks like.
```
