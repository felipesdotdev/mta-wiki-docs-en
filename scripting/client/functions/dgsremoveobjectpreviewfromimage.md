---
doc_id: "mta-wiki:11971"
title: "DgsRemoveObjectPreviewFromImage"
source_title: "DgsRemoveObjectPreviewFromImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRemoveObjectPreviewFromImage"
revision_id: 65068
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:13.399269+00:00"
---

# DgsRemoveObjectPreviewFromImage

This function removes the object preview element from dgs image.

## Syntax

```
bool dgsRemoveObjectPreviewFromImage( element dgsImage )
```

### Required Arguments

- **dgsImage:** A DGS image to remove from.
...
setTimer(function()
	DGS:dgsRemoveObjectPreviewFromImage(image) --Remove
end,5000,1)
```
