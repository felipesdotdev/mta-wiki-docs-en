---
doc_id: "mta-wiki:14369"
title: "SetWorldProperty"
source_title: "SetWorldProperty"
source_url: "https://wiki.multitheftauto.com/wiki/SetWorldProperty"
revision_id: 81366
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:16:50.053321+00:00"
---
...
This function is used to override time cycle and weather related properties. Preview (album): [https://imgur.com/a/jeUxx7L](https://imgur.com/a/jeUxx7L) 
...
| [[{{{image}}}\|link=\|]] | Tip: This function can be used to implement custom time cycles and other advanced weather features. It allows you to override values set by the game for weathers (timecyc.dat). The downside of overriding is the need to implement custom blending (to change weather properties over time creating night / day cycle). |
| --- | --- |
|  |  |
...
**Counterpart**: *[getWorldProperty](mta://scripting/client/functions/getworldproperty.md)*
...
```
Example arguments forRGB: 255, 255, 255FLOAT: 0.5INT: 100
```
