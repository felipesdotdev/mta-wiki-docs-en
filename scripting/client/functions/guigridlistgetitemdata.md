---
doc_id: "mta-wiki:2539"
title: "GuiGridListGetItemData"
source_title: "GuiGridListGetItemData"
source_url: "https://wiki.multitheftauto.com/wiki/GuiGridListGetItemData"
revision_id: 60528
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:36.843787+00:00"
---

# GuiGridListGetItemData

With this function you can retrieve the [string](mta://reference/misc/string.md) data associated with an item in a [grid list](mta://scripting/concepts/element-gui-gridlist.md). This is not the text that is displayed on the item, but an internal string that you can use to hold extra information about the item.  

**Note:** This function will only work **after** you set the item's text using [guiGridListSetItemText](mta://scripting/client/functions/guigridlistsetitemtext.md)!
...
**Method**: *[GuiGridList](mta://scripting/concepts/element-gui-gridlist.md):getItemData(...)*
