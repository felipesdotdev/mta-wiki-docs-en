---
doc_id: "mta-wiki:9947"
title: "DgsCloseWindow"
source_title: "DgsGUICloseWindow"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGUICloseWindow"
revision_id: 53594
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:13.690745+00:00"
---
...
```
bool dgsCloseWindow ( element theElement )
```
...
function closeDgsGUI ()
	...
	local close = DGS:dgsCloseWindow(window)

	-- if the DGS window was closed output a message and hide the player's cursor.
	if close then
                -- Output a message saying that the DGS window was closed.
