---
doc_id: "mta-wiki:14439"
title: "DxScrollSetCurrentPosition"
source_title: "DxScrollSetCurrentPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DxScrollSetCurrentPosition"
revision_id: 80654
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:51.071148+00:00"
---

# DxScrollSetCurrentPosition

Esta funcion modifica la posición del boton de la barra de desplazamiento creada [dxScroll](mta://scripting/client/functions/dxscroll.md).
...
```
bool dxScrollSetCurrentPosition(element element, int valor)
```
...
- **valor**: Un valor numerico al cual se lo va a posicionar (**0**-**1**).
...
-- Ej: Scroll Estilo Vertical
scrollV = dxScroll(277, 317, 317, true, false, false)	

-- Asignamos la función actual para aplicar su posicionamiento. (0-1)
dxScrollSetCurrentPosition(scrollV, 1)
```
