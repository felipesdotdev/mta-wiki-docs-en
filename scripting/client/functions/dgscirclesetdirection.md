---
doc_id: "mta-wiki:14130"
title: "DgsCircleSetDirection"
source_title: "DgsCircleSetDirection"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleSetDirection"
revision_id: 77566
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:56.974084+00:00"
---

# DgsCircleSetDirection

This function sets the direction of dgs circle.

## Syntax

```
bool dgsCircleSetDirection( element circle, bool direction )
```

### Required Arguments

- **circle:** A dgs-dxcircle plugin.

- **direction :** A bool indicates if dgs circle is anti-clockwise or clockwise.
...
DGS:dgsCircleSetAngle(c,90)
DGS:dgsCircleSetDirection(c,false) --clockwise

local ac = DGS:dgsCreateCircle(0.5,0.3)
local img2 = DGS:dgsCreateImage(300,200,200,200,ac,false)
DGS:dgsCircleSetAngle(ac,90)
DGS:dgsCircleSetDirection(ac,true) --anti-clockwise
```
