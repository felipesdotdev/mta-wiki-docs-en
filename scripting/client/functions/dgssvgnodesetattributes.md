---
doc_id: "mta-wiki:13628"
title: "DgsSVGNodeSetAttributes"
source_title: "DgsSVGNodeSetAttributes"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSVGNodeSetAttributes"
revision_id: 81337
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:19.721633+00:00"
---

# DgsSVGNodeSetAttributes

This function change svg [xmlnode](mta://reference/misc/xmlnode.md) attributes value with formated.

## Syntax

```
bool dgsSVGNodeSetAttributes( xmlnode xmlNode, table attributesWithValue)
```

### Required Arguments

- **xmlNode:** [xmlnode](mta://reference/misc/xmlnode.md) That you want to change its attributes and value .

- **attributesWithValue:** Table that contain attributes as key and attribute value as value.
