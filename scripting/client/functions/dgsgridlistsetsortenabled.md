---
doc_id: "mta-wiki:10055"
title: "DgsGridListSetSortEnabled"
source_title: "DgsGridListSetSortEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetSortEnabled"
revision_id: 54059
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:41.372650+00:00"
---

# DgsGridListSetSortEnabled

This function sets whether the sort which activated by clicking the column of grid list enabled.

## Syntax

```
bool dgsGridListSetSortEnabled( element gridlist, bool state )
```

### Required Arguments

- **gridlist:** The grid list which you want to set sort state to.

- **state:** A bool of the state.
...
DGS:dgsGridListSetSortEnabled(gridlist,false) -- Disable!
```
