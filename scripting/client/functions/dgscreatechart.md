---
doc_id: "mta-wiki:13582"
title: "DgsCreateChart"
source_title: "DgsCreateChart"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCreateChart"
revision_id: 75997
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:12:13.541199+00:00"
---

# DgsCreateChart

This function creates a data chart.

## Syntax

```
element dgsCreateChart ( float x, float y, float width, float height, string chartType, bool relative [, element parent = nil ] )
```
...
- **x:** A float of the 2D x position of the chart on a player's screen. This is affected by the *relative* argument.

- **y:** A float of the 2D y position of the chart on a player's screen. This is affected by the *relative* argument.

- **width:** A float of the width of the chart. This is affected by the *relative* argument.

- **height:** A float of the height of the chart. This is affected by the *relative* argument.

- **chartType:** A string of chart type. The available values are:
...
- **parent:** This is the parent that the DGS Chart is attached to. If the relative argument is true, sizes and positioning will be made relative to this parent. If the relative argument is false, positioning will be the number of offset pixels from the parent's origin. If no parent is passed, the parent will become the screen - causing positioning and sizing according to screen positioning.

### Returns

Returns a [dgs chart](https://wiki.multitheftauto.com/index.php?title=Dgs-dxchart&action=edit&redlink=1) plugin element if it was created successfully, false otherwise.
...
local chart = DGS:dgsCreateChart(100,100,600,300,"line",false)
DGS:dgsChartSetLabels(chart,"Month",{"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"})
DGS:dgsSetProperty(chart,"axisYScaler",{0,100})
DGS:dgsSetProperty(chart,"gridLineWidth",2)
DGS:dgsSetProperty(chart,"axisLineWidth",4)
DGS:dgsSetProperty(chart,"axisTextOffsetFromGrid",10)
DGS:dgsSetProperty(chart,"chartPadding",{40,40,40,40,false}) --Top Botton Left Right
local datasetID = DGS:dgsChartAddDataset(chart,"Counts")
DGS:dgsChartDatasetSetStyle(chart,datasetID,{
...
DGS:dgsChartDatasetSetData(chart,datasetID,setdata)
