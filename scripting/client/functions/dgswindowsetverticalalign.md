---
doc_id: "mta-wiki:13155"
title: "DgsWindowSetVerticalAlign"
source_title: "DgsWindowSetVerticalAlign"
source_url: "https://wiki.multitheftauto.com/wiki/DgsWindowSetVerticalAlign"
revision_id: 70763
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:42.878251+00:00"
---

# DgsWindowSetVerticalAlign

This function sets the vertical alignment of the title text of a dgs window.

## Syntax

```
bool dgsWindowSetVerticalAlign ( element window, string align )
```

### Required Arguments

- **window:** The dgs window to set the vertical alignment.
...
DGS:dgsWindowSetVerticalAlign( window, "bottom" )
```
