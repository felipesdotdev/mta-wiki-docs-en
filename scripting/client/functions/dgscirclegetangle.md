---
doc_id: "mta-wiki:14127"
title: "DgsCircleGetAngle"
source_title: "DgsCircleGetAngle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleGetAngle"
revision_id: 77570
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:54.427968+00:00"
---

# DgsCircleGetAngle

This function gets the angle from dgs circle.

## Syntax

```
float dgsCircleGetAngle( element circle )
```
...
Returns a *float* indicates the angle of dgs circle in degrees if successful, *false* otherwise.
...
DGS:dgsCircleSetAngle(c,DGS:dgsCircleGetAngle(c)+20)
```
