---
doc_id: "mta-wiki:11916"
title: "DgsGridListGetColumnHeight"
source_title: "DgsGridListGetColumnHeight"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetColumnHeight"
revision_id: 64881
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:22.595843+00:00"
---

# DgsGridListGetColumnHeight

This function is used to get the height of a dgs gridlist column.

## Syntax

```
int dgsGridListGetColumnHeight( element dgsGridlist )
```

### Required Arguments

- **dgsGridlist**: The dgs grid list you want to get the column height from

### Returns

Returns a *integer* if successful, *false* otherwise.
...
local columnHeight = DGS:dgsGridListGetColumnHeight(list)
outputChatBox("column height "..tostring(columnHeight))
```
