---
doc_id: "mta-wiki:10064"
title: "DgsGridListGetItemImage"
source_title: "DgsGridListGetItemImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetItemImage"
revision_id: 69602
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:25.604859+00:00"
---

# DgsGridListGetItemImage

This function gets the image from a grid list item.

## Syntax

```
texture, int, float, float, float, float dgsGridListGetItemImage( element gridList, int rowIndex, int columnIndex )
```
...
for i=1,10 do
	...
	DGS:dgsGridListSetItemImage(gridlist,row,1,texture,tocolor(255,255,255,255),10,5,25,20)
end

Image, Color, PosX, PosY, Width, Height = DGS:dgsGridListGetItemImage(gridlist,2,1)
