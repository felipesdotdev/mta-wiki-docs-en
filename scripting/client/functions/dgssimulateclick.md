---
doc_id: "mta-wiki:10182"
title: "DgsSimulateClick"
source_title: "DgsSimulateClick"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSimulateClick"
revision_id: 55204
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:34.028541+00:00"
---

# DgsSimulateClick

This function simulates a click without mouse clicking.

## Syntax

```
string dgsSimulateClick( element dgsElement, string button )
```

### Required Arguments

- **dgsElement:** The dgs element you want to triggered

- **button:** Mouse button triggered, available values as follows:
...
addEventHandler("onDgsMouseClick",button,function(button,state)
	if button == "left" and state == "down" then
		outputChatBox("clicked")
	end
end)
DGS:dgsSimulateClick(button,"left")
```
