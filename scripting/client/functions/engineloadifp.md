---
doc_id: "mta-wiki:5485"
title: "EngineLoadIFP"
source_title: "EngineLoadIFP"
source_url: "https://wiki.multitheftauto.com/wiki/EngineLoadIFP"
revision_id: 64796
language: "en"
categories: ["Client_functions", "Changes_in_1.5.5"]
generated_at: "2026-07-26T16:14:56.784712+00:00"
---

# EngineLoadIFP

This function loads an animation library (IFP) file into GTA with a custom block name. All three IFP formats are supported ANPK, ANP2, and ANP3. Unfortunately, GTA 3 animations are not supported, however, you can load GTA:VC IFP files using this function. You don't have to replace any animation to play a custom one, to play a custom animation, load the IFP file using this function, then use [setPedAnimation](mta://scripting/shared/functions/setpedanimation.md).

If you wish to replace a GTA internal animation with a custom one, you can use [engineReplaceAnimation](mta://scripting/client/functions/enginereplaceanimation.md). To unload the IFP file, use [destroyElement](mta://scripting/shared/functions/destroyelement.md), restarting or stopping the resource can also unload the IFP file automatically.
...
- **ifp_file / raw_data:** the [filepath](mta://reference/misc/filepath.md) to the IFP file you want to load or whole data buffer of the IFP file.

- **custom_block_name:** the new block name for the IFP file. You cannot use the GTA default [internal block](mta://reference/misc/animations.md) names. **You should namespace this name** using a string like *resource.blockname*

### Returns

Returns an [IFP](https://wiki.multitheftauto.com/index.php?title=IFP&action=edit&redlink=1) element if the IFP file loaded, *false* otherwise.
...
This example loads a custom IFP file ([parkour.ifp](https://drive.google.com/file/d/1XZNNCCn7xhBNbhaIbsBubky3BEj06zWp/view?usp=sharing)), adds a command "animation" that takes 1 parameter as animation name for playing animations within that IFP.
