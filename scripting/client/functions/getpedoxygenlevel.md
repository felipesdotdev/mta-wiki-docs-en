...
generated_at: "2026-07-26T16:15:17.977268+00:00"
---

# GetPedOxygenLevel

This function returns the current oxygen level of the specified [ped](mta://reference/misc/ped.md).
...
**Method**: *[ped](mta://reference/misc/ped.md):getOxygenLevel(...)*
...
- **thePed:** The [ped](mta://reference/misc/ped.md) whose oxygen level you want to check
