---
doc_id: "mta-wiki:13639"
title: "DgsIsDragNDropData"
source_title: "DgsIsDragNDropData"
source_url: "https://wiki.multitheftauto.com/wiki/DgsIsDragNDropData"
revision_id: 74357
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:45.399997+00:00"
---

# DgsIsDragNDropData

This function checks whether there is some data holding on cursor.

## Syntax

```
bool dgsIsDragNDropData (  )
```
...
Returns *true* if there is some data holding on cursor, *false* otherwise
...
addEventHandler("onDgsDrag",sender,function(data)
	local theTimer = setTimer(function()
		outputChatBox(tostring(dgsIsDragNDropData()))
