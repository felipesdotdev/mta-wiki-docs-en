---
doc_id: "mta-wiki:13211"
title: "DgsSetStyle"
source_title: "DgsSetStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetStyle"
revision_id: 71101
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:33.342820+00:00"
---

# DgsSetStyle

This function applies a DGS style to DGS global or just inside a specific resource. If the style is added but not loaded, this funtion will automatically load the style.

## Syntax

```
bool dgsSetStyle( string styleName [, resource-data/string bindResource = resource ] )
```

### Required Arguments

- **styleName**: A string of the style name that you want to apply.

### Optional Arguments

- **bindResource**:  A resource-data you want to apply to. For DGS global, use string "**global**". Leave this to *nil* to use **resource**([getThisResource](mta://scripting/shared/functions/getthisresource.md)). [Note: When resource stops, the style will also be unloaded]
...
DGS:dgsAddStyle("myStyle", "styleFolder/myStyle") --Add
DGS:dgsLoadStyle("myStyle") --Load ( can be unncessary )

DGS:dgsSetStyle("myStyle") --Apply style to this resource ( which has higher priority )

DGS:dgsSetStyle("myStyle","global") --Apply style to dgs global ( which has lower priority )
```
