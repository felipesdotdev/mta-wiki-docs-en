...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setWheelScale(...)*
...
- **theVehicle**: The [vehicle](mta://reference/misc/vehicle.md) whose wheel scale you wish to modify.
