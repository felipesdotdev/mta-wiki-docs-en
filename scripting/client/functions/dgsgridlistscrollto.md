---
doc_id: "mta-wiki:13183"
title: "DgsGridListScrollTo"
source_title: "DgsGridListScrollTo"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListScrollTo"
revision_id: 70829
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:32.393860+00:00"
---

# DgsGridListScrollTo

This function scrolls the grid list to the specific item.

## Syntax

```
bool dgsGridListScrollTo( element gridList, int row, int column )
```
...
- **row:** An integer of the row index of the grid list you want to scroll to.

- **column:** An integer of the column index of the grid list you want to scroll to.
...
```
DGS = exports.dgs
gridlist = DGS:dgsCreateGridList(500,50,600,600,false)
DGS:dgsGridListAddColumn(gridlist,"test1",0.4)
DGS:dgsGridListAddColumn(gridlist,"test2",0.8)
DGS:dgsGridListAddColumn(gridlist,"test3",0.8)
for i=1,500 do
	local row = DGS:dgsGridListAddRow(gridlist)
	DGS:dgsGridListSetItemText(gridlist,row,1,i.."-1")
	DGS:dgsGridListSetItemText(gridlist,row,2,i.."-2")
	DGS:dgsGridListSetItemText(gridlist,row,3,i.."-3")
end
setTimer(function()
	DGS:dgsGridListScrollTo(gridlist,300,2)
end,100,1)
```
