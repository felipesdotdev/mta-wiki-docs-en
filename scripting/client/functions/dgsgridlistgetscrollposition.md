---
doc_id: "mta-wiki:10042"
title: "DgsGridListGetScrollPosition"
source_title: "DgsGridListGetScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetScrollPosition"
revision_id: 54019
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:29.065917+00:00"
---

# DgsGridListGetScrollPosition

This function get scroll position of dgs grid list.

## Syntax

```
float, float dgsGridListGetScrollPosition( element gridList )
```

### Required Arguments

- **gridList:** The dgs grid list element to get from.

### Returns

Returns two float values indicate vertical and horizontal scroll position, *false* otherwise
...
local vertical,horizontal = DGS:dgsGridListGetScrollPosition(testList)
outputChatBox("vertical:"..vertical.." ; horizontal:"..horizontal)
```
