---
doc_id: "mta-wiki:13854"
title: "Dgs3DLineSetItemPosition"
source_title: "Dgs3DLineSetItemPosition"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DLineSetItemPosition"
revision_id: 75989
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:39.566260+00:00"
---

# Dgs3DLineSetItemPosition

This function sets the position of the specified item of DGS 3D Line.

## Syntax

```
bool dgs3DLineSetItemPosition( element line3D, int index, float x, float y, float z )
```
...
- **index**: The item index of DGS 3D Line.

- **x:** A float of the 3D x position of the item of DGS 3D Line in the world. Set to nil to use the end position of previous item.

- **y:** A float of the 3D y position of the item of DGS 3D Line in the world. Set to nil to use the end position of previous item.

- **z:** A float of the 3D z position of the item of DGS 3D Line in the world. Set to nil to use the end position of previous item.
...
DGS:dgs3DLineSetItemPosition(line,1,0,10,10)
```
