---
doc_id: "mta-wiki:13679"
title: "DxCheckBox"
source_title: "DxCheckBox"
source_url: "https://wiki.multitheftauto.com/wiki/DxCheckBox"
revision_id: 77457
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:43.383174+00:00"
---
...
Esta funcion crea una checkBox basado en dxDrawing.
...
```
element dxCheckBox(int x, int y, string text, [ element parent = nil, bool rounded = nil ] )
```
...
- **text**: Una cadena de caracteres(string) que representa el texto que contendra el [CheckBox](https://wiki.multitheftauto.com/wiki/DxCheckBox).

### Argumentos Opcionales

- **parent**: Este es el padre el cual el [CheckBox](https://wiki.multitheftauto.com/wiki/DxCheckBox) se adjunta.
...
--creamos un checkBox
check1 = dxCheckBox(432, 83, 'guardar datos', win)
```
