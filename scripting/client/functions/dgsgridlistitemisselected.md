---
doc_id: "mta-wiki:10302"
title: "DgsGridListItemIsSelected"
source_title: "DgsGridListItemIsSelected"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListItemIsSelected"
revision_id: 56269
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:31.020392+00:00"
---

# DgsGridListItemIsSelected

This function returns a bool value indicates whether the item is selected.(Different from [dgsGridListGetSelectedItem](mta://scripting/client/functions/dgsgridlistgetselecteditem.md), this function is always used in multi-selecting mode)

## Syntax

```
int dgsGridListItemIsSelected( element gridList, int row, int column )
```

### Required Arguments

- **gridList:** the grid list you want to check
...
Returns true if specific item is selected, false otherwise.
...
print(DGS:dgsGridListItemIsSelected(GridList,1,1)) --Return true
```
