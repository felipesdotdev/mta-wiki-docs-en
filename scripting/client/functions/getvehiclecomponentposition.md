...
generated_at: "2026-07-26T16:15:27.056443+00:00"
---

# GetVehicleComponentPosition

This function gets the component position of a [vehicle](mta://reference/misc/vehicle.md). The vehicle must be streamed in.
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getComponentPosition(...)*

**Counterpart**: *[setVehicleComponentPosition](mta://scripting/client/functions/setvehiclecomponentposition.md)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) you wish to get component position of.
