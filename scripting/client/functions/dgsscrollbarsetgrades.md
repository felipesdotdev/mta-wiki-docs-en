---
doc_id: "mta-wiki:12269"
title: "DgsScrollBarSetGrades"
source_title: "DgsScrollBarSetGrades"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollBarSetGrades"
revision_id: 66237
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:22.852864+00:00"
---

# DgsScrollBarSetGrades

This function allows you can use grades on dgs scroll bar. This can make scroll bar have steps when scrolling.

## Syntax

```
bool dgsScrollBarSetGrades( element scrollBar, int grades [, bool remainMultipler = false ] )
```

### Required Arguments

- **scrollBar:** The scroll bar whose grades have to be changed.

- **grades:** An int of the grades of the cursor.

### Optional Arguments

- **remainMultipler:** A bool of whether to remain the multiplier value which will affect the scroll speed when using mouse wheel.

## Example

This example move scroll bar by 40

```
DGS = exports.dgs 
addEventHandler("onClientResourceStart", resourceRoot, function()
     local scrollBar = DGS:dgsCreateScrollBar(0.29, 0.30, 0.44, 0.04, true, true)
     DGS:dgsScrollBarSetGrades(scrollBar,20,2)
end)
```
