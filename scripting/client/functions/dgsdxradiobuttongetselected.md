---
doc_id: "mta-wiki:9957"
title: "DgsRadioButtonGetSelected"
source_title: "DgsDxRadioButtonGetSelected"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxRadioButtonGetSelected"
revision_id: 76155
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:15.884277+00:00"
---
...
```
bool dgsRadioButtonGetSelected( element RadioButton )
```

### Required Arguments

- **RadioButton:** The radio button you wish to retrieve the selection state of.
...
```
DGS = exports.dgs 
button1 = DGS:dgsCreateRadioButton( 243, 204, 36, 16, "test1", false ) --Create a radio button
button2 = DGS:dgsCreateRadioButton( 243, 234, 36, 16, "test2", false ) --Create another radio button
addEventHandler("onDgsMouseClickUp",root,function()
	if DGS:dgsRadioButtonGetSelected( button1 ) then
		outputChatBox("Radio Button 1 is checked")
	else
		outputChatBox("Radio Button 1 is unchecked")
	end
end)
```
