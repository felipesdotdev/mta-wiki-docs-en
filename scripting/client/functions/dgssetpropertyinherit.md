---
doc_id: "mta-wiki:11187"
title: "DgsSetPropertyInherit"
source_title: "DgsSetPropertyInherit"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetPropertyInherit"
revision_id: 62048
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:32.434059+00:00"
---

# DgsSetPropertyInherit

This function sets the value of a specific property of a DGS element and **affects its children**. For a list of properties and their meaning, see the [DGS properties page](https://wiki.multitheftauto.com/wiki/Template:DGSPROPERTIES).
...
```
string dgsSetPropertyInherit ( element/table dgsElement, string property, mixed value [, mixed arg1, mixed arg2 ... ] )
```
...
```
DGS = exports.dgs
label = DGS:dgsCreateLabel(20, 200, 150, 30, "Test1", false)
label2 = DGS:dgsCreateLabel(0, 800, 150, 30, "Test2", false, label2)
dgsSetPropertyInherit(label,"text","We are the same")
```
