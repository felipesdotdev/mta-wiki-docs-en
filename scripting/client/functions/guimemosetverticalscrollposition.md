---
doc_id: "mta-wiki:10358"
title: "GuiMemoSetVerticalScrollPosition"
source_title: "GuiMemoSetVerticalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/GuiMemoSetVerticalScrollPosition"
revision_id: 71646
language: "en"
categories: ["Client_functions", "Changes_in_1.5.5"]
generated_at: "2026-07-26T16:15:40.002414+00:00"
---
...
**Method**: *[GuiMemo](https://wiki.multitheftauto.com/index.php?title=GuiMemo&action=edit&redlink=1):setVerticalScrollPosition(...)*

**Variable**: *.verticalScrollPosition*

**Counterpart**: *[guiMemoGetVerticalScrollPosition](mta://scripting/client/functions/guimemogetverticalscrollposition.md)*

### Required Arguments

- **theMemo**: the [memo](mta://scripting/client/functions/guicreatememo.md) you want to change the vertical scroll position of.

- **position**: a [float](mta://reference/misc/float.md) ranging between 0 and 100.
...
This example sets the position of a memo called "theMemo" created with [guiCreateMemo](mta://scripting/client/functions/guicreatememo.md), and outputs it to the chatbox.
