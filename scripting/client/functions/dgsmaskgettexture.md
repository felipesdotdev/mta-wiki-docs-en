---
doc_id: "mta-wiki:12319"
title: "DgsMaskGetTexture"
source_title: "DgsMaskGetTexture"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMaskGetTexture"
revision_id: 66442
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:52.215281+00:00"
---

# DgsMaskGetTexture

This function gets the texture that is used as source texture of dgs mask.

## Syntax

```
element dgsMaskGetTexture( element mask )
```
...
Returns a texture if successful, *false* otherwise.
...
if DGS:dgsMaskGetTexture(mask) == sourceTex then
	outputChatBox("Get Source Texture")
end
```
