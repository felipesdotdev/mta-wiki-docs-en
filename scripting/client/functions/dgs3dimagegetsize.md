---
doc_id: "mta-wiki:13185"
title: "Dgs3DImageGetSize"
source_title: "Dgs3DImageGetSize"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageGetSize"
revision_id: 70841
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:26.524253+00:00"
---

# Dgs3DImageGetSize

This function gets the size of the image of the 3d image **when distance between camera and 3d image is 50 units**.

## Syntax

```
float, float dgs3DImageGetSize( element image3D )
```
...
Returns two *float* representing the width and height of the 3d image, *false* otherwise.
...
local w,h = DGS:dgs3DImageGetSize(image)
outputChatBox(w.."x"..h)
```
