---
doc_id: "mta-wiki:12363"
title: "DgsGridListSetItemHoverable"
source_title: "DgsGridListSetItemHoverable"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetItemHoverable"
revision_id: 66690
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:36.369625+00:00"
---

# DgsGridListSetItemHoverable

This function sets whether the item is hoverable, which has a lower priority than [dgsGridListSetRowHoverable](mta://scripting/client/functions/dgsgridlistsetrowhoverable.md).

## Syntax

```
string dgsGridListSetItemHoverable( element gridlist, int row, int column, boolean state )
```
...
- **column:** The column index of the grid list.

- **state:** A bool indicates whether the row of grid list is hoverable or not.
...
for id, player in ipairs(getElementsByType("player")) do
    ...
    DGS:dgsGridListSetItemHoverable( playerList, row, column, false)
end
```
