---
doc_id: "mta-wiki:10538"
title: "CustomScrollPane:getScrollSpeed"
source_title: "CustomScrollPane:getScrollSpeed"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AgetScrollSpeed"
revision_id: 57316
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:10:57.792003+00:00"
---

# CustomScrollPane:getScrollSpeed

This function gets Custom Scroll Pane scrolling speed with Middle Mouse Button.

## Syntax

```
float СustomScrollPane:getScrollSpeed()
```

### Returns

Returns custom Scroll Pane scrolling speed.
...
This example creates window with Scroll Pane and prints its scroll speed:
...
outputChatBox(SPane:getScrollSpeed())
```
