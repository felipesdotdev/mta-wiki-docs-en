---
doc_id: "mta-wiki:13177"
title: "DgsGetDetectArea"
source_title: "DgsGetDetectArea"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetDetectArea"
revision_id: 70820
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:12.687697+00:00"
---

# DgsGetDetectArea

This function gets the detectarea from a dgs element.

## Syntax

```
element dgsGetDetectArea( element dgsElement )
```

### Required Arguments

- **dgsElement :** The dgs element.

### Returns

Returns a dgs-dxdetectarea element if there is a detectarea applied to the dgs element, *false* otherwise.
...
local da = DGS:dgsCreateDetectArea()
DGS:dgsDetectAreaSetDebugModeEnabled(da,true)
DGS:dgsDetectAreaSetFunction(da,[[return (mxRlt-0.5)^2+(myRlt-0.5)^2 < 0.25]])
local image = DGS:dgsCreateImage(200,200,100,100,_,false,_,tocolor(255,255,255,128))
print(DGS:dgsGetDetectArea(image)) --returns false
DGS:dgsApplyDetectArea(image,da)
print(DGS:dgsGetDetectArea(image)) --returns the detect area element
```
