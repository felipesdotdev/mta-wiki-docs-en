...
generated_at: "2026-07-26T16:16:57.772736+00:00"
---
...
- **checkBuildings:** Specifies whether [buildings](mta://development/building.md) should be detected, i.e., elements of the default GTA map or those created using [createBuilding](mta://scripting/shared/functions/createbuilding.md).

- **checkVehicles:** Specifies whether [vehicles](mta://reference/misc/vehicle.md) should be detected.

- **checkPeds:** Specifies whether [peds](mta://reference/misc/ped.md) (including [players](mta://reference/misc/player.md)) should be detected.

- **checkObjects:** Specifies whether [objects](mta://reference/misc/object.md) should be detected.
