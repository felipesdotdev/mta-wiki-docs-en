---
doc_id: "mta-wiki:12324"
title: "DgsCreateRemoteImage"
source_title: "DgsCreateRemoteImage"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCreateRemoteImage"
revision_id: 68277
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:21.793682+00:00"
---

# DgsCreateRemoteImage

This function creates a texture from URL, that can be used for [dgsCreateImage](mta://scripting/client/functions/dgscreateimage.md).

## Syntax

```
element dgsCreateRemoteImage( string URL )
```
...
Returns an dgs-dxremoteimage (DGS Plugin Type)[shader(element type)] if successful, *false* otherwise.
...
local image = DGS:dgsCreateImage(0, 0, 400, 200, texture, false) 
