---
doc_id: "mta-wiki:9895"
title: "DgsGridListGetColumnCount"
source_title: "DgsDxGridListGetColumnCount"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListGetColumnCount"
revision_id: 53427
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:59.290602+00:00"
---

# DgsGridListGetColumnCount

This function returns the number of columns in a dgs grid list.

## Syntax

```
int dgsGridListGetColumnCount ( element gridList )
```

### Required Arguments

- **gridList:** The dgs grid list to get the number of columns from.

### Returns

Returns the number of columns if the function is successful, *false* otherwise.
...
local list = DGS:dgsCreateGridList ( 0.80, 0.10, 0.15, 0.60, true ) 
for i=1,10 do
	DGS:dgsGridListAddColumn( list, "Test", 0.85 ) 
end
outputChatBox("Columns :"..DGS:dgsGridListGetColumnCount(list))
```
