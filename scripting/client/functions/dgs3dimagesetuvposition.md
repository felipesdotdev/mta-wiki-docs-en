---
doc_id: "mta-wiki:13158"
title: "Dgs3DImageSetUVPosition"
source_title: "Dgs3DImageSetUVPosition"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageSetUVPosition"
revision_id: 70834
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:28.519878+00:00"
---

# Dgs3DImageSetUVPosition

This function sets the UV positon of a DGS 3d image (Only available when there is a texture loaded in DGS 3d image).

## Syntax

```
bool dgs3DImageSetUVPosition ( element dgs3DImage, float UPos, float VPos, bool relative )
```

### Required Arguments

- **dgs3DImage**: The dgs 3d image of which you wish to set the UV position.

- **UPos**: A float of the U position of 3d image.

- **VPos**: A float of the V position of 3d image.
