---
doc_id: "mta-wiki:12316"
title: "DgsBlurBoxGetResolution"
source_title: "DgsBlurBoxGetResolution"
source_url: "https://wiki.multitheftauto.com/wiki/DgsBlurBoxGetResolution"
revision_id: 66438
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:48.203974+00:00"
---

# DgsBlurBoxGetResolution

This function gets resolution of a blur box.

## Syntax

```
int, int dgsBlurBoxGetResolution( element blurBox )
```
...
Returns two **integer** stand for the resolution of blur box if successful, *false* otherwise.
...
iprint(DGS:dgsBlurBoxGetResolution(blurbox)) -- returns 600, 500
```
