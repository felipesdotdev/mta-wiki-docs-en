---
doc_id: "mta-wiki:13214"
title: "DgsGetAddedStyleList"
source_title: "DgsGetAddedStyleList"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetAddedStyleList"
revision_id: 71108
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:10.066936+00:00"
---

# DgsGetAddedStyleList

This function get the added style list from DGS global or a specific resource.

## Syntax

```
bool dgsGetAddedStyleList( [ bool includeGlobal = false, resource-data/string bindResource = resource ] )
```

### Optional Arguments

- **includeGlobal**: A bool indicates whether the returning table includes added styles of "global".
...
Returns a *table* includes the name of added style, *false* otherwise.
...
for name in ipairs(DGS:dgsGetAddedStyleList())
	outputChatBox(name) 
end
```
