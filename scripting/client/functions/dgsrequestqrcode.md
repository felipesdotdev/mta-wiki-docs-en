---
doc_id: "mta-wiki:11965"
title: "DgsRequestQRCode"
source_title: "DgsRequestQRCode"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRequestQRCode"
revision_id: 65058
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:13.856467+00:00"
---
...
```
element dgsRequestQRCode( string dataString [, int width = 128, int height = 128 ] )
```
...
- **dataString:** A string that you want to encode.

### Optional Arguments

- **width:** A integer of the width of QRCode.

- **height:** A integer of the height of QRCode.

### Returns

Returns a dgs-dxqrcode element (DGS Plugin Type)[ texture (Element Type) ] if succeed, *false* otherwise
