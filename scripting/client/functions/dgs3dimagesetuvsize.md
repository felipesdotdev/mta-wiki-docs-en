---
doc_id: "mta-wiki:13159"
title: "Dgs3DImageSetUVSize"
source_title: "Dgs3DImageSetUVSize"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageSetUVSize"
revision_id: 70832
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:28.804427+00:00"
---

# Dgs3DImageSetUVSize

This function sets the UV size of a DGS 3d image (Only available when there is a texture loaded in DGS 3d image).

## Syntax

```
bool dgs3DImageSetUVSize ( element dgs3DImage, float UPos, float VPos, bool relative )
```

### Required Arguments

- **dgs3DImage** The dgs 3d image of which you want to set the UV size.

- **UPos**: A float of the U size of 3d image.

- **VPos**: A float of the V size of 3d image.
...
local VSize,VSize = DGS:dgs3DImageGetUVSize(image,false)
DGS:dgs3DImageSetUVSize(image,USize+10,VSize+10,false)
```
