---
doc_id: "mta-wiki:13585"
title: "Dgs3DGetPosition"
source_title: "Dgs3DInterfaceGetPosition"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceGetPosition"
revision_id: 74012
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:31.395052+00:00"
---

# Dgs3DGetPosition

This function returns the position of 3D element in the world.

## Syntax

```
float, float, float dgs3DGetPosition ( element dgsElement )
```
...
Returns x, y, z of the 3D element in the world.
...
function panelPosition()
    ...
    if dgs3dPanel then -- if Panel exists 
        px, py, pz = DGS:dgs3DGetPosition(dgs3dPanel ) -- Gets the panel position
        outputChatBox("X: "..px.." Y: "..py.." Z: "..pz) -- outputs to ChatBox
    end
end
```
