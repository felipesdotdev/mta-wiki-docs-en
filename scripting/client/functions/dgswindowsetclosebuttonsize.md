---
doc_id: "mta-wiki:11547"
title: "DgsWindowSetCloseButtonSize"
source_title: "DgsWindowSetCloseButtonSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsWindowSetCloseButtonSize"
revision_id: 63286
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:41.826208+00:00"
---

# DgsWindowSetCloseButtonSize

This functions sets the dgs-dxwindow close(off) button size.

## Syntax

```
bool dgsWindowSetCloseButtonSize( element dgsElement, int width, int height[, bool relative] )
```

### Required Arguments

- **dgsElement:** The DGS window element you wish to set close button size.

- **width:** A float of the width of the close button. This is affected by the relative argument.

- **height:** A float of the height of the close button. This is affected by the relative argument.

### Optional Arguments

- **relative:** This is whether sizes and positioning are relative.  If this is *true*, then all width,height floats must be between 0 and 1, representing sizes/positions as a fraction of the window size. If *false*, then the size and co-ordinates are based on client's resolution, accessible using [guiGetScreenSize](mta://scripting/client/functions/guigetscreensize.md).
...
DGS:dgsWindowSetCloseButtonSize(dgsWindow,5,5,true)
```
