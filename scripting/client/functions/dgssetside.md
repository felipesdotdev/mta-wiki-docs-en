---
doc_id: "mta-wiki:11339"
title: "DgsSetSide"
source_title: "DgsSetSide"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetSide"
revision_id: 68985
language: "en"
categories: ["Client_functions", "Deprecated"]
generated_at: "2026-07-26T16:14:33.021594+00:00"
---
...
| --- | --- |
| Please use dgsGetElementAlignment instead. |  |

This function to set the position of the DGS element.

## Syntax

```
int dgsSetSide( element theElement, string display, bool topleft )
```
...
- **display:** A position string, "right" or "bottom".
...
DGS:dgsSetSide(button, "right", true) -- in right top left of the window
```
