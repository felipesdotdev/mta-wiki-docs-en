---
doc_id: "mta-wiki:12058"
title: "DgsCheckBoxGetHorizontalAlign"
source_title: "DgsCheckBoxGetHorizontalAlign"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCheckBoxGetHorizontalAlign"
revision_id: 66284
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:51.845328+00:00"
---

# DgsCheckBoxGetHorizontalAlign

This function gets the horizontal alignment of a dgs check box.
...
```
string dgsCheckBoxGetHorizontalAlign ( element checkBox )
```

### Required Arguments

- **checkBox:** The dgs check box to get the horizontal alignment from.
...
```
DGS = exports.dgs
local cb = DGS:dgsCreateCheckBox ( 300, 200, 500, 50, "Text", false )
outputChatBox( DGS:dgsCheckBoxGetHorizontalAlign ( cb ) )
```
