---
doc_id: "mta-wiki:13154"
title: "DgsWindowSetHorizontalAlign"
source_title: "DgsWindowSetHorizontalAlign"
source_url: "https://wiki.multitheftauto.com/wiki/DgsWindowSetHorizontalAlign"
revision_id: 70762
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:42.079444+00:00"
---

# DgsWindowSetHorizontalAlign

This function sets the horizontal alignment of the title text of a dgs window.

## Syntax

```
bool dgsWindowSetHorizontalAlign ( element window, string align )
```

### Required Arguments

- **window:** The dgs window to set the horizontal alignment.
...
```
DGS = exports.dgs
local window = DGS:dgsCreateWindow(500,500,200,30,"test window",false)
DGS:dgsWindowSetHorizontalAlign( window, "right" )
```
