---
doc_id: "mta-wiki:13210"
title: "DgsUnloadStyle"
source_title: "DgsUnloadStyle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsUnloadStyle"
revision_id: 71097
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:38.559416+00:00"
---

# DgsUnloadStyle

This function unloads an existing style from memory.

## Syntax

```
bool dgsUnloadStyle( string styleName [, resource-data/string bindResource = resource ] )
```

### Required Arguments

- **styleName**: A string of the style name that you want to unload.

### Optional Arguments

- **bindResource**:  A resource-data you want to unload from. For DGS global, use string "**global**". Leave this to *nil* to use **resource**([getThisResource](mta://scripting/shared/functions/getthisresource.md)). [Note: When resource stops, the style will also be unloaded]
...
DGS:dgsUnloadStyle("myStyle") --Unload
```
