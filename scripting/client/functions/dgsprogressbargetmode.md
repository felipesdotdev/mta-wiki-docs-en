---
doc_id: "mta-wiki:10029"
title: "DgsProgressBarGetMode"
source_title: "DgsProgressBarGetMode"
source_url: "https://wiki.multitheftauto.com/wiki/DgsProgressBarGetMode"
revision_id: 53911
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:07.520871+00:00"
---

# DgsProgressBarGetMode

This function gets bar image showing mode.

## Syntax

```
bool dgsProgressBarGetMode ( element progressBar )
```
...
- **progressBar:** the Progress Bar that you want to get from.

### Returns

Returns *true* if the mode state is *true*, *false* otherwise.

```
DGS = exports.dgs
pb = DGS:dgsCreateProgressBar(100,370,400,50,false)
local state = DGS:dgsProgressBarGetMode(pg,true)
outputChatBox(tostring(state)) --Default value is false
```
