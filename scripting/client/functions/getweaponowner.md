...
generated_at: "2026-07-26T16:15:30.123935+00:00"
---
...
This function was intended to return the [player](mta://reference/misc/player.md) which owns the [custom weapon](mta://reference/misc/element-weapon.md), and *false* if an error occured. However, at the moment it always returns *false*.
