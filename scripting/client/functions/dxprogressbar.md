---
doc_id: "mta-wiki:14432"
title: "DxProgressBar"
source_title: "DxProgressBar"
source_url: "https://wiki.multitheftauto.com/wiki/DxProgressBar"
revision_id: 80641
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:50.547933+00:00"
---

# DxProgressBar

Esta función crea una barra de progreso útil.
...
```
element dxProgressBar( int x, int y, int w, int h, [ element parent = nil , bool roundedProgressBar = false, int colorBackground = tocolor(255, 255, 255, 255), int colorProgress = tocolor(255, 255, 255, 255), int colorText = tocolor(255, 255, 255, 255)] )
```
...
- **w**: Un entero que representa el ancho del dxProgressBar.

- **h**: Un entero que representa la altura del dxProgressBar.

### Argumentos Opcionales

- **parent**: Este es el padre el cual la [dxProgressBar](https://wiki.multitheftauto.com/wiki/dxProgressBar) se adjunta.

- **roundedProgressBar**: valor [booleano](https://wiki.multitheftauto.com/wiki/Boolean) que representa si el elemento va a ser redondeado o no.
...
- **colorProgress**: El color de la barra, un valor producido por [tocolor](https://wiki.multitheftauto.com/wiki/Tocolor) o 0xAARRGGBB (AA = alfa, RR = rojo, GG = verde, BB = azul).
...
-- Elemento de Ejemplo
dxProgressBar(283, 596, 270, 38, false, true)
```
