---
doc_id: "mta-wiki:13161"
title: "Dgs3DImageGetUVSize"
source_title: "Dgs3DImageGetUVSize"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DImageGetUVSize"
revision_id: 70831
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:27.086440+00:00"
---

# Dgs3DImageGetUVSize

This function gets the UV size of a DGS 3d image (Only available when there is a texture loaded in DGS 3d image).

## Syntax

```
float, float dgs3DImageGetUVSize ( element dgs3DImage, bool relative )
```

### Required Arguments

- **dgs3DImage**: The DGS 3d image of which you want to get the UV size.
...
Returns the DGS 3d image size *U* and *V* if the function has been successful, *false* otherwise.
