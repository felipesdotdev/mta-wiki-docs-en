---
doc_id: "mta-wiki:12282"
title: "DgsMediaGetDuration"
source_title: "DgsMediaGetDuration"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMediaGetDuration"
revision_id: 66302
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:53.453388+00:00"
---

# DgsMediaGetDuration

This function gets the duration of the loaded media.

## Syntax

```
int dgsMediaGetDuration( element multiMediaBrowser )
```
...
returns an *integer* if successful, *false* otherwise.
...
addEventHandler("onDgsMediaLoaded", browser, function() -- on loaded
    outputChatBox("Duration: "..dgsMediaGetDuration(browser))
end)
```
