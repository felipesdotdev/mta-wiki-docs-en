---
doc_id: "mta-wiki:12419"
title: "DxCreateRenderTarget"
source_title: "DxRenderTarget"
source_url: "https://wiki.multitheftauto.com/wiki/DxRenderTarget"
revision_id: 81685
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:14:50.833352+00:00"
---

# DxCreateRenderTarget

This function creates a render target element, which is a special type of [texture](mta://reference/misc/texture.md) that can be drawn on with the dx functions. Successful render target creation is not guaranteed, and may fail due to hardware or memory limitations.
...
**Method**: *[DxRenderTarget](mta://reference/misc/texture.md)(...)*
...
Returns a [texture](mta://reference/misc/texture.md) element if successful, *false* if the system is unable to create a render target.
