---
doc_id: "mta-wiki:13246"
title: "DgsMemoGetTypingSoundVolume"
source_title: "DgsMemoGetTypingSoundVolume"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoGetTypingSoundVolume"
revision_id: 71390
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:59.956527+00:00"
---

# DgsMemoGetTypingSoundVolume

This function gets the volume of the typing sound of a dgs memo

## Syntax

```
number dgsMemoGetTypingSoundVolume( element memo )
```

### Required Arguments

- **memo:** The dgs-dxmemo you want to get.

### Returns

Returns a *float* indicates the volume of the typing sound if succeed, *false* otherwise.
...
outputhatBox(DGS:dgsMemoGetTypingSoundVolume(memo)) --Default is 1
```
