---
doc_id: "mta-wiki:10678"
title: "DgsGridListSelectItem"
source_title: "DgsGridListSelectItem"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSelectItem"
revision_id: 68076
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:32.644096+00:00"
---

# DgsGridListSelectItem

This function is used to select single item by state.

## Syntax

```
int dgsGridListSelectItem ( element gridList, int row, int column, bool state  )
```
...
- **row:** the row index you want to set.

- **column:** the column index you want to set.

- **state:** the select state.
...
local column1 = DGS:dgsGridListAddColumn( GridList, "test1", 0.85 )
local column2 = DGS:dgsGridListAddColumn( GridList, "test2", 0.85 )
for i=1,10 do
	local row = DGS:dgsGridListAddRow ( GridList )
	DGS:dgsGridListSetItemText ( GridList, row, column1, tostring(i) )
	DGS:dgsGridListSetItemText ( GridList, row, column2, tostring(10-i) )
end
DGS:dgsGridListSelectItem( GridList, 1, 2, true )
```
