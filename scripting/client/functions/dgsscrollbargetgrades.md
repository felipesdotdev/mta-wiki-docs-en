---
doc_id: "mta-wiki:12270"
title: "DgsScrollBarGetGrades"
source_title: "DgsScrollBarGetGrades"
source_url: "https://wiki.multitheftauto.com/wiki/DgsScrollBarGetGrades"
revision_id: 66236
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:20.782338+00:00"
---

# DgsScrollBarGetGrades

This function gets the grade of scroll bar cursor.

## Syntax

```
int dgsScrollBarGetGrades( element scrollBar )
```

### Required Arguments

- **scrollBar:** The scroll bar whose cursor grade is to be returned.

### Returns

Returns an *int* indicates the grade of the cursor of the scroll bar, *false* otherwise.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	local scrollBar = DGS:dgsCreateScrollBar(0.29, 0.30, 0.44, 0.04, true, true)¨
        DGS:dgsScrollBarSetGrades(scrollBar, 50)
	outputChatBox(DGS:dgsScrollBarGetGrades(scrollBar)) -- output grades float
end)
```
