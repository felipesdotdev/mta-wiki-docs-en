---
doc_id: "mta-wiki:13683"
title: "DxCheckBoxSetState"
source_title: "DxCheckBoxSetState"
source_url: "https://wiki.multitheftauto.com/wiki/DxCheckBoxSetState"
revision_id: 74661
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:43.479656+00:00"
---

# DxCheckBoxSetState

Esta función cambia el estado de un [dxCheckBox](mta://scripting/client/functions/dxcheckbox.md).
...
```
bool dxCheckBoxSetState( element element, bool bool )
```

### Argumentos requeridos

- **element:** El elemento [dxCheckBox](mta://scripting/client/functions/dxcheckbox.md).

- **bool:** Un booleano (true o false).

## Ejemplo

En el siguiente ejemplo veremos como al darle click al boton el [dxCheckBox](mta://scripting/client/functions/dxcheckbox.md) cambia de estado.

```
loadstring( exports.dxLibrary:dxGetLibrary( ) )( )

--creamos un dxCheckBox
checkB = dxCheckBox(432, 83, 32, 32)

-- creamos un boton
button = dxButton( 276, 80, 100, 40, "Clickea" )
addEventHandler ( "onClick", button,
   function()
      dxCheckBoxSetState(checkB, not dxCheckBoxSetState(checkB))
   end
)
```
