---
doc_id: "mta-wiki:3802"
title: "GuiStaticImageLoadImage"
source_title: "GuiStaticImageLoadImage"
source_url: "https://wiki.multitheftauto.com/wiki/GuiStaticImageLoadImage"
revision_id: 63630
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:15:42.010654+00:00"
---

# GuiStaticImageLoadImage

This function allows you to change the image in GUI static image element to another one. **Tip**: If you set other images as children you will have to use [setElementCallPropagationEnabled](mta://scripting/shared/functions/setelementcallpropagationenabled.md) to only affect the parent image.
...
**Method**: *[GuiStaticImage](mta://scripting/concepts/element-gui-static-image.md):loadImage(...)*
...
- **filename:** A string specifying the [filepath](mta://reference/misc/filepath.md) of the image file being loaded in current resource.
