...
generated_at: "2026-07-26T16:16:44.883456+00:00"
---

# SetSoundLooped

This function is used to change the loop state of the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](mta://reference/misc/sound.md):setLooped(...)*

**Counterpart**: *[isSoundLooped](mta://scripting/client/functions/issoundlooped.md)*

### Required Arguments

- **theSound:** The [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) to set the loop.

- **bool:** A [boolean](mta://reference/misc/boolean.md) representing whether the sound will be looped.

### Returns

Returns *true* if the [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) loop state was successfully changed, *false* otherwise.

## Example

This example creates a [sound](mta://reference/misc/sound.md) [element](mta://reference/misc/element.md) and turn on its looping:
