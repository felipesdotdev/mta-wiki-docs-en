---
doc_id: "mta-wiki:14113"
title: "DgsComboBoxGetItemBackGroundColor"
source_title: "DgsComboBoxGetItemBackGroundColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetItemBackGroundColor"
revision_id: 77489
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:02.232414+00:00"
---

# DgsComboBoxGetItemBackGroundColor

This function gets the background color of a specific item of the combo box.

## Syntax

```
int, int, int dgsComboBoxGetRowBackGroundColor( element comboBox, int itemIndex )
```
...
Returns 3 integers if exist are **colorDefault**, **colorHoving**, **colorSelected** correspondingly if get successfully, *false* if one of the arguments was invalid.
...
local a,b,c = DGS:dgsComboBoxGetItemBackGroundColor(combobox, 2)
