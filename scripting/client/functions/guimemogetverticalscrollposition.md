---
doc_id: "mta-wiki:10357"
title: "GuiMemoGetVerticalScrollPosition"
source_title: "GuiMemoGetVerticalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/GuiMemoGetVerticalScrollPosition"
revision_id: 71647
language: "en"
categories: ["Client_functions", "Changes_in_1.5.5"]
generated_at: "2026-07-26T16:15:39.689693+00:00"
---
...
**Method**: *[GuiMemo](https://wiki.multitheftauto.com/index.php?title=GuiMemo&action=edit&redlink=1):getVerticalScrollPosition(...)*

**Variable**: *.verticalScrollPosition*

**Counterpart**: *[guiMemoSetVerticalScrollPosition](mta://scripting/client/functions/guimemosetverticalscrollposition.md)*

### Required Arguments

- **theMemo**: the [memo](mta://scripting/client/functions/guicreatememo.md) you want to know the vertical scroll position of.

### Returns

Returns a [float](mta://reference/misc/float.md) ranging between 0 and 100, or **false** otherwise.

## Example

This example gets the position of a memo called "theMemo" created with [guiCreateMemo](mta://scripting/client/functions/guicreatememo.md), and outputs it to the chatbox.
