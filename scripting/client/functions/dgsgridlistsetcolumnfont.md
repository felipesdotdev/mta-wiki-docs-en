---
doc_id: "mta-wiki:11189"
title: "DgsGridListSetColumnFont"
source_title: "DgsGridListSetColumnFont"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListSetColumnFont"
revision_id: 62090
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:33.331658+00:00"
---

# DgsGridListSetColumnFont

This function is used to set the font of a dgs gridlist column.

## Syntax

```
bool dgsGridListSetColumnFont( element dgsGridlist, int columnIndex, dx-font/string font [, affectRow = false ] )
```

### Required Arguments

- **dgsGridlist:** The dgs grid list you want to set the column font to

- **columnIndex:** Column ID

- **font:** The font that can be dx-font and string

### Optional Arguments

- **affectRow:** A bool indicates whether this operation will apply on rows or not.
...
column = DGS:dgsGridListAddColumn(list, "New column", 0.9) -- Create a new column in the grid list
DGS:dgsGridListSetColumnFont(list, column, "default-bold")
```
