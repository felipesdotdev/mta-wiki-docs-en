---
doc_id: "mta-wiki:9948"
title: "DgsDeleteTab"
source_title: "DgsDxDeleteTab"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxDeleteTab"
revision_id: 53883
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:13.972279+00:00"
---
...
```
bool dgsDeleteTab ( element tabToDelete )
```
...
This example remove a tab panel

```
DGS = exports.dgs
matab = {}
matab[1] = DGS:dgsCreateTabPanel (0.22, 0.19, 0.56, 0.63,true)
matab[2] = DGS:dgsCreateTab("Main",matab[1])
matab[3] = DGS:dgsCreateTab("Rules",matab[1])
matab[4] = DGS:dgsCreateTab("FAQ",matab[1])
matab[5] = DGS:dgsCreateTab("About Us",matab[1])

use = false
addCommandHandler("Delete",function (cmd,player)
	if use == false then 
		use = true
		for i = 2, 4 do 
			DGS:dgsDeleteTab(matab[i])
		end 
	end
end)
```
