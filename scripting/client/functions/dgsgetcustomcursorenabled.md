---
doc_id: "mta-wiki:12770"
title: "DgsGetCustomCursorEnabled"
source_title: "DgsGetCustomCursorEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGetCustomCursorEnabled"
revision_id: 69739
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:11.550779+00:00"
---

# DgsGetCustomCursorEnabled

This function gets whether the custom cursor of DGS is enabled or not.

## Syntax

```
bool dgsGetCustomCursorEnabled ()
```

### Returns

Returns *true* if custom cursor is enabled, *false* otherwise
...
outputChatBox("DGS Custom Cursor is ".. (DGS:dgsGetCustomCursorEnabled() and "Enabled" or "Disabled")) --Disabled by default
```
