---
doc_id: "mta-wiki:11756"
title: "Dgs3DInterfaceGetAttachedOffsets"
source_title: "Dgs3DInterfaceGetAttachedOffsets"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DInterfaceGetAttachedOffsets"
revision_id: 68269
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:29.710685+00:00"
---

# Dgs3DInterfaceGetAttachedOffsets

This function gets the attached offsets of the attached dgs 3d interface.

## Syntax

```
float, float, float, float, float, float dgs3DInterfaceGetAttachedOffsets( element dgsElement )
```

### Required Arguments

- **dgsElement:** The DGS 3D interface of which you wish to get the attached offset.

### Returns

Returns 6 floats indicates offset x,y,z and face to x,y,z if successful, *false* otherwise.
...
function panelPosition()
	...
	local offX,offY,offZ,offFaceX,offFaceY,offFaceZ = DGS:dgs3DInterfaceGetAttachedOffsets(material)
	outputChatBox("Offset X:"..offX)
	outputChatBox("Offset Y:"..offY)
	outputChatBox("Offset Z:"..offZ)
	outputChatBox("Offset Face To X:"..offFaceX)
	outputChatBox("Offset Face To Y:"..offFaceY)
	outputChatBox("Offset Face To Z:"..offFaceZ)
end
```
