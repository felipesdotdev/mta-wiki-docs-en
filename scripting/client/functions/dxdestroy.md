---
doc_id: "mta-wiki:12139"
title: "DxDestroy"
source_title: "DxDestroy"
source_url: "https://wiki.multitheftauto.com/wiki/DxDestroy"
revision_id: 65547
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:43.775889+00:00"
---

# DxDestroy

This function destroys a DxElement.

## Syntax

```
bool dxDestroy ( DxElement dxElement )
```

**OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**: *DxElement:destroy(...)*

### Required Arguments

- **dxElement:** element you wish to destroy

### Returns

Returns true if the DxElement was destroyed, false otherwise
