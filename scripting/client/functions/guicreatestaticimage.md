---
doc_id: "mta-wiki:2683"
title: "GuiCreateStaticImage"
source_title: "GuiCreateStaticImage"
source_url: "https://wiki.multitheftauto.com/wiki/GuiCreateStaticImage"
revision_id: 78484
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:15:33.577765+00:00"
---
...
```
element guiCreateStaticImage ( float x, float y, float width, float height, string path, [ bool relative = false, gui-element parent = nil] )
```

**OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**: *[GuiStaticImage](mta://scripting/concepts/element-gui-static-image.md)(...)*
...
- **path:** The [filepath](mta://reference/misc/filepath.md) of the image file that is being loaded.
...
Returns [element](mta://reference/misc/element.md) if image was created successfully, *false* otherwise.
...
In this example [Meta.xml](mta://reference/misc/meta-xml.md) is used to tell the server which files it will be using.
