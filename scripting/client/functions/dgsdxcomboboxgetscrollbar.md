---
doc_id: "mta-wiki:9974"
title: "DgsComboBoxGetScrollBar"
source_title: "DgsDxComboBoxGetScrollBar"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxComboBoxGetScrollBar"
revision_id: 78882
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:20.785360+00:00"
---

# DgsComboBoxGetScrollBar

This function gets the scroll bar of dgs combo box.

## Syntax

```
element dgsComboBoxGetScrollBar( element comboBox )
```

### Required Arguments

- **comboBox:** The dgs combo box element to be got from.

### Returns

Returns a dgs-dxscrollbar if successful, *false* otherwise.
...
function clientsideResourceStart ()
	...
	-- Get the Scroll Bar
	local scrollBar = DGS:dgsComboBoxGetScrollBar( combobox )
	DGS:dgsSetElementAlpha(scrollBar,0)
end
