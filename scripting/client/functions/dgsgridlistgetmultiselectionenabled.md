---
doc_id: "mta-wiki:10166"
title: "DgsGridListGetMultiSelectionEnabled"
source_title: "DgsGridListGetMultiSelectionEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGridListGetMultiSelectionEnabled"
revision_id: 54947
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:26.580293+00:00"
---

# DgsGridListGetMultiSelectionEnabled

This function checks whether the multi-selecting mode is enabled.

## Syntax

```
bool dgsGridListGetMultiSelectionEnabled( element gridlist )
```
...
- **gridlist:** The grid list that you want to get the state from.

### Returns

Returns a bool value indicates whether the multi-selecting mode is enabled, false otherwise.
...
function clientsideResourceStart ()
	...
	local state = DGS:dgsGridListGetMultiSelectionEnabled(gridlist)
	for i=1,50 do
		local row = DGS:dgsGridListAddRow(gridlist)
		DGS:dgsGridListSetItemText(gridlist,row,1,tostring(i).." DGS Test")
	end
	outputChatBox("Multi Selection: "..(state and "enabled" or "disabled")) --default is disabled
	showCursor ( true )
end
