---
doc_id: "mta-wiki:12492"
title: "DgsMemoGetMaxLength"
source_title: "DgsMemoGetMaxLength"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoGetMaxLength"
revision_id: 67364
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:57.497164+00:00"
---

# DgsMemoGetMaxLength

This function gets the maximum text length that can be typed into a memo.

## Syntax

```
bool dgsMemoGetMaxLength ( element theElement )
```

### Required Arguments

- **theElement:** The dgs-dxmemo to be got.
...
outputChatBox("Max Length: "..DGS:dgsMemoGetMaxLength( memo ))
```
