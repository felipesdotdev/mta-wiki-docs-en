---
doc_id: "mta-wiki:14238"
title: "DgsEditAutoCompleteAddParameterFunction"
source_title: "DgsEditAutoCompleteAddParameterFunction"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEditAutoCompleteAddParameterFunction"
revision_id: 78881
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:58.802979+00:00"
---

# DgsEditAutoCompleteAddParameterFunction

This function adds the advanced usage of dgs edit auto complete, which can be used as dynamic auto complete.

## Syntax

```
bool dgsEditAutoCompleteAddParameterFunction( string parameterType, string functionCode )
```

### Required Arguments

- **parameterType:** A string of the parameter type you want to attach.

- **functionCode :** A string of the function that you want to execute.
...
edit = DGS:dgsCreateEdit(400,700,200,50,"",false)

DGS:dgsEditAddAutoComplete(edit,{"cmd","<player>"},true,true)

DGS:dgsEditAutoCompleteAddParameterFunction("<player>",[[
	local input = ...
	for i,player in ipairs(getElementsByType("player")) do
		if input == getPlayerName(player):sub(1,#input) then
