---
doc_id: "mta-wiki:13162"
title: "DgsImageGetNativeSize"
source_title: "DgsImageGetNativeSize"
source_url: "https://wiki.multitheftauto.com/wiki/DgsImageGetNativeSize"
revision_id: 70785
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:42.704273+00:00"
---

# DgsImageGetNativeSize

This function gets the size of the texture that is loaded in DGS image.

## Syntax

```
int, int dgsImageGetNativeSize( element dgsImage )
```

### Required Arguments

- **dgsImage**: The DGS image of which you want to get the native size.

### Returns

Returns the two *integer* indicates the width and height of the size of the texture that is loaded in DGS image, *false* otherwise.
...
local width,height = DGS:dgsImageGetNativeSize(image,false)
