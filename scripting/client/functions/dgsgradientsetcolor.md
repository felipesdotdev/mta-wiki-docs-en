---
doc_id: "mta-wiki:14193"
title: "DgsGradientSetColor"
source_title: "DgsGradientSetColor"
source_url: "https://wiki.multitheftauto.com/wiki/DgsGradientSetColor"
revision_id: 78586
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:19.142149+00:00"
---

# DgsGradientSetColor

This function sets the color of the dgs gradient plugin.

## Syntax

```
bool dgsGradientSetColor( element gradShader, int colorFrom, int colorTo )
```

### Required Arguments

- **gradShader:** The dgs gradient you want to set.
...
-- Create A Button
img = DGS:dgsCreateImage( 0.7, 0.1, 0.2, 0.1, gradient, true )

-- Change Color
DGS:dgsGradientSetColor(tocolor(10,10,10,255),tocolor(100,10,10,255))
```
