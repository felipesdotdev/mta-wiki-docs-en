---
doc_id: "mta-wiki:12438"
title: "DgsSelectorSetSelectedItem"
source_title: "DgsSelectorSetSelectedItem"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorSetSelectedItem"
revision_id: 67050
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:28.484155+00:00"
---

# DgsSelectorSetSelectedItem

This function sets the selected item from a dgs selector.

## Syntax

```
bool dgsSelectorSetSelectedItem( element selector, int item )
```

### Required Arguments

- **selector:** the dgs selector you want to select an item from

- **item:** the item you want to select.
...
This example creates a DGS selector and set item to 8.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
    ...
    DGS:dgsSelectorSetSelectedItem(selector, 8)
