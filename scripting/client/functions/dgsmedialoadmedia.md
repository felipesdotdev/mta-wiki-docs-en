---
doc_id: "mta-wiki:10723"
title: "DgsMediaLoadMedia"
source_title: "DgsMediaLoadMedia"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMediaLoadMedia"
revision_id: 82413
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:54.462236+00:00"
---

# DgsMediaLoadMedia

This function is for loading Video/Audio/Image to a Media Browser ([dgsCreateMediaBrowser](mta://scripting/client/functions/dgscreatemediabrowser.md)) element.
...
```
element dgsMediaLoadMedia ( element media, string path, string theType )
```

### Required Arguments

- **media:** The element media that you want to load the media into it.

- **path:** Path to the media file that you want to load.

- **theType:** Type of the media file you want to load, available values are:
...
- **imagedata:** Image raw data.

### Returns

Returns true if media loaded, false otherwise.
