---
doc_id: "mta-wiki:9917"
title: "DgsEditSetTextFilter"
source_title: "DgsDxEditSetWhiteList"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxEditSetWhiteList"
revision_id: 75241
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:05.758027+00:00"
---

# DgsEditSetTextFilter

This function sets the text filter of edit text. Text Filter in edit means every character of the text should meet the requirement of the filter, or the characters will be cut.

## Syntax

```
bool dgsEditSetTextFilter( element edit, string filter )
```
...
- **filter:** the pattern (refer to lua pattern).
...
DGS:dgsEditSetTextFilter(edit ,"[^a-zA-Z0-9$]") --This regular expression set a restrict that the character of text allowed is from "a" to "z", "A" to "Z" and 0 to 9
```
