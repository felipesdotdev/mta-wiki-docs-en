---
doc_id: "mta-wiki:10788"
title: "DgsSetAttachTranslation"
source_title: "DgsSetAttachTranslation"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSetAttachTranslation"
revision_id: 68251
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:29.135708+00:00"
---

# DgsSetAttachTranslation

This function allows following dgs element to attach to translation table when creating **in the same resource**.

This is not **client-global** setting, only **resource-global**.

| [[{{{image}}}\|link=\|]] | Note: This function is different from dgsAttachToTranslation . See detail information in example |
| --- | --- |
|  |  |
...
```
bool dgsSetAttachTranslation( string name )
```
...
DGS:dgsSetAttachTranslation("EN")  --DGS Elements created after this function will be automatically attached to translation table "EN"
local login = DGS:dgsCreateButton(200,200,200,100,{"login"},false)  --It is unnecessary to use dgsAttachToTranslation again
local register= DGS:dgsCreateButton(500,200,200,100,{"register "},false)  
DGS:dgsSetAttachTranslation()  --Reset
```
