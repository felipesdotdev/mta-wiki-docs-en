...
generated_at: "2026-07-26T16:16:42.684353+00:00"
---

# SetPedExitVehicle

This function makes a [ped](mta://reference/misc/ped.md) exit a [vehicle](mta://reference/misc/vehicle.md), similar to the enter_exit control state.
...
- **thePed:** The [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) to exit the vehicle.
