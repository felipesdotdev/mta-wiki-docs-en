---
doc_id: "mta-wiki:13641"
title: "DgsComboBoxGetItemData"
source_title: "DgsComboBoxGetItemData"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetItemData"
revision_id: 74422
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:03.319156+00:00"
---
...
```
mixed dgsComboBoxGetItemData ( element combobox, int itemIndex )
```
...
Returns the item data of the specified item, *false* otherwise.

## Example

This example displays a random item data from the combobox.
...
function clientsideResourceStart ()
    ...
    outputChatBox ( "My combobox item data: " .. myItemData )
end
...
```
mixed dgsComboBoxGetItemData ( element combobox, int itemIndex, mixed key )
```
...
- **key:** the key you wish to retrieve the data with.
...
function clientsideResourceStart ()
    ...
    local item = DGS:dgsComboBoxAddItem ( numberList )
    local myItem = DGS:dgsComboBoxSetItemText ( numberList, item, tostring( math.random(0, 10) ^ 100 ) )
    DGS:dgsComboBoxSetItemData( numberList, item, "myKey", "Test" )
    local myItemData = DGS:dgsComboBoxGetItemData( numberList, item, "myKey" )
    outputChatBox ( "My combobox item data: " .. myItemData )
end
addEventHandler ( "onClientResourceStart", resourceRoot, clientsideResourceStart )
```
