---
doc_id: "mta-wiki:12281"
title: "DgsRoundRectGetBorderOnly"
source_title: "DgsRoundRectGetBorderOnly"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectGetBorderOnly"
revision_id: 66296
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:14.421381+00:00"
---

# DgsRoundRectGetBorderOnly

This function gets whether the round rectangle is border only ( unfilled ).

## Syntax

```
bool dgsRoundRectGetBorderOnly( element rndRect )
```
...
Returns *true* if the round rectangle is unfilled, *false* otherwise.
...
local rndRect = DGS:dgsCreateRoundRect(5,false,tocolor(0,0,0,150), nil, nil, false)  --Create Rounded Rectangle with 5 pixels radius and border only
...
iprint(DGS:dgsRoundRectGetBorderOnly(rndRect)) -- output true into debugscript
```
