---
doc_id: "mta-wiki:12154"
title: "DgsCreateSwitchButton"
source_title: "DgsCreateSwitchButton"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCreateSwitchButton"
revision_id: 69007
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:12:23.272651+00:00"
---
...
```
element dgsCreateSwitchButton( float x, float y, float width, float height [, string textOn = "", string textOff = "", bool state = false, bool relative = false, element parent = nil, int textColorOn = 0x5AA0E6FF, int textColorOff = 0x3C3C3CFF, float scaleX = 1, float scaleY = 1 ] )
```
...
Returns an [element](mta://reference/misc/element.md) of the created [Switch Button](mta://reference/misc/dgs-dxswitchbutton.md) if it was successfully created, *false* otherwise.
