---
doc_id: "mta-wiki:13691"
title: "DxGridListRemoveColumn"
source_title: "DxGridListRemoveColumn"
source_url: "https://wiki.multitheftauto.com/wiki/DxGridListRemoveColumn"
revision_id: 74652
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:50.051097+00:00"
---

# DxGridListRemoveColumn

Esta función sirve para remover una columna de una [dxGridList](mta://scripting/client/functions/dxgridlist.md).
...
```
bool dxGridListRemoveColumn( element element, string name )
```
...
- **name**: El nombre de la columna a eliminar.
...
dxGridListRemoveColumn(lista, 'Dueño')
```
