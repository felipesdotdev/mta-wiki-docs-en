---
doc_id: "mta-wiki:13383"
title: "DgsCircleGetRadius"
source_title: "DgsCircleGetRadius"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCircleGetRadius"
revision_id: 72885
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:55.300598+00:00"
---

# DgsCircleGetRadius

This function gets the outside/inside radius from the dgs circle.

## Syntax

```
float,float dgsCircleGetRadius( element circle )
```
...
Returns a two *float*s indicate outside/inside radius.
...
local outsideRadius,insideRadius = DGS:dgsCircleGetRadius(c)
outputChatBox("Outside:"..outsideRadius.."; Inside:"..insideRadius)
```
