---
doc_id: "mta-wiki:2682"
title: "GuiCreateRadioButton"
source_title: "GuiCreateRadioButton"
source_url: "https://wiki.multitheftauto.com/wiki/GuiCreateRadioButton"
revision_id: 78483
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:15:33.354384+00:00"
---

# GuiCreateRadioButton

This function creates a [radio button](mta://scripting/concepts/element-gui-radio-button.md).

## Syntax

```
element guiCreateRadioButton ( float x, float y, float width, float height, string text, [ bool relative = false, gui-element parent = nil ] )
```

**OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**: *[GuiRadioButton](mta://scripting/concepts/element-gui-radio-button.md)(...)*
...
Returns [element](mta://reference/misc/element.md) of the radio button if it was created succesfully, *false* otherwise.
