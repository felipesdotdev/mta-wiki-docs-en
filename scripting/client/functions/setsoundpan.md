...
generated_at: "2026-07-26T16:16:44.949373+00:00"
---

# SetSoundPan

This function is used to change the pan level of the specified [sound](mta://reference/misc/sound.md) element.
...
**Method**: *[sound](mta://reference/misc/sound.md):setPan(...)*
...
- **theSound:** The [sound](mta://reference/misc/sound.md) element which pan you want to modify.
...
Returns *true* if the [sound](mta://reference/misc/sound.md) element pan was successfully changed, *false* otherwise.
