---
doc_id: "mta-wiki:10093"
title: "DgsMemoClearText"
source_title: "DgsMemoClearText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoClearText"
revision_id: 54651
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:55.929986+00:00"
---

# DgsMemoClearText

This function clears the whole text of the memo.

## Syntax

```
bool dgsMemoClearText ( element theElement )
```

### Required Arguments

- **theElement:** The memo to be cleared.
...
setTimer(function()
	DGS:dgsMemoClearText(memo) --Now it is cleared.
end,500,10)
```
