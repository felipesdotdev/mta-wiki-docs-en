---
doc_id: "mta-wiki:12874"
title: "DgsSelectorSetItemText"
source_title: "DgsSelectorSetItemText"
source_url: "https://wiki.multitheftauto.com/wiki/DgsSelectorSetItemText"
revision_id: 69746
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:28.184547+00:00"
---

# DgsSelectorSetItemText

This function changes the text of a dgs selector item.

## Syntax

```
bool dgsSelectorSetItemText ( element selector, int itemId, string/number text )
```

### Required Arguments

- **selector:** the dgs selector containing the item you're interested in
...
addCommandHandler("setText",function(cmd, text)
	local item = DGS:dgsSelectorGetSelectedItem(selector)
	if item ~= -1 then
		DGS:dgsSelectorSetItemText(selector, item, text)
	end
end)
```
