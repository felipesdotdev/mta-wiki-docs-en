---
doc_id: "mta-wiki:9938"
title: "DgsMemoGetReadOnly"
source_title: "DgsDxMemoGetReadOnly"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoGetReadOnly"
revision_id: 53572
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:11.456552+00:00"
---

# DgsMemoGetReadOnly

This function allows you to get read-only status for a dgs memo.

## Syntax

```
bool dgsMemoGetReadOnly ( element memo )
```

### Required Arguments

- **memo:** The dgs-dxmemo that you want to get.

### Returns

Returns a boolean value of the read-only status of the dgs memo.
...
function createAdvert( )
	...
	outputChatBox("The memo is"..(dgsMemoGetReadOnly ( advert ) and " not" or "") .." editable")
