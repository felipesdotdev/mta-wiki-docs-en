---
doc_id: "mta-wiki:10189"
title: "DgsIsAniming"
source_title: "DgsIsAniming"
source_url: "https://wiki.multitheftauto.com/wiki/DgsIsAniming"
revision_id: 55240
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:45.135768+00:00"
---

# DgsIsAniming

This function allow us to check whether the dgs element is being animated [dgsAnimTo](mta://scripting/client/functions/dgsanimto.md).

## Syntax

```
table dgsIsAniming ( element dgsElement )
```
...
setTimer(function()
	if DGS:dgsIsAniming(parent) then
