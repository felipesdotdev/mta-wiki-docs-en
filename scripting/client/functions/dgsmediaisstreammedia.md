...
generated_at: "2026-07-26T16:13:54.234399+00:00"
---
...
- **media:** The media browser that you want to check.

### Returns

Returns true if the the media browser has already loaded a media source, *false* otherwise.
...
if dgsMediaIsStreamMedia(browser) then
    outputChatBox("There is a media source loaded")
else
    outputChatBox("No media source loaded")
end
```
