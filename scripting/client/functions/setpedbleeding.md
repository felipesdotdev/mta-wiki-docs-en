---
doc_id: "mta-wiki:13340"
title: "SetPedBleeding"
source_title: "SetPedBleeding"
source_url: "https://wiki.multitheftauto.com/wiki/SetPedBleeding"
revision_id: 81310
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:16:42.299789+00:00"
---

# SetPedBleeding

This function allows you to set [player's](mta://reference/misc/player.md) or [ped's](mta://reference/misc/ped.md) bleeding effect.
...
**Method**: *[ped](mta://reference/misc/ped.md):setBleeding(...)*

**Variable**: *.bleeding*

**Counterpart**: *[isPedBleeding](mta://scripting/client/functions/ispedbleeding.md)*

### Required Arguments

- **thePed:** The [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) whose bleeding effect you want to set of.

- **bleeding:** [Boolean](mta://reference/misc/boolean.md) specifying whether the player or ped is bleeding or not.
