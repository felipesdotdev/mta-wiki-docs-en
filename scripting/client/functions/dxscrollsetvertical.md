---
doc_id: "mta-wiki:14440"
title: "DxScrollSetVertical"
source_title: "DxScrollSetVertical"
source_url: "https://wiki.multitheftauto.com/wiki/DxScrollSetVertical"
revision_id: 80656
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:51.122569+00:00"
---

# DxScrollSetVertical

Esta funcion modifica el estilo de posición de la barra de desplazamiento creada [dxScroll](mta://scripting/client/functions/dxscroll.md).
...
```
bool dxScrollSetVertical(element element, bool valorSet)
```

### Argumentos requeridos

- **element**: La [dxScroll](mta://scripting/client/functions/dxscroll.md) creada.

- **valorSet**: un valor [booleano](https://wiki.multitheftauto.com/wiki/Boolean) que representa si el elemento va a ser vertical o no.
...
-- Ej: Scroll Estilo Horizontal
scrollH = dxScroll(302, 317, 317, false, false, true)

-- Asignamos la función actual para aplicarlo.
dxScrollSetVertical(scrollV, true) -- Activo
dxScrollSetVertical(scrollV, false) -- Desactivado
```
