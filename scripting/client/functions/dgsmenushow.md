---
doc_id: "mta-wiki:14565"
title: "DgsMenuShow"
source_title: "DgsMenuShow"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMenuShow"
revision_id: 82169
language: "en"
categories: ["Client_functions", "Utility_templates"]
generated_at: "2026-07-26T16:14:05.060642+00:00"
---

# DgsMenuShow

This function is for showing a DGS menu.

For create [Dgs](mta://reference/misc/dgs.md) menu use [dgsCreateMenu](mta://scripting/client/functions/dgscreatemenu.md).

## Syntax

```
element dgsMenuShow( element dgsMenu [, float x, float y ] )
```

### Required Arguments

- **dgsMenu:** the DGS menu to showing

### Optional Arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](mta://reference/misc/optional-arguments--f0d8694a.md).

- **x:** A float of the 2D x position of the DGS menu on a player's screen.

- **y:** A float of the 2D y position of the DGS menu on a player's screen.
