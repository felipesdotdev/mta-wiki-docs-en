---
doc_id: "mta-wiki:9717"
title: "DgsIsSizing"
source_title: "DgsIsSizing"
source_url: "https://wiki.multitheftauto.com/wiki/DgsIsSizing"
revision_id: 53826
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:46.458262+00:00"
---

# DgsIsSizing

This function allow us to check whether the size of dgs element is being changed by [dgsSizeTo](mta://scripting/client/functions/dgssizeto.md).

## Syntax

```
table dgsIsSizing ( element dgsElement )
```
...
setTimer(function()
	if DGS:dgsIsSizing(parent) then
