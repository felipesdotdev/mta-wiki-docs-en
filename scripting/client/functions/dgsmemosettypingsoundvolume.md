---
doc_id: "mta-wiki:13245"
title: "DgsMemoSetTypingSoundVolume"
source_title: "DgsMemoSetTypingSoundVolume"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMemoSetTypingSoundVolume"
revision_id: 71388
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:03.846599+00:00"
---

# DgsMemoSetTypingSoundVolume

This function changes the volume of the typing sound to a dgs memo.

## Syntax

```
bool dgsMemoSetTypingSoundVolume( element memo, number volume )
```

### Required Arguments

- **memo:** The dgs-dxmemo you want to set.

- **volume:** A floating point number representing the desired typing sound volume level. Range is from 0.0 to 1.0. This can go above 1.0 for amplification.
...
DGS:dgsMemoSetTypingSound(memo,"test.wav") --You can add a sound file for test
DGS:dgsMemoSetTypingSoundVolume(memo,0.5) --Lower
```
