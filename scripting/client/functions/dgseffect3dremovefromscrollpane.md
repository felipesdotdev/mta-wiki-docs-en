---
doc_id: "mta-wiki:11915"
title: "DgsEffect3DRemoveFromScrollPane"
source_title: "DgsEffect3DRemoveFromScrollPane"
source_url: "https://wiki.multitheftauto.com/wiki/DgsEffect3DRemoveFromScrollPane"
revision_id: 64877
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:09.148204+00:00"
---

# DgsEffect3DRemoveFromScrollPane

This function removes dgs effect 3d from a scroll pane if existing.

## Syntax

```
bool dgsEffect3DRemoveFromScrollPane( element scrollpane )
```

### Required Arguments

- **scrollpane:** A dgs-dxscrollpane element to remove from.
...
effect3d = dgsCreateEffect3D(20)  --Create the 3D effect plugin
sp = dgsCreateScrollPane(300,300,500,500,false)  --Create a scroll pane
img = dgsCreateImage(0,0,1,1,_,true,sp,tocolor(0,0,0,180))  --Create an image
...
setTimer(function()
	dgsEffect3DRemoveFromScrollPane(sp) --Remove
end,1000,1)
```
