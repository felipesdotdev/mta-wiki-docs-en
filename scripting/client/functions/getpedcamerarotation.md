...
generated_at: "2026-07-26T16:15:17.009027+00:00"
---
...
This function gets the current camera rotation of a [ped](mta://reference/misc/ped.md).
...
**Method**: *[ped](mta://reference/misc/ped.md):getCameraRotation(...)*
...
- **thePed:** the [ped](mta://reference/misc/ped.md) to retrieve the camera rotation of.

### Returns

Returns the camera rotation of the [ped](mta://reference/misc/ped.md) in degrees if successful. Returns *false* if an invalid element was passed.
