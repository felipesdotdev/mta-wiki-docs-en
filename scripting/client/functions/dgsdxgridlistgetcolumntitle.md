---
doc_id: "mta-wiki:9896"
title: "DgsGridListGetColumnTitle"
source_title: "DgsDxGridListGetColumnTitle"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxGridListGetColumnTitle"
revision_id: 53430
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:59.757117+00:00"
---

# DgsGridListGetColumnTitle

This function is used to get the column title of a dgs gridlist column.

## Syntax

```
string dgsGridListGetColumnTitle( element dgsGridlist, int columnIndex )
```

### Required Arguments

- **dgsGridlist**: The dgs grid list you want to get the column title from
...
function getColumnTitle()
	local columnTitle = DGS:dgsGridListGetColumnTitle(list,column) 
