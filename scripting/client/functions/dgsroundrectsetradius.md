---
doc_id: "mta-wiki:11242"
title: "DgsRoundRectSetRadius"
source_title: "DgsRoundRectSetRadius"
source_url: "https://wiki.multitheftauto.com/wiki/DgsRoundRectSetRadius"
revision_id: 77578
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:14:16.731976+00:00"
---

# DgsRoundRectSetRadius

This function sets the radius of the corner of the dgs rounded rectangle.

## Syntax

```
bool dgsRoundRectSetRadius( element rndRect, float radius [, bool isRelative = true] )
```
...
- **radius:** A float of the relative radius of corner of the rounded rectangle ranges from 0 to 1 with **isRelative** *false*, or specified by absolute pixels .

- **isRelative:** A bool indicated whether the radius is relative to the size.
...
local texture = dxCreateTexture("example.png")
...
DGS:dgsRoundRectSetRadius(rndRect,25)  --Change the radius
```
