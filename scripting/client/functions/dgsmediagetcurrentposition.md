---
doc_id: "mta-wiki:12368"
title: "DgsMediaGetCurrentPosition"
source_title: "DgsMediaGetCurrentPosition"
source_url: "https://wiki.multitheftauto.com/wiki/DgsMediaGetCurrentPosition"
revision_id: 66711
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:53.177215+00:00"
---

# DgsMediaGetCurrentPosition

This function gets the position of the loaded media.

## Syntax

```
int dgsMediaGetCurrentPosition( element multiMediaBrowser )
```

### Required Arguments

- **multiMediaBrowser :** The multi media browser you want to operate.

### Returns

Returns a float representing the *current time* in seconds of the media, or false if the position could not be retrieved.
...
addEventHandler("onDgsMediaLoaded", browser, function() -- on loaded
    outputChatBox("Position: "..dgsMediaGetCurrentPosition(browser))
end)
```
