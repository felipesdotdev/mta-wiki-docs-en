---
doc_id: "mta-wiki:12236"
title: "DgsComboBoxGetEditEnabled"
source_title: "DgsComboBoxGetEditEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/DgsComboBoxGetEditEnabled"
revision_id: 66056
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:01.943795+00:00"
---

# DgsComboBoxGetEditEnabled

This function allows you to get whether combobox editable.

## Syntax

```
bool dgsComboBoxGetEditEnabled( element comboBox )
```

### Required Arguments

- **comboBox:** The dgs combo box that you are interested in.

### Returns

Returns *true* if combo box field is editable, *false* otherwise.
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	...
	DGS:dgsComboBoxSetEditEnabled(combobox, true) -- set edit to true
	print(DGS:dgsComboBoxGetEditEnabled(qiw)) -- output true into debugscript
end)
```
