---
doc_id: "mta-wiki:11739"
title: "DgsCreateEffect3D"
source_title: "DgsCreateEffect3D"
source_url: "https://wiki.multitheftauto.com/wiki/DgsCreateEffect3D"
revision_id: 67307
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:12:16.775735+00:00"
---

# DgsCreateEffect3D

This function creates a 3d effect for scroll pane.

## Syntax

```
element dgsCreateEffect3D( float rotateFactor )
```

 

Example Effect 3D Plugin (Contributor: Allerek)

### Required Arguments

- **rotateFactor:** A float of the rotation factor when moving mouse (Setting to 0 makes the effect 3d static. Setting to 180 makes the effect 3d turn 180 degrees when mouse moves to the left edge of the scroll pane).

### Returns

Returns a dgs-dxeffect3d element (DGS Plugin Type)[ shader (Element Type) ] if succeed, *false* otherwise
...
DGS:dgsEffect3DApplyToScrollPane(effect3d,sp)  --Apply the plugin to scroll pane
