---
doc_id: "mta-wiki:11208"
title: "Dgs3DTextSetAttachedOffsets"
source_title: "Dgs3DTextSetAttachedOffsets"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs3DTextSetAttachedOffsets"
revision_id: 62139
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:11:43.107670+00:00"
---

# Dgs3DTextSetAttachedOffsets

This function sets the attached offsets of the attached DGS 3D Text

## Syntax

```
bool dgs3DTextSetAttachedOffsets( element text3D [, float offsetX = 0, float offsetY = 0, float offsetZ = 0 ] )
```
...
- **offsetX:** A float of the attach offset X.

- **offsetY:** A float of the attach offset Y.

- **offsetZ:** A float of the attach offset Z.
...
DGS:dgs3DTextSetAttachedOffsets(text,1,0,0)
```
