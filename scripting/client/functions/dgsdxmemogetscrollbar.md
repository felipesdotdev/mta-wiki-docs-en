---
doc_id: "mta-wiki:9934"
title: "DgsMemoGetScrollBar"
source_title: "DgsDxMemoGetScrollBar"
source_url: "https://wiki.multitheftauto.com/wiki/DgsDxMemoGetScrollBar"
revision_id: 53563
language: "en"
categories: ["Client_functions"]
generated_at: "2026-07-26T16:13:10.401774+00:00"
---

# DgsMemoGetScrollBar

This function gets two scroll bars of dgs memo.

## Syntax

```
table dgsMemoGetScrollBar( element memo )
```

### Required Arguments

- **memo:** The dgs memo element to be got from.

### Returns

Returns a table which includes two scroll bars if scroll bars are got successfully, *false* otherwise.
...
function clientsideResourceStart ()
	...
	local testMemo = DGS:dgsCreateMemo ( 0.45, 0.45, 0.15, 0.15, "", true ) 
	-- Get the Scroll Bar
	local scrollBars = DGS:dgsMemoGetScrollBar( testMemo )
	DGS:dgsSetVisible(scrollBars[1],true)
end
