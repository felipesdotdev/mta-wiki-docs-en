---
doc_id: "mta-wiki:14398"
title: "ResetTimeFrozen"
source_title: "ResetTimeFrozen"
source_url: "https://wiki.multitheftauto.com/wiki/ResetTimeFrozen"
revision_id: 80044
language: "en"
categories: ["Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:16:33.690407+00:00"
---
...
This function unfreezes time frozen using [setTimeFrozen](mta://scripting/client/functions/settimefrozen.md). This is equivalent to using [setTimeFrozen](mta://scripting/client/functions/settimefrozen.md) to false.

## Syntax

```
bool resetTimeFrozen( )
```
...
This example let you to unfreeze time
