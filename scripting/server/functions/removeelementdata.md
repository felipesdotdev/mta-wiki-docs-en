---
doc_id: "mta-wiki:3648"
title: "RemoveElementData"
source_title: "RemoveElementData"
source_url: "https://wiki.multitheftauto.com/wiki/RemoveElementData"
revision_id: 80362
language: "en"
categories: ["Server_functions"]
generated_at: "2026-07-26T16:16:32.213314+00:00"
---

# RemoveElementData

This function removes the [element data](mta://reference/misc/element-data--975d1ea3.md) with the given key for that element. The element data removal is synced with all the clients.
...
**Method**: *[element](mta://reference/misc/element.md):removeData(...)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) you wish to remove the data from.
