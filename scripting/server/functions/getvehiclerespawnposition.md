...
generated_at: "2026-07-26T16:15:28.761479+00:00"
---

# GetVehicleRespawnPosition

This function retrieves the respawn coordinates of a [vehicle](mta://reference/misc/vehicle.md).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getRespawnPosition(...)*
...
- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) which you'd like to retrieve the respawn coordinates of.

### Returns

Returns three [floats](mta://reference/misc/float.md) indicating the respawn coordinates of the [vehicle](mta://reference/misc/vehicle.md), *x*, *y* and *z* respectively.
