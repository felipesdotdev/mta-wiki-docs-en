...
generated_at: "2026-07-26T16:16:40.582416+00:00"
---

# SetElementSyncer

This function can be used to change the syncer ([player](mta://reference/misc/player.md)) of an element. The syncer is the player who is responsible for informing the server about the state of that element - it's position, orientation and other state information. The function can be also used to remove an element's syncer.

Only [vehicle](mta://reference/misc/vehicle.md) and [ped](mta://reference/misc/ped.md) elements can have a syncer, other element types are not currently automatically synced by MTA.
...
- **thePlayer:** The [player](mta://reference/misc/player.md) who should be the new syncer of the element. If set to *false*, this element will not have a syncer. If set to *true*, MTA will pick automatically the nearest or most relevant player to that element.
