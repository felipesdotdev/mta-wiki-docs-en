...
generated_at: "2026-07-26T16:16:32.242974+00:00"
---

# RemoveElementDataSubscriber

This function unsubscribes a [player](mta://reference/misc/player.md) from specific [element data](mta://reference/misc/element-data--975d1ea3.md).
...
- **theElement:** The [element](mta://reference/misc/element.md) you wish to unsubscribe the [player](mta://reference/misc/player.md) from.

- **key:** The key you wish to unsubscribe the player from.

- **thePlayer:** The [player](mta://reference/misc/player.md) you wish to unsubscribe.
