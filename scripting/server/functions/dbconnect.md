...
generated_at: "2026-07-26T16:11:32.096087+00:00"
---
...
**Method**: *[Connection](mta://reference/misc/connection.md)(...)*
...
Under certain platforms, for example on Unix-based OSes like Linux, using this function could fail with a debug warning containing "[Could not connect]" accompanied by a prior debug error explaining the problem. In that case you should check the [Server Manual](mta://getting-started/server-manual--68626fb4.md) to see if you have missed any recommended (best-effort) steps for server set-up.
