---
doc_id: "mta-wiki:3307"
title: "RespawnVehicle"
source_title: "RespawnVehicle"
source_url: "https://wiki.multitheftauto.com/wiki/RespawnVehicle"
revision_id: 80450
language: "en"
categories: ["Server_functions"]
generated_at: "2026-07-26T16:16:34.695779+00:00"
---

# RespawnVehicle

This function respawns a vehicle according to its set respawn position, set by [setVehicleRespawnPosition](mta://scripting/server/functions/setvehiclerespawnposition.md) or the position and rotation it was created on. To spawn a vehicle to a specific location just once, [spawnVehicle](mta://scripting/server/functions/spawnvehicle.md) can be used.
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):respawn(...)*
