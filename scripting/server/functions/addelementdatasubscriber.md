...
generated_at: "2026-07-26T16:10:20.579694+00:00"
---

# AddElementDataSubscriber

This function subscribes a [player](mta://reference/misc/player.md) to specific [element data](mta://reference/misc/element-data--975d1ea3.md).
...
- **theElement:** The [element](mta://reference/misc/element.md) you wish to subscribe the [player](mta://reference/misc/player.md) to.

- **key:** The key you wish to subscribe the player to.

- **thePlayer:** The [player](mta://reference/misc/player.md) you wish to subscribe.
