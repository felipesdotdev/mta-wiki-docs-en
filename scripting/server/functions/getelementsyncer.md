---
doc_id: "mta-wiki:4415"
title: "GetElementSyncer"
source_title: "GetElementSyncer"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementSyncer"
revision_id: 80358
language: "en"
categories: ["Server_functions"]
generated_at: "2026-07-26T16:15:12.236599+00:00"
---
...
**Method**: *[element](mta://reference/misc/element.md):getSyncer(...)*

**Variable**: *.syncer*

**Counterpart**: *[setElementSyncer](mta://scripting/server/functions/setelementsyncer.md)*

### Required Arguments

- **theElement**: The [element](mta://reference/misc/element.md) to get the syncer of.

### Returns

Returns the [element](mta://reference/misc/element.md) that is the syncer of *theElement* or *false* if the element does not have a syncer.
