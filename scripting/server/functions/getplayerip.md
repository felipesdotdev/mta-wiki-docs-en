...
generated_at: "2026-07-26T16:15:19.926364+00:00"
---

# GetPlayerIP

This function returns a [string](mta://reference/misc/string.md) containing the IP address of the [player](mta://reference/misc/player.md).
...
**Method**: *[player](mta://reference/misc/player.md):getIP(...)*

**Variable**: *.ip*

### Required Arguments

- **thePlayer:** The [player](mta://reference/misc/player.md) element you want to get the IP of.
