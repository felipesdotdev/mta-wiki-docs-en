...
generated_at: "2026-07-26T16:16:44.098454+00:00"
---

# SetPlayerTeam

This function adds a [player](mta://reference/misc/player.md) to an existing [team](mta://reference/misc/team.md). The player will automatically be removed from his current team if he's on one.
...
**Method**: *[player](mta://reference/misc/player.md):setTeam(...)*
...
- **thePlayer:** The [player](mta://reference/misc/player.md) you wish to add to a team.

- **theTeam:** The [team](mta://reference/misc/team.md) you want to add the player to, or *nil* if you wish to unassign a player from his team.
