---
doc_id: "mta-wiki:1319"
title: "GetRandomPlayer"
source_title: "GetRandomPlayer"
source_url: "https://wiki.multitheftauto.com/wiki/GetRandomPlayer"
revision_id: 80396
language: "en"
categories: ["Server_functions"]
generated_at: "2026-07-26T16:15:22.663430+00:00"
---

# GetRandomPlayer

This function returns a random [player](mta://reference/misc/player.md).
...
**Method**: *[Player](mta://reference/misc/player.md).getRandom(...)*

### Returns

Returns a random [player](mta://reference/misc/player.md), *false* if the server is empty.
