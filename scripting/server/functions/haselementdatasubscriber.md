...
generated_at: "2026-07-26T16:15:42.945852+00:00"
---

# HasElementDataSubscriber

This function returns whether a [player](mta://reference/misc/player.md) is subscribed to specific [element data](mta://reference/misc/element-data--975d1ea3.md).
...
- **theElement:** The [element](mta://reference/misc/element.md) you wish to check whether the [player](mta://reference/misc/player.md) is subscribed to.

- **key:** The key you wish to check whether the player is subscribed to.

- **thePlayer:** The [player](mta://reference/misc/player.md) you wish to check.
