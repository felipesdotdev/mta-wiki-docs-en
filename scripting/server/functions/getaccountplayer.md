...
generated_at: "2026-07-26T16:15:06.269354+00:00"
---

# GetAccountPlayer

This function returns the [player](mta://reference/misc/player.md) element that is currently using a specified [account](mta://reference/misc/account.md), i.e. is logged into it. Only one player can use an account at a time.
...
- **theAccount:** The [account](mta://reference/misc/account.md) you wish to get the [player](mta://reference/misc/player.md) of.

### Returns

Returns a [player](mta://reference/misc/player.md) element if the account is currently in use, *false* otherwise.
