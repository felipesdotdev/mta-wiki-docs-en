...
generated_at: "2026-07-26T16:15:28.812916+00:00"
---

# GetVehicleRespawnRotation

This function retrieves the respawn rotation of a [vehicle](mta://reference/misc/vehicle.md).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getRespawnRotation(...)*

**Variable**: *.respawnRotation*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) which you'd like to retrieve the respawn rotation of.

### Returns

Returns three [floats](mta://reference/misc/float.md) indicating the respawn rotation of the [vehicle](mta://reference/misc/vehicle.md), *x*, *y* and *z* respectively.
