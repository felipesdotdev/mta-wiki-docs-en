---
doc_id: "mta-wiki:2614"
title: "StopResource"
source_title: "StopResource"
source_url: "https://wiki.multitheftauto.com/wiki/StopResource"
revision_id: 80432
language: "en"
categories: ["Server_functions"]
generated_at: "2026-07-26T16:16:52.557129+00:00"
---
...
| [[{{{image}}}\|link=\|]] | Note: This function does not stop the resource immediately, so don't expect that it starts stopping until the onResourceStop event for that resource is triggered. This happens after the scripts are done executing for this server frame. |
| --- | --- |
|  |  |
...
**Method**: *[resource](mta://reference/misc/resource.md):stop(...)*

### Required Arguments

- **theResource:** the [resource](mta://reference/misc/resource.md) that should be stopped.
