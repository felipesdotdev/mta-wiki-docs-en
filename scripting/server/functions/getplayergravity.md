...
generated_at: "2026-07-26T16:15:19.878845+00:00"
---
...
This function returns a float that contains the current gravity for the specified [player](mta://reference/misc/player.md).
...
- **thePlayer:** The [player](mta://reference/misc/player.md) whose gravity you want to check
