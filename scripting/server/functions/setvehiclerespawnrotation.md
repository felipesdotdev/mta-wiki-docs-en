...
generated_at: "2026-07-26T16:16:48.250039+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setRespawnRotation(...)*

**Variable**: *.respawnRotation*

### Required Arguments

- **theVehicle**: The [vehicle](mta://reference/misc/vehicle.md) you wish to change the respawn position of.
...
Returns *true* if the [vehicle](mta://reference/misc/vehicle.md) respawn rotation was set successfully, *false* otherwise.
