---
doc_id: "mta-wiki:4339"
title: "OnPlayerLogout"
source_title: "OnPlayerLogout"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerLogout"
revision_id: 59488
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:24.946590+00:00"
---
...
- **thePreviousAccount**: the [account](mta://reference/misc/account.md) the client was logged in as.

- **theCurrentAccount**: the [account](mta://reference/misc/account.md) the client is a part of now (usually a guest account).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the player that logged out.
