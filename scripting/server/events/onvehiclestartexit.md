...
generated_at: "2026-07-26T16:16:26.617414+00:00"
---
...
- **exitingPed**: a [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) element who is starting to exit a vehicle.

- **seat**: an [int](mta://reference/misc/int.md) representing the seat in which the ped is exiting from.

- **jacked**: a [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) element representing who is jacking.

- **door**: an [int](mta://reference/misc/int.md) representing the door that the ped is using to leave.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [vehicle](mta://reference/misc/vehicle.md) in which a ped began to exit.
