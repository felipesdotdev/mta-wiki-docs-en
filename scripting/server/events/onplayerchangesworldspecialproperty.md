...
generated_at: "2026-07-26T16:16:24.563567+00:00"
---
...
This event is triggered every time a [player](mta://reference/misc/player.md) calls [setWorldSpecialPropertyEnabled](mta://scripting/shared/functions/setworldspecialpropertyenabled.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who changed a special property.
