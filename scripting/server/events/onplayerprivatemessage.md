...
generated_at: "2026-07-26T16:16:25.266051+00:00"
---
...
- **recipient**: the [player](mta://reference/misc/player.md) to whom the message is being sent.
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who sent the private message.
