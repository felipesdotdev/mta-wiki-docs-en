...
generated_at: "2026-07-26T16:16:25.444706+00:00"
---
...
- **posX**: the X position the [player](mta://reference/misc/player.md) spawned at.

- **posY**: the Y position the [player](mta://reference/misc/player.md) spawned at.

- **posZ**: the Z position the [player](mta://reference/misc/player.md) spawned at.

- **spawnRotation**: the rotation the [player](mta://reference/misc/player.md) spawned with.

- **theTeam**: the [team](mta://reference/misc/team.md) the [player](mta://reference/misc/player.md) spawned with.

- **theSkin**: the [skin/model](mta://reference/misc/character-skins.md) the [player](mta://reference/misc/player.md) spawned with.

- **theInterior**: the [interior](mta://reference/misc/interior.md) the [player](mta://reference/misc/player.md) spawned in.

- **theDimension**: the [dimension](mta://reference/misc/dimension.md) the [player](mta://reference/misc/player.md) spawned in.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that just spawned.
