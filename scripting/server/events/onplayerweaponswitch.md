---
doc_id: "mta-wiki:1832"
title: "OnPlayerWeaponSwitch"
source_title: "OnPlayerWeaponSwitch"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerWeaponSwitch"
revision_id: 78594
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:26.037106+00:00"
---

# OnPlayerWeaponSwitch

This event is triggered whenever a player's equipped weapon **slot** changes. This means [giveWeapon](mta://scripting/server/functions/giveweapon.md) and [takeWeapon](mta://scripting/server/functions/takeweapon.md) will trigger this event if the equipped slot is forced to change.
...
- **previousWeaponID**: An [integer](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapons.md) that was switched from.

- **currentWeaponID**: An [integer](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapons.md) that was switched to.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that switched his weapon.

## Cancel effect

If this event is [canceled](mta://reference/misc/event-system.md), then the player's weapon won't be switched.
