...
generated_at: "2026-07-26T16:16:25.200070+00:00"
---
...
- **pickupLeft**: the [pickup](mta://reference/misc/pickup.md) the [player](mta://reference/misc/player.md) left.

## Source

The source of this event is the [player](mta://reference/misc/player.md) that left the pickup.
