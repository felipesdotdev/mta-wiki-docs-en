...
generated_at: "2026-07-26T16:16:25.312480+00:00"
---
...
This event is triggered every time a projectile is created by a [player](mta://reference/misc/player.md) - either through a weapon, a vehicle weapon or [createProjectile](mta://scripting/client/functions/createprojectile.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who created the projectile.
