---
doc_id: "mta-wiki:3459"
title: "OnPlayerVehicleEnter"
source_title: "OnPlayerVehicleEnter"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerVehicleEnter"
revision_id: 75902
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:25.745413+00:00"
---

# OnPlayerVehicleEnter

This event is triggered when a [player](mta://reference/misc/player.md) enters a vehicle.
...
- **theVehicle**: a [vehicle](mta://reference/misc/vehicle.md) element representing the vehicle that was entered.

- **seat**: an [int](mta://reference/misc/int.md) representing the seat in which the player is entering.
