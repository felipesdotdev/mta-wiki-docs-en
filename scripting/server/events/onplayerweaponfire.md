...
generated_at: "2026-07-26T16:16:25.967749+00:00"
---
...
- **hitElement**: an [element](mta://reference/misc/element.md) which was hit by a shot. Currently this can be only another [player](mta://reference/misc/player.md). **Note: hitElement could be incorrect and should not be relied upon.**
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who fired the weapon.
