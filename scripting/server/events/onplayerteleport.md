---
doc_id: "mta-wiki:14531"
title: "OnPlayerTeleport"
source_title: "OnPlayerTeleport"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerTeleport"
revision_id: 82041
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:25.598629+00:00"
---
...
This event is triggered when a player's position changes significantly without direct server intervention, such as the use of [setElementPosition](mta://scripting/shared/functions/setelementposition.md). When the player synchronizes data with the server, the server monitors player positions to detect significant unexpected movements. If a player's position deviates beyond the established threshold without server functions like [setElementPosition](mta://scripting/shared/functions/setelementposition.md) being used, this event will be triggered.
...
- **previousX**: A [float](mta://reference/misc/float.md) representing the player X-coordinate before teleporting.

- **previousY**: A [float](mta://reference/misc/float.md) representing the player Y-coordinate before teleporting.

- **previousZ**: A [float](mta://reference/misc/float.md) representing the player Z-coordinate before teleporting.

- **currentX**: A [float](mta://reference/misc/float.md) representing the player current X-coordinate after teleporting.

- **currentY**: A [float](mta://reference/misc/float.md) representing the player current Y-coordinate after teleporting.

- **currentZ**: A [float](mta://reference/misc/float.md) representing the player current Z-coordinate after teleporting.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who triggered the teleport detection.
