...
generated_at: "2026-07-26T16:16:24.321412+00:00"
---
...
- **previousWeaponID**: an [int](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapon.md) that was switched from.

- **currentWeaponID**: an [int](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapon.md) that was switched to.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [ped](mta://reference/misc/ped.md) that switched his weapon.
