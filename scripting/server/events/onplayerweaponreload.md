...
generated_at: "2026-07-26T16:16:26.007909+00:00"
---
...
This event is triggered when a [player](mta://reference/misc/player.md) is reloading their weapon.
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who's reloading their weapon.
...
This example will output informations when a [player](mta://reference/misc/player.md)'s weapon is reloading.
