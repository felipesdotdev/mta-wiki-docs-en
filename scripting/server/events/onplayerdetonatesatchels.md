---
doc_id: "mta-wiki:14192"
title: "OnPlayerDetonateSatchels"
source_title: "OnPlayerDetonateSatchels"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerDetonateSatchels"
revision_id: 78745
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:24.797029+00:00"
---
...
This event is triggered every time satchels are detonated - either by a [player](mta://reference/misc/player.md) or through [detonateSatchels](mta://scripting/shared/functions/detonatesatchels.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) whose satchels are being detonated.

### Canceling

If this event is [canceled](mta://reference/misc/event-system.md), the satchels will not detonate.
