---
doc_id: "mta-wiki:8354"
title: "OnPlayerNetworkStatus"
source_title: "OnPlayerNetworkStatus"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerNetworkStatus"
revision_id: 59493
language: "en"
categories: ["Server_Events", "Changes_in_1.4.1"]
generated_at: "2026-07-26T16:16:25.122018+00:00"
---

# OnPlayerNetworkStatus

This event is triggered when a players network connection to the server is interrupted. See [onClientPlayerNetworkStatus](mta://scripting/client/events/onclientplayernetworkstatus.md) for detecting server to player interruptions.
...
- **status**: an [int](mta://reference/misc/int.md) which is 0 if the interruption has begun, or 1 if the interruption is ending.

- **ticks**: an [int](mta://reference/misc/int.md) representing the ticks since the interruption started.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that has the network interruption.
