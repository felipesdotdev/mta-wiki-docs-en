...
generated_at: "2026-07-26T16:16:24.307354+00:00"
---
...
- **weapon**: an [int](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapon.md) that has been reloaded.

- **clip**: an [int](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapon.md) clip size.

- **ammo**: an [int](mta://reference/misc/int.md) representing the [weapon](mta://reference/misc/weapon.md) ammo.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [ped](mta://reference/misc/ped.md) that reloaded his weapon.
