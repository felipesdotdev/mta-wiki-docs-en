...
generated_at: "2026-07-26T16:16:25.231574+00:00"
---
...
- **thePickupToUse**: the [pickup](mta://reference/misc/pickup.md) the [player](mta://reference/misc/player.md) is standing on and is about to pick up.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that is standing on a pickup.
