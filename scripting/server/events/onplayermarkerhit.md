...
generated_at: "2026-07-26T16:16:24.984098+00:00"
---

# OnPlayerMarkerHit

This event is triggered when a [player](mta://reference/misc/player.md) hits a [marker](mta://reference/misc/marker.md).
...
- **markerHit**: the [marker](mta://reference/misc/marker.md) the [player](mta://reference/misc/player.md) hit.

- **matchingDimension**: a [boolean](mta://reference/misc/boolean.md) representing whether the [player](mta://reference/misc/player.md) and the hit [marker](mta://reference/misc/marker.md) are in the same [dimension](mta://reference/misc/dimension.md).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that hit the marker.
