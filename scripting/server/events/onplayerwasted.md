...
generated_at: "2026-07-26T16:16:25.924622+00:00"
---
...
- **killer**: an [element](mta://reference/misc/element.md) representing the [player](mta://reference/misc/player.md), [ped](mta://reference/misc/ped.md), [vehicle](mta://reference/misc/vehicle.md) or [object](mta://reference/misc/object.md) who was the killer. Deaths resulting from fall damage provide the [vehicle](mta://reference/misc/vehicle.md) or [object](mta://reference/misc/object.md) landed on as the killer. If there is no killer this is *false*.
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that died or got killed.
