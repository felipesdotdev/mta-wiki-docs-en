...
generated_at: "2026-07-26T16:16:25.516574+00:00"
---
...
- **targettedElement**: the [element](mta://reference/misc/element.md) the [player](mta://reference/misc/player.md) is targetting. *false* if no element is being targetted anymore.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) that is targetting the element.
