---
doc_id: "mta-wiki:14486"
title: "OnPlayerChangesProtectedData"
source_title: "OnPlayerChangesProtectedData"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerChangesProtectedData"
revision_id: 81777
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:24.534155+00:00"
---
...
This event is triggered when a player tries to change protected element data. The server protects element data with using [elementdata_whitelisted](mta://reference/misc/server-mtaserver-conf.md) from **mtaserver.conf** and the **clientChangesPolicy** parameter in [setElementData](mta://scripting/shared/functions/setelementdata.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](mta://reference/misc/player.md) who changes protected element data.
