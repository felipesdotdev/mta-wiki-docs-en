---
doc_id: "mta-wiki:4328"
title: "OnPlayerConnect"
source_title: "OnPlayerConnect"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerConnect"
revision_id: 79500
language: "en"
categories: ["Server_Events"]
generated_at: "2026-07-26T16:16:24.701108+00:00"
---
...
| [[{{{image}}}\|link=\|]] | WARNING: You should never, under any circumstances, modify the player returned by getPlayerFromName before onPlayerJoin to avoid desynchronization (e.g. setPlayerName ). If you want to set custom disconnect text, cancelEvent should be called at the end of the onPlayerConnect event, otherwise the client will be displayed the default text if any other event, native or custom, is triggered before cancelling. |
| --- | --- |
|  |  |
...
- **playerVersionString**: The player's MTA version in sortable string form. Same as the return value from [getPlayerVersion](mta://scripting/server/functions/getplayerversion.md).
...
If this event is [canceled](mta://reference/misc/event-system.md), the player will be disconnected with an error message saying the reason specified in cancelEvent or "Disconnected: server refused the connection" if none was specified.
