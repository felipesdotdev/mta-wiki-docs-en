...
generated_at: "2026-07-26T16:16:57.429453+00:00"
---

# TakePlayerMoney

This function subtracts money from a [player](mta://reference/misc/player.md)'s current money amount.
...
**Method**: *[player](mta://reference/misc/player.md):takeMoney(...)*

**Variable**: *.money*

#### Required Arguments

- **thePlayer:** the [player](mta://reference/misc/player.md) you are taking the money from.
