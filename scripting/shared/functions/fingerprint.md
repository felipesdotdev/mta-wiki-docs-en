---
doc_id: "mta-wiki:14196"
title: "Fingerprint"
source_title: "Fingerprint"
source_url: "https://wiki.multitheftauto.com/wiki/Fingerprint"
revision_id: 78618
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:01.804043+00:00"
---

# Fingerprint

This function calculates a fingerprint unique to each computer.

## Syntax

```
void fingerprint ( function callback )
```
...
function fingerprint(callback)
    assert(type(callback) == 'function', 'Bad argument @ fingerprint [Expected function at argument 1, got '..type(callback)..']')
    local browser = createBrowser(1, 1, true, true)
    addEventHandler('onClientBrowserDocumentReady', browser, function()
        local num = tonumber(getBrowserTitle(browser) or 0) or 0
    ...
    addEventHandler('onClientBrowserCreated', browser, function()
        loadBrowserURL(browser, 'http://mta/local/')
...
addEventHandler('onClientResourceStart', resourceRoot, function()
    fingerprint(function(num)
        outputChatBox('fingerprint: '..num)
