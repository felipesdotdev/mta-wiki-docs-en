---
doc_id: "mta-wiki:1439"
title: "GetRootElement"
source_title: "GetRootElement"
source_url: "https://wiki.multitheftauto.com/wiki/GetRootElement"
revision_id: 55937
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:15:23.910388+00:00"
---

# GetRootElement

This function returns the root node of the [element tree](mta://reference/misc/element-tree.md), called *root*. This node contains every other element: all resource root elements, players and remote clients. It is never destroyed and cannot be destroyed using [destroyElement](mta://scripting/shared/functions/destroyelement.md).
...
Returns the root [element](mta://reference/misc/element.md).
