...
generated_at: "2026-07-26T16:15:18.618068+00:00"
---

# GetPedWeaponSkill

This function gets the [ped](mta://reference/misc/ped.md)'s corresponding [weapon skill level](mta://reference/misc/weapon-skill-levels.md)
...
- **thePed:** the [ped](mta://reference/misc/ped.md) whose weapon skill level you want to get
...
A *string* with the [ped](mta://reference/misc/ped.md)'s corresponding [weapon skill level](mta://reference/misc/weapon-skill-levels.md) name or *false* if the passed arguments were invalid
