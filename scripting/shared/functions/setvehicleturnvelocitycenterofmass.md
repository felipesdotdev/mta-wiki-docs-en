---
doc_id: "mta-wiki:10603"
title: "SetVehicleTurnVelocityCenterOfMass"
source_title: "SetVehicleTurnVelocityCenterOfMass"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleTurnVelocityCenterOfMass"
revision_id: 64938
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:48.827825+00:00"
---
...
```
bool setVehicleTurnVelocityCenterOfMass( vehicle theVehicle, float rx, float ry, float rz )
```

*Counter Part: [getVehicleTurnVelocityCenterOfMass](mta://scripting/shared/functions/getvehicleturnvelocitycenterofmass.md)*

### Required Arguments

- **targetVehicle**: The vehicle you want to get the turn velocity from.

- **rx:** velocity around the X axis relative to vehicle center of mass.

- **ry:** velocity around the Y axis relative to vehicle center of mass.

- **rz:** velocity around the Z axis relative to vehicle center of mass.
