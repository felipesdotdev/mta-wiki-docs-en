...
generated_at: "2026-07-26T16:16:44.238138+00:00"
---

# SetRadarAreaSize

This function changes the size of an existing [radar area](mta://reference/misc/radararea.md).
...
**Method**: *[radararea](mta://reference/misc/radararea.md):setSize(...)*

### Required Arguments

- **theRadararea:** the [radararea](mta://reference/misc/radararea.md) element whose size is to be changed.
