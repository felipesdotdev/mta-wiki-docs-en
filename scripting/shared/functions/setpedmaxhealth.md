...
generated_at: "2026-07-26T16:16:43.113999+00:00"
---

# SetPedMaxHealth

This function sets the health for the specified [element](mta://reference/misc/element.md). This can be a [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md).
...
- **thePed:** The [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md) whose health you want to set.
