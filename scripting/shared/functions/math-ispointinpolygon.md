---
doc_id: "mta-wiki:10170"
title: "Math.isPointInPolygon"
source_title: "Math.isPointInPolygon"
source_url: "https://wiki.multitheftauto.com/wiki/Math.isPointInPolygon"
revision_id: 65872
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:16:09.531425+00:00"
---

# Math.isPointInPolygon

This function allow you to check if point is inside polygon or not.

## Syntax

```
bool math.isPointInPolygon( float x, float y, float vertex1x, float vertex1y, float vertex2x, float vertex2y, float vertex3x, float vertex3y,  [...])
```

### Required Arguments

- **x, y**: Position of point which you want to check.

- **vertex1x, vertex1y**: First vertex, position `x` and `y`

- **vertex2x, vertex2y**: Second vertex, position `x` and `y`

- **vertex3x, vertex3y**: Third vertex, position `x` and `y`

### Optional Arguments

- **vertexNx, vertexNy**: Another vertex, any numbers of vertices.
...
This example checks if point 0,0 and 0,5 is inside triangle.

```
local inside = pointInPolygon(0,0, -1,-1, 1,1, -1,1) -- true
local outside = pointInPolygon(0,5, -1,-1, 1,1, -1,1) -- false
print( inside, outside )
```

Author: CrosRoad95, based on [https://stackoverflow.com/questions/31730923/check-if-point-lies-in-polygon-lua](https://stackoverflow.com/questions/31730923/check-if-point-lies-in-polygon-lua)
