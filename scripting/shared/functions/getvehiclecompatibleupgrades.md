...
generated_at: "2026-07-26T16:15:27.003850+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getCompatibleUpgrades(...)*

**Variable**: *.compatibleUpgrades*

### Required Arguments

- **theVehicle:** the [vehicle](mta://reference/misc/vehicle.md) you wish to retrieve the list of compatible upgrades of.
