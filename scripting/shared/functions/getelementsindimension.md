---
doc_id: "mta-wiki:7326"
title: "GetElementsInDimension"
source_title: "GetElementsInDimension"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementsInDimension"
revision_id: 78402
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:12.827345+00:00"
---
...
| [[{{{image}}}\|link=\|]] | Important Note: The element type which you type must be a string . |
| --- | --- |
|  |  |
...
```
for _, player in ipairs(getElementsInDimension("player", 2)) do
    outputChatBox("You are in correct dimension!", localPlayer and 255 or player)
end
```
