---
doc_id: "mta-wiki:8351"
title: "IsTextInGridList"
source_title: "IsTextInGridList"
source_url: "https://wiki.multitheftauto.com/wiki/IsTextInGridList"
revision_id: 55354
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:00.720774+00:00"
---
...
function findText(cmd,text)
  if not tostring(text) then return end 
    if isTextInGridList(playerList, tostring(text), 1) then
