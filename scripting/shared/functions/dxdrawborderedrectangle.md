---
doc_id: "mta-wiki:9174"
title: "DxDrawBorderedRectangle"
source_title: "DxDrawBorderedRectangle"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawBorderedRectangle"
revision_id: 52546
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:14:44.326293+00:00"
---

# DxDrawBorderedRectangle

This is a function renders a rectangle background with an outline.

## Syntax

```
bool DxDrawBorderedRectangle ( float x, float y, float width, float height, int colorRectangle, int colorLine, [ int thickness = 1, bool postGUI = false ] )
```
...
- **colorRectangle:** the hex color of the rectangle, produced using tocolor or 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).

- **colorLine:** the hex color of the lines, produced using tocolor or 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).

## Optional Arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](mta://reference/misc/optional-arguments--f0d8694a.md).

- **thickness:** An integer representing how thick the lines will be.
...
This example draws a grey ractangle with two pixel-thick red borders
