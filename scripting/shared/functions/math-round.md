---
doc_id: "mta-wiki:4889"
title: "Math.round"
source_title: "Math.round"
source_url: "https://wiki.multitheftauto.com/wiki/Math.round"
revision_id: 78220
language: "en"
categories: ["Utility_templates", "Useful_Functions"]
generated_at: "2026-07-26T16:16:10.620970+00:00"
---
...
This example adds a command that outputs the rounded players current position. It's useful for [createWater](mta://scripting/shared/functions/createwater.md) function.
...
addCommandHandler("roundedPos",roundedPos)
```
