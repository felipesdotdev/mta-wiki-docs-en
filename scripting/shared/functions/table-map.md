---
doc_id: "mta-wiki:4592"
title: "Table.map"
source_title: "Table.map"
source_url: "https://wiki.multitheftauto.com/wiki/Table.map"
revision_id: 78381
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:16:56.549001+00:00"
---
...
function table.map(tab, depth, func, ...)
    for key, value in pairs(tab) do
        ...
        else tab[key] = func(key, value, ...) end
    end
    return tab
end
```

**Author:** NeonBlack, [Youssef Maged (iManGaaX)](https://wiki.multitheftauto.com/wiki/User:IManGaaX)
...
```
local myTable = {"test_1", "test_2", "test_3"}
table.map(myTable, 1, function(k, v)
    outputChatBox(k.." - "..v)
end)
--// Result:
--// 1 - test_1
