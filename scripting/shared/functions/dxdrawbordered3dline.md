---
doc_id: "mta-wiki:13811"
title: "DxDrawBordered3DLine"
source_title: "DxDrawBordered3DLine"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawBordered3DLine"
revision_id: 75630
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:44.148769+00:00"
---

# DxDrawBordered3DLine

This function creates a bordered area with 3D dx lines.

- **NOTE:** this is made to be only client side

```
bool dxDrawBordered3DLine(float startX, float startY, float startZ, float endX, float endY, float endZ, color, width)
```

### Required Arguments

- **startX/startY/startZ:**The start position of the 3D Line, representing a coordinate in the GTA world.

- **endX/endY/endZ:**The end position of the 3D Line, representing a coordinate in the GTA world.

- **color:** the hex color of the line (red, green, blue, alpha)

### Optional Argument

- **width:** represents the width of the line
...
this draws 3D line around Restricted Area

```
local x, y,z, w,h, d = 96.683, 1798.932, 17.640625 , 285.30496, 1940.2816, 17.640625

local radar = createRadarArea( x, y, w, h, 50, 255, 50, 100)
