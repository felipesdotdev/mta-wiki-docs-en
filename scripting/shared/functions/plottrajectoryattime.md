---
doc_id: "mta-wiki:11743"
title: "PlotTrajectoryAtTime"
source_title: "PlotTrajectoryAtTime"
source_url: "https://wiki.multitheftauto.com/wiki/PlotTrajectoryAtTime"
revision_id: 64350
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:29.593331+00:00"
---

# PlotTrajectoryAtTime

This function let you calculate projectile trajectory by using starting position and normal vector
...
- **start**: Vector3D with starting position

- **velocity**: Direction of trajectory, it also depends on how strong it is.

- **time**: How far from starting position it should be calculated.

### Returns

Position of specified trajectory point.
