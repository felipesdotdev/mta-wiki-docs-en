...
generated_at: "2026-07-26T16:11:59.862631+00:00"
---

# CreateMarkerAttachedTo

This function creates a [marker](mta://reference/misc/marker.md) that is attached to an [element](mta://reference/misc/element.md).
...
- **elementToAttachTo:** The [element](mta://reference/misc/element.md) to attach the [marker](mta://reference/misc/marker.md) to.
