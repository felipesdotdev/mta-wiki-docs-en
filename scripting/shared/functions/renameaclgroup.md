---
doc_id: "mta-wiki:7910"
title: "RenameAclGroup"
source_title: "RenameAclGroup"
source_url: "https://wiki.multitheftauto.com/wiki/RenameAclGroup"
revision_id: 78386
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:32.888878+00:00"
---

# RenameAclGroup

This function is used to rename an [ACL group](mta://reference/misc/aclgroup--4c7248ae.md).
...
- **old:** the name of the ACL group you want to change.

- **new:** the new name we want to change the group to.

### Returns

- *true* if the acl group was renamed successfully.
...
- **Author:** Al Obaidi Hassan.

- **Edited by:** Shaio Fencski, [Youssef Maged (iManGaaX)](https://wiki.multitheftauto.com/wiki/User:IManGaaX).
...
addEventHandler("onResourceStart", resourceRoot, function()
    local renamedSuccess = renameAclGroup("Moderator", "HassoN")
    if (renamedSuccess) then
        outputDebugString("ACL Group 'Moderator' has been renamed Successfully to 'HassoN'.")
    else
        outputDebugString("Failed to rename ACL Group 'Moderator' to 'HassoN'.", 1)
    end
end)
```
