---
doc_id: "mta-wiki:11759"
title: "IsVehicleUpgraded"
source_title: "IsVehicleUpgraded"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleUpgraded"
revision_id: 64464
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:03.258998+00:00"
---

# IsVehicleUpgraded

This function checks is vehicle upgraded by upgrade ID.

## Syntax

```
bool isVehicleUpgraded ( vehicle theVehicle, int upgrade )
```

### Required Arguments

- **theVehicle**: The [element](mta://reference/misc/element.md) representing the [vehicle](mta://reference/misc/vehicle.md) you wish to check the upgrade to.

- **upgrade**: The id of the upgrade you wish to check. (1000 to 1193), *see [Vehicle Upgrades](mta://reference/misc/vehicle-upgrades.md)*

## Returns

Returns *true* if the upgrade is on the vehicle, *false* if it is not..
