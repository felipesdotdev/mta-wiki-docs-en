---
doc_id: "mta-wiki:9291"
title: "Byte2human"
source_title: "Byte2human"
source_url: "https://wiki.multitheftauto.com/wiki/Byte2human"
revision_id: 82488
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:12:15.769946+00:00"
---

# Byte2human

This function lets you transform a number of bytes into a human readable unit.

## Syntax

```
string byte2human ( int bytes )
```

### Required Arguments

- **bytes:** The value which you want to get the human readable version.

### Returns

Returns a string which shows the number transformed into a human-friendly string.
...
**Author: Renkon**
(based on [http://stackoverflow.com/a/14919494/2980812](http://stackoverflow.com/a/14919494/2980812))
