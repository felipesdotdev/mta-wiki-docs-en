---
doc_id: "mta-wiki:1502"
title: "SetWeatherBlended"
source_title: "SetWeatherBlended"
source_url: "https://wiki.multitheftauto.com/wiki/SetWeatherBlended"
revision_id: 55458
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:16:49.891864+00:00"
---

# SetWeatherBlended

This function will change the current [weather](mta://reference/misc/weather.md) to another in a smooth manner, over the period of 1-2 in-game hours (unlike [setWeather](mta://scripting/shared/functions/setweather.md), which sets a new weather instantly). To ensure this transition performs as expected, you should not call this function until [getWeather](mta://scripting/shared/functions/getweather.md) indicates that no transition is already being done.
...
- **weatherID:** The ID of the [weather](mta://reference/misc/weather.md) state you wish to set. Valid values are 0 to 255 inclusive.
