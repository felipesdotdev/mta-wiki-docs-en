---
doc_id: "mta-wiki:9120"
title: "DxDrawOctagon3D"
source_title: "DxDrawOctagon3D"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawOctagon3D"
revision_id: 65347
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:46.437560+00:00"
---

# DxDrawOctagon3D

This function creates the Octagon , by combining dxDrawLine3D with each other , it needs to act onClientRender because the function of action on frames.
...
An example of how dxDrawOctagon3D function works in practice.

```
bool dxDrawOctagon3D(int x, int y, int z, [int radius, int width, int color = white] )
```

## Required Arguments

- **x:** x coordinates of the form

- **y:** y coordinates of the form

- **z:** z coordinates of the form
...
Returns true if successful, false if they are not passed good arguments to the function.
...
```
-- Octagon is visible on the Blueberry Farm
function renderOctagon3D()
   dxDrawOctagon3D(0.0, 5.0, 25.0, 1.0, tocolor(255, 255, 255, 255) )
end
addEventHandler( "onClientRender", root, renderOctagon3D)
```
