...
generated_at: "2026-07-26T16:15:20.901020+00:00"
---
...
This function tells you which weapon type is in the player's current slot (clientside, you can optionally specify a slot other than the current one). See [Weapon Info](mta://reference/misc/weapon.md)
...
- **thePlayer**: the [player](mta://reference/misc/player.md) you want to get the weapon type from.
