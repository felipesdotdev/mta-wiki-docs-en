---
doc_id: "mta-wiki:14115"
title: "DxDrawDiamond"
source_title: "DxDrawDiamond"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawDiamond"
revision_id: 77501
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:45.010762+00:00"
---
...
```
bool dxDrawDiamond(x,y,w,tocolor)
```

### Required Arguments

- **x**: An integer representing the absolute starting X position of the line, represented in pixels on the screen.

- **y**: An integer representing the absolute starting Y position of the line, represented in pixels on the screen.

- **w**: An integer representing the absolute starting width of the line, represented in pixels on the screen.

- **tocolor**: Represents a color produced by [tocolor](mta://scripting/shared/functions/tocolor.md) or 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).
...
```
function dxDrawDiamond(x, y, w, tocolor)
    local i = 1;
    while (w-i*2) > 0 do
...
addEventHandler('onClientRender', root,
    function()
        dxDrawDiamond(401, 268, 150, tocolor(0, 0, 0, 180))
    end
)
```

*Author*: ClawSuit
*Translated by*: Sousateew
