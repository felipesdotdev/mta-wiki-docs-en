---
doc_id: "mta-wiki:11097"
title: "SetTableToSql"
source_title: "SetTableToSql"
source_url: "https://wiki.multitheftauto.com/wiki/SetTableToSql"
revision_id: 61502
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:45.419915+00:00"
---

# SetTableToSql

This function is used to save the table in the database (sql)

## Syntax

```
setTableToSql( string/int id, string theTable )﻿
```

### Required arguments

- **id**: The ID used to get the table using the function ([GetTableFromSql](https://wiki.multitheftauto.com/wiki/getTableFromSql)).

- **theTable**: Table to be saved.
