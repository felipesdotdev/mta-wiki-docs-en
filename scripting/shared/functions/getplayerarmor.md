...
generated_at: "2026-07-26T16:15:19.172731+00:00"
---
...
This function returns a float that contains the current armor for the specified [player](mta://reference/misc/player.md).
...
- **thePlayer:** The [player](mta://reference/misc/player.md) whose armor you want to check
