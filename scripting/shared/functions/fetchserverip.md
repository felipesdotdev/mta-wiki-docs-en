---
doc_id: "mta-wiki:14520"
title: "FetchServerIp"
source_title: "FetchServerIp"
source_url: "https://wiki.multitheftauto.com/wiki/FetchServerIp"
revision_id: 81679
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:00.752684+00:00"
---

# FetchServerIp

This function returns the server ip as reported by a third-party service.

## Syntax

```
string fetchServerIp ( )
```
...
```
outputServerLog("Public server IP: " .. fetchServerIp())
```
