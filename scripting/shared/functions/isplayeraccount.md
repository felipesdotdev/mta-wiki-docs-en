---
doc_id: "mta-wiki:14258"
title: "IsPlayerAccount"
source_title: "IsPlayerAccount"
source_url: "https://wiki.multitheftauto.com/wiki/IsPlayerAccount"
revision_id: 78997
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:58.950591+00:00"
---

# IsPlayerAccount

This function checks if the account is valid player account (the account exists and is not a guest account)

## Syntax

```
bool isPlayerAccount ( account theAccount )
```

### Required Arguments

- **theAccount**: The account you want to check
...
```
function isPlayerAccount(account)
...
```
addCommandHandler("isAccount", function(player) 
    local acc = getPlayerAccount(player) 
    if not isPlayerAccount(acc) then
        return outputChatBox('Account is not valid', player)
    end
    outputChatBox('Account is valid!', player)
end)
```
