---
doc_id: "mta-wiki:10204"
title: "DxDrawTextOnRectangle"
source_title: "DxDrawTextOnRectangle"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawTextOnRectangle"
revision_id: 69699
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:48.189143+00:00"
---

# DxDrawTextOnRectangle

Esta Funcion Crea un Texto Dentro de un [dxDrawRectangle](mta://scripting/client/functions/dxdrawrectangle.md)

## Sintaxis

```
dxDrawTextOnRectangle(posX, posY, width, height, texto, [fuente, alignX, alignY, color, posGui])
```

### Argumentos Requeridos

- **posX**: Un entero que representa la posición X de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **posY**: Un entero que representa la posición Y de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **width**: Un entero que representa la anchura de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **height**: Un entero que representa la altura de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **texto**: El texto que estará en el draw.

### Argumentos Opcionales

- **Fuente**: Representa la fuente personalizada creada con [dxCreateFont](mta://scripting/client/functions/dxcreatefont.md) o Bien ↓
...
- **alignX**: Representa la posición horizontal del texto **"left"**, **"center"**, **"right"**.

- **alignY**: Representa la posición vertical del texto **"top"**, **"center"**, **"bottom"**.

- **color**: Representa un color producido por [tocolor](mta://scripting/shared/functions/tocolor.md) o 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).

- **posGui**: Un booleano que representa si el texto debe dibujarse encima o detrás de cualquier interfaz gráfica de usuario dentro del juego.

### Returns

Si colocaste bien los argumentos requeridos retorna un valor verdadero, caso contrario falso.
...
```
function dxDrawTextOnRectangle(posX, posY, width, height, texto, fuente, alignX, alignY, color, posGui)
