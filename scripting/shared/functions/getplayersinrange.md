---
doc_id: "mta-wiki:12515"
title: "GetPlayersInRange"
source_title: "GetPlayersInRange"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayersInRange"
revision_id: 67446
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:21.692304+00:00"
---

# GetPlayersInRange

| [[{{{image}}}\|link=\|]] | Note: You can use countPlayersInRange if you want count players in the range. |
| --- | --- |
|  |  |
...
```
table getPlayersInRange(element thePlayer, float range)
```

### Required Arguments

- **thePlayer** : The player you want to get the players in range.

- **range** : Range size.

### Returns

Returns a table of players that are within a certain range if there is minimum 1 player else it returns false.
