---
doc_id: "mta-wiki:13568"
title: "Math.average"
source_title: "Math.average"
source_url: "https://wiki.multitheftauto.com/wiki/Math.average"
revision_id: 77133
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:08.465655+00:00"
---

# Math.average

This function returns the arithmetic mean of table.

## Syntax

```
int math.average( table theTable )
```

### Required Arguments

- **theTable**: The table you want to get the simple arithmetic mean.
...
This example returns the simple arithmetic mean of integers: 30, 25, 40, 42, 49.

```
local numbers = {30, 25, 40, 32, 49}
local n = math.average(numbers)
iprint(n) -- output: 35.2
```
