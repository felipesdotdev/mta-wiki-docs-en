...
generated_at: "2026-07-26T16:16:43.299671+00:00"
---
...
This function allows you to set the value of a specific statistic for a [ped](mta://reference/misc/ped.md). **Visual stats (FAT and BODY_MUSCLE) can only be used on the CJ skin**, they have no effect on other skins. When this function is used client-side, it can only be used on client-side created peds.
...
- **thePed**: the [ped](mta://reference/misc/ped.md) whose statistic you want to modify.
