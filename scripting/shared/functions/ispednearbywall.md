...
generated_at: "2026-07-26T16:15:58.677741+00:00"
---

# IsPedNearbyWall

This function checks if [player](mta://reference/misc/player.md)/[ped](mta://reference/misc/ped.md) is nearby walls like buildings or objects.
...
- **element**: the [player](mta://reference/misc/player.md)/[ped](mta://reference/misc/ped.md) element to check.

### Optional Arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](mta://reference/misc/optional-arguments--f0d8694a.md).

- **customDistance**: the distance between the walls and the [player](mta://reference/misc/player.md)/[ped](mta://reference/misc/ped.md).
