---
doc_id: "mta-wiki:11156"
title: "GetPlayerPreviousAndNextWeapon"
source_title: "GetPlayerPreviousAndNextWeapon"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayerPreviousAndNextWeapon"
revision_id: 70179
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:20.372671+00:00"
---
...
```
int getPlayerPreviousAndNextWeapon ( element thePlayer )
```
...
```
function getPlayerPreviousAndNextWeapon(player)
	assert(isElement(player) and getElementType(player) == "player", "@getPlayerPreviousAndNextWeapon, expected player at argument '1', received ".. type(player) ..".");
	local weapons = {};
	for i=0, 12 do
