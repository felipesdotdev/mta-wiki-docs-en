...
generated_at: "2026-07-26T16:16:49.273809+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setWheelStates(...)*

**Counterpart**: *[getVehicleWheelStates](mta://scripting/shared/functions/getvehiclewheelstates.md)*

## Required Arguments

- **theVehicle:** A handle to the [vehicle](mta://reference/misc/vehicle.md) that you wish to change the wheel states of.
