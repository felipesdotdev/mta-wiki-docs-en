---
doc_id: "mta-wiki:9845"
title: "DxDrawDashedLine"
source_title: "DxDrawDashedLine"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawDashedLine"
revision_id: 53207
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:44.844795+00:00"
---

# DxDrawDashedLine

This function lets you draw a line with dashes or dots.

## Syntax

```
dxDrawDashedLine ( int startX, int startY, int endX, int endY, int lengthLine, [ int lengthSpace = lengthLine, int color = 0xFFFFFFFF, int width = 1, bool postGUI = false ] )
```
...
- **lengthLine:** An integer representing the length of each dash.

### Optional Arguments

- **lengthSpace:** An integer representing the length of the empty space between the dashes.
...
This example shows how to draw an X on the screen.

```
local sW, sH = guiGetScreenSize()

addEventHandler("onClientRender", root, function()
	dxDrawDashedLine(100, 100, sW - 100, sH - 100, 10, 5, tocolor(255, 255, 255, 255), 2, false);
	dxDrawDashedLine(100, sH - 100, sW - 100, 100, 10, 5, tocolor(255, 255, 255, 255), 2, false);
end )
```
