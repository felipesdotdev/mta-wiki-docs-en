---
doc_id: "mta-wiki:12411"
title: "GuiSetStaticImageMovable"
source_title: "GuiSetStaticImageMovable"
source_url: "https://wiki.multitheftauto.com/wiki/GuiSetStaticImageMovable"
revision_id: 66945
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:41.744786+00:00"
---

# GuiSetStaticImageMovable

This function allows you to specify whether or not a user can move a StaticImage.

## Syntax

```
string guiSetStaticImageMovable ( element TheElement, bool status )
```

**OOP Syntax** [Help! I don't understand this!](mta://tutorials/oop-introduction.md)

**Method**: *[GuiStaticImage](mta://scripting/concepts/element-gui-static-image.md):setMovable(...)*

**Variable**: *.element*

### Required Arguments

- **TheElement:** The image that will be movable or not.

- **status:** A boolean value indicating whether the image is movable or not..
...
**Example 1:** This example creates a staticImage "mtalogo.png" and sets it to be movable or not using command move and state true or false :

Click to collapse [-]
Example1

```
photo = guiCreateStaticImage(476, 223, 284, 221, "mtalogo.png", false)
showCursor(true)

function Movable( _,state )
if (state) and state == 'true' then
guiSetStaticImageMovable(photo,true)
outputChatBox('StaticImageMovable:'..state)
elseif (state) and state == 'false' then
guiSetStaticImageMovable(photo,false)
outputChatBox('StaticImageMovable:'..state)
end
end
addCommandHandler('move',Movable)
```
