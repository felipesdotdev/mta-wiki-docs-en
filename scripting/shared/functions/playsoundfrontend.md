...
generated_at: "2026-07-26T16:16:29.269378+00:00"
---
...
**Method**: *[player](mta://reference/misc/player.md):playSoundFrontEnd(...)*

### Required Arguments

- **thePlayer:** the [player](mta://reference/misc/player.md) you want the sound to play for.
...
**Method**: *[Sound](mta://reference/misc/sound.md).playFrontEnd(...)*
