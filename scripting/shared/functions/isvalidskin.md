---
doc_id: "mta-wiki:12397"
title: "IsValidSkin"
source_title: "IsValidSkin"
source_url: "https://wiki.multitheftauto.com/wiki/IsValidSkin"
revision_id: 71136
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:01.500253+00:00"
---

# IsValidSkin

This function will check if the given skin id is a valid skin or not.
...
Returns *true* if the given id a valid skin, *false* otherwise
...
```
addCommandHandler("isvalid",
function(player,_,id)
    if isValidSkin(id) then 
        outputChatBox(id.." valid skin!",player,0,255,0)
    else
        outputChatBox(id.." invalid skin!",player,255,0,0)
    end 
end)
```
