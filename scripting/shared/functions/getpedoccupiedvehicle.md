...
generated_at: "2026-07-26T16:15:17.920550+00:00"
---

# GetPedOccupiedVehicle

This function gets the [vehicle](mta://reference/misc/vehicle.md) that the ped is currently in or is trying to enter, if any.
...
**Method**: *[ped](mta://reference/misc/ped.md):getOccupiedVehicle(...)*
...
- **thePed**: The [ped](mta://reference/misc/ped.md) whose vehicle you're looking up.
