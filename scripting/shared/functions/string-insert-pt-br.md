---
doc_id: "mta-wiki:12816"
title: "PT-BR/String.insert"
source_title: "String.insert/PT-BR"
source_url: "https://wiki.multitheftauto.com/wiki/String.insert/PT-BR"
revision_id: 69192
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:53.440088+00:00"
---

# PT-BR/String.insert

Esta função insere uma *string* dentro de uma outra *string*.

## Sintaxe

```
string string.insert( string stringPricipal, string stringParaInserir, int pos )
```

### Argumentos Necessários

- **stringPrincipal**: String que será usada para receber a string do argumento *stringParaInserir*.

- **stringParaInserir**: String que será adicionado em *stringPricipal*.

- **pos**: Posição em que *stringParaInserir* será inserido.

### Retorna

Retorna uma string, sendo esta o resultado final da inserção.
...
Este simples exemplo insere a palavra **belo** na frase *Olá mundo* e imprime o resultado final.

```
texto = 'Olá mundo'

local texto2 = string.insert(texto, 'belo ', 5) -- output: 'Olá belo mundo'

print(texto2)
```

This second example uses another way to use the **string.insert** function.

```
texto = 'Olá mundo'

local texto2 = texto:insert('belíssimo ', 5) -- output: 'Olá belíssimo mundo'
