...
generated_at: "2026-07-26T16:16:26.197598+00:00"
---

# OnPlayerZoneChange

This code implements an [event](mta://reference/misc/event.md) that is triggered when the [player](mta://reference/misc/player.md) enters a new area on the map.
...
- **oldZone:** old zone of [player](mta://reference/misc/player.md).

- **newZone:** new zone of [player](mta://reference/misc/player.md).
