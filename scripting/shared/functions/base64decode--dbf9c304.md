---
doc_id: "mta-wiki:7596"
title: "Base64Decode"
source_title: "Base64decode"
source_url: "https://wiki.multitheftauto.com/wiki/Base64decode"
revision_id: 78856
language: "en"
categories: ["Server_functions", "Client_functions", "Deprecated"]
generated_at: "2026-07-26T16:11:57.911750+00:00"
---

# Base64Decode

This function returns the decrypted data from [base64](https://en.wikipedia.org/wiki/Base64) representation of the encrypted block

|  | This function is deprecated. This means that its use is discouraged and that it might not exist in future versions. |
| --- | --- |
| Please use decodeString instead. |  |
...
Returns the decrypted data from [base64](https://en.wikipedia.org/wiki/Base64) representation of the encrypted block if the decryption process was successfully completed, *false* otherwise.

## Example

```
local k = base64Decode("SGVsbG8sIHdvcmxkIQ==")
outputConsole(k)
--Output: Hello, world!
```
