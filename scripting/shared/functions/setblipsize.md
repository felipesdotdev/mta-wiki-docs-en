...
generated_at: "2026-07-26T16:16:38.286424+00:00"
---
...
**Method**: *[blip](mta://reference/misc/blip.md):setSize(...)*
...
Returns an *true* if the blip's size was set successfully. Returns *false* if the [element](mta://reference/misc/element.md) passed was not a [blip](mta://reference/misc/blip.md) or if the icon size passed was invalid.
