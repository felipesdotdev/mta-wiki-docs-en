---
doc_id: "mta-wiki:13346"
title: "GuiCancelMoveElement"
source_title: "GuiCancelMoveElement"
source_url: "https://wiki.multitheftauto.com/wiki/GuiCancelMoveElement"
revision_id: 72046
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:31.663946+00:00"
---

# GuiCancelMoveElement

This function Cancel moves guiElement by/like using moveObject

## Syntax

```
guiCancelMoveElement ( element guiElement )
```

### Required Arguments

- **guiElement**: the GUI element that will be cancel moved.
...
```
function guiCancelMoveElement(element)
    for i, gui_elements in ipairs ( table_ ) do
        if gui_elements[1] == element then
            table.remove ( table_, i )
            if isElement ( gui_elements[2] ) then
                destroyElement ( gui_elements[2] )
            end
        end
    end
end
...
**Author:** [ArLixx](https://wiki.multitheftauto.com/wiki/User:Arlixx)
