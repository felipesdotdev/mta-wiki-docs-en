...
generated_at: "2026-07-26T16:15:01.994267+00:00"
---

# FixVehicle

This function will set a [vehicle](mta://reference/misc/vehicle.md)'s health to full and fix its damage model. If you wish to only change the vehicle's health, without affecting its damage model, use [setElementHealth](mta://scripting/shared/functions/setelementhealth.md).
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):fix(...)*
