---
doc_id: "mta-wiki:10917"
title: "WordWrap"
source_title: "WordWrap"
source_url: "https://wiki.multitheftauto.com/wiki/WordWrap"
revision_id: 66718
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:17:07.350868+00:00"
---

# WordWrap

This function splits a long string into a table of lines no longer than *maxwidth*.

| [[{{{image}}}\|link=\|]] | Note: A line without any spaces in it will not break, meaning it may exceed maxwidth . |
| --- | --- |
|  |  |

| [[{{{image}}}\|link=\|]] | Tip: This function may lag if used too often. Consider only calling this function when any of the arguments change (such as the text, maxwidth, it's scale or font, etc.) and caching the result, rather than calling it onClientRender or similarly frequent events. |
| --- | --- |
|  |  |
...
```
table wordWrap( string text, float maxwidth, [float scale=1, mixed font="default", bool bColorCoded=false] )
```

### Required Arguments

- **text:** The string to break into lines.

- **maxwidth:** The number of pixels of allowed length per line.

### Optional Arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](mta://reference/misc/optional-arguments--f0d8694a.md).

- **scale:** The size of the text, as in [dxGetTextWidth](mta://scripting/client/functions/dxgettextwidth.md). Defaults to 1.

- **font:** Either a custom DX font element or the name of a built-in dx font, as in [dxGetTextWidth](mta://scripting/client/functions/dxgettextwidth.md). Defaults to "default".

- **bColorCoded:** Should color codes be excluded from the width? (false will include #rrggbb in the length calculations). Defaults to false.
