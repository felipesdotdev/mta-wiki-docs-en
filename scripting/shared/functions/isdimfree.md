---
doc_id: "mta-wiki:13823"
title: "IsDimFree"
source_title: "IsDimFree"
source_url: "https://wiki.multitheftauto.com/wiki/IsDimFree"
revision_id: 75692
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:54.339409+00:00"
---

# IsDimFree

This function checks whether the passed dimension is free or not.

## Syntax

```
bool isDimFree (Type,Dim )
```
...
Returns *true* if the dimension is free, *false* otherwise.
...
**[IcENog](https://wiki.multitheftauto.com/wiki/User:IcENog) - (Discord: IcENog#7849)**
