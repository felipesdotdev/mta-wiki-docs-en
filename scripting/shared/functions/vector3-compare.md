...
generated_at: "2026-07-26T16:17:03.370719+00:00"
---

# Vector3:compare

This method checks whether two [vectors](mta://reference/misc/vector3.md) match (optionally with precision defined).
...
- **comparison:** The [Vector3](mta://reference/misc/vector3.md) to compare to.
