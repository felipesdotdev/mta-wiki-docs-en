---
doc_id: "mta-wiki:8617"
title: "GetPlayersInACLGroup"
source_title: "GetPlayersInACLGroup"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayersInACLGroup"
revision_id: 63953
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:21.166884+00:00"
---
...
```
table getPlayersInACLGroup ( string GroupName )
```
...
```
addCommandHandler ( "killPlayerGroup", function ( _ , _ , GroupName_ )
    Players = getPlayersInACLGroup (  GroupName_  )
...
```
addCommandHandler("GiveGroupMoney", function ( p , _ , Group_ , aMoney )
    Players = getPlayersInACLGroup ( Group_ )
    for i , PlayersGroup in ipairs ( Players ) do
