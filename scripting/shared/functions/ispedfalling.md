...
generated_at: "2026-07-26T16:15:58.402320+00:00"
---

# IsPedFalling

This function checks if [player](mta://reference/misc/player.md)/[ped](mta://reference/misc/ped.md) is falling from a high place.
...
- **thePed**: the [player](mta://reference/misc/player.md)/[ped](mta://reference/misc/ped.md) element to check.
