---
doc_id: "mta-wiki:10605"
title: "GetPlayersInVehicles"
source_title: "GetPlayersInVehicles"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayersInVehicles"
revision_id: 57585
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:21.842249+00:00"
---

# GetPlayersInVehicles

This function returns a table of the player's insides vehicles in from a specified dimension.

## Syntax

```
table getPlayersInVehicles ( int dimension )
```

### Required Arguments

- **dimension**: The dimension that you want to get players from.
...
This example will get the players inside vehicles from a specified dimension. **/playersCount 0**
