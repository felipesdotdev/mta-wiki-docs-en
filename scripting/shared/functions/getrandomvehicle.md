...
generated_at: "2026-07-26T16:15:22.793493+00:00"
---

# GetRandomVehicle

This function returns a random [vehicle](mta://reference/misc/vehicle.md) between every vehicle created.
...
It returns a random [vehicle](mta://reference/misc/vehicle.md) if possible. If not, it returns *false*.
