---
doc_id: "mta-wiki:5848"
title: "UtfSub"
source_title: "UtfSub"
source_url: "https://wiki.multitheftauto.com/wiki/UtfSub"
revision_id: 47961
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:17:02.640163+00:00"
---
...
- **theString:** The [string](mta://reference/misc/string.md).

- **Start:** An [int](mta://reference/misc/int.md) with the start position.

- **End:** An [int](mta://reference/misc/int.md) with the end position.

### Returns

Returns a *[string](mta://reference/misc/string.md)* if the function was successful, *false* otherwise.
