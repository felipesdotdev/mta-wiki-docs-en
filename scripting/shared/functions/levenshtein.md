---
doc_id: "mta-wiki:14286"
title: "Levenshtein"
source_title: "Levenshtein"
source_url: "https://wiki.multitheftauto.com/wiki/Levenshtein"
revision_id: 79303
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:04.443942+00:00"
---

# Levenshtein

This function can be used to calculate the Levenshtein distance between two strings
(wiki to Levenshtein distance: [https://en.wikipedia.org/wiki/Levenshtein_distance](https://en.wikipedia.org/wiki/Levenshtein_distance))

## Syntax

```
int levenshtein(string1, string2)
```
...
Returns an integer representing the levenshtein distance between this two strings
...
function levenshtein(string1, string2)
    ...
    for i = 1, m do
        for j = 1, n do
            local cost = string1:sub(i, i) == string2:sub(j, j) and 0 or 1
