...
generated_at: "2026-07-26T16:15:27.305383+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getController(...)*

**Variable**: *.controller*

### Required Arguments

- **theVehicle:** the [vehicle](mta://reference/misc/vehicle.md) you want to get the 'controller' of.

### Returns

Returns a [player](mta://reference/misc/player.md) object, if there isn't a driver, it will search the 'trailer chain' for the front driver, *false* otherwise.
