---
doc_id: "mta-wiki:11010"
title: "Table.getRandomRows"
source_title: "Table.getRandomRows"
source_url: "https://wiki.multitheftauto.com/wiki/Table.getRandomRows"
revision_id: 78257
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:56.368439+00:00"
---

# Table.getRandomRows

This function returns the N random unique rows.

## Syntax

```
table table.getRandomRows( table theTable, uint rowsCount )
```

### Required Arguments

- **theTable**: The table to retrieve the total size of.

- **rowsCount**: How many rows you want.

### Returns

Return N random unique rows.
...
```
local tab = {1,2,3,4,5}
iprint( table.getRandomRows(tab, 3) ) -- will print three random rows, example {1,2,3}
```
