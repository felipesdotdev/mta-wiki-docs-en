---
doc_id: "mta-wiki:13790"
title: "GetElementDirectionCardialPoint"
source_title: "GetElementDirectionCardialPoint"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementDirectionCardialPoint"
revision_id: 78396
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:11.337716+00:00"
---

# GetElementDirectionCardialPoint

This function returns the direction of the element according to the *wind rose*.

## Syntax

```
string getElementDirectionCardialPoint( element theElement )
```

### Required Arguments

- **theElement**: The element to be able to get direction.

## Returns

Returns a [string](mta://reference/misc/string.md) indicating the cardinal direction the element is in (North, East, South and West). Otherwise nil.
...
This example displays on the Client screen the cardinal point of the direction in which it is.
...
addEventHandler("onClientRender", root, function()
    dxDrawText(getElementDirectionCardialPoint(localPlayer), 0, 0, 300, 300)
end)
```
