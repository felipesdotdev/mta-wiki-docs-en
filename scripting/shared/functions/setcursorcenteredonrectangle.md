---
doc_id: "mta-wiki:14140"
title: "SetCursorCenteredOnRectangle"
source_title: "SetCursorCenteredOnRectangle"
source_url: "https://wiki.multitheftauto.com/wiki/SetCursorCenteredOnRectangle"
revision_id: 78391
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:39.189077+00:00"
---

# SetCursorCenteredOnRectangle

This function will center the cursor inside of an rectangle.

## Syntax

```
bool setCursorCenteredOnRectangle ( float x, float y, float width, float height)
```
...
```
function setCursorCenteredOnRectangle(x, y, width, height)
...
setCursorCenteredOnRectangle(sx * 200, sy * 500, sx * 200, sy * 33)

addEventHandler("onClientRender", root, function()
    dxDrawRectangle(sx * 200, sy * 500, sx * 200, sy * 33, tocolor(255, 0, 0, 255), false)
end)
```
