---
doc_id: "mta-wiki:10082"
title: "PL/Hsv2rgb"
source_title: "Hsv2rgb"
source_url: "https://wiki.multitheftauto.com/wiki/Hsv2rgb"
revision_id: 54555
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:43.652887+00:00"
---

# PL/Hsv2rgb

Funkcja ta zwraca podany kolor HSV w postaci RGB.

## Składnia

```
string hsv2rgb ( int h, int s, int v)
```
...
- **s:** Wartość 'saturation' (0-100).

- **v:** Wartość 'value' (0-100).
...
```
local color = hsv2rgb(283,99,100)
outputChatBox(color)
```
