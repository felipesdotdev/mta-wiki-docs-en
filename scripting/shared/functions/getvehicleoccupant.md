...
generated_at: "2026-07-26T16:15:28.408155+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getOccupant(...)*

### Required Arguments

- **theVehicle:** the [vehicle](mta://reference/misc/vehicle.md) of which you wish to retrieve the driver or a passenger.
...
Returns the [player](mta://reference/misc/player.md) sitting in the vehicle, or *false* if the seat is unoccupied or doesn't exist.
