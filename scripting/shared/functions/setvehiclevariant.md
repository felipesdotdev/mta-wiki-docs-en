...
generated_at: "2026-07-26T16:16:48.918816+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setVariant(...)*

**Counterpart**: *[getVehicleVariant](mta://scripting/shared/functions/getvehiclevariant.md)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) that you want to set the variant.
