---
doc_id: "mta-wiki:10997"
title: "Preprocessor"
source_title: "Preprocessor"
source_url: "https://wiki.multitheftauto.com/wiki/Preprocessor"
revision_id: 60903
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:29.952512+00:00"
---
...
```
bool preprocess( string code, function theCallbackFunction )
```

### Required Arguments

- **code**: A code for preprocessing

- **theCallbackFunction**: The function who will recive

### Returns

True if both argument are valid
...
function preprocess( code, cb )
  if( code and cb)then
    fetchRemote ( "https://godbolt.org/api/compiler/g82/compile?options=-E",{postData = code, method = "POST"},
