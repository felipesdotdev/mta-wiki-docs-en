---
doc_id: "mta-wiki:5456"
title: "GetElementAttachedOffsets"
source_title: "GetElementAttachedOffsets"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementAttachedOffsets"
revision_id: 48692
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:15:10.605577+00:00"
---

# GetElementAttachedOffsets

This function returns the offsets of an element that has been attached to another element using [attachElements](mta://scripting/shared/functions/attachelements.md).
...
**Method**: *[element](mta://reference/misc/element.md):getAttachedOffsets(...)*

**Counterpart**: *[setElementAttachedOffsets](mta://scripting/shared/functions/setelementattachedoffsets.md)*
...
Returns 6 [floats](mta://reference/misc/float.md), of which the first 3 indicate the position offset (x, y, z), and the last 3 indicate the rotation offset (x, y, z), if successful. *false* otherwise.
