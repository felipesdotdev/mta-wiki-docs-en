---
doc_id: "mta-wiki:13348"
title: "Math.rotVecToEulerAngle"
source_title: "Math.rotVecToEulerAngle"
source_url: "https://wiki.multitheftauto.com/wiki/Math.rotVecToEulerAngle"
revision_id: 72061
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:10.453770+00:00"
---

# Math.rotVecToEulerAngle

Syntax

```
float float float math.rotVecToEulerAngle( float x, float y, float z, float rot )
```

### Required Arguments

- **x**: A float of the x of the rotation vector.

- **y**: A float of the y of the rotation vector.

- **z**: A float of the z of the rotation vector.

- **rot**: A float of the rotation of the rotation vector.

### Returns

Returns three floats indicates rotX, rotY and rotZ.

## Code

```
function math.rotVecToEular( x, y, z, rot ) 
...
```
local x,y,z,rot = 1,0,0,0
print( math.rotVecToEular( x, y, z, rot )  )
```
