---
doc_id: "mta-wiki:11910"
title: "FindEmptyCarSeat"
source_title: "FindEmptyCarSeat"
source_url: "https://wiki.multitheftauto.com/wiki/FindEmptyCarSeat"
revision_id: 64861
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:01.242627+00:00"
---

# FindEmptyCarSeat

This function allows you to find the first empty seat in a vehicle. Returns false if it did not find an empty seat.

## Syntax

```
int findEmptyCarSeat( vehicle vehicle )
```

### Required Arguments

- **vehicle**: a vehicle element

### Returns

Returns seat number if there is a seat available, *false* otherwise.
