---
doc_id: "mta-wiki:14307"
title: "String.startsWith"
source_title: "String.startsWith"
source_url: "https://wiki.multitheftauto.com/wiki/String.startsWith"
revision_id: 79425
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:54.004299+00:00"
---

# String.startsWith

This function checks if a string starts with other string.
...
- **suffix**: Prefix you want to check your string against

### Returns

Returns true if string starts with a prefix, false otherwise.
...
```
local str = 'Carl Johnson'
if str:startsWith('Carl') then
    iprint('Mr. C. '..str:sub(6))
end
```
