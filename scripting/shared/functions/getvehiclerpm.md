...
generated_at: "2026-07-26T16:15:28.691115+00:00"
---

# GetVehicleRPM

This function returns a [vehicle](mta://reference/misc/vehicle.md) engine speed. You will also need a function to [getElementSpeed](mta://scripting/shared/functions/getelementspeed.md).
...
It returns a [vehicle](mta://reference/misc/vehicle.md) engine speed. If not, it returns *0*.
