---
doc_id: "mta-wiki:13417"
title: "IsElementObject"
source_title: "IsElementObject"
source_url: "https://wiki.multitheftauto.com/wiki/IsElementObject"
revision_id: 77674
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:55.340691+00:00"
---

# IsElementObject

This function tells you if an element is an object or no.

## Syntax

```
bool isElementObject ( element theElement )
```

### Required Arguments

- **theElement:** The element that you wish to check if is an object or no.

### Returns

Returns **true** if element is an object, **false** otherwise.

## Code

```
function isElementObject(element)
   return isElement(element) and getElementType(element) == 'object'
end
```

**Author: Hydra45, Tracer**
