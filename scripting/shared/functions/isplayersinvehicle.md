---
doc_id: "mta-wiki:7817"
title: "IsVehicleOccupied"
source_title: "IsPlayersInVehicle"
source_url: "https://wiki.multitheftauto.com/wiki/IsPlayersInVehicle"
revision_id: 40941
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:00.091983+00:00"
---

# IsVehicleOccupied

This function checks if a [vehicle](mta://reference/misc/vehicle.md) is being occupied by a [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md).
...
- **vehicle**: The [vehicle](mta://reference/misc/vehicle.md) you want to check if it's occupied or not.
