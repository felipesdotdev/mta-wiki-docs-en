---
doc_id: "mta-wiki:13367"
title: "Math.clamp"
source_title: "Math.clamp"
source_url: "https://wiki.multitheftauto.com/wiki/Math.clamp"
revision_id: 82635
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:09.031974+00:00"
---

# Math.clamp

This function returns the number between range of numbers or it's minimum or maximum. Alternatively if you can remember "min max min max" do math.min(math.max(x, min), max)
...
- **number**: Number that will be compared with range.
...
**Author**: Olez14, Xenius

## Example

```
local num = math.clamp(50, 1, 100)
print(num)
-- This prints 50.0

local num = math.clamp(-10, 1, 100)
print(num)
-- This prints 1.0

local num = math.clamp(225, 1, 100)
print(num)
-- This prints 100.0
```
