---
doc_id: "mta-wiki:13681"
title: "RGBToDecimal"
source_title: "RGBToDecimal"
source_url: "https://wiki.multitheftauto.com/wiki/RGBToDecimal"
revision_id: 74621
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:30.814634+00:00"
---

# RGBToDecimal

This function convert RGB color to Decimal color.

## Syntax

```
RGBToDecimal( float r, float g, float b )
```
...
Returns a decimal [integer](mta://reference/misc/integer.md) converted from specified RGB values
...
print(RGBToDecimal(r, g, b)) -- output: 16711680
```

## Author

[Lettify](https://wiki.multitheftauto.com/wiki/User:Lettify)
