...
generated_at: "2026-07-26T16:15:17.852152+00:00"
---

# GetPedMaxOxygenLevel

This functions gets the maximum oxigen level a [ped](mta://reference/misc/ped.md) should have, considering its max underwater stamina (225) and stamina (22) [stat](https://wiki.multitheftauto.com/wiki/Template:Stats).
...
- **thePed:** the [ped](mta://reference/misc/ped.md) whose maximum oxygen level you want to get.

### Returns

A *float* with the maximum oxygen level of the specified [ped](mta://reference/misc/ped.md), an error if a invalid [ped](mta://reference/misc/ped.md) was passed.
