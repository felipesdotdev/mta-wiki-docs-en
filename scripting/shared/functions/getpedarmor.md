...
generated_at: "2026-07-26T16:15:16.940971+00:00"
---

# GetPedArmor

This function returns the current armor of the specified [ped](mta://reference/misc/ped.md).
...
**Method**: *[ped](mta://reference/misc/ped.md):getArmor(...)*
...
- **thePed:** The [ped](mta://reference/misc/ped.md) whose armor you want to check
