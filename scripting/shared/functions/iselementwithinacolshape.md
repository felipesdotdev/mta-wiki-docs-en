...
generated_at: "2026-07-26T16:15:55.814696+00:00"
---

# IsElementWithinAColShape

This function checks if the [element](mta://reference/misc/element.md) is in a [colshape](mta://reference/misc/colshape.md).
...
Returns a [colshape](mta://reference/misc/colshape.md) the [element](mta://reference/misc/element.md) is in else false if the element isn't in one or no arguments were passed.
