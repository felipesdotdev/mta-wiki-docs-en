---
doc_id: "mta-wiki:3973"
title: "GetPedAmmoInClip"
source_title: "GetPedAmmoInClip"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedAmmoInClip"
revision_id: 73882
language: "en"
categories: ["Server_functions", "Client_functions", "Functions_and_events_with_issues"]
generated_at: "2026-07-26T16:15:16.722203+00:00"
---

# GetPedAmmoInClip

This function returns an integer that contains the ammo in a specified [ped](mta://reference/misc/ped.md)'s weapon. See [Weapon Info](mta://reference/misc/weapon.md)
...
**Method**: *[ped](mta://reference/misc/ped.md):getAmmoInClip(...)*

**Variable**: *.ammoInClip*

### Required Arguments

- **thePed:** The [ped](mta://reference/misc/ped.md) whose ammo you want to check.
...
Returns an [int](mta://reference/misc/int.md) containing the amount of ammo in the specified ped's currently selected or specified clip, or 0 if the ped specified is invalid.
