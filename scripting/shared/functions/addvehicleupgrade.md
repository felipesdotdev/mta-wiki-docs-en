...
generated_at: "2026-07-26T16:10:20.990339+00:00"
---

# AddVehicleUpgrade

This function adds an upgrade to a [vehicle](mta://reference/misc/vehicle.md), e.g. nitrous, hydraulics.
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):addUpgrade(...)*

### Required Arguments

- **theVehicle**: The [element](mta://reference/misc/element.md) representing the [vehicle](mta://reference/misc/vehicle.md) you wish to add the upgrade to.
