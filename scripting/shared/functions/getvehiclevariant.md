...
generated_at: "2026-07-26T16:15:29.559665+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getVariant(...)*

**Counterpart**: *[setVehicleVariant](mta://scripting/shared/functions/setvehiclevariant.md)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) that you want to get the variant of.
...
This example tells the [player](mta://reference/misc/player.md) in the [vehicle](mta://reference/misc/vehicle.md) what their vehicle variants are with a command named *getvehvar*:
