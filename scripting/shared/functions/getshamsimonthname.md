---
doc_id: "mta-wiki:11539"
title: "GetShamsiMonthName"
source_title: "GetShamsiMonthName"
source_url: "https://wiki.multitheftauto.com/wiki/GetShamsiMonthName"
revision_id: 63342
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:24.877449+00:00"
---

# GetShamsiMonthName

This function returns the shamsi month name.
...
```
getShmasiMonthName( int month)
```

## Returns

This function returns a string containing the month name ( Shamsi )
...
This example output the first shamsi month.

```
addCommandHandler("firstmonth",
function ()
	local month = GetShmasiMonthName(1)
...
```
function firstMonth(thePlayer,command)
	outputChatBox("First Month: "..GetShmasiMonthName(1).." ",thePlayer)
end
addCommandHandler("firstmonth", firstMonth)
```
