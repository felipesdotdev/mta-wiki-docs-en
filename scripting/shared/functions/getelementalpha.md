---
doc_id: "mta-wiki:2741"
title: "GetElementAlpha"
source_title: "GetElementAlpha"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementAlpha"
revision_id: 43750
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:15:10.536194+00:00"
---

# GetElementAlpha

This function returns the alpha (transparency) value for the specified [element](mta://reference/misc/element.md). This can be a [player](mta://reference/misc/player.md), [ped](mta://reference/misc/ped.md), [object](mta://reference/misc/object.md), [vehicle](mta://reference/misc/vehicle.md) or [weapon](mta://reference/misc/element-weapon.md).
...
**Method**: *[element](mta://reference/misc/element.md):getAlpha(...)*

**Variable**: *.alpha*

**Counterpart**: *[setElementAlpha](mta://scripting/shared/functions/setelementalpha.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) whose alpha you want to retrieve.
