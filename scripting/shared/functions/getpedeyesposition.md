---
doc_id: "mta-wiki:9122"
title: "GetPedEyesPosition"
source_title: "GetPedEyesPosition"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedEyesPosition"
revision_id: 49156
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:17.345937+00:00"
---

# GetPedEyesPosition

This function allows you to get peds eyes position.

## Syntax

```
table getPedEyesPosition ( ped/player Ped )
```
...
```
{
{left eye x, left eye y, left eye z},
{right eye x, right eye y, right eye z}
}
```
