...
generated_at: "2026-07-26T16:16:47.803779+00:00"
---

# SetVehicleNitroActivated

This function activates or deactivates the nitro on the specified [vehicle](mta://reference/misc/vehicle.md), like if a player pressed the button for activating nitro.
...
- **theVehicle** The [vehicle](mta://reference/misc/vehicle.md) to activate or deactivate the nitro on.
