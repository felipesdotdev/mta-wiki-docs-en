...
generated_at: "2026-07-26T16:10:33.203906+00:00"
---
...
- **clearFor :** The [player](mta://reference/misc/player.md) whose chat is to be cleared. By default, this is set to the root element, which will affect all players.
