---
doc_id: "mta-wiki:12604"
title: "Math.lerp"
source_title: "Math.lerp"
source_url: "https://wiki.multitheftauto.com/wiki/Math.lerp"
revision_id: 76282
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:09.665470+00:00"
---
...
```
int math.lerp(int from, int to, int val)
```

### Required Arguments

- **val**: The number from 0 to 1

### Returns

Returns a number if everything went good, *to* otherwise.

## Code

```
-- Where b must be greater than a
