...
generated_at: "2026-07-26T16:15:11.414011+00:00"
---

# GetElementHealth

This function returns the current health for the specified [element](mta://reference/misc/element.md). This can be a [player](mta://reference/misc/player.md), a [ped](mta://reference/misc/ped.md), a [vehicle](mta://reference/misc/vehicle.md), or an [object](mta://reference/misc/object.md).
...
- **theElement:** The [player](mta://reference/misc/player.md) or [vehicle](mta://reference/misc/vehicle.md) whose health you want to check.
