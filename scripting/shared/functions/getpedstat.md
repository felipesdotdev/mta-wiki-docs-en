...
generated_at: "2026-07-26T16:15:18.132092+00:00"
---

# GetPedStat

This function returns the value of the specified statistic of a specific [ped](mta://reference/misc/ped.md).
...
**Method**: *[ped](mta://reference/misc/ped.md):getStat(...)*

### Required Arguments

- **thePed**: The [ped](mta://reference/misc/ped.md) whose stat you want to retrieve.
