...
generated_at: "2026-07-26T16:15:27.843003+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):getMaxPassengers(...)*

**Variable**: *.maxPassengers*

### Required Arguments

- **theVehicle:** the [vehicle](mta://reference/misc/vehicle.md) that you wish to know the maximum capacity of.
