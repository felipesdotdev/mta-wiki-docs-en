---
doc_id: "mta-wiki:14150"
title: "Table.flip"
source_title: "Table.flip"
source_url: "https://wiki.multitheftauto.com/wiki/Table.flip"
revision_id: 78300
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:55.904948+00:00"
---

# Table.flip

This function returns the [table](mta://reference/misc/table.md) from the last value to the first value, such as reflection.

## Syntax

```
table table.flip( table theTable )
```

### Required Arguments

- **theTable**: the [table](mta://reference/misc/table.md) to flip its values.

### Returns

Returns the table from the last value to the first value, such as reflection.
