---
doc_id: "mta-wiki:9768"
title: "GetCursorMovedOn"
source_title: "GetCursorMovedOn"
source_url: "https://wiki.multitheftauto.com/wiki/GetCursorMovedOn"
revision_id: 66839
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:09.625166+00:00"
---

# GetCursorMovedOn

This function checks in which way the cursor is currently moving, it's updated version of [https://wiki.multitheftauto.com/wiki/GetCursorMoveOn](https://wiki.multitheftauto.com/wiki/GetCursorMoveOn).

## Syntax

```
string getCursorMovedOn( )
```
...
This clientside example rotate camera around vehicle by mouse.

```
local isSpectating = false
local facing = 0
local vehicle = createVehicle(400, 0, 0, 6)
...
addCommandHandler( "resetViewMode", resetViewMode )

function spectateVehicle ()
    ...
    local turn = getCursorMovedOn()
	
    if turn == "right" then
        facing = facing + 0.00025
    elseif turn == "left" then
        facing = facing - 0.00025
    end
end
addEventHandler("onClientRender", getRootElement(), spectateVehicle)
```
