---
doc_id: "mta-wiki:10200"
title: "GuiFadeElement"
source_title: "GuiFadeElement"
source_url: "https://wiki.multitheftauto.com/wiki/GuiFadeElement"
revision_id: 55325
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:15:34.643826+00:00"
---

# GuiFadeElement

This function fades -decrease/increase- gui elements

## Syntax

```
guiFadeElement ( element guiElement, bool state[, int speed, int decrease/increase] )
```
...
- **state**: the new visibility state (true/false).

### Optional Arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](mta://reference/misc/optional-arguments--f0d8694a.md).

- **speed**: speed to decrease or increase the guiElement's alpha (from 50 to unlimited).

- **decrease/increase**: decrease/increase's amount (from 1 to 255).
...
**Author:** [killerProject](https://forum.mtasa.com/profile/51427-killerProject)
