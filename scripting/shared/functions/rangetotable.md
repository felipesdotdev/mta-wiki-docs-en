---
doc_id: "mta-wiki:8274"
title: "RangeToTable"
source_title: "RangeToTable"
source_url: "https://wiki.multitheftauto.com/wiki/RangeToTable"
revision_id: 78375
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:31.350472+00:00"
---
...
function rangeToTable( range )
    assert(type(range) == "string", "Bad argument @ 'rangeToTable' [Expected string at argument 1, got "..type(range).."]")
...
**Author:** MrTasty, [Youssef Maged (iManGaaX)](https://wiki.multitheftauto.com/wiki/User:IManGaaX)
...
```
local toStrings = rangeToTable("1,2-3,4") --Result: {1, 2, 3, 4}
for k, v in ipairs(toStrings) do
    outputChatBox(v)
end
--Result:
--1
