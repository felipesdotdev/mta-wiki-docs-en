---
doc_id: "mta-wiki:10526"
title: "AssignLod"
source_title: "AssignLod"
source_url: "https://wiki.multitheftauto.com/wiki/AssignLod"
revision_id: 80928
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:10:23.899226+00:00"
---

# AssignLod

This function is used to conveniently create a LOD for map objects.

|  | Warning: This outdated useful function will create an object with the same model ID as the High Level-of-Detail object, and assign it as the LLOD!! This is a terrible idea, and not optimized . Refer to createObject or createBuilding for a better explanation on how to properly handle LODs. |
| --- | --- |
|  |  |

### Required Arguments

- **element**: The object element you would like to generate a LOD for
...
This example shows how to correctly call the function by passing it an object spawned with createObject.
To use this, maps must first be converted from .map to .lua (createObject).

```
assignLOD(createObject(2283, -820.107421875, 512.89978027344, 21.44261932373, 0, 0, 22.4990234375))
assignLOD(createObject(1238, -823.825421875, 524.15778027344, 16.12261932373))
assignLOD(createObject(1238, -829.204421875, 536.33978027344, 15.98161932373))
```
