---
doc_id: "mta-wiki:13655"
title: "SvgCreateRoundedRectangle"
source_title: "SvgCreateRoundedRectangle"
source_url: "https://wiki.multitheftauto.com/wiki/SvgCreateRoundedRectangle"
revision_id: 74553
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:54.413259+00:00"
---

# SvgCreateRoundedRectangle

This function creates a rectangle with rounded edges by using svg

## Syntax

```
svg svgCreateRoundedRectangle(width, height, ratio, color1, [ borderWidth, color2 ])
```
...
- **ratio**: an integer representing the radius of the border.

- **color1**: represents a producing color by [tocolor](mta://scripting/shared/functions/tocolor.md).

### Optional arguments

- **borderWidth**: an integer representing the width of the border line.

- **color2**: represents a producing color by [tocolor](mta://scripting/shared/functions/tocolor.md).
...
local window = svgCreateRoundedRectangle(sx*0.3, sy*0.3, 15, tocolor(255,0,255,180))

addEventHandler( "onClientRender", getRootElement(),
	function()
		dxDrawImage((sx-sx*0.3)/2, (sy-sy*0.3)/2, sx*0.3, sy*0.3, window)
	end
)
```
