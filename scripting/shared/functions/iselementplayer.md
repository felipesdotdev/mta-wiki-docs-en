---
doc_id: "mta-wiki:13398"
title: "IsElementPlayer"
source_title: "IsElementPlayer"
source_url: "https://wiki.multitheftauto.com/wiki/IsElementPlayer"
revision_id: 78490
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:55.541352+00:00"
---
...
```
bool isElementPlayer ( element theElement )
```
...
Returns **true** if element is a **player** or **false** if element is not a **player**.
...
```
local marker = createMarker(-2324.6, -1628.594, 483.703 -1, "cylinder", 3, 255, 255, 0, 110)

function onMarkerHitted(theElement)
    if (isElementPlayer(theElement)) then
        outputChatBox("The theElement is a player.", root)
    else
        outputChatBox("The theElement is not a player, the theElement is a "..(getElementType(element))..".", root)
    end
end
addEventHandler("onMarkerHit", marker, onMarkerHitted)
```
