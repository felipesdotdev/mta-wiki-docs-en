---
doc_id: "mta-wiki:7079"
title: "IsPlayerInACL"
source_title: "IsPlayerInACL"
source_url: "https://wiki.multitheftauto.com/wiki/IsPlayerInACL"
revision_id: 78496
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:59.413431+00:00"
---

# IsPlayerInACL

This function checks if the player is in the target acl.
...
```
-- Make sure to only call this check with 'client' and not source or the equivalent (see https://wiki.multitheftauto.com/wiki/Script_security)
function checkAccess(client)
    if isPlayerInACL(client, "Admin") then
        outputChatBox("Access Granted!", client)
    else
        outputChatBox("Access Denied!", client)
    end
end
