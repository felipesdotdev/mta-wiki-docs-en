---
doc_id: "mta-wiki:3978"
title: "IsPedChoking"
source_title: "IsPedChoking"
source_url: "https://wiki.multitheftauto.com/wiki/IsPedChoking"
revision_id: 43065
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:15:57.895046+00:00"
---

# IsPedChoking

This function checks if the specified [ped](mta://reference/misc/ped.md) is choking (coughing) or not. This happens as a result of weapons that produce smoke - smoke grenades, fire extinguisher and the spray can.
...
**Method**: *[ped](mta://reference/misc/ped.md):isChoking(...)*

**Variable**: *.choking*

**Counterpart**: *[setPedChoking](mta://scripting/server/functions/setpedchoking.md)*

### Required Arguments

- **thePed**: The [ped](mta://reference/misc/ped.md) you wish to check
