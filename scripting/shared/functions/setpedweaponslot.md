...
generated_at: "2026-07-26T16:16:43.430828+00:00"
---

# SetPedWeaponSlot

This function changes the selected weapon slot of a [ped](mta://reference/misc/ped.md).
...
**Method**: *[ped](mta://reference/misc/ped.md):setWeaponSlot(...)*
...
- **thePed:** the [ped](mta://reference/misc/ped.md) whose weapon slot you want to set. In a clientside script, this cannot be used on remote players.
