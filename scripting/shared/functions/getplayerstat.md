...
generated_at: "2026-07-26T16:15:20.525596+00:00"
---
...
This function returns a float that contains the value of the specified statistic, for a specific [player](mta://reference/misc/player.md).
...
- **thePlayer**: The [player](mta://reference/misc/player.md) whose stat you want to retrieve.
