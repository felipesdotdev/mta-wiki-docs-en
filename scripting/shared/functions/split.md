---
doc_id: "mta-wiki:1627"
title: "Split"
source_title: "Split"
source_url: "https://wiki.multitheftauto.com/wiki/Split"
revision_id: 78593
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:16:52.288126+00:00"
---
...
**Note:** You can use the function [gettok](mta://scripting/shared/functions/gettok.md) to retrieve a single token from the string at a specific index. This may be faster for one-off lookups, but considerably slower if you are going to check each token in a long string.
...
- **separatingChar** A string of the character you want to split, or the [ASCII number](mta://reference/misc/ascii.md) representing the character you want to use to split. If you want to split a string at multiple characters see [splitMultiple](mta://scripting/shared/functions/splitmultiple.md)
