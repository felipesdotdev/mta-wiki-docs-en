---
doc_id: "mta-wiki:12872"
title: "GradientString"
source_title: "GradientString"
source_url: "https://wiki.multitheftauto.com/wiki/GradientString"
revision_id: 69736
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:31.231363+00:00"
---

# GradientString

This function lets you transform a string in a new coloured gradient string.

## Syntax

```
string gradientString ( string str )
```

### Required Arguments

- **str:** The string you want to transform in gradient.

### Returns

Returns the new coloured gradient string.
...
```
function gradientString(str)
    local cr, cg, cb
    local r, g, b = math.random(255), math.random(255), math.random(255)
    
    return string.gsub(str, "(%w+)", function(w)
        -- R
        if not cr then
            r = r - 25
            if r <= 0 then
        ...
        return string.format("#%.2X%.2X%.2X", r, g, b) .. w
    end)
end
```
