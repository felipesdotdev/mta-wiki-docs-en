---
doc_id: "mta-wiki:6543"
title: "DxDrawImage3D"
source_title: "DxDrawImage3D"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawImage3D"
revision_id: 64791
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:14:45.616616+00:00"
---

# DxDrawImage3D

This function draws a textured 3D line between two points in the 3D world that appers to be a 3D image - rendered for one frame  This should be used in conjunction with [onClientPreRender](mta://scripting/client/events/onclientprerender.md) in order to display continuously.
...
bool dxDrawImage3D ( float x, float y, float z, float width, float height, element material,
                   [ int color = white, float rotation = 0, [ bool postGUI = false, ] float faceTowardX, float faceTowardY, float faceTowardZ ] )
```
...
- **postGUI**: A bool representing whether the image should be drawn on top of or behind any ingame GUI.
