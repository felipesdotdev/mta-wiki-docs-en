...
generated_at: "2026-07-26T16:15:58.234036+00:00"
---

# IsPedDrivingVehicle

This function checks if a specified [ped](mta://reference/misc/ped.md) or [player](mta://reference/misc/player.md) is driving a [vehicle](mta://reference/misc/vehicle.md).
...
- **ped**: a [player](mta://reference/misc/player.md) or [ped](mta://reference/misc/ped.md) to check if it's driving a [vehicle](mta://reference/misc/vehicle.md) or not.

### Returns

Returns *true* and a vehicle if the specified ped is driving a [vehicle](mta://reference/misc/vehicle.md), *false* if it's not or a bad argument was passed.
