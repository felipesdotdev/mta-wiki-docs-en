...
generated_at: "2026-07-26T16:15:31.029241+00:00"
---

# GivePlayerMoney

This function adds money to a [player](mta://reference/misc/player.md)'s current money amount.  To set absolute values, [setPlayerMoney](mta://scripting/shared/functions/setplayermoney.md) can be used.
...
**Method**: *[player](mta://reference/misc/player.md):giveMoney(...)*

**Variable**: *.money*

### Required Arguments

- **thePlayer:** the [player](mta://reference/misc/player.md) you are giving the money to.
