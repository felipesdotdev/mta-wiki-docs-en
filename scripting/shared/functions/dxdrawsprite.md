---
doc_id: "mta-wiki:11648"
title: "DxDrawSprite"
source_title: "DxDrawSprite"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawSprite"
revision_id: 63636
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:47.771609+00:00"
---

# DxDrawSprite

This function draws a sprite in the 3D world.

## Syntax

```
dxDrawSprite( float x, float y, float z, float size, element material, int color )﻿
```

### Required arguments

- **X/Y/Z:** The center position of the sprite image, representing a coordinate in the GTA world.

- **size:** A size of the sprite.

- **material:** A material to draw the sprite with.

- **color:** A color of the sprite.
...
```
local material = dxCreateTexture("0.png")

addEventHandler("onClientRender", root, function()
        dxDrawSprite(0, 0, 3, 6, material, tocolor(255, 255, 255, 192))
    end
)
```

**Author:** Lex128 / Easterdie.
