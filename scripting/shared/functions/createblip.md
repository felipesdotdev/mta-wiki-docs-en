...
generated_at: "2026-07-26T16:10:36.918133+00:00"
---

# CreateBlip

This function creates a [blip](mta://reference/misc/blip.md) [element](mta://reference/misc/element.md), which is displayed as an icon on the client's radar.
...
Returns an [element](mta://reference/misc/element.md) of the [blip](mta://reference/misc/blip.md) if it was created successfully, *false* otherwise.
