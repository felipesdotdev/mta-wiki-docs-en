---
doc_id: "mta-wiki:14620"
title: "GetServerAveragePing"
source_title: "GetServerAveragePing"
source_url: "https://wiki.multitheftauto.com/wiki/GetServerAveragePing"
revision_id: 82424
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:24.589444+00:00"
---

# GetServerAveragePing

This function gets average players ping.
...
Returns the average players ping as integer.
  

Returns **0** if no players are online.
...
function getAveragePing()
    ...
    for _, player in ipairs(players) do
        totalPing = totalPing + getPlayerPing(player)
    end

    return math.floor(totalPing / #players)
end
```
...
```
addCommandHandler("avgping", function()
    local avg = getAveragePing()
    if avg > 0 then
        print("Average Ping: " .. avg .. " ms")
    else
