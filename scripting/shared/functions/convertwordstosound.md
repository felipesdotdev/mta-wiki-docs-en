---
doc_id: "mta-wiki:7906"
title: "ConvertTextToSpeech"
source_title: "ConvertWordsToSound"
source_url: "https://wiki.multitheftauto.com/wiki/ConvertWordsToSound"
revision_id: 66451
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:12:03.078267+00:00"
---
...
```
boolean, element, string convertTextToSpeech ( string text [, table/element broadcastTo = root, string language = "en" ] )
```
...
- This function returns *[nil](mta://reference/misc/nil.md)* and outputs an error if an argument it's not valid.
...
- If called clientside and if all arguments are valid, this function returns *true*, the corresponding [sound](mta://reference/misc/sound.md) element and its URL if the sound could theorically be played (althrough it may not play); *[nil](mta://reference/misc/nil.md)* otherwise.
...
- Original author: *Al Obaidi Hassan*.
