---
doc_id: "mta-wiki:13339"
title: "HexColorToRGB"
source_title: "HexColorToRGB"
source_url: "https://wiki.multitheftauto.com/wiki/HexColorToRGB"
revision_id: 71984
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:43.377916+00:00"
---

# HexColorToRGB

This function converts hex string to RGBA values.

## Syntax

```
int, int, int, int hexColorToRGB(string/int hex_color)
```

### Returns

Returns R, G, B, A colors if successful, otherwise false.
...
```
local color1 = 0xFFFF0000 -- the slowest
local color2 = '0xFFFF0000'
local color3 = '#FF0000'
local color4 = '#F00' -- the fastest

iprint(hexColorToRGB(color1)) -- 255, 0, 0, 255
iprint(hexColorToRGB(color2)) -- 255, 0, 0, 255
iprint(hexColorToRGB(color3)) -- 255, 0, 0, 255
iprint(hexColorToRGB(color4)) -- 255, 0, 0, 255
```
