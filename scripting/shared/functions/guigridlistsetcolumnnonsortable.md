---
doc_id: "mta-wiki:11609"
title: "GuiGridListSetColumnNonSortable"
source_title: "GuiGridListSetColumnNonSortable"
source_url: "https://wiki.multitheftauto.com/wiki/GuiGridListSetColumnNonSortable"
revision_id: 76263
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:38.253996+00:00"
---

# GuiGridListSetColumnNonSortable

This prevents the player from sorting a specific gridlist column. If you need to disable sorting of all columns, you can use [GuiSetProperty](mta://scripting/client/functions/guisetproperty.md) on the gridlist.
...
- **gridList:** The grid list you want to set the column non-sortable.

- **columnID:** An integer representing the column which will be non-sortable.

### Returns

Returns *true* if the gridlist column is no longer sortable, *false* if bad arguments were given.
...
This example creates a gridlist with two columns. After the rows has been successfully created, we make the second column non-sortable. If the player clicks on it, nothing happens and the column remains as is. The first column is still sortable.
...
guiGridListAddColumn (gridlist, "Column One", 0.5)
guiGridListAddColumn (gridlist, "Column Two", 0.4)
guiGridListAddRow (gridList, "Hello", "World")
guiGridListAddRow (gridList, "Lua", "Script")
guiGridListSetColumnNonSortable (gridList, 2)
```
