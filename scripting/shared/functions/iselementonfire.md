---
doc_id: "mta-wiki:14510"
title: "IsElementOnFire"
source_title: "IsElementOnFire"
source_url: "https://wiki.multitheftauto.com/wiki/IsElementOnFire"
revision_id: 82177
language: "en"
categories: ["Server_functions", "Client_functions", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:55.370493+00:00"
---
...
This function checks if the specified [element](mta://reference/misc/element.md) is on fire or not. 
...
**Method**: *[element](mta://reference/misc/element.md):isOnFire(...)*

**Variable**: *.onFire*

**Counterpart**: *[setElementOnFire](mta://scripting/shared/functions/setelementonfire.md)*

### Required Arguments

- **theElement**: The [element](mta://reference/misc/element.md) to check.

### Returns

Returns *true* if the [element](mta://reference/misc/element.md) is on fire, *false* otherwise.
