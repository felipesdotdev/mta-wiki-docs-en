---
doc_id: "mta-wiki:11098"
title: "GetTableFromSql"
source_title: "GetTableFromSql"
source_url: "https://wiki.multitheftauto.com/wiki/GetTableFromSql"
revision_id: 67965
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:25.850556+00:00"
---

# GetTableFromSql

This functionality is used to obtain saved tables using the function ([SetTableToSql](https://wiki.multitheftauto.com/wiki/SetTableToSql))

## Syntax

```
table getTableFromSql ( string/int id )﻿
```

### Required arguments

- **id**: The identifier to which the table was previously saved by using the function ([SetTableToSql](https://wiki.multitheftauto.com/wiki/SetTableToSql)).

### Returns

Returns a table containing the previously saved data or an empty table.
...
- getTableFromSql » This functionality is used to obtain saved tables using the function ([SetTableToSql](https://wiki.multitheftauto.com/wiki/SetTableToSql)).
