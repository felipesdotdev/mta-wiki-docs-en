...
generated_at: "2026-07-26T16:15:59.558949+00:00"
---

# IsPlayerInTeam

This function checks if the specified [player](mta://reference/misc/player.md) is in the specified [team](mta://reference/misc/team.md).
...
- **thePlayer**: the [player](mta://reference/misc/player.md) you want to check if it's in the specified [team](mta://reference/misc/team.md).

- **theTeam**: a [team](mta://reference/misc/team.md) element or name to check if the [player](mta://reference/misc/player.md) is in it. If not specified, this function will return *true* if the [player](mta://reference/misc/player.md) is in any [team](mta://reference/misc/team.md).
