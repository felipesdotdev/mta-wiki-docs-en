...
generated_at: "2026-07-26T16:15:10.572368+00:00"
---
...
- **theElement:** The [element](mta://reference/misc/element.md) to retrieve the angular velocity from. Can be either a [player](mta://reference/misc/player.md), [ped](mta://reference/misc/ped.md), [object](mta://reference/misc/object.md), [vehicle](mta://reference/misc/vehicle.md) or a [custom weapon](mta://reference/misc/element-weapon.md). **Server side supports only vehicles currently.**
