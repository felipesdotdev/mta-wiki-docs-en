---
doc_id: "mta-wiki:5686"
title: "CenterWindow"
source_title: "CenterWindow"
source_url: "https://wiki.multitheftauto.com/wiki/CenterWindow"
revision_id: 50847
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:11:28.315770+00:00"
---
...
This example creates an already centralized window without the function above.

```
addEventHandler("onClientResourceStart", resourceRoot, function ()
    local screenWidth, screenHeight = guiGetScreenSize()
    centralWindow = guiCreateWindow ((screenWidth - 600) / 2, (screenHeight  - 500) / 2, 600, 500, "Window Centralized", false)
end, false)
```
