...
generated_at: "2026-07-26T16:15:18.333718+00:00"
---

# GetPedTotalAmmo

This function returns an integer that contains the total ammo in a specified [ped](mta://reference/misc/ped.md)'s weapon. See [Weapon Info](mta://reference/misc/weapon.md)
...
**Method**: *[ped](mta://reference/misc/ped.md):getTotalAmmo(...)*
