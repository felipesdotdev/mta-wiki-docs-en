...
generated_at: "2026-07-26T16:16:41.282150+00:00"
---
...
**Method**: *[Marker](mta://reference/misc/marker.md):setColor(...)*

**Counterpart**: *[getMarkerColor](mta://scripting/shared/functions/getmarkercolor.md)*

### Required Arguments

- **theMarker:** The [marker](mta://reference/misc/marker.md) that you wish to set the color of.
