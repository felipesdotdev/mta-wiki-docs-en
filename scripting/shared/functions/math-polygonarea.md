---
doc_id: "mta-wiki:10171"
title: "Math.polygonArea"
source_title: "Math.polygonArea"
source_url: "https://wiki.multitheftauto.com/wiki/Math.polygonArea"
revision_id: 55112
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:16:10.145939+00:00"
---

# Math.polygonArea

This function compute area of any polygon.

## Syntax

```
float math.polygonArea(float vertex1x, float vertex1y, float vertex2x, float vertex2y, float vertex3x, float vertex3y,  [...] )
```
...
Return polygon area in meters^2
...
This example compute area of cube 1x1 and triangle, base=5, height=4

```
local cubeArea = math.polygonArea(0,0, 1,0, 1,1, 0,1) -- cube -- 1
local triangleArea = math.polygonArea(0,0, 5,4, 5,0) -- triangle -- 10
-- triangleArea
--[[
  height: 4
  base: 5
  area = 1/2 * height * base = 10
  area = 1/2 * 4 = 2 * 5 = 10
]]--
print( cubeArea, triangleArea )
```

Author: CrosRoad95, based on [https://www.mathopenref.com/coordpolygonarea2.html](https://www.mathopenref.com/coordpolygonarea2.html)
