---
doc_id: "mta-wiki:4708"
title: "FormatDate"
source_title: "FormatDate"
source_url: "https://wiki.multitheftauto.com/wiki/FormatDate"
revision_id: 79525
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:15:02.242995+00:00"
---
...
```
string formatDate( string theFormat, [ string escaper = "'", int timestamp = GetTimestamp() ] )
```
...
function OnPlayerJoin()
    ...
    outputChatBox(formatDate("'You joined our server on' m/d/Y at h:i."))
end
