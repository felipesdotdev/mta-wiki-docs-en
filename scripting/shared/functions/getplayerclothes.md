...
generated_at: "2026-07-26T16:15:19.214265+00:00"
---
...
This function is used to get the current clothes texture and model of a certain type on a [player](mta://reference/misc/player.md).
...
- **thePlayer:** The [player](mta://reference/misc/player.md) whose clothes you want to retrieve.
