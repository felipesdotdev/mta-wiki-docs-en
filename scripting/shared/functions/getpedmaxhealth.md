...
generated_at: "2026-07-26T16:15:17.668457+00:00"
---

# GetPedMaxHealth

This functions gets the maximum health a [ped](mta://reference/misc/ped.md) should have, considering its max health (24) [stat](https://wiki.multitheftauto.com/wiki/Template:Stats).
...
- **thePed:** the [ped](mta://reference/misc/ped.md) whose maximum health you want to get.

### Returns

A *float* with the maximum health of the specified [ped](mta://reference/misc/ped.md), an error if a invalid [ped](mta://reference/misc/ped.md) was passed.
