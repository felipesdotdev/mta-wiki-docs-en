---
doc_id: "mta-wiki:12386"
title: "String.insert"
source_title: "String.insert"
source_url: "https://wiki.multitheftauto.com/wiki/String.insert"
revision_id: 66808
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:53.302351+00:00"
---

# String.insert

This function inserts a string within another string at a given position

## Syntax

```
string string.insert( string mainString, string stringToInsert, int pos )
```

### Required Arguments

- **mainString**: Main string that will be used to add the *stringToInsert*.

- **stringToInsert**: String to be added to *mainString*.

- **pos**: An integer determining the position where the *stringToInsert* will be inserted.

### Returns

Returns the string with successful inserts
...
This simple example inserts the word **beautiful** into the text *Hello World* and print it.

```
text = 'Hello world'

local second_text = string.insert(text, 'beautiful ', 6) -- output:  'Hello beautiful world'
...
local second_text = text:insert('wonderful ', 6) -- output:  'Hello wonderful world'
