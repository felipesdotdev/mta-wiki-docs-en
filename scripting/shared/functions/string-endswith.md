---
doc_id: "mta-wiki:14305"
title: "String.endsWith"
source_title: "String.endsWith"
source_url: "https://wiki.multitheftauto.com/wiki/String.endsWith"
revision_id: 79421
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:53.022954+00:00"
---

# String.endsWith

This function checks if a string ends with other string.
...
- **suffix**: Suffix you want to check your string against

### Returns

Returns true if string ends with a suffix, false otherwise.
...
if str:endsWith('World!') then
    iprint('World says Hello!')
else
    iprint(str:sub(8, -2).. 'says Hello!')
end
```
