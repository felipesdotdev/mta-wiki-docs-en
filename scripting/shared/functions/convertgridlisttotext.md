---
doc_id: "mta-wiki:10833"
title: "ConvertGridListToText"
source_title: "ConvertGridListToText"
source_url: "https://wiki.multitheftauto.com/wiki/ConvertGridListToText"
revision_id: 77886
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:10:35.569442+00:00"
---

# ConvertGridListToText

This function converts the grid list contents to a text that can be written in a notepad

## Syntax

```
string convertGridListToText ( element gridList )
```
...
Returns a text if the arguments are right, false otherwise.
...
addEventHandler ( "onClientResourceStart", resourceRoot,
	function ( )
		...
		guiGridListAddColumn( playerList, "id", 0.2 ) 
		guiGridListAddColumn( playerList, "name", 0.75 ) 
		for id, player in ipairs(getElementsByType("player")) do 
			local row = guiGridListAddRow ( playerList )
			guiGridListSetItemText ( playerList, row, 1, id, false, false )
			guiGridListSetItemText ( playerList, row, 2, getPlayerName ( player ), false, false )
		end
		local report = convertGridListToText ( playerList )
		if report then
			setClipboard ( report )
			outputChatBox ( "* Use CTRL+V to paste the report." )
		end
	end
)
```
