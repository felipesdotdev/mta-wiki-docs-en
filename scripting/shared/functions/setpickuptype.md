...
generated_at: "2026-07-26T16:16:43.560154+00:00"
---
...
- **weapon**: If the type is a Weapon pickup, then it represents the [weapon ID](mta://reference/misc/weapon.md) of the weapon pickup the 'ammo' field must be entered if the type is Weapon Pickup.
