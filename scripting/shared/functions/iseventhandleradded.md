---
doc_id: "mta-wiki:9846"
title: "IsEventHandlerAdded"
source_title: "IsEventHandlerAdded"
source_url: "https://wiki.multitheftauto.com/wiki/IsEventHandlerAdded"
revision_id: 68011
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:56.004985+00:00"
---
...
| [[{{{image}}}\|link=\|]] | Note: Consider using a variable instead of this function. Using this function will be worse for the script performance than with a variable. |
| --- | --- |
|  |  |
...
- **eventName:** The name of the [event](mta://reference/misc/event.md) you want to attach the handler function to.
