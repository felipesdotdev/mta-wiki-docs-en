---
doc_id: "mta-wiki:13891"
title: "IsCommandHandlerAdded"
source_title: "IsCommandHandlerAdded"
source_url: "https://wiki.multitheftauto.com/wiki/IsCommandHandlerAdded"
revision_id: 76218
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:53.880947+00:00"
---

# IsCommandHandlerAdded

Checks if a command is added in the respective resource.

## Syntax

```
isCommandHandlerAdded(string command)
```

### Required Arguments

- **command:** The name of the command you want to check.

### Returns

Return true if the command exists and false if not.
...
```
function isCommandHandlerAdded(theCmd)
...
addEventHandler("onPlayerCommand", root, function(cmd)
    for _, tele in ipairs(tps) do
        if cmd == tele then
           if not isCommandHandlerAdded(tele) then
              print("Indeed, it's not added")
           else
              print("Seems like it's added")
           end
        end
    end
end)

addCommandHandler("sf", function(thePlayer, _)
end)
```
