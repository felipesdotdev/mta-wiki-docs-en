---
doc_id: "mta-wiki:13653"
title: "GetPlayerNameFromID"
source_title: "GetPlayerNameFromID"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayerNameFromID"
revision_id: 74489
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:20.162680+00:00"
---

# GetPlayerNameFromID

This function will get the player name using the ID element data.

## Syntax

```
bool getPlayerNameFromID(number theID, element theElement)
```
...
**The example will show you how to get the player name using getPlayerNameFromID**

```
function SetIDOnJoin()
   setElementData(source, "ID", math.random(1, 500))
end
addEventHandler("onPlayerJoin", root, SetIDOnJoin)

function getMyID(thePlayer, theCommand)
   iprint(getPlayerNameFromID(getElementData(thePlayer, "ID"), thePlayer))
end
addCommandHandler("tid", getMyID)
```
