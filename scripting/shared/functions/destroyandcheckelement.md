---
doc_id: "mta-wiki:11214"
title: "DestroyAndCheckElement"
source_title: "DestroyAndCheckElement"
source_url: "https://wiki.multitheftauto.com/wiki/DestroyAndCheckElement"
revision_id: 62177
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:11:20.878561+00:00"
---

# DestroyAndCheckElement

This function checks if an element exists when it exists destroys it.

## Syntax

```
bool destroyAndCheckElement(element theElement)
```

### Required Arguments

- **theElement**: The element to destroy.

### Returns

Returns true if the element was destroyed successfully, false if the element not exists.
...
```
local ped = createPed(2, 0, 0, 0, 0)

local destroy = destroyAndCheckElement(ped)
