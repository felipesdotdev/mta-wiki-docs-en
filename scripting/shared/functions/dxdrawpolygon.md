---
doc_id: "mta-wiki:9859"
title: "DxDrawPolygon"
source_title: "DxDrawPolygon"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawPolygon"
revision_id: 53863
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:14:46.586999+00:00"
---

# DxDrawPolygon

This function draws a polygon with a custom number of its sides.

## Syntax

```
dxDrawPolygon( int x, int y, float radius, int sides, int color, [ float rotation, float width=1 ] )
```

### Required Arguments

- **x:** An float representing the absolute X position of the middle of the polygon's circumcircle.

- **y:** An float representing the absolute Y position of the middle of the polygon's circumcircle.

- **radius:** A float representing the radius of the polygon's circumcircle.

- **sides:** An float representing the number of the polygon's sides.

- **color:** An integrer of the hex color, produced using [tocolor](mta://scripting/shared/functions/tocolor.md) or 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).

## Optional Arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](mta://reference/misc/optional-arguments--f0d8694a.md).

- **rotation:** A float representing the polygon's rotation in degrees.

- **width:** A float representing how thick the polygon's sides will be.
...
This example draws a white hexagon in the middle of the screen.

```
local sx, sy = guiGetScreenSize()

addEventHandler("onClientRender", root, function()
   dxDrawPolygon(sx/2, sy/2, 100, 6, tocolor(255,255,255,255), 0, 3)
end)
```
