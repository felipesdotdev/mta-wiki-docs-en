---
doc_id: "mta-wiki:8144"
title: "IsMouseInPosition"
source_title: "IsMouseInPosition"
source_url: "https://wiki.multitheftauto.com/wiki/IsMouseInPosition"
revision_id: 75307
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:57.060508+00:00"
---

# IsMouseInPosition

This function allows you to check whether the mouse cursor/pointer is within a rectangular position. You can use the alternative version to check DX text.
...
Draws a rectangle in the middle of the screen, which changes color to cyan blue when you move the cursor over it.

```
local screenX, screenY = guiGetScreenSize()
local panelX, panelY, panelW, panelH = (screenX - 400) * 0.5, (screenY - 400) * 0.5, 400, 400
local panelColor = tocolor(230, 230, 230, 255)
