---
doc_id: "mta-wiki:1726"
title: "GetElementPosition"
source_title: "GetElementPosition"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementPosition"
revision_id: 72832
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:15:11.643006+00:00"
---
...
- [Players](mta://reference/misc/element-player.md)

- [Vehicles](mta://reference/misc/element-vehicle.md)

- [Objects](mta://reference/misc/element-object.md)

- [Pickups](mta://reference/misc/element-pickup.md)

- [Markers](mta://reference/misc/element-marker.md)

- [Collision shapes](mta://reference/misc/element-collision-shape.md)

- [Blips](mta://reference/misc/element-blip.md)

- [Radar areas](mta://reference/misc/element-radar-area.md)
...
**Method**: *[element](mta://reference/misc/element.md):getPosition(...)*

**Variable**: *.position*

**Counterpart**: *[setElementPosition](mta://scripting/shared/functions/setelementposition.md)*
