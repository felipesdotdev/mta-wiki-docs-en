...
generated_at: "2026-07-26T16:16:47.393686+00:00"
---
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setLightState(...)*

**Counterpart**: *[getVehicleLightState](mta://scripting/shared/functions/getvehiclelightstate.md)*

## Required Arguments

- **theVehicle:** A handle to the [vehicle](mta://reference/misc/vehicle.md) that you wish to change the light state of.
