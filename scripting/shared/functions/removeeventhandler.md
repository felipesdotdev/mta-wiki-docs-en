...
generated_at: "2026-07-26T16:16:32.252663+00:00"
---

# RemoveEventHandler

This functions removes a handler function from an [event](mta://reference/misc/event.md), so that the function is not called anymore when the event is triggered. See [event system](mta://reference/misc/event-system.md) for more information on how the event system works.
...
- **eventName:** The name of the [event](mta://reference/misc/event.md) you want to detach the handler function from.
