---
doc_id: "mta-wiki:13219"
title: "GetRealMonth"
source_title: "GetRealMonth"
source_url: "https://wiki.multitheftauto.com/wiki/GetRealMonth"
revision_id: 71123
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:22.918720+00:00"
---

# GetRealMonth

This function returns the current month name.
...
```
addCommandHandler("realMonth",
    function()
        local realMonth = getRealMonth()
        outputChatBox(realMonth, 255, 0, 0)
    end	
)
```
