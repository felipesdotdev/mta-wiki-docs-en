---
doc_id: "mta-wiki:13395"
title: "Math.percentProgress"
source_title: "Math.percentProgress"
source_url: "https://wiki.multitheftauto.com/wiki/Math.percentProgress"
revision_id: 72932
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:09.984466+00:00"
---

# Math.percentProgress

This function returns a percentage progress from two specific values.

## Syntax

```
float math.percentProgress(float cur_value, float maxvalue [, int decimal])
```

### Required Arguments

- **cur_value**: The current value (Like **480**/1000).

- **maxvalue**: The max value (Like 480/**1000**).

- **decimal**: How many decimal places the percentage will have at most. Default is 1.
...
This example returns how is the current progress of a player do get max points.

```
local current_point = 150
local points_to_win = 500
local n = math.percentProgress(current_point, points_to_win, 0)
print('Your progress is', n) -- output: 30%
```
