---
doc_id: "mta-wiki:10755"
title: "SetElementAngularVelocity"
source_title: "SetElementAngularVelocity"
source_url: "https://wiki.multitheftauto.com/wiki/SetElementAngularVelocity"
revision_id: 81197
language: "en"
categories: ["Server_functions", "Client_functions", "Changes_in_1.5.5"]
generated_at: "2026-07-26T16:16:39.616921+00:00"
---
...
**Method**: *[element](mta://reference/misc/element.md):setAngularVelocity(...)*

**Variable**: *.angularVelocity*

**Counterpart**: *[getElementAngularVelocity](mta://scripting/shared/functions/getelementangularvelocity.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) to apply the spin to. Can be either a [player](mta://reference/misc/player.md), [ped](mta://reference/misc/ped.md), [object](mta://reference/misc/object.md), [vehicle](mta://reference/misc/vehicle.md) or a [custom weapon](mta://reference/misc/element-weapon.md).
