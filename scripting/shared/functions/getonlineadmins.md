---
doc_id: "mta-wiki:6549"
title: "GetOnlineAdmins"
source_title: "GetOnlineAdmins"
source_url: "https://wiki.multitheftauto.com/wiki/GetOnlineAdmins"
revision_id: 78278
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:16.568297+00:00"
---
...
addCommandHandler("admins",function(p)
	...
	outputChatBox((#Admins == 0 and "No " or "").."Online Admins", p, 255, 0, 0, true) -- if the table empty show 'No Online Admins' and if not empty show 'Online Admins'
	if #Admins ~= 0 then -- if the admins table are not empty then
