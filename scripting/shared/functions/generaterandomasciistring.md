---
doc_id: "mta-wiki:8139"
title: "GenerateRandomASCIIString"
source_title: "GenerateRandomASCIIString"
source_url: "https://wiki.multitheftauto.com/wiki/GenerateRandomASCIIString"
revision_id: 57351
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:15:05.675631+00:00"
---
...
```
int generateRandomASCIIString( int stringLenght )
```

### Required Arguments

- **stringLenght**: How long the string should be.
...
*Fixed by: Pirulax AKA John_Lugo*

### Fixed

Fixed the bug where the function generated the same results every time when called.
