---
doc_id: "mta-wiki:4709"
title: "Check"
source_title: "Check"
source_url: "https://wiki.multitheftauto.com/wiki/Check"
revision_id: 55910
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:11:14.652490+00:00"
---
...
```
void check(string pattern, arguments [...])
```

### Arguments

- **pattern**: a string consisting of the first letter of each datatype passed into the function (see example)

- **arguments**: arguments to match the pattern
...
```
function warpPlayer(player, x, y, z)
	check('unnn', player, x, y, z) -- 'unnn' means userdata (player in this case), number, number, number
