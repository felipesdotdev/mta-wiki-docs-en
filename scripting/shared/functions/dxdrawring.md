---
doc_id: "mta-wiki:11226"
title: "DxDrawRing"
source_title: "DxDrawRing"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawRing"
revision_id: 76259
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:14:47.307799+00:00"
---

# DxDrawRing

This function draws a ring by using [dx-lines](mta://scripting/client/functions/dxdrawline.md). It can also draw an incomplete ring. This function should be used in conjunction with [onClientRender](mta://scripting/client/events/onclientrender.md) in order to display continuously.
...
- **color:** the hex color of the ring, produced using [tocolor](mta://scripting/shared/functions/tocolor.md) or 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).
