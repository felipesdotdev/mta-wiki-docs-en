...
generated_at: "2026-07-26T16:10:36.942228+00:00"
---

# CreateBlipAttachedTo

This function creates a [blip](mta://reference/misc/blip.md) that is attached to an [element](mta://reference/misc/element.md). This blip is displayed as an icon on the client's radar and will 'follow' the element that it is attached to around.
...
**Method**: *[Blip](mta://reference/misc/blip.md).createAttachedTo(...)*
...
Returns a [blip](mta://reference/misc/blip.md) if the blip was created succesfully, or *false* otherwise.
