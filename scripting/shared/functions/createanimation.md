---
doc_id: "mta-wiki:9492"
title: "Animate"
source_title: "CreateAnimation"
source_url: "https://wiki.multitheftauto.com/wiki/CreateAnimation"
revision_id: 71565
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:12:21.081952+00:00"
---
...
```
animation animate(int/float from, int/float to, string/int easing, int duration, function onChange [ , function onEnd ])
```
...
- **easing**: the [easing function](mta://reference/misc/easing.md) to use for the animation or can be used the easing number, e.g. "Linear" = 1, "InQuad" = 2, "OutQuad" = 3, ...
...
Returns animation or false if invalid arguments were passed.
