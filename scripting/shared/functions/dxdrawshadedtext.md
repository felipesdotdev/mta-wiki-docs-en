---
doc_id: "mta-wiki:13786"
title: "DxDrawShadedText"
source_title: "DxDrawShadedText"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawShadedText"
revision_id: 75350
language: "en"
categories: ["Useful_Functions", "Changes_in_1.3.0", "Changes_in_1.3.5"]
generated_at: "2026-07-26T16:14:47.608806+00:00"
---

# DxDrawShadedText

This function creates shadow effect for the dxText.
  

**Important : WORKS ONLY FOR DX TEXT!**

## Syntax

```
table dxDrawShadedText( string text, float leftX, float topY, float rightX, float bottomY, int color, int shadowColor, float offsetX, float offsetY, float scaleXY = 1.0 [, float scaleY = 1.0 ],
...
- **offsetX**: the number that offsets your text along the X axis.

- **offsetY**: the number that offsets your text along the Y axis.
...
The code below will create shadow for the text.

```
addEventHandler("onClientRender", root, function()
    dxDrawShadedText("Hello World!", 0, 0, nil, nil, tocolor(255, 255, 255), nil, 1, 1)
end)
```
