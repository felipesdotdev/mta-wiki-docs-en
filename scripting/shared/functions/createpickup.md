...
generated_at: "2026-07-26T16:10:38.148777+00:00"
---
...
- **weapon**: If the type is a Weapon pickup, then it represents the [weapon ID](mta://reference/misc/weapon.md) of the weapon pickup. When used with the weapon pickup type set, the ammo parameter can be used.
...
Returns [pickup](mta://reference/misc/pickup.md) [element](mta://reference/misc/element.md) if the pickup was created succesfully, otherwise returns *false*.
