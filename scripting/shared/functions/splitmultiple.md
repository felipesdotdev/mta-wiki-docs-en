---
doc_id: "mta-wiki:14194"
title: "SplitMultiple"
source_title: "SplitMultiple"
source_url: "https://wiki.multitheftauto.com/wiki/SplitMultiple"
revision_id: 78591
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:52.432104+00:00"
---

# SplitMultiple

This function splits a string into a table when the specified character(s) are detected.

## Syntax

```
table splitMultiple( string str, string chars )
```
...
- **chars**: The characters to detect and split the string at.
...
```
function splitMultiple(str, word)
    local result = {}
    local pattern = "(.-)" .. word
    ...
    local lastPart = string.match(str, word .. "(.*)")
    if lastPart then
...
```
local text = "This is an example string with some words to split."
local word = "word"
local parts = splitStringByWord(text, word)
