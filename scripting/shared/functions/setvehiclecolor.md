---
doc_id: "mta-wiki:1604"
title: "SetVehicleColor"
source_title: "SetVehicleColor"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleColor"
revision_id: 82727
language: "en"
categories: ["Server_functions", "Client_functions"]
generated_at: "2026-07-26T16:16:46.008135+00:00"
---

# SetVehicleColor

This function will set the color of a vehicle using either a RGB format, or the [standard San Andreas color IDs.](mta://reference/misc/vehicle-colors.md) Vehicles can have up to 4 colors, most of the vehicles have 2 colors only.
...
**Method**: *[vehicle](mta://reference/misc/vehicle.md):setColor(...)*

### Required Arguments

- **theVehicle:** The [vehicle](mta://reference/misc/vehicle.md) that you wish to set the color of.
...
- **p1, p2, p3, p4:** Exactly four integers indicating the [vehicle color IDs](mta://reference/misc/vehicle-colors.md) from the palette.   
