...
generated_at: "2026-07-26T16:15:57.913413+00:00"
---

# IsPedDead

This function checks if the specified [ped](mta://reference/misc/ped.md) is dead or not.
...
**Method**: *[ped](mta://reference/misc/ped.md):isDead(...)*

**Variable**: *.dead*

### Required Arguments

- **thePed**: the [ped](mta://reference/misc/ped.md) you want to check up on.
