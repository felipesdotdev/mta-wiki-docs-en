...
generated_at: "2026-07-26T16:15:59.099291+00:00"
---

# IsPlayerActuallyInVehicle

This function provides a hacky way to recreate the client-side behavior of [isPedInVehicle](mta://scripting/shared/functions/ispedinvehicle.md) server-sided for [player](mta://reference/misc/player.md) elements ONLY. It checks if a specified [player](mta://reference/misc/player.md) is actually in a [vehicle](mta://reference/misc/vehicle.md) and not just in the process of entering.
...
- **thePlayer**: a [player](mta://reference/misc/player.md) to check if they are inside a [vehicle](mta://reference/misc/vehicle.md) or not.

### Returns

Returns *true* if the specified [player](mta://reference/misc/player.md) has fully completed entering a [vehicle](mta://reference/misc/vehicle.md) and hasn't fully completed exiting it yet, *false* otherwise.
