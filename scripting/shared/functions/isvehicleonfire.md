---
doc_id: "mta-wiki:13797"
title: "IsVehicleOnFire"
source_title: "IsVehicleOnFire"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleOnFire"
revision_id: 78519
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:02.546590+00:00"
---

# IsVehicleOnFire

This function checks if the vehicle is on fire.

## Syntax

```
bool isVehicleOnFire(vehicle theVehicle)
```
...
```
function isVehicleOnFire(elementVehicle)
    if elementVehicle and getElementType(elementVehicle) == "vehicle" then
        local vHealth = getElementHealth(elementVehicle)
        return vHealth < 250
    end
    return false
end
