---
doc_id: "mta-wiki:13787"
title: "Table.sortNumerically"
source_title: "Table.sortNumerically"
source_url: "https://wiki.multitheftauto.com/wiki/Table.sortNumerically"
revision_id: 75352
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:57.382065+00:00"
---

# Table.sortNumerically
...
```
table table.sortNumerically( table theTable, bool fromHighestToLowest = false )
```
...
```
function table.sortNumerically(theTable, fromHighestToLowest)
    local sortTable = { }
...
local sortedTable = table.sortNumerically(theTable, true)
iprint(sortedTable) -- {"Rattle", "Boat", "Dog", "Dino", "Car", "Doll"}

local sortedTable2 = table.sortNumerically(theTable, false)
iprint(sortedTable2) -- {"Doll", "Car", "Dino", "Dog", "Boat", "Rattle"}

local sortedTable3 = table.sortNumerically(theTable2, false)
