...
generated_at: "2026-07-26T16:15:17.030691+00:00"
---

# GetPedClothes

This function is used to get the current clothes texture and model of a certain type on a [ped](mta://reference/misc/ped.md).
...
**Method**: *[ped](mta://reference/misc/ped.md):getClothes(...)*

**Counterpart**: *[addPedClothes](mta://scripting/shared/functions/addpedclothes.md)*

### Required Arguments

- **thePed:** The [ped](mta://reference/misc/ped.md) whose clothes you want to retrieve.
