---
doc_id: "mta-wiki:13648"
title: "SetPedAttack"
source_title: "SetPedAttack"
source_url: "https://wiki.multitheftauto.com/wiki/SetPedAttack"
revision_id: 74467
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:42.132095+00:00"
---

# SetPedAttack

This function makes a ped to attack a player.
...
```
bool setPedAttack(ped theElement, target element theTarget, weapon theWeapon, ammo theAmmo, slot thePedSlot)
```

### Required Arguments

- **theElement**: The ped element.

- **theTarget**: The target element.

- **theWeapon**: The weapon for the ped.

- **theAmmo**: The weapon ammo for the ped.

- **thePedSlot**: The weapon slot for the ped.

## Code

*NOTE:* This function requires function **[findRotation](mta://scripting/shared/functions/findrotation.md)** in order to work correctly.
...
**The example will show you how you can make a ped attack a player**

```
local ped = createPed(0, 0, 0, 5)

function TestAttack()
   setPedAttack(ped, localPlayer, 38, 9999, 7)
end
addEventHandler("onClientRender", root, TestAttack)
```
