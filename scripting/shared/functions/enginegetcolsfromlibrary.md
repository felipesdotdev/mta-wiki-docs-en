---
doc_id: "mta-wiki:12737"
title: "EngineGetCOLsFromLibrary"
source_title: "EngineGetCOLsFromLibrary"
source_url: "https://wiki.multitheftauto.com/wiki/EngineGetCOLsFromLibrary"
revision_id: 69701
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:55.315641+00:00"
---

# EngineGetCOLsFromLibrary

This function gets the collision data from the col library.

## Syntax

```
table engineGetCOLsFromLibrary( string path/rawdata )
```

### Required Arguments

- **path/rawdata**: You can give the path of the collision library file or just give the raw data.
...
```
local colLib = engineGetCOLsFromLibrary("models/colLibrary.col")
outputChatBox("this col library includes:")
for colName,colData in pairs(colLib) do
	outputChatBox( colName )
end
outputChatBox ( "> loading objects" )
colExample = engineLoadCOL ( colLib.example )
engineReplaceCOL ( colExample, 3781 )
txdExample = engineLoadTXD ( "models/example.txd" )
engineImportTXD ( txdExample, 3781 )
dffExample = engineLoadDFF ( "models/example.dff" )
engineReplaceModel ( dffExample, 3781 )
```
