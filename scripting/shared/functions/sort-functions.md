---
doc_id: "mta-wiki:9683"
title: "Sort Functions"
source_title: "Sort Functions"
source_url: "https://wiki.multitheftauto.com/wiki/Sort_Functions"
revision_id: 77666
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:16:52.009200+00:00"
---
...
Insert Sorting works possibly the fastest way If we don't know how sorted our array is.
You need to specify a table, and the table's index which we will be using to sort with.
For Example if our table has values like this, then you would specify 3:
{player, vehicle, playerid, npc}
local table = insertSortingByIndex(table, 3)
