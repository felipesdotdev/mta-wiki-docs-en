---
doc_id: "mta-wiki:8218"
title: "SetElementSpeed"
source_title: "SetElementSpeed"
source_url: "https://wiki.multitheftauto.com/wiki/SetElementSpeed"
revision_id: 78867
language: "en"
categories: ["Useful_Functions", "Utility_templates"]
generated_at: "2026-07-26T16:16:40.521043+00:00"
---
...
*NOTE:* This function requires function **[getElementSpeed](mta://scripting/shared/functions/getelementspeed.md)** in order to work correctly.
...
function setElementSpeed(element, unit, speed)
	...
	if not acSpeed or acSpeed == 0 then
		return false
	end
	 -- if true - element is valid, no need to check again
...
```
addCommandHandler("setmyspeed", function(player, cmd, speed)
	local veh = getPedOccupiedVehicle(player)
	if not veh then
		outputChatBox("You have to sit in vehicle", player)
		return
	end
	setElementSpeed(veh, "km/h", tonumber(speed))
end)
```
