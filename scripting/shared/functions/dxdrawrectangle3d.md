---
doc_id: "mta-wiki:6542"
title: "DxDrawRectangle3D"
source_title: "DxDrawRectangle3D"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawRectangle3D"
revision_id: 81863
language: "en"
categories: ["Useful_Functions", "MTA_Wiki:Delete", "Utility_templates"]
generated_at: "2026-07-26T16:14:46.971487+00:00"
---
...
| --- | --- |
| Reason: Useless function, use DxDrawLine3D or DxDrawMaterialLine3D instead. Actions: Delete (Administrators) - Discuss - What links here - Category |  |

This function draws a textured 3D line between two points in the 3D world that appers to be a rectangle - rendered for one frame  This should be used in conjunction with [onClientPreRender](mta://scripting/client/events/onclientprerender.md) in order to display continuously.
...
```
bool dxDrawRectangle3D ( float x, float y, float z, float width, float height[, int color, float rotation, float faceTowardX, float faceTowardY, float faceTowardZ]
```
