---
doc_id: "mta-wiki:11253"
title: "ES/dxDrawRombo"
source_title: "DxDrawRombo"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawRombo"
revision_id: 62462
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:47.440120+00:00"
---

# ES/dxDrawRombo

Esta Funcion Crea Un Rombo

## Sintaxis

```
bool dxDrawRombo(x,y,w,tocolor)
```

### Argumentos Requeridos

- **x**: Un entero que representa la posición X de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **y**: Un entero que representa la posición Y de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **w**: Un entero que representa la anchura de inicio absoluto de la línea, representada por píxeles en la pantalla.

- **tocolor**: Representa un color producido por [tocolor](mta://scripting/shared/functions/tocolor.md) o 0xAARRGGBB (AA = alpha, RR = red, GG = green, BB = blue).
...
addEventHandler('onClientRender', root,
    function()
        dxDrawRombo(401, 268, 150, tocolor(0, 0, 0, 180))
    end
)
```
