---
doc_id: "mta-wiki:14529"
title: "Dumpdelete"
source_title: "Dumpdelete"
source_url: "https://wiki.multitheftauto.com/wiki/Dumpdelete"
revision_id: 82849
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:43.156078+00:00"
---

# Dumpdelete

This function recursively deletes elements inside a table, and if the element is a valid game object (such as a timer or an element), it destroys element or kills the timer.
...
- **o**: The table or object to recursively process and delete its elements.

### Returns

This function does not return any value. It processes the table and deletes elements as required.
...
-- Now the vehicle, ped, and timer are destroyed.
```
