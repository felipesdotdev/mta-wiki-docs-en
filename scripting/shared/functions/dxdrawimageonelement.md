---
doc_id: "mta-wiki:8497"
title: "DxDrawImageOnElement"
source_title: "DxDrawImageOnElement"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawImageOnElement"
revision_id: 77183
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:45.760372+00:00"
---
...
```
none dxDrawImageOnElement(element TheElement, element Image [, int distance = 20, int height = 1, int width = 1, int R = 255, int G = 255, int B = 255, int alpha = 255, bool checkBuildings = true, bool checkVehicles = false, bool checkPeds = false, bool checkDummies = true, bool seeThroughStuff = true, bool ignoreSomeObjectsForCamera = false, element ignoredElement = nil ] )
```
...
- *Image*: The image you want. Use [dxCreateTexture](mta://scripting/client/functions/dxcreatetexture.md) to create it.
