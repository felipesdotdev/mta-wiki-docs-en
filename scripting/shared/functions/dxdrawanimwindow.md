---
doc_id: "mta-wiki:7412"
title: "DxDrawAnimWindow"
source_title: "DxDrawAnimWindow"
source_url: "https://wiki.multitheftauto.com/wiki/DxDrawAnimWindow"
revision_id: 78543
language: "en"
categories: ["Useful_Functions"]
generated_at: "2026-07-26T16:14:43.964786+00:00"
---
...
```
dxDrawAnimWindow ( string text, int height, int width, int color, string element font, string anim)
```
...
- **anim:** The easing or animation type. See [https://wiki.multitheftauto.com/wiki/Easing](https://wiki.multitheftauto.com/wiki/Easing)] For more Types-
...
Always remember to define the "start" value with getTickCount() and use onClientRender or onClientPreRender
