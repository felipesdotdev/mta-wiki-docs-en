---
doc_id: "mta-wiki:3468"
title: "Resource : Assault"
source_title: "Gamemode Assault"
source_url: "https://wiki.multitheftauto.com/wiki/Gamemode_Assault"
revision_id: 50186
language: "en"
categories: ["Resource"]
generated_at: "2026-07-26T16:15:05.208318+00:00"
---
...
If you want to create a simple map without additional code or custom objectives, you may want to skip to the [#Map Elements](#Map_Elements).
...
- **objectiveReached:** A table with all the attributes supplied in the map file (see [Map Elements](#Objectives))
...
- **objectiveToCreate:** A table with all the attributes supplied in the map file (see [Map Elements](#Objectives))
...
*Please note that you have to use [Call](mta://scripting/shared/functions/call.md) with exported functions.*

# General Assault Settings

**(as of version 1.1)**

These settings can be specified in Assault's *meta.xml* [settings](mta://reference/misc/settings-system.md).
...
All these settings can be specified in the *meta.xml* [settings](mta://reference/misc/settings-system.md) or the *assaultSettings* element in the mapfile. The *meta.xml* settings will always overrule the mapfile settings.
...
If there is a **timelimit**, **time**, **weather**, **author** or **description** [setting](mta://reference/misc/settings-system.md) specified in the meta file, it will overule the attribute in this element (version 1.0)
...
- **markerType:** defines the type of the marker used to mark the objective (see [CreateMarker](mta://scripting/shared/functions/createmarker.md) for details on the values)
...
- **defenderDescription:** This text is shown at the bottom of the screen to tell the defenders what to do *(default: the **defenderText** attribute of the [#Assault Settings](#Assault_Settings) element)*
