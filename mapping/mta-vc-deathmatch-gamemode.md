---
doc_id: "mta-wiki:4735"
title: "MTA:VC Deathmatch Gamemode"
source_title: "MTA:VC Deathmatch Gamemode"
source_url: "https://wiki.multitheftauto.com/wiki/MTA%3AVC_Deathmatch_Gamemode"
revision_id: 31497
language: "en"
categories: ["MTA_0.5", "Historical", "Vice_City"]
generated_at: "2026-07-26T16:16:06.798641+00:00"
---
...
MTA:VC 0.2.2 then added the [Stunt Gamemode](mta://mapping/mta-vc-stunt-gamemode.md) in addition to the already successful deathmatch mode. This was never as popular though.
...
0.5 mainly fixed bugs with the previous version. Again, much of the work in 0.5 had gone into GTA3's deathmatch and Vice City's [Stunt Gamemode](mta://mapping/mta-vc-stunt-gamemode.md) so not many new features had been added. However, the weapon damage levels had been tweaked again. This caused problems within the community as many players believed that the weapons were underpowered now and complained about the fact that you could no longer jump with the stubby. This prevented a glitch that some players had used to an unfair advantage in 0.4, but several glitches still existed.

The future of MTA:VC (and 0.5 in general) is uncertain. Previously, plans were to have GTA3 and VC run on the [Blue](mta://reference/misc/blue.md) core, but plans seem to have dissipated. A future release of the 0.x core is also uncertain.
...
| Cops - Spawns at a cop station around town. Cops | Mexicans - Spawns at Escobar International Airport's terminal. Mexicans | Robbers - Spawns at Phil's Place in Little Haiti. Robbers | Vice City Crusader - Spawns at a random location around Vice Point. Crusader |
| --- | --- | --- | --- |
| Secret Service - Spawns under a shelter in Ocean Beach. Secret Service | Sailors - Spawns at the Vice Docks. Sailors | Spectator - This mode is used to simply watch other players, you don't spawn anywhere. Spectator |  |
