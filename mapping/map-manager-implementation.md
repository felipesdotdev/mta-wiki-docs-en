---
doc_id: "mta-wiki:2675"
title: "Resource : Mapmanager"
source_title: "Map manager/Implementation"
source_url: "https://wiki.multitheftauto.com/wiki/Map_manager/Implementation"
revision_id: 79338
language: "en"
categories: ["Resource"]
generated_at: "2026-07-26T16:16:07.997206+00:00"
---
...
In this section we are going to continue the basic gamemode we created in the [Introduction to Scripting](mta://scripting/concepts/scripting-introduction.md). We will add a simple map resource that only contains the spawnpoint data for the players, and load the data in the main script when the player needs to spawn.
...
Note that "spawnpoint" is the type of the element, used in [getElementsByType](mta://scripting/shared/functions/getelementsbytype.md) function; likewise, "id" is used in [getElementByID](mta://scripting/shared/functions/getelementbyid.md) function.
...
The following settings from the [registry](mta://reference/misc/settings-system.md) are applied by the map manager when a map is started:
