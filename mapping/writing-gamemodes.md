...
generated_at: "2026-07-26T16:16:55.627028+00:00"
---
...
Now instead of writing a map-loader for every single gamemode, the [Map manager](mta://mapping/map-manager.md) provides functions to load gamemodes and maps. Simply put, when you enter the correct command (for example 'gamemode ctf ctf-italy') it will start both resources 'ctf' and 'ctf-italy' while triggering an event ([onGamemodeMapStart](https://wiki.multitheftauto.com/index.php?title=OnGamemodeMapStart&action=edit&redlink=1)) to tell the 'ctf' resource that a map was loaded. The 'ctf' resource can then access the information 'ctf-italy' contains and start spawning players etc.
...
[Map manager](mta://mapping/map-manager.md) exports a few more access functions which you don't have to use, but may be useful.
