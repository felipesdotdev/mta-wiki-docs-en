---
doc_id: "mta-wiki:4907"
title: "Switching from Race"
source_title: "Switching from Race"
source_url: "https://wiki.multitheftauto.com/wiki/Switching_from_Race"
revision_id: 21239
language: "en"
categories: []
generated_at: "2026-07-26T16:16:54.699975+00:00"
---
...
Custom vehicle and object models in Race.
...
The [new map editor](mta://resources/editor.md) allows you to create race maps with ease, while offering many new and advanced features not present in the old race editor.

### Backward compatibility

 

Race's new GUI and spectator system.

Although *.map files now have a different syntax, it's easy to convert all your old MTA:SA Race maps for full compatibility with MTA:SA 1.0. You can download our official batch converter [here](http://files.mtasa.com/apps/1.0/raceconv.zip).
