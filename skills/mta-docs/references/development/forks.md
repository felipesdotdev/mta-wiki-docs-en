...
You can now leverage "full Anticheat for forks" as well. For more information, visit this article: **[Forks Full AC](https://wiki.multitheftauto.com/index.php?search=Forks%20Full%20AC)**

.. But otherwise

Custom MTA builds and forked projects will face some challenges relating to anti-cheat (AC). Due to the fact that many forks and custom builds perform in ways that the anti-cheat module does not expect, we were forced to remove plenty of advanced detections and protections from the anti-cheat, in order to create and provide a separate module (the one from [https://mirror.mtasa.com/bdata/netc.dll](https://mirror.mtasa.com/bdata/netc.dll)) that, simply put, is a much weaker anti-cheat than the 'real' MTA has. So, unless you take measures of your own, your forked project can (and will) easily become infested with cheaters. This can be sidestepped with [Forks Full AC](https://wiki.multitheftauto.com/index.php?search=Forks%20Full%20AC) (click for article). But in the standard scenario, reading the below information helps.
