...
The following damage types are used by events like [onPlayerDamage](mta://scripting/server/events/onplayerdamage.md) or [onPlayerWasted](mta://scripting/server/events/onplayerwasted.md) for the **weapon** argument to describe the reason, why a [ped](https://wiki.multitheftauto.com/index.php?search=ped) has been damaged or died.  
