---
doc_id: "mta-wiki:10316"
title: "CustomWidgets.Variables"
source_title: "CustomWidgets.Variables"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidgets.Variables"
revision_id: 59118
language: "en"
categories: []
---
...
- **Width, Height** - default user screen size ([guiGetScreenSize](mta://scripting/client/functions/guigetscreensize.md));

- **DefaultColors** - default theme of all elements of Custom Widgets (without [CustomWidget:setColorScheme](mta://scripting/client/functions/customwidget-setcolorscheme.md))
