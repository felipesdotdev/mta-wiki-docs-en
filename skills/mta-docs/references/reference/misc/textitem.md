---
doc_id: "mta-wiki:1289"
title: "Textitem"
source_title: "Textitem"
source_url: "https://wiki.multitheftauto.com/wiki/Textitem"
revision_id: 76898
language: "en"
categories: []
---
...
A text item can only be seen by players if it is added to a [textdisplay](mta://reference/misc/textdisplay.md) they are observers of using [textDisplayAddText](mta://scripting/server/functions/textdisplayaddtext.md).
