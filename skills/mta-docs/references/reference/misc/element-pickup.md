...
- **type**: A string indicating the type of the pickup. This can either be "health", "armor", "custom", or an integer representing the [weapon ID](https://wiki.multitheftauto.com/index.php?search=weapon%20ID) of the pickup..
