---
doc_id: "mta-wiki:4728"
title: "Ammunation"
source_title: "Ammunation"
source_url: "https://wiki.multitheftauto.com/wiki/Ammunation"
revision_id: 23268
language: "en"
categories: []
---
...
Ammunations are functioning on all three islands on GTA3:MTA. You can purchase weapons, armor, health on all islands, and a taxi (for gamemode selection) on the [Shoreside Vale](mta://reference/misc/gta3-ssv.md) island. Ammunations can be found by holding down right-click while outside a vehicle, which will result in blips to appear on the radar. The only selectable weapons are:
