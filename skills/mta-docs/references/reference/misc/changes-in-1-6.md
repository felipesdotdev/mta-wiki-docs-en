...
- Added missing getType method for [camera](https://wiki.multitheftauto.com/index.php?search=camera) element ([a89d975](https://github.com/multitheftauto/mtasa-blue/commit/a89d975d7b959fe6c9b0af73ef6261cdb3763715) by **TheNormalnij** and **StrixG**)
...
- Fixed [setElementModel](mta://scripting/shared/functions/setelementmodel.md) forcing an element to be streamed in no matter the distance from [localPlayer](https://wiki.multitheftauto.com/index.php?search=localPlayer) ([467df06](https://github.com/multitheftauto/mtasa-blue/commit/467df061b5fadcee81bb7c0c4fb6cf23e741b3eb) by **TheNormalnij**)
...
- Replaced [getLocalPlayer](mta://scripting/client/functions/getlocalplayer.md) with [localPlayer](https://wiki.multitheftauto.com/index.php?search=localPlayer) across multiple resources ([01f7695](https://github.com/multitheftauto/mtasa-resources/commit/01f7695d3a49ce97639666773c274b747a7a158d) by **ArranTuna**)

- Replaced [getResourceRootElement](mta://scripting/shared/functions/getresourcerootelement.md) with [resourceRoot](https://wiki.multitheftauto.com/index.php?search=resourceRoot) across multiple resources ([0dee496](https://github.com/multitheftauto/mtasa-resources/commit/0dee4961826feaad364fcb1565cba0824a4e1849) by **ArranTuna**)

- Replaced [getRootElement](mta://scripting/shared/functions/getrootelement.md) with [root](https://wiki.multitheftauto.com/index.php?search=root) across multiple resources ([9582a82](https://github.com/multitheftauto/mtasa-resources/commit/9582a82ea92d9e8f89a958dd7b33d82698ed1c9f) by **ArranTuna**)
