...
***** MTA refers to the raw information that a [texture](https://wiki.multitheftauto.com/index.php?search=texture) contains as 'pixels'.

***** Pixels can be retrieved from any [texture](https://wiki.multitheftauto.com/index.php?search=texture) type including [render targets](mta://scripting/client/functions/dxcreaterendertarget.md) and [screen sources](mta://scripting/client/functions/dxcreatescreensource.md) by using the function [dxGetTexturePixels](mta://scripting/client/functions/dxgettexturepixels.md).
