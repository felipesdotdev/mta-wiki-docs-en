...
These are the sound [ids](https://wiki.multitheftauto.com/index.php?search=ids) you can use with [playSoundFrontEnd](mta://scripting/shared/functions/playsoundfrontend.md).
