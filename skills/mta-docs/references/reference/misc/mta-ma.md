...
A very popular script is *MTA:mA:GRS* (*General Release Script*, developed by Oliver Brown ([FMJ]Oli), which is widely used in both *[GTA3:MTA](https://wiki.multitheftauto.com/index.php?search=GTA3%3AMTA)* and *[MTA:VC](https://wiki.multitheftauto.com/index.php?search=MTA%3AVC)* servers.
