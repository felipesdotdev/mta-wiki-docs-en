...
- Ability to pass [vectors](mta://reference/misc/vector.md) and [matrices](mta://reference/misc/matrix.md) to [shaders](https://wiki.multitheftauto.com/index.php?search=shaders) ([#391](https://github.com/multitheftauto/mtasa-blue/pull/391) by **tederis**)
