...
The Map Editor is now functional as of 1.0.  This is assuming you have the map editor installed.  Please see the [Editor manual](https://wiki.multitheftauto.com/index.php?search=Editor%20manual) for details.
