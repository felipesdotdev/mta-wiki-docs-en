...
- The all new open-sourced [Map Editor](mta://resources/editor.md) means you can create your race maps with ease.
...
All you have to do is head to the [download page](http://www.mtasa.com/) and install MTA:SA 1.6.
