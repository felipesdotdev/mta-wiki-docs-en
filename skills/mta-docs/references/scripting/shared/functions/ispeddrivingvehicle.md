---
doc_id: "mta-wiki:7306"
title: "IsPedDrivingVehicle"
source_title: "IsPedDrivingVehicle"
source_url: "https://wiki.multitheftauto.com/wiki/IsPedDrivingVehicle"
revision_id: 40848
language: "en"
...
This function checks if a specified [ped](https://wiki.multitheftauto.com/index.php?search=ped) or [player](https://wiki.multitheftauto.com/index.php?search=player) is driving a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
- **ped**: a [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) to check if it's driving a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) or not.

### Returns

Returns *true* and a vehicle if the specified ped is driving a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle), *false* if it's not or a bad argument was passed.
