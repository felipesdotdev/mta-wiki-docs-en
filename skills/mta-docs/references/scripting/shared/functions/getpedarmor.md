---
doc_id: "mta-wiki:3976"
title: "GetPedArmor"
source_title: "GetPedArmor"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedArmor"
revision_id: 67107
language: "en"
...
This function returns the current armor of the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped).
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getArmor(...)*

**Variable**: *.armor*

**Counterpart**: *[setPedArmor](mta://scripting/shared/functions/setpedarmor.md)*

### Required Arguments

- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose armor you want to check
