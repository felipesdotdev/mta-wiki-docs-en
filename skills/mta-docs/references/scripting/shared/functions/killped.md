...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):kill(...)*

### Required Arguments

- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) to kill

### Optional Arguments

- **theKiller:** The ped responsible for the kill

- **weapon:** The ID of the [weapon](https://wiki.multitheftauto.com/index.php?search=weapon) or [Damage Types](mta://reference/misc/damage-types.md) that should appear to have killed the ped (doesn't affect how they die)
