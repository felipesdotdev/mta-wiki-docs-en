...
This function returns the [serial](mta://reference/misc/serial.md) for a specified [player](https://wiki.multitheftauto.com/index.php?search=player).
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getSerial(...)*
...
**Method**: *[localPlayer](https://wiki.multitheftauto.com/index.php?search=localPlayer):getSerial(...)*
