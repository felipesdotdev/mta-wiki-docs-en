...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):isDoingGangDriveby(...)*
...
- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) element whose state is to be checked.
