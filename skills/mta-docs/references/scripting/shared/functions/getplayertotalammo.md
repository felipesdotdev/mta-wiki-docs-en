...
This function returns an integer that contains the total ammo in a specified [player](https://wiki.multitheftauto.com/index.php?search=player)'s weapon. See [Weapon Info](https://wiki.multitheftauto.com/index.php?search=Weapon%20Info)
