...
This function returns the nearest [element](mta://reference/misc/element.md) (of a specific type) to a [player](https://wiki.multitheftauto.com/index.php?search=player).
