...
- **category:** Performance statistics category. If empty string is given, list of all categories is returned.See [categories](https://wiki.multitheftauto.com/index.php?search=categories) for more information.
