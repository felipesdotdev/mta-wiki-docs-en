...
This function returns the current rotation (in degrees) of a player around the Z axis. It's used with on-foot players: use [getVehicleRotation](mta://scripting/shared/functions/getvehiclerotation.md) on the occupied [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) if the player is in one.
...
- **thePlayer**: the [player](https://wiki.multitheftauto.com/index.php?search=player) whose rotation you want to retrieve.
