...
This function is used to get the element a [ped](https://wiki.multitheftauto.com/index.php?search=ped) is currently targeting.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getTarget(...)*

### Required Arguments

- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose target you want to retrieve.
