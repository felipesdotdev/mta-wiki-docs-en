...
**Method**: *[object](https://wiki.multitheftauto.com/index.php?search=object):setScale(...)*
...
- **theObject**: the [object](https://wiki.multitheftauto.com/index.php?search=object) you wish to change the scale of.
