---
doc_id: "mta-wiki:2633"
title: "GetPlayerName"
source_title: "GetPlayerName"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayerName"
revision_id: 78777
language: "en"
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getName(...)*

**Variable**: *.name*

**Counterpart**: *[setPlayerName](mta://scripting/server/functions/setplayername.md)*

### Required Arguments

- **thePlayer:** the [player](https://wiki.multitheftauto.com/index.php?search=player) you want to get the name of
