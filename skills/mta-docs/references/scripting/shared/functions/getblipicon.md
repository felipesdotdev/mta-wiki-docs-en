...
This function returns the icon a [blip](https://wiki.multitheftauto.com/index.php?search=blip) currently has.
...
**Method**: *[blip](https://wiki.multitheftauto.com/index.php?search=blip):getIcon(...)*
