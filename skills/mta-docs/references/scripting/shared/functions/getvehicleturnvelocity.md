---
doc_id: "mta-wiki:2636"
title: "GetVehicleTurnVelocity"
source_title: "GetVehicleTurnVelocity"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleTurnVelocity"
revision_id: 79201
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getTurnVelocity(...)*

**Variable**: *.turnVelocity*

**Counterpart**: *[setVehicleTurnVelocity](mta://scripting/shared/functions/setvehicleturnvelocity.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to get the turning velocities of.
