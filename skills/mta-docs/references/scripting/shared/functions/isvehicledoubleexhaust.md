---
doc_id: "mta-wiki:13220"
title: "IsVehicleDoubleExhaust"
source_title: "IsVehicleDoubleExhaust"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleDoubleExhaust"
revision_id: 71128
language: "en"
categories: ["Useful_Functions"]
---

# IsVehicleDoubleExhaust

This function checks if a exhaust [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) is double.

## Syntax

```
bool isVehicleDoubleExhaust( element vehicle )
```

### Required Arguments

- **vehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you want to check.

### Returns

Returns *true* if the vehicle has double exhaust, *false* if not double exhaust.
