---
doc_id: "mta-wiki:4193"
title: "GetVehicleEngineState"
source_title: "GetVehicleEngineState"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleEngineState"
revision_id: 59198
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getEngineState(...)*

**Variable**: *.engineState*

**Counterpart**: *[setVehicleEngineState](mta://scripting/shared/functions/setvehicleenginestate.md)*

### Required Arguments

- **theVehicle**: the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to get the engine state of.
