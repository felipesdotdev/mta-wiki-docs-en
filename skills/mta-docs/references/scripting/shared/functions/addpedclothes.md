...
This function is used to set the current clothes on a [ped](https://wiki.multitheftauto.com/index.php?search=ped).
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):addClothes(...)*

**Counterpart**: *[getPedClothes](mta://scripting/shared/functions/getpedclothes.md)*

### Required Arguments

- **thePed**: The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose clothes you want to change.
