---
doc_id: "mta-wiki:2546"
title: "GetVehicleLandingGearDown"
source_title: "GetVehicleLandingGearDown"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleLandingGearDown"
revision_id: 77047
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getLandingGearDown(...)*

**Variable**: *.landingGearDown*

**Counterpart**: *[setVehicleLandingGearDown](mta://scripting/shared/functions/setvehiclelandinggeardown.md)*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) of which you wish to check the landing gear state.
