...
Returns *true* if the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element is finished, *false* if unfinished or invalid arguments were passed.
