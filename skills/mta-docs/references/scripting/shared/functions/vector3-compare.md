---
doc_id: "mta-wiki:9261"
title: "Vector3:compare"
source_title: "Vector3:compare"
source_url: "https://wiki.multitheftauto.com/wiki/Vector3%3Acompare"
revision_id: 49967
language: "en"
...
This method checks whether two [vectors](https://wiki.multitheftauto.com/index.php?search=vectors) match (optionally with precision defined).
...
- **comparison:** The [Vector3](https://wiki.multitheftauto.com/index.php?search=Vector3) to compare to.

### Optional Arguments

- **precision:** A [float](mta://reference/misc/float.md) representing the precision of the comparison.

### Returns

A [boolean](mta://reference/misc/boolean.md) representing whether the vectors match taking into account the precision.
