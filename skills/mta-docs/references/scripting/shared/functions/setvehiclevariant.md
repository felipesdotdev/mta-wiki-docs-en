---
doc_id: "mta-wiki:5954"
title: "SetVehicleVariant"
source_title: "SetVehicleVariant"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleVariant"
revision_id: 81035
language: "en"
...
This function sets the variant of a specified vehicle. In GTA: San Andreas some vehicles are different; for example the labelling on trucks or the contents of a pick-up truck and the varying types of a motor bike. For the default variant list see: [Vehicle variants](mta://reference/misc/vehicle-variants.md).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setVariant(...)*

**Counterpart**: *[getVehicleVariant](mta://scripting/shared/functions/getvehiclevariant.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you want to set the variant.

### Optional Arguments

Both arguments need to be supplied, otherwise random variants will be picked.

- **variant1**: An integer for the first variant. See [Vehicle variants](mta://reference/misc/vehicle-variants.md).

- **variant2**: An integer for the second variant. See [Vehicle variants](mta://reference/misc/vehicle-variants.md).
