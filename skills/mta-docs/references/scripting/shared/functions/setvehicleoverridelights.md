---
doc_id: "mta-wiki:1696"
title: "SetVehicleOverrideLights"
source_title: "SetVehicleOverrideLights"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleOverrideLights"
revision_id: 51190
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setOverrideLights(...)*

**Variable**: *.overrideLights*

**Counterpart**: *[getVehicleOverrideLights](mta://scripting/shared/functions/getvehicleoverridelights.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to change the override lights setting of.
