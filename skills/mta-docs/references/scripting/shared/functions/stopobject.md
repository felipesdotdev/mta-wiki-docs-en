...
**Method**: *[object](https://wiki.multitheftauto.com/index.php?search=object):stop(...)*

### Required Arguments

- **theObject:** the [object](https://wiki.multitheftauto.com/index.php?search=object) whose movement you wish to stop
