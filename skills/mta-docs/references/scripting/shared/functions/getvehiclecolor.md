---
doc_id: "mta-wiki:1593"
title: "GetVehicleColor"
source_title: "GetVehicleColor"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleColor"
revision_id: 67686
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getColor(...)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to get the color of.
...
- Returns 12 [ints](mta://reference/misc/int.md) (if bRGB is *true*) indicating the red, green and blue components of each of the 4 vehicle colors.

- Returns 4 [ints](mta://reference/misc/int.md) (if bRGB is *false*) indicating the color ids of each of the 4 vehicle colors.
