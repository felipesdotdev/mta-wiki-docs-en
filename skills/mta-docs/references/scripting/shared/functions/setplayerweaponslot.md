...
- **theplayer:** the [player](https://wiki.multitheftauto.com/index.php?search=player) whose weapon slot you want to set. In a clientside script, this can only be the local player.
