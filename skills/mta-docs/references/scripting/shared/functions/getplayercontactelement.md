...
- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) you want to get the [element](mta://reference/misc/element.md) he is touching from.

### Returns

Returns an [object](https://wiki.multitheftauto.com/index.php?search=object) or a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) if the player is standing on one, *false* if he is touching none or is a invalid player.
