...
- **playerElement:** The [player](https://wiki.multitheftauto.com/index.php?search=player) from whom we want to retrieve the cursor state.
...
On the client-side, this function doesn't require any arguments because it gets the cursor state of the [localPlayer](https://wiki.multitheftauto.com/index.php?search=localPlayer).
