---
doc_id: "mta-wiki:1642"
title: "GetPlayerStat"
source_title: "GetPlayerStat"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayerStat"
revision_id: 67695
language: "en"
...
| --- | --- |
| Please use getPedStat instead. |  |

## Description

This function returns a float that contains the value of the specified statistic, for a specific [player](https://wiki.multitheftauto.com/index.php?search=player).
...
- **thePlayer**: The [player](https://wiki.multitheftauto.com/index.php?search=player) whose stat you want to retrieve.
...
Returns a [float](mta://reference/misc/float.md) indicating the statistic value.
...
addEventHandler ( "onPlayerSpawn", root, checkWeightOnSpawn )
```
