---
doc_id: "mta-wiki:2622"
title: "SetVehicleDoorsUndamageable"
source_title: "SetVehicleDoorsUndamageable"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleDoorsUndamageable"
revision_id: 43352
language: "en"
...
This function makes a vehicle's doors undamageable, so they won't fall off when they're hit. Note that the vehicle **has** to be locked using [setVehicleLocked](mta://scripting/shared/functions/setvehiclelocked.md) for this setting to have any effect.
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setDoorsUndamageable(...)*

**Variable**: *.doorsUndamageable*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) of which you wish to set the car door damageability.
