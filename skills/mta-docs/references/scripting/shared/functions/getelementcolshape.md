...
Some elements have an associated colshape, for example [Marker](https://wiki.multitheftauto.com/index.php?search=Marker) and [Pickup](https://wiki.multitheftauto.com/index.php?search=Pickup). This function is used to get the associated colshape.
