...
This function will trigger a named [event](https://wiki.multitheftauto.com/index.php?search=event) on a specific [element](mta://reference/misc/element.md) in the [element tree](mta://reference/misc/element-tree.md). See [event system](mta://reference/misc/event-system.md) for more information on how the event system works.
