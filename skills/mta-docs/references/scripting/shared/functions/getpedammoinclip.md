...
This function returns an integer that contains the ammo in a specified [ped](https://wiki.multitheftauto.com/index.php?search=ped)'s weapon. See [Weapon Info](https://wiki.multitheftauto.com/index.php?search=Weapon%20Info)
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getAmmoInClip(...)*
