...
This function is used to determine if an [element](mta://reference/misc/element.md) is within a [marker](https://wiki.multitheftauto.com/index.php?search=marker).
...
- **theMarker:** The [marker](https://wiki.multitheftauto.com/index.php?search=marker) you're checking.
