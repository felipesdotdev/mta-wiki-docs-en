---
doc_id: "mta-wiki:4352"
title: "IsTrainDerailed"
source_title: "IsTrainDerailed"
source_url: "https://wiki.multitheftauto.com/wiki/IsTrainDerailed"
revision_id: 54608
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):isDerailed(...)*

**Variable**: *.derailed*

**Counterpart**: *[setTrainDerailed](mta://scripting/shared/functions/settrainderailed.md)*

### Required Arguments

- **vehicleToCheck:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to check is derailed.
