...
Sets the current [animation](mta://reference/misc/animations.md) of a [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped). Not specifying the type of animation will automatically cancel the current one.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):setAnimation(...)*

**Counterpart**: *[getPedAnimation](mta://scripting/client/functions/getpedanimation.md)*

### Required Arguments

- **thePed:** the [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to apply an [animation](mta://reference/misc/animations.md) to.
