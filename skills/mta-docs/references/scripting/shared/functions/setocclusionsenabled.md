---
doc_id: "mta-wiki:6056"
title: "SetOcclusionsEnabled"
source_title: "SetOcclusionsEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/SetOcclusionsEnabled"
revision_id: 81054
language: "en"
...
This function is used to enable or disable occlusions. Occlusions are used by GTA to enhance performance by hiding objects that are (normally) obscured by certain large buildings. However when [removeWorldModel](mta://scripting/shared/functions/removeworldmodel.md) is used they may also have the undesired effect of making parts of the map disappear. Disabling occlusions will fix that.
