---
doc_id: "mta-wiki:4031"
title: "IsPedDead"
source_title: "IsPedDead"
source_url: "https://wiki.multitheftauto.com/wiki/IsPedDead"
revision_id: 43063
language: "en"
...
This function checks if the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped) is dead or not.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):isDead(...)*

**Variable**: *.dead*

### Required Arguments

- **thePed**: the [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to check up on.
