---
doc_id: "mta-wiki:1657"
title: "SetVehicleLightState"
source_title: "SetVehicleLightState"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleLightState"
revision_id: 54601
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setLightState(...)*

**Counterpart**: *[getVehicleLightState](mta://scripting/shared/functions/getvehiclelightstate.md)*

## Required Arguments

- **theVehicle:** A handle to the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to change the light state of.
