...
This function is used to remove the current clothes of a certain type on a [ped](https://wiki.multitheftauto.com/index.php?search=ped). It will remove them if the clothesTexture and clothesModel aren't specified, or if they match the current clothes on that slot.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):removeClothes(...)*

### Required Arguments

- **thePed**: The [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to remove clothes from.
