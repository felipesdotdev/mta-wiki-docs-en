...
This function allows you to check the current blur level of a specified [player](https://wiki.multitheftauto.com/index.php?search=player).
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getBlurLevel(...)*

**Counterpart**: *[setPlayerBlurLevel](mta://scripting/shared/functions/setplayerblurlevel.md)*

### Required Arguments

- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) whose blur level you want to check.
