---
doc_id: "mta-wiki:1779"
title: "GetVehicleController"
source_title: "GetVehicleController"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleController"
revision_id: 67714
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getController(...)*

**Variable**: *.controller*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you want to get the 'controller' of.

### Returns

Returns a [player](https://wiki.multitheftauto.com/index.php?search=player) object, if there isn't a driver, it will search the 'trailer chain' for the front driver, *false* otherwise.
