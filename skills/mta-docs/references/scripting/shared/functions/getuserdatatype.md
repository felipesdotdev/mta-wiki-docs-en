...
- *acl*: an [ACL entry](https://wiki.multitheftauto.com/index.php?search=ACL%20entry).

- *acl-group*: an [ACL group](https://wiki.multitheftauto.com/index.php?search=ACL%20group).
