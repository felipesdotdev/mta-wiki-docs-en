---
doc_id: "mta-wiki:1600"
title: "FixVehicle"
source_title: "FixVehicle"
source_url: "https://wiki.multitheftauto.com/wiki/FixVehicle"
revision_id: 54893
language: "en"
...
This function will set a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle)'s health to full and fix its damage model. If you wish to only change the vehicle's health, without affecting its damage model, use [setElementHealth](mta://scripting/shared/functions/setelementhealth.md).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):fix(...)*
