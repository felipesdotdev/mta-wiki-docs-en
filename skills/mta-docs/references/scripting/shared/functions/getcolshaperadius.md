...
**Method**: *[colshape](https://wiki.multitheftauto.com/index.php?search=colshape):getRadius(...)*

**Counterpart**: *[setColShapeRadius](mta://scripting/shared/functions/setcolshaperadius.md)*

### Required Arguments

- **shape:** The [colshape](https://wiki.multitheftauto.com/index.php?search=colshape) you wish to get the radius of.
