---
doc_id: "mta-wiki:1402"
title: "Gettok"
source_title: "Gettok"
source_url: "https://wiki.multitheftauto.com/wiki/Gettok"
revision_id: 62260
language: "en"
...
- **separatingCharacter:** the [ASCII number](mta://reference/misc/ascii.md) representing the character you want to use to separate the tokens. You can easily retrieve this by running string.byte on a string containing the separating character.

### Returns

Returns a [string](mta://reference/misc/string.md) containing the token if it exists, *false* otherwise.
