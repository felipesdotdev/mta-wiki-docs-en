...
**Method**: *[radararea](https://wiki.multitheftauto.com/index.php?search=radararea):setFlashing(...)*
...
- **theRadarArea:** the [radararea](https://wiki.multitheftauto.com/index.php?search=radararea) element we want to change flashing state of.
