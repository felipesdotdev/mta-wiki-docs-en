---
doc_id: "mta-wiki:1645"
title: "GetVehicleUpgradeOnSlot"
source_title: "GetVehicleUpgradeOnSlot"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleUpgradeOnSlot"
revision_id: 71540
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getUpgradeOnSlot(...)*
...
- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) whose upgrade you want to retrieve.

- **slot**: The slot id of the upgrade. *([Upgrade list](mta://reference/misc/upgrade-list.md) ordered by slot number)*
