...
- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose frozen state will be changed.

- **frozen:** A [bool](https://wiki.multitheftauto.com/index.php?search=bool) value as to whether the ped is frozen or not.
