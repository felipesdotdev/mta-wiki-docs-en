---
doc_id: "mta-wiki:7848"
title: "GetPedMaxOxygenLevel"
source_title: "GetPedMaxOxygenLevel"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedMaxOxygenLevel"
revision_id: 63295
language: "en"
...
This functions gets the maximum oxigen level a [ped](https://wiki.multitheftauto.com/index.php?search=ped) should have, considering its max underwater stamina (225) and stamina (22) [stat](https://wiki.multitheftauto.com/wiki/Template:Stats).
...
- **thePed:** the [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose maximum oxygen level you want to get.

### Returns

A *float* with the maximum oxygen level of the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped), an error if a invalid [ped](https://wiki.multitheftauto.com/index.php?search=ped) was passed.
