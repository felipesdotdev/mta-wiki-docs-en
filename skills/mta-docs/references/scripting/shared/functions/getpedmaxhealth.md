---
doc_id: "mta-wiki:7687"
title: "GetPedMaxHealth"
source_title: "GetPedMaxHealth"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedMaxHealth"
revision_id: 41040
language: "en"
...
This functions gets the maximum health a [ped](https://wiki.multitheftauto.com/index.php?search=ped) should have, considering its max health (24) [stat](https://wiki.multitheftauto.com/wiki/Template:Stats).
...
- **thePed:** the [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose maximum health you want to get.

### Returns

A *float* with the maximum health of the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped), an error if a invalid [ped](https://wiki.multitheftauto.com/index.php?search=ped) was passed.
