---
doc_id: "mta-wiki:2638"
title: "GetVehiclePlateText"
source_title: "GetVehiclePlateText"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehiclePlateText"
revision_id: 42593
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getPlateText(...)*

**Variable**: *.plateText*

**Counterpart**: *[setVehiclePlateText](mta://scripting/shared/functions/setvehicleplatetext.md)*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to retrieve the plate text from.
