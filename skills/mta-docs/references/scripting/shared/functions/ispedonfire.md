---
doc_id: "mta-wiki:4232"
title: "IsPedOnFire"
source_title: "IsPedOnFire"
source_url: "https://wiki.multitheftauto.com/wiki/IsPedOnFire"
revision_id: 81571
language: "en"
...
This function checks if the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped) is on fire or not.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):isOnFire(...)*

**Variable**: *.onFire*

**Counterpart**: *[setPedOnFire](mta://scripting/shared/functions/setpedonfire.md)*
