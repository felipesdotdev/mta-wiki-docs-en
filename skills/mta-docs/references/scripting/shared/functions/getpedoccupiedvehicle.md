---
doc_id: "mta-wiki:3975"
title: "GetPedOccupiedVehicle"
source_title: "GetPedOccupiedVehicle"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedOccupiedVehicle"
revision_id: 59604
language: "en"
...
This function gets the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that the ped is currently in or is trying to enter, if any.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getOccupiedVehicle(...)*

**Variable**: *.vehicle*

**Counterpart**: *[warpPedIntoVehicle](mta://scripting/shared/functions/warppedintovehicle.md)*

### Required Arguments

- **thePed**: The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose vehicle you're looking up.
