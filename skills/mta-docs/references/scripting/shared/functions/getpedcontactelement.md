---
doc_id: "mta-wiki:3941"
title: "GetPedContactElement"
source_title: "GetPedContactElement"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedContactElement"
revision_id: 75655
language: "en"
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getContactElement(...)*

**Variable**: *.contactElement*

### Required Arguments

- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) of which you want to get the [element](mta://reference/misc/element.md) he is standing on.

### Returns

Returns an [object](https://wiki.multitheftauto.com/index.php?search=object) or a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) if the ped is standing on one, *false* if he is touching none or an invalid element was passed.
