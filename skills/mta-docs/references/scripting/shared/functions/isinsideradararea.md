...
This function checks if a 2D position is inside a [radar area](https://wiki.multitheftauto.com/index.php?search=radar%20area) or not.
...
**Method**: *[radararea](https://wiki.multitheftauto.com/index.php?search=radararea):isInside(...)*

### Required Arguments

- **theArea:** The [radar area](https://wiki.multitheftauto.com/index.php?search=radar%20area) you're checking the position against.
