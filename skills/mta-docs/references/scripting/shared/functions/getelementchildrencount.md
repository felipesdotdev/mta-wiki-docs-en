---
doc_id: "mta-wiki:1529"
title: "GetElementChildrenCount"
source_title: "GetElementChildrenCount"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementChildrenCount"
revision_id: 43626
language: "en"
...
This function returns the number of children an element has. Note that only the direct children are counted and not elements that are further down the [element tree](mta://reference/misc/element-tree.md).
...
**Method**: *[element](mta://reference/misc/element.md):getChildrenCount(...)*
