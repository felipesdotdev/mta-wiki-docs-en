---
doc_id: "mta-wiki:10076"
title: "GetVehicleRPM"
source_title: "GetVehicleRPM"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleRPM"
revision_id: 68030
language: "en"
...
This function returns a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) engine speed. You will also need a function to [getElementSpeed](mta://scripting/shared/functions/getelementspeed.md).

## Syntax

```
vehicle getVehicleRPM (vehicle)
```

### Returns

It returns a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) engine speed. If not, it returns *0*.
