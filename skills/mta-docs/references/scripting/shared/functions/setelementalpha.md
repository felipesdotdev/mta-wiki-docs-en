---
doc_id: "mta-wiki:2742"
title: "SetElementAlpha"
source_title: "SetElementAlpha"
source_url: "https://wiki.multitheftauto.com/wiki/SetElementAlpha"
revision_id: 82680
language: "en"
...
This function sets the alpha (transparency) value for the specified [element](mta://reference/misc/element.md). This can be a [player](https://wiki.multitheftauto.com/index.php?search=player), [ped](https://wiki.multitheftauto.com/index.php?search=ped), [object](https://wiki.multitheftauto.com/index.php?search=object), [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) or [weapon](mta://reference/misc/element-weapon.md).
...
**Method**: *[element](mta://reference/misc/element.md):setAlpha(...)*

**Variable**: *.alpha*

**Counterpart**: *[getElementAlpha](mta://scripting/shared/functions/getelementalpha.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) whose alpha you want to set.

- **alpha:**  The alpha value to set. Values are 0-255, where 255 is fully opaque and 0 is fully transparent.

- **Note:** [Objects](https://wiki.multitheftauto.com/index.php?search=Objects) are fully transparent at 140.
