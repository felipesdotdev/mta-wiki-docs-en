---
doc_id: "mta-wiki:4542"
title: "IsVehicleBlown"
source_title: "IsVehicleBlown"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleBlown"
revision_id: 43390
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):isBlown(...)*

**Variable**: *.blown*

**Counterpart**: *[blowVehicle](mta://scripting/shared/functions/blowvehicle.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you want to obtain the blown status of.
