---
doc_id: "mta-wiki:1723"
title: "SetVehicleEngineState"
source_title: "SetVehicleEngineState"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleEngineState"
revision_id: 67711
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setEngineState(...)*

**Variable**: *.engineState*

**Counterpart**: *[getVehicleEngineState](mta://scripting/shared/functions/getvehicleenginestate.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to change the engine state of.
