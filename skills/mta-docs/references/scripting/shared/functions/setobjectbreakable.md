...
**Method**: *[object](https://wiki.multitheftauto.com/index.php?search=object):setBreakable(...)*
...
- **object** the [object](https://wiki.multitheftauto.com/index.php?search=object) that's being set.
