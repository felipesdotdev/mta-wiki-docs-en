---
doc_id: "mta-wiki:5953"
title: "GetVehicleVariant"
source_title: "GetVehicleVariant"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleVariant"
revision_id: 81034
language: "en"
...
This function gets the variant of a specified vehicle. In GTA: San Andreas some vehicles are different; for example the labelling on trucks or the contents of a pick-up truck and the varying types of a motor bike. For the default variant list see: [Vehicle variants](mta://reference/misc/vehicle-variants.md).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getVariant(...)*

**Counterpart**: *[setVehicleVariant](mta://scripting/shared/functions/setvehiclevariant.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you want to get the variant of.

## Returns

Returns 2 [int](mta://reference/misc/int.md) containing the vehicle variants, *false* otherwise (the specified vehicle doesn't exist).
...
This example tells the [player](https://wiki.multitheftauto.com/index.php?search=player) in the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) what their vehicle variants are with a command named *getvehvar*:
