---
doc_id: "mta-wiki:1527"
title: "GetElementChildren"
source_title: "GetElementChildren"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementChildren"
revision_id: 43624
language: "en"
...
This function is used to retrieve a list of the child elements of a given parent element. Note that it will only return direct children and not elements that are further down the [element tree](mta://reference/misc/element-tree.md).
...
**Method**: *[element](mta://reference/misc/element.md):getChildren(...)*
