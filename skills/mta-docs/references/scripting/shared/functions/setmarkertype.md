...
**Method**: *[Marker](https://wiki.multitheftauto.com/index.php?search=Marker):setMarkerType(...)*
...
- **theMarker**: A [marker](https://wiki.multitheftauto.com/index.php?search=marker) element referencing the specified marker.
