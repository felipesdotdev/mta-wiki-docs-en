---
doc_id: "mta-wiki:10756"
title: "GetElementAngularVelocity"
source_title: "GetElementAngularVelocity"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementAngularVelocity"
revision_id: 81198
language: "en"
...
**Method**: *[element](mta://reference/misc/element.md):getAngularVelocity(...)*

**Variable**: *.angularVelocity*

**Counterpart**: *[setElementAngularVelocity](mta://scripting/shared/functions/setelementangularvelocity.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) to retrieve the angular velocity from. Can be either a [player](https://wiki.multitheftauto.com/index.php?search=player), [ped](https://wiki.multitheftauto.com/index.php?search=ped), [object](https://wiki.multitheftauto.com/index.php?search=object), [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) or a [custom weapon](mta://reference/misc/element-weapon.md). **Server side supports only vehicles currently.**
