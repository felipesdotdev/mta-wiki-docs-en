...
**Method**: *[Marker](https://wiki.multitheftauto.com/index.php?search=Marker):setSize(...)*
...
- **theMarker:** The [marker](https://wiki.multitheftauto.com/index.php?search=marker) that you wish to set the size of.
