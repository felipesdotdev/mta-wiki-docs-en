...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setDoorState(...)*
...
- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to change the door state of.
