---
doc_id: "mta-wiki:1599"
title: "GetVehicleOccupant"
source_title: "GetVehicleOccupant"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleOccupant"
revision_id: 66966
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getOccupant(...)*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) of which you wish to retrieve the driver or a passenger.
...
Returns the [player](https://wiki.multitheftauto.com/index.php?search=player) sitting in the vehicle, or *false* if the seat is unoccupied or doesn't exist.
