---
doc_id: "mta-wiki:9322"
title: "DebugSleep"
source_title: "DebugSleep"
source_url: "https://wiki.multitheftauto.com/wiki/DebugSleep"
revision_id: 81192
language: "en"
...
debugSleep freezes the client/server for the specified time. This means that all synchronization, rendering and script execution will stop except HTTP processing invoked by [fetchRemote](mta://scripting/shared/functions/fetchremote.md). This function only works, if development mode is enabled by [setDevelopmentMode](mta://scripting/shared/functions/setdevelopmentmode.md) and can be utilised to build a debugger that communicates via HTTP requests with the editor/IDE.
...
- [setClipboard](https://wiki.multitheftauto.com/index.php?search=setClipboard)
