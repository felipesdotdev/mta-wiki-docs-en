...
This function is used to set the current clothes of a certain type on a [player](https://wiki.multitheftauto.com/index.php?search=player). It can only be used on players with the CJ skin (id 0).
...
- **thePlayer**: The [player](https://wiki.multitheftauto.com/index.php?search=player) whose clothes you want to change.
