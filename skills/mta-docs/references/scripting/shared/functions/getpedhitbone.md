...
- **thePed:** the [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose bone you want to get.

- **hitX**, **hitY**, **hitZ**: [float](mta://reference/misc/float.md) world coordinates representing a hit point.

### Returns

An **int** with the approximate bone where the [ped](https://wiki.multitheftauto.com/index.php?search=ped) take damage, does not work properly serverside
