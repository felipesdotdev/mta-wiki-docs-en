...
This function is used for getting the X and Y size of an existing [radar area](https://wiki.multitheftauto.com/index.php?search=radar%20area).
...
**Method**: *[radararea](https://wiki.multitheftauto.com/index.php?search=radararea):getSize(...)*

### Required Arguments

- **theRadararea:** The [radar area](https://wiki.multitheftauto.com/index.php?search=radar%20area) element whose size you wish to get.
