---
doc_id: "mta-wiki:5109"
title: "GetVehicleOccupants"
source_title: "GetVehicleOccupants"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleOccupants"
revision_id: 64555
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getOccupants(...)*

**Variable**: *.occupants*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) of which you wish to retrieve the occupants.

### Returns

Returns a [table](mta://reference/misc/table.md) with seat ID as an index and the occupant as an element like this: table[seat] = occupant
