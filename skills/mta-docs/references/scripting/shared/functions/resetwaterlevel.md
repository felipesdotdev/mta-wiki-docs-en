...
This function resets the water of the GTA world back to its default level. [Water elements](https://wiki.multitheftauto.com/index.php?search=Water%20elements) are not affected.
...
**Method**: *[Water](https://wiki.multitheftauto.com/index.php?search=Water).resetLevel(...)*
