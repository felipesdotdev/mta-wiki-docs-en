---
doc_id: "mta-wiki:1403"
title: "SetWeather"
source_title: "SetWeather"
source_url: "https://wiki.multitheftauto.com/wiki/SetWeather"
revision_id: 58497
language: "en"
...
This function sets the current [weather](mta://reference/misc/weather.md) to the given valid value. To change the weather gradually, see [setWeatherBlended](mta://scripting/shared/functions/setweatherblended.md).
...
- **weatherID**: The ID of new [weather](mta://reference/misc/weather.md). Valid values are 0 to 255 inclusive.
