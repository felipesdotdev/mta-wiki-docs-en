...
This function can be used to set a [element](mta://reference/misc/element.md) on fire or extinguish a fire on it. Supported types are [ped](https://wiki.multitheftauto.com/index.php?search=ped), [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) and [object](https://wiki.multitheftauto.com/index.php?search=object). 
