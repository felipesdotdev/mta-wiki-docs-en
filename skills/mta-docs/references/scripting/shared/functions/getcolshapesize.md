...
**Method**: *[colshape](https://wiki.multitheftauto.com/index.php?search=colshape):getSize(...)*

**Counterpart**: *[setColShapeSize](mta://scripting/shared/functions/setcolshapesize.md)*

### Required Arguments

- **shape:** The [colshape](https://wiki.multitheftauto.com/index.php?search=colshape) you wish to get the size of.
