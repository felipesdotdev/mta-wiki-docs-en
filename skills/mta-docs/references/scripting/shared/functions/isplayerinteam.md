---
doc_id: "mta-wiki:6947"
title: "IsPlayerInTeam"
source_title: "IsPlayerInTeam"
source_url: "https://wiki.multitheftauto.com/wiki/IsPlayerInTeam"
revision_id: 40878
language: "en"
...
This function checks if the specified [player](https://wiki.multitheftauto.com/index.php?search=player) is in the specified [team](https://wiki.multitheftauto.com/index.php?search=team).
...
- **thePlayer**: the [player](https://wiki.multitheftauto.com/index.php?search=player) you want to check if it's in the specified [team](https://wiki.multitheftauto.com/index.php?search=team).

- **theTeam**: a [team](https://wiki.multitheftauto.com/index.php?search=team) element or name to check if the [player](https://wiki.multitheftauto.com/index.php?search=player) is in it. If not specified, this function will return *true* if the [player](https://wiki.multitheftauto.com/index.php?search=player) is in any [team](https://wiki.multitheftauto.com/index.php?search=team).
