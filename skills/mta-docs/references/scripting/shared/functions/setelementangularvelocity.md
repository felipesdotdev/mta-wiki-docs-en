...
- **theElement:** The [element](mta://reference/misc/element.md) to apply the spin to. Can be either a [player](https://wiki.multitheftauto.com/index.php?search=player), [ped](https://wiki.multitheftauto.com/index.php?search=ped), [object](https://wiki.multitheftauto.com/index.php?search=object), [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) or a [custom weapon](mta://reference/misc/element-weapon.md).
