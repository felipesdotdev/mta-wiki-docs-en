...
Returns a [player](https://wiki.multitheftauto.com/index.php?search=player) element if the specified [serial](mta://reference/misc/serial.md) is owned by an existent player on the server, *false* otherwise.
