---
doc_id: "mta-wiki:4039"
title: "SetPedStat"
source_title: "SetPedStat"
source_url: "https://wiki.multitheftauto.com/wiki/SetPedStat"
revision_id: 82645
language: "en"
categories: ["Server_functions", "Client_functions", "Needs_Checking"]
---
...
| --- | --- |
| Reason(s): Things like infinite run, fire proof CJ, 150 armor have special activation flags. They need a way to be triggered on/off. |  |

This function allows you to set the value of a specific statistic for a [ped](https://wiki.multitheftauto.com/index.php?search=ped). **Visual stats (FAT and BODY_MUSCLE) can only be used on the CJ skin**, they have no effect on other skins. When this function is used client-side, it can only be used on client-side created peds.
...
- **thePed**: the [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose statistic you want to modify.
