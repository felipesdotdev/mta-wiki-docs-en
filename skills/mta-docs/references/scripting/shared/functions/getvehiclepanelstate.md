---
doc_id: "mta-wiki:2637"
title: "GetVehiclePanelState"
source_title: "GetVehiclePanelState"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehiclePanelState"
revision_id: 54607
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getPanelState(...)*

**Counterpart**: *[setVehiclePanelState](mta://scripting/shared/functions/setvehiclepanelstate.md)*

## Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to know the panel state of.
...
Returns an [int](mta://reference/misc/int.md) indicating the state of the specified the panel. This is a value between 0 and 3, with 0 indicating the panel is undamaged and 3 indicating it is very damaged.
