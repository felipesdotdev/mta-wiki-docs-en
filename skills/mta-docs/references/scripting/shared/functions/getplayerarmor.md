---
doc_id: "mta-wiki:1326"
title: "GetPlayerArmor"
source_title: "GetPlayerArmor"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayerArmor"
revision_id: 44557
language: "en"
...
This function returns a float that contains the current armor for the specified [player](https://wiki.multitheftauto.com/index.php?search=player).
...
- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) whose armor you want to check
