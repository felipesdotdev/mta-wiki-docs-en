...
This function returns the ping of a specified [player](https://wiki.multitheftauto.com/index.php?search=player). The ping is the number of milliseconds that data takes to travel from the player's client to the server or vice versa. If a player is using a VPN their ping will still be returned correctly.
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getPing(...)*

**Variable**: *.ping*

### Required Arguments

- **thePlayer**: The [player](https://wiki.multitheftauto.com/index.php?search=player) whose ping you want to determine.
