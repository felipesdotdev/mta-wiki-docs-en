---
doc_id: "mta-wiki:1639"
title: "PlaySoundFrontEnd"
source_title: "PlaySoundFrontEnd"
source_url: "https://wiki.multitheftauto.com/wiki/PlaySoundFrontEnd"
revision_id: 71871
language: "en"
categories: ["Changes_in_1.4.0", "Server_functions", "Client_functions"]
---
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):playSoundFrontEnd(...)*

### Required Arguments

- **thePlayer:** the [player](https://wiki.multitheftauto.com/index.php?search=player) you want the sound to play for.

- **sound:** a whole [int](mta://reference/misc/int.md) specifying the sound id to play. Valid values are:
...
**Method**: *[Sound](https://wiki.multitheftauto.com/index.php?search=Sound).playFrontEnd(...)*
