---
doc_id: "mta-wiki:2277"
title: "GetVehicleWheelStates"
source_title: "GetVehicleWheelStates"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleWheelStates"
revision_id: 43335
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getWheelStates(...)*

**Counterpart**: *[setVehicleWheelStates](mta://scripting/shared/functions/setvehiclewheelstates.md)*

## Required Arguments

- **theVehicle:** A handle to the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you wish to know the wheel states of.

## Returns

Returns 4 [ints](mta://reference/misc/int.md) indicating the states of the wheels (front left, rear left, front right, rear right). These values can be:
