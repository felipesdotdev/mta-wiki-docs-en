...
This function gets the current [team](https://wiki.multitheftauto.com/index.php?search=team) a [player](https://wiki.multitheftauto.com/index.php?search=player) is on.
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getTeam(...)*
...
- **thePlayer**: The [player](https://wiki.multitheftauto.com/index.php?search=player) whose team you want to find out.
