---
doc_id: "mta-wiki:4260"
title: "GetElementRotation"
source_title: "GetElementRotation"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementRotation"
revision_id: 58654
language: "en"
...
**Method**: *[element](mta://reference/misc/element.md):getRotation(...)*

**Variable**: *.rotation*

**Counterpart**: *[setElementRotation](mta://scripting/shared/functions/setelementrotation.md)*
...
- *"ZXY":* rotation about the Z axis (*up*), then about the resulting X axis (*right*) and finally about the resulting Y axis (*front*). This is the default rotation order for [objects](https://wiki.multitheftauto.com/index.php?search=objects)

- *"ZYX":* rotation about the Z axis (*up*), then about the resulting Y axis (*front*), and finally about the resulting X axis (*right*). This is the default rotation order for [vehicles](https://wiki.multitheftauto.com/index.php?search=vehicles)
