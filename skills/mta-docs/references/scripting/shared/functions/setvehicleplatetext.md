---
doc_id: "mta-wiki:7158"
title: "SetVehiclePlateText"
source_title: "SetVehiclePlateText"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehiclePlateText"
revision_id: 81181
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setPlateText(...)*

**Variable**: *.plateText*

**Counterpart**: *[getVehiclePlateText](mta://scripting/shared/functions/getvehicleplatetext.md)*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) whose numberplate you want to change.
