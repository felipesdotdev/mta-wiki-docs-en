...
This function is used to remove the current clothes of a certain type on a [player](https://wiki.multitheftauto.com/index.php?search=player). It will remove them if the clothesTexture and clothesModel aren't specified, or if they match the current clothes on that slot.
...
- **thePlayer**: The [player](https://wiki.multitheftauto.com/index.php?search=player) whose clothes you want to remove.
