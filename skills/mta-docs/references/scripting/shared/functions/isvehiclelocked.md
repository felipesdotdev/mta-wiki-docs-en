---
doc_id: "mta-wiki:1416"
title: "IsVehicleLocked"
source_title: "IsVehicleLocked"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleLocked"
revision_id: 67669
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):isLocked(...)*

**Variable**: *.locked*

**Counterpart**: *[setVehicleLocked](mta://scripting/shared/functions/setvehiclelocked.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that you want to obtain the locked status of.
