---
doc_id: "mta-wiki:3974"
title: "GetPedTotalAmmo"
source_title: "GetPedTotalAmmo"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedTotalAmmo"
revision_id: 80594
language: "en"
...
This function returns an integer that contains the total ammo in a specified [ped](https://wiki.multitheftauto.com/index.php?search=ped)'s weapon. See [Weapon Info](https://wiki.multitheftauto.com/index.php?search=Weapon%20Info)
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getTotalAmmo(...)*

### Required Arguments

- **thePed**: The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose ammo you want to check.
...
Returns an [int](mta://reference/misc/int.md) containing the total amount of ammo for the specified ped's weapon, or 0 if the ped specified is invalid.
