...
This function returns the size of a specified resource in **kB**(kilobyte). Resource files that are not declared in [meta](https://wiki.multitheftauto.com/index.php?search=meta) are not counted.
