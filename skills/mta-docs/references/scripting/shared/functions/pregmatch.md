---
doc_id: "mta-wiki:7032"
title: "PregMatch"
source_title: "PregMatch"
source_url: "https://wiki.multitheftauto.com/wiki/PregMatch"
revision_id: 81175
language: "en"
...
- **base:** The base [string](mta://reference/misc/string.md) for replace.
...
Returns a *[table](mta://reference/misc/table.md)* if one or more match is found, *false* otherwise.
