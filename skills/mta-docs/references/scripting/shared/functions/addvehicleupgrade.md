---
doc_id: "mta-wiki:1644"
title: "AddVehicleUpgrade"
source_title: "AddVehicleUpgrade"
source_url: "https://wiki.multitheftauto.com/wiki/AddVehicleUpgrade"
revision_id: 69665
language: "en"
...
This function adds an upgrade to a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle), e.g. nitrous, hydraulics.
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):addUpgrade(...)*

### Required Arguments

- **theVehicle**: The [element](mta://reference/misc/element.md) representing the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to add the upgrade to.

- **upgrade**: The id of the upgrade you wish to add: 1000 to 1193 (*see [Vehicle Upgrades](mta://reference/misc/vehicle-upgrades.md)*) or "**all"** to add all upgrades.
