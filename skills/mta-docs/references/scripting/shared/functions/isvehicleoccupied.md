---
doc_id: "mta-wiki:7670"
title: "IsVehicleOccupied"
source_title: "IsVehicleOccupied"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleOccupied"
revision_id: 40941
language: "en"
...
This function checks if a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) is being occupied by a [ped](https://wiki.multitheftauto.com/index.php?search=ped) or [player](https://wiki.multitheftauto.com/index.php?search=player).
...
- **vehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you want to check if it's occupied or not.
