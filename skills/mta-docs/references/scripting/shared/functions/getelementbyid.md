---
doc_id: "mta-wiki:1531"
title: "GetElementByID"
source_title: "GetElementByID"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementByID"
revision_id: 50573
language: "en"
...
**Method**: *[Element](mta://reference/misc/element.md).getByID(...)*

### Required Arguments

- **id:** The ID of the element as it appears in the XML file or as set by [setElementID](mta://scripting/shared/functions/setelementid.md).
...
Returns the [element](mta://reference/misc/element.md) with the given ID, or *false* if no such element exists.
