...
- [unbindControlKeys](https://wiki.multitheftauto.com/index.php?search=unbindControlKeys) » This function allows you to unbind each key bound to a control individually. Use this function with bindControlKeys.
