---
doc_id: "mta-wiki:5900"
title: "SetDevelopmentMode"
source_title: "SetDevelopmentMode"
source_url: "https://wiki.multitheftauto.com/wiki/SetDevelopmentMode"
revision_id: 81032
language: "en"
categories: ["Server_functions", "Client_functions", "Changes_in_1.5"]
---
...
- **[showcol](mta://reference/misc/client-commands.md)**: Enables colshapes to be viewed as a wireframe object.

- **[showsound](mta://reference/misc/client-commands.md)**: Enables world sound ids to be printed in the debug output window.

**Shared** development mode functions:

- **[debugSleep](mta://scripting/shared/functions/debugsleep.md)**: Sets the freeze time for the client/server.
...
It is important to note that this example has to be in a client side script. Otherwise, the execution of the command would only result in the shared dev mode that does not allow the use of **[showcol](mta://reference/misc/client-commands.md)** and **[showsound](mta://reference/misc/client-commands.md)**.
