---
doc_id: "mta-wiki:2282"
title: "GetElementsWithinColShape"
source_title: "GetElementsWithinColShape"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementsWithinColShape"
revision_id: 72349
language: "en"
...
| [[{{{image}}}\|link=\|]] | Note: For legacy reasons, a colshape created on the client does not collide with elements already existing at that location until they first move. This function doesn't verify whether elements are in the same dimension and interior, additional checks could be implemented manually if they are needed. |
| --- | --- |
|  |  |
...
**Method**: *[colshape](https://wiki.multitheftauto.com/index.php?search=colshape):getElementsWithin(...)*
...
Returns a [table](mta://reference/misc/table.md) containing all the elements inside the colshape, of the specified type. Returns an empty [table](mta://reference/misc/table.md) if there are no elements inside. Returns *false* if the colshape is invalid.

## Example

This example retrieves a [table](mta://reference/misc/table.md) of players inside a colshape and prints their name to the chat.
