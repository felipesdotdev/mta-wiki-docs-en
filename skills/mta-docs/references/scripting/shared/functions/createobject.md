---
doc_id: "mta-wiki:1459"
title: "CreateObject"
source_title: "CreateObject"
source_url: "https://wiki.multitheftauto.com/wiki/CreateObject"
revision_id: 80893
language: "en"
...
Creates an [object](https://wiki.multitheftauto.com/index.php?search=object) [element](mta://reference/misc/element.md) at a given position and rotation.

## Important info about [Objects](https://wiki.multitheftauto.com/index.php?search=Objects)
...
- The createObject function can also create non-dynamic objects, but for optimization reasons **it is recommended to spawn [Buildings](https://wiki.multitheftauto.com/index.php?search=Buildings) when creating static objects that don't rely on the [Dimension](mta://reference/misc/dimension.md) system** (buildings don't use the same MTA object-streaming system).
...
**Method**: *[Object](https://wiki.multitheftauto.com/index.php?search=Object)(...)*
...
- **isLowLOD:** A bool value specifying if the object will be low LOD. A low LOD object has no collision and a longer draw distance. See [setLowLODElement](mta://scripting/shared/functions/setlowlodelement.md) for linking a LOD object.

### Returns

- Returns the [object](https://wiki.multitheftauto.com/index.php?search=object) element if the creation was successful, *false* otherwise.
...
**This script onlys works CLIENTSIDE due to [createBuilding](mta://scripting/shared/functions/createbuilding.md) and [engineGetModelPhysicalPropertiesGroup](mta://scripting/client/functions/enginegetmodelphysicalpropertiesgroup.md).**
