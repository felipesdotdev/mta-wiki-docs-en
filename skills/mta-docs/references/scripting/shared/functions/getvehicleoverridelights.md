---
doc_id: "mta-wiki:1697"
title: "GetVehicleOverrideLights"
source_title: "GetVehicleOverrideLights"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleOverrideLights"
revision_id: 42589
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getOverrideLights(...)*

**Variable**: *.overrideLights*

**Counterpart**: *[setVehicleOverrideLights](mta://scripting/shared/functions/setvehicleoverridelights.md)*

### Required Arguments

- **theVehicle**: the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to retrieve the override lights setting of.
