...
- **theVehicle**: The [element](mta://reference/misc/element.md) representing the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to remove the upgrade from
