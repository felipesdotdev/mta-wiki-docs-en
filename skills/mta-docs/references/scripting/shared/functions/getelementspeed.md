---
doc_id: "mta-wiki:5401"
title: "GetElementSpeed"
source_title: "GetElementSpeed"
source_url: "https://wiki.multitheftauto.com/wiki/GetElementSpeed"
revision_id: 66790
language: "en"
...
- **theElement**: the [element](mta://reference/misc/element.md) you want to get the speed of. Compatible [element](mta://reference/misc/element.md) types are:

- [Players](https://wiki.multitheftauto.com/index.php?search=Players)

- [Peds](https://wiki.multitheftauto.com/index.php?search=Peds)

- [Objects](https://wiki.multitheftauto.com/index.php?search=Objects)

- [Vehicles](https://wiki.multitheftauto.com/index.php?search=Vehicles)

- [Projectiles](https://wiki.multitheftauto.com/index.php?search=Projectiles)

### Optional arguments

*NOTE:* When using optional arguments, you might need to supply all arguments before the one you wish to use. For more information on optional arguments, see [optional arguments](https://wiki.multitheftauto.com/index.php?search=optional%20arguments).

- **Unit**: The unit of the speed returned. If not specified, the unit will be *m/s*. It can be specified as a *[string](mta://reference/misc/string.md)* or *number* as follows:
...
This function returns a *number* containing the [element](mta://reference/misc/element.md)'s speed if the arguments provided are valid. It returns *[nil](mta://reference/misc/nil.md)* plus an *error* otherwise.
...
**It is recommended to use MTA:SA 1.4** or higher with this function to use [OOP](mta://tutorials/oop.md).
...
This example draws the local player's speed rounded to a single decimal in the top-right corner of the screen in different units.
...
addEventHandler("onClientPreRender", getRootElement(), drawSpeed)
```
