...
**Method**: *[object](https://wiki.multitheftauto.com/index.php?search=object):isBreakable(...)*
...
- **theObject / modelId:** The [object](https://wiki.multitheftauto.com/index.php?search=object) / model ID that's being checked.
