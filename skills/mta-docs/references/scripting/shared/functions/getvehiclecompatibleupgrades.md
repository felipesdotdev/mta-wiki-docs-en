---
doc_id: "mta-wiki:2519"
title: "GetVehicleCompatibleUpgrades"
source_title: "GetVehicleCompatibleUpgrades"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleCompatibleUpgrades"
revision_id: 67715
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getCompatibleUpgrades(...)*

**Variable**: *.compatibleUpgrades*

### Required Arguments

- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to retrieve the list of compatible upgrades of.
