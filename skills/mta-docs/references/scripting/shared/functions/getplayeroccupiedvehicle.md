...
This function gets the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that the player is currently in, if any.
...
- **thePlayer**: The [player](https://wiki.multitheftauto.com/index.php?search=player) whose vehicle you're looking up.
