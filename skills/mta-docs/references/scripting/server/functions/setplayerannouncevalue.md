...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):setAnnounceValue(...)*

**Counterpart**: *[getPlayerAnnounceValue](mta://scripting/server/functions/getplayerannouncevalue.md)*

### Required Arguments

- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) whos announce value you wish to change.
