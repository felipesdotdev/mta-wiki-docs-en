...
This function removes a [player](https://wiki.multitheftauto.com/index.php?search=player) observer of a [textdisplay](mta://reference/misc/textdisplay.md). This stops the [player](https://wiki.multitheftauto.com/index.php?search=player) from being able to see [textitems](mta://reference/misc/textitem.md) that the [textdisplay](mta://reference/misc/textdisplay.md) contains.
...
- **display**: The [textdisplay](mta://reference/misc/textdisplay.md) to remove the [player](https://wiki.multitheftauto.com/index.php?search=player) from as an observer.

- **playerToRemove**: The [player](https://wiki.multitheftauto.com/index.php?search=player) that should be removed from the [textdisplay](mta://reference/misc/textdisplay.md).
