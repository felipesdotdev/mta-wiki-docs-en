---
doc_id: "mta-wiki:1673"
title: "ToggleVehicleRespawn"
source_title: "ToggleVehicleRespawn"
source_url: "https://wiki.multitheftauto.com/wiki/ToggleVehicleRespawn"
revision_id: 80457
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):toggleRespawn(...)*

**Variable**: *.respawnable*

**Counterpart**: *[isVehicleRespawnable](mta://scripting/server/functions/isvehiclerespawnable.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to toggle the respawning of.
