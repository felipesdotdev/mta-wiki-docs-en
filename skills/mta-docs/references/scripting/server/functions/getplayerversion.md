...
This function gets the client version of the specified [player](https://wiki.multitheftauto.com/index.php?search=player) as a **sortable string**. The string is always 15 characters long and is formatted as follows:
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getVersion(...)*

**Variable**: *.version*

### Required Arguments

- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) whose client version you wish to get.

### Returns

Returns a string containing the client version, or false if the [player](https://wiki.multitheftauto.com/index.php?search=player) is invalid.
