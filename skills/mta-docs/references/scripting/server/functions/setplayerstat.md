...
This function allows you to set the float value of a specific statistic for a [player](https://wiki.multitheftauto.com/index.php?search=player). **Visual stats (FAT and BODY_MUSCLE) can only be used on the CJ skin.** A large number of the stats will have no effect.
...
- **thePlayer**: the [player](https://wiki.multitheftauto.com/index.php?search=player) whose statistic you want to modify.
