...
This function removes every weapons from a specified [ped](https://wiki.multitheftauto.com/index.php?search=ped), rendering it unarmed.
...
- **thePed**: A [ped](https://wiki.multitheftauto.com/index.php?search=ped) element referencing the specified ped
