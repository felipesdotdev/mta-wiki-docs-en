...
This function adds a [player](https://wiki.multitheftauto.com/index.php?search=player) as an observer of a [textdisplay](mta://reference/misc/textdisplay.md). This allows the [player](https://wiki.multitheftauto.com/index.php?search=player) to see any [textitems](mta://reference/misc/textitem.md) that the [textdisplay](mta://reference/misc/textdisplay.md) contains.
...
- **display**: The [textdisplay](mta://reference/misc/textdisplay.md) to add the [player](https://wiki.multitheftauto.com/index.php?search=player) to as an observer.

- **playerToAdd**: The [player](https://wiki.multitheftauto.com/index.php?search=player) that should observe the [textdisplay](mta://reference/misc/textdisplay.md).
