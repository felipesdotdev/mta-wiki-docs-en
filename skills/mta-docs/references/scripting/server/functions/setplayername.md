...
This function changes the specified [player](https://wiki.multitheftauto.com/index.php?search=player)'s name. Note that any change made to a players name with this function is not saved in their settings so the name change only lasts till they disconnect.
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):setName(...)*
...
- **thePlayer:** the [player](https://wiki.multitheftauto.com/index.php?search=player) that will have its name set.
