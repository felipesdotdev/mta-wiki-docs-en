---
doc_id: "mta-wiki:2260"
title: "GetAlivePlayers"
source_title: "GetAlivePlayers"
source_url: "https://wiki.multitheftauto.com/wiki/GetAlivePlayers"
revision_id: 80388
language: "en"
...
This function returns a table of all the alive players on the server. Opposite function of [getDeadPlayers](mta://scripting/server/functions/getdeadplayers.md).
...
**Method**: *[Player](https://wiki.multitheftauto.com/index.php?search=Player).getAllAlive(...)*
