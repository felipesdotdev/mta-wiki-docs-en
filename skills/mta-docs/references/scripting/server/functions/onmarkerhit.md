...
- **hitElement**: the [element](mta://reference/misc/element.md) that hit the [marker](https://wiki.multitheftauto.com/index.php?search=marker).
...
The [source](mta://reference/misc/event-system.md) of this event is the [marker](https://wiki.multitheftauto.com/index.php?search=marker) that got hit by the element.
