...
This function allows you to set the armor value of a [player](https://wiki.multitheftauto.com/index.php?search=player).
...
- **thePlayer**: the [player](https://wiki.multitheftauto.com/index.php?search=player) whose armor you want to modify.
