---
doc_id: "mta-wiki:10777"
title: "SetVehicleRespawnRotation"
source_title: "SetVehicleRespawnRotation"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleRespawnRotation"
revision_id: 80455
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setRespawnRotation(...)*

**Variable**: *.respawnRotation*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to change the respawn position of.

- **rx**: A [float](mta://reference/misc/float.md) representing the rotation about the X axis in degrees.

- **ry**: A [float](mta://reference/misc/float.md) representing the rotation about the Y axis in degrees.

- **rz**: A [float](mta://reference/misc/float.md) representing the rotation about the Z axis in degrees.

## Returns

Returns *true* if the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) respawn rotation was set successfully, *false* otherwise.
