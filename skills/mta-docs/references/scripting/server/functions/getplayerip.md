---
doc_id: "mta-wiki:4334"
title: "GetPlayerIP"
source_title: "GetPlayerIP"
source_url: "https://wiki.multitheftauto.com/wiki/GetPlayerIP"
revision_id: 80394
language: "en"
...
This function returns a [string](mta://reference/misc/string.md) containing the IP address of the [player](https://wiki.multitheftauto.com/index.php?search=player).
...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getIP(...)*

**Variable**: *.ip*

### Required Arguments

- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) element you want to get the IP of.

### Returns

Returns a [string](mta://reference/misc/string.md) containing the requested players's IP, or *false* if the player passed to the function is invalid.
