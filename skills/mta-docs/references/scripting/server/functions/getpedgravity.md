...
This function returns the current gravity for the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped). The default gravity is 0.008.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getGravity(...)*
...
- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose gravity you want to check.
