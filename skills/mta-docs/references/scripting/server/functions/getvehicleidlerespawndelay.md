---
doc_id: "mta-wiki:14332"
title: "GetVehicleIdleRespawnDelay"
source_title: "GetVehicleIdleRespawnDelay"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleIdleRespawnDelay"
revision_id: 80441
language: "en"
...
[BETA](mta://reference/misc/beta-features.md): NEW FEATURE (BUILD: 1.6.0 [r22505](https://buildinfo.mtasa.com/?Author=&Branch=&Revision=22505))

This function gets the time delay (in milliseconds)
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getIdleRespawnDelay(...)*

**Variable**: *.idleRespawnDelay*

**Counterpart**: *[setVehicleIdleRespawnDelay](mta://scripting/server/functions/setvehicleidlerespawndelay.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to get the idle delay of.
