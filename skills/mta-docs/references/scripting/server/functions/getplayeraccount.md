...
**Method**: *[player](https://wiki.multitheftauto.com/index.php?search=player):getAccount(...)*

**Variable**: *.account*

### Required Arguments

- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) element you want to get the [account](mta://reference/misc/account.md) of.
