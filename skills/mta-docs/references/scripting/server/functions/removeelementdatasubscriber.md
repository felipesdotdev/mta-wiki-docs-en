---
doc_id: "mta-wiki:12425"
title: "RemoveElementDataSubscriber"
source_title: "RemoveElementDataSubscriber"
source_url: "https://wiki.multitheftauto.com/wiki/RemoveElementDataSubscriber"
revision_id: 81240
language: "en"
...
This function unsubscribes a [player](https://wiki.multitheftauto.com/index.php?search=player) from specific [element data](mta://reference/misc/element-data--975d1ea3.md).
...
**Method**: *[element](mta://reference/misc/element.md):removeDataSubscriber(...)*

**Counterpart**: *[addElementDataSubscriber](mta://scripting/server/functions/addelementdatasubscriber.md)*

### Required Arguments

- **theElement:** The [element](mta://reference/misc/element.md) you wish to unsubscribe the [player](https://wiki.multitheftauto.com/index.php?search=player) from.

- **key:** The key you wish to unsubscribe the player from.

- **thePlayer:** The [player](https://wiki.multitheftauto.com/index.php?search=player) you wish to unsubscribe.
