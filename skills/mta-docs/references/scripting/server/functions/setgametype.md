...
**It should be noted that [mapmanager](https://wiki.multitheftauto.com/index.php?search=mapmanager) handles this automatically for gamemodes that utilise the map/gamemode system.**
