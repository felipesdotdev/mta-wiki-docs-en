---
doc_id: "mta-wiki:14330"
title: "IsVehicleRespawnable"
source_title: "IsVehicleRespawnable"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleRespawnable"
revision_id: 80446
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):isRespawnable(...)*

**Variable**: *.respawnable*

**Counterpart**: *[toggleVehicleRespawn](mta://scripting/server/functions/togglevehiclerespawn.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) which you'd like to get respawn state of.
