...
This function can be used to retrieve all the [players](https://wiki.multitheftauto.com/index.php?search=players)  currently observing a specified [textdisplay](mta://reference/misc/textdisplay.md).
