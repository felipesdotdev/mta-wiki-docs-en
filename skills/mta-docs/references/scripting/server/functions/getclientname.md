...
This function gets a [client](mta://reference/misc/client.md)'s name (a client can either be a [player](https://wiki.multitheftauto.com/index.php?search=player) or an admin).
