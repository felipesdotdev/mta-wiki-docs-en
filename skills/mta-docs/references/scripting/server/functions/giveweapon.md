...
- **thePlayer:** A [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) object referencing the specified player (or [ped](https://wiki.multitheftauto.com/index.php?search=ped))
