---
doc_id: "mta-wiki:1676"
title: "SetVehicleIdleRespawnDelay"
source_title: "SetVehicleIdleRespawnDelay"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleIdleRespawnDelay"
revision_id: 80452
language: "en"
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setIdleRespawnDelay(...)*

**Variable**: *.idleRespawnDelay*

**Counterpart**: *[getVehicleIdleRespawnDelay](mta://scripting/server/functions/getvehicleidlerespawndelay.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to change the respawn delay of.
