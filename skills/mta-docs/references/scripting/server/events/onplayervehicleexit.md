---
doc_id: "mta-wiki:3460"
title: "OnPlayerVehicleExit"
source_title: "OnPlayerVehicleExit"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerVehicleExit"
revision_id: 68473
language: "en"
...
This event is triggered when a [player](https://wiki.multitheftauto.com/index.php?search=player) leaves a vehicle, for whatever reason.
...
- **theVehicle**: a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) element representing the vehicle in which the player exited from.

- **seat**: an [int](mta://reference/misc/int.md) representing the seat in which the player was before exiting.
...
- **forcedByScript:** a [boolean](mta://reference/misc/boolean.md) representing whether the exit was forced using [removePedFromVehicle](mta://scripting/shared/functions/removepedfromvehicle.md) or by the player.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that left the vehicle.
