---
doc_id: "mta-wiki:14297"
title: "OnPlayerTeamChange"
source_title: "OnPlayerTeamChange"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerTeamChange"
revision_id: 79388
language: "en"
...
- **oldTeam**: An [team](https://wiki.multitheftauto.com/index.php?search=team) representing the previous team of the player. If there is no old team, this is nil.

- **newTeam**: An [team](https://wiki.multitheftauto.com/index.php?search=team) representing the new team of the player. If there is no new team, this is nil.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) whose team was changed.

## Cancel effect

If this event is [canceled](mta://reference/misc/event-system.md), then the player's team change will be prevented.
