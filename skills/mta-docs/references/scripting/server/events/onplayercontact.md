...
- **previousElement**: the [element](mta://reference/misc/element.md) [player](https://wiki.multitheftauto.com/index.php?search=player) was standing on before. *nil* if none.

- **currentElement**: the new [element](mta://reference/misc/element.md) that the [player](https://wiki.multitheftauto.com/index.php?search=player) is standing on now. *nil* if none.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who hit an element.
