...
- **newSyncer**: a [player](https://wiki.multitheftauto.com/index.php?search=player) element representing the player who is now syncing the [element](mta://reference/misc/element.md).
