...
This event is triggered when a [pickup](https://wiki.multitheftauto.com/index.php?search=pickup) is spawned or respawned.
...
The [source](mta://reference/misc/event-system.md) of this event is the [pickup](https://wiki.multitheftauto.com/index.php?search=pickup) that just spawned or respawned.
