...
- **weaponID**:  an [int](mta://reference/misc/int.md) representing [weapon](mta://reference/misc/weapons.md) used for making a shot.

- **endX**: [float](mta://reference/misc/float.md) world X coordinate representing the end point.

- **endY**: [float](mta://reference/misc/float.md) world Y coordinate representing the end point.
