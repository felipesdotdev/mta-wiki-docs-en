---
doc_id: "mta-wiki:10229"
title: "OnPlayerPickupLeave"
source_title: "OnPlayerPickupLeave"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerPickupLeave"
revision_id: 82038
language: "en"
...
This event is triggered when a [player](https://wiki.multitheftauto.com/index.php?search=player) leaves a [pickup](https://wiki.multitheftauto.com/index.php?search=pickup).
...
- **pickupLeft**: the [pickup](https://wiki.multitheftauto.com/index.php?search=pickup) the [player](https://wiki.multitheftauto.com/index.php?search=player) left.

## Source

The source of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that left the pickup.
