---
doc_id: "mta-wiki:2321"
title: "OnPlayerPickupUse"
source_title: "OnPlayerPickupUse"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerPickupUse"
revision_id: 59496
language: "en"
...
- **thePickupToUse**: the [pickup](https://wiki.multitheftauto.com/index.php?search=pickup) the [player](https://wiki.multitheftauto.com/index.php?search=player) is standing on and is about to pick up.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that is standing on a pickup.

## Cancel effect

If this event is [canceled](mta://reference/misc/event-system.md), the player will not be able to pick up this pickup.
