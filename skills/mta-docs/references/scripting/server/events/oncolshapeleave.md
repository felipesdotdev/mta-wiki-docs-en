...
The [source](mta://reference/misc/event-system.md) of this event is the [colshape](https://wiki.multitheftauto.com/index.php?search=colshape) that the element no longer is in contact with.
