---
doc_id: "mta-wiki:2319"
title: "OnPlayerMarkerHit"
source_title: "OnPlayerMarkerHit"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerMarkerHit"
revision_id: 79779
language: "en"
...
This event is triggered when a [player](https://wiki.multitheftauto.com/index.php?search=player) hits a [marker](https://wiki.multitheftauto.com/index.php?search=marker).
...
- **markerHit**: the [marker](https://wiki.multitheftauto.com/index.php?search=marker) the [player](https://wiki.multitheftauto.com/index.php?search=player) hit.

- **matchingDimension**: a [boolean](mta://reference/misc/boolean.md) representing whether the [player](https://wiki.multitheftauto.com/index.php?search=player) and the hit [marker](https://wiki.multitheftauto.com/index.php?search=marker) are in the same [dimension](mta://reference/misc/dimension.md).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that hit the marker.
