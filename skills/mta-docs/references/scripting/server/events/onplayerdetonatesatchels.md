...
This event is triggered every time satchels are detonated - either by a [player](https://wiki.multitheftauto.com/index.php?search=player) or through [detonateSatchels](mta://scripting/shared/functions/detonatesatchels.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) whose satchels are being detonated.
