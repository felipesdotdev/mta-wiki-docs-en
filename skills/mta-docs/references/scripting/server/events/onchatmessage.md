...
- **theElement:** A [resource](mta://reference/misc/resource.md) if it was done via [outputChatBox](mta://scripting/shared/functions/outputchatbox.md) or a [player](https://wiki.multitheftauto.com/index.php?search=player) element if it was done via *say*, *teamsay* or *me*.
