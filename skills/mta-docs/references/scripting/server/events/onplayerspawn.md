---
doc_id: "mta-wiki:1828"
title: "OnPlayerSpawn"
source_title: "OnPlayerSpawn"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerSpawn"
revision_id: 59500
language: "en"
...
- **posX**: the X position the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned at.

- **posY**: the Y position the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned at.

- **posZ**: the Z position the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned at.

- **spawnRotation**: the rotation the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned with.

- **theTeam**: the [team](https://wiki.multitheftauto.com/index.php?search=team) the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned with.

- **theSkin**: the [skin/model](mta://reference/misc/character-skins.md) the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned with.

- **theInterior**: the [interior](mta://reference/misc/interior.md) the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned in.

- **theDimension**: the [dimension](mta://reference/misc/dimension.md) the [player](https://wiki.multitheftauto.com/index.php?search=player) spawned in.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that just spawned.
