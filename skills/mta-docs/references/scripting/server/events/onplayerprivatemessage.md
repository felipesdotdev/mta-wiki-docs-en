---
doc_id: "mta-wiki:4972"
title: "OnPlayerPrivateMessage"
source_title: "OnPlayerPrivateMessage"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerPrivateMessage"
revision_id: 79384
language: "en"
...
- **fullMessage**: a [string](mta://reference/misc/string.md) representing the message along with the nickname

- **recipient**: the [player](https://wiki.multitheftauto.com/index.php?search=player) to whom the message is being sent.

- **content**: a [string](mta://reference/misc/string.md) representing the message content only. This parameter is available since **1.6.0-9.22430** version.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who sent the private message.

## Cancel effect

If this event is [canceled](mta://reference/misc/event-system.md), the game's chat system won't deliver the message. You may use [outputChatBox](mta://scripting/shared/functions/outputchatbox.md) to send the messages then.
