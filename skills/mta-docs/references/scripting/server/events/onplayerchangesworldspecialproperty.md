---
doc_id: "mta-wiki:14485"
title: "OnPlayerChangesWorldSpecialProperty"
source_title: "OnPlayerChangesWorldSpecialProperty"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerChangesWorldSpecialProperty"
revision_id: 81779
language: "en"
...
[BETA](mta://reference/misc/beta-features.md): NEW FEATURE (BUILD: 1.6.0 [r22815](https://buildinfo.mtasa.com/?Author=&Branch=&Revision=22815))

This event is triggered every time a [player](https://wiki.multitheftauto.com/index.php?search=player) calls [setWorldSpecialPropertyEnabled](mta://scripting/shared/functions/setworldspecialpropertyenabled.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who changed a special property.
