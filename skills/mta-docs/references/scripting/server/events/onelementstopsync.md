...
- **oldSyncer**: a [player](https://wiki.multitheftauto.com/index.php?search=player) element representing the last player who was syncing the [element](mta://reference/misc/element.md).
