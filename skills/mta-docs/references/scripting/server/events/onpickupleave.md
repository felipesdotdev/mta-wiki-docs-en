...
- **thePlayer**: a [player](https://wiki.multitheftauto.com/index.php?search=player) element referring to the player who left the [pickup](https://wiki.multitheftauto.com/index.php?search=pickup).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [pickup](https://wiki.multitheftauto.com/index.php?search=pickup) that was left by the player.
