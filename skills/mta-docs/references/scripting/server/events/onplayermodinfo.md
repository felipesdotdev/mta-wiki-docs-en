---
doc_id: "mta-wiki:5755"
title: "OnPlayerModInfo"
source_title: "OnPlayerModInfo"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerModInfo"
revision_id: 59491
language: "en"
...
- **filename**: a [string](mta://reference/misc/string.md) with the filename of the modified file.

- **itemlist**: a [table](mta://reference/misc/table.md) with the details of each modification within the file. Possible keys for each sub-table are:
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player).
