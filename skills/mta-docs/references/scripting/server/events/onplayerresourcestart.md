...
This event is triggered when a [resource](mta://reference/misc/resource.md) has loaded client-side for a [player](https://wiki.multitheftauto.com/index.php?search=player).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who loaded the resource.
