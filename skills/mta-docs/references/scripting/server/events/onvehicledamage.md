...
- **loss**: a [float](mta://reference/misc/float.md) representing the amount of health the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) lost.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that got damaged.
