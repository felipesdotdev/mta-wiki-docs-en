...
This event is triggered when a [player](https://wiki.multitheftauto.com/index.php?search=player) enters a vehicle.
...
- **theVehicle**: a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) element representing the vehicle that was entered.
