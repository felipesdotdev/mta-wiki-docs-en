...
- **responsibleElement**: the [player](https://wiki.multitheftauto.com/index.php?search=player) who added the ban.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who was banned.
