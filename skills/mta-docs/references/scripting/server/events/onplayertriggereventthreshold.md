---
doc_id: "mta-wiki:14200"
title: "OnPlayerTriggerEventThreshold"
source_title: "OnPlayerTriggerEventThreshold"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerTriggerEventThreshold"
revision_id: 82415
language: "en"
...
This event is triggered when a player exceeds the maximum threshold for events via [triggerServerEvent](mta://scripting/client/functions/triggerserverevent.md).

During each interval (*player_triggered_event_interval*), all usage of [triggerServerEvent](mta://scripting/client/functions/triggerserverevent.md) will be counted for each player. This includes registered events, non-registered events and non-remote events.

If the count exceeds *max_player_triggered_events_per_interval*, this event will be fired. The count is reset each interval.

You can set these options via [setServerConfigSetting](mta://scripting/server/functions/setserverconfigsetting.md).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who exceeded the threshold.
