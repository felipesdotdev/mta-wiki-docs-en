...
- **killer**: an [element](mta://reference/misc/element.md) representing the [player](https://wiki.multitheftauto.com/index.php?search=player), [ped](https://wiki.multitheftauto.com/index.php?search=ped) or [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) who was the killer.  If there was no killer this is *false*.
...
The [source](mta://reference/misc/event-system.md) of this event is the [ped](https://wiki.multitheftauto.com/index.php?search=ped) that died or got killed.
