...
- **isAdded**: An [bool](https://wiki.multitheftauto.com/index.php?search=bool) representing whether called event is added.

- **isRemote**: An [bool](https://wiki.multitheftauto.com/index.php?search=bool) representing whether called event is remote.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who triggered invalid event.
