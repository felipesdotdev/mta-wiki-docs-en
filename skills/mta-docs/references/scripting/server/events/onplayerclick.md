...
- **clickedElement**: the [element](mta://reference/misc/element.md) the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked on. This value is *nil* if none.

- **worldPosX**: the X position in the world the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked on.

- **worldPosY**: the Y position in the world the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked on.

- **worldPosZ**: the Z position in the world the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked on.

- **screenPosX**: the X position on the screen the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked on.

- **screenPosY**: the Y position on the screen the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked on.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that clicked.
