...
- **theTruck**: the truck [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that this trailer got detached from.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the trailer [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that the truck got detached from.
