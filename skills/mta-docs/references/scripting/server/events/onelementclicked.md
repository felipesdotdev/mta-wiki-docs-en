...
- **playerWhoClicked**: the [player](https://wiki.multitheftauto.com/index.php?search=player) that clicked on the [element](mta://reference/misc/element.md).

- **clickPosX**: the X position in the world the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked at.

- **clickPosY**: the Y position in the world the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked at.

- **clickPosZ**: the Z position in the world the [player](https://wiki.multitheftauto.com/index.php?search=player) clicked at.
