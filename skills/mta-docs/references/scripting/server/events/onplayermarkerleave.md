...
This event is triggered when a [player](https://wiki.multitheftauto.com/index.php?search=player) leaves the area of a [marker](https://wiki.multitheftauto.com/index.php?search=marker).
...
- **markerLeft**: the [marker](https://wiki.multitheftauto.com/index.php?search=marker) the [player](https://wiki.multitheftauto.com/index.php?search=player) left.

- **matchingDimension**: a [boolean](mta://reference/misc/boolean.md) representing whether the [player](https://wiki.multitheftauto.com/index.php?search=player) and the left [marker](https://wiki.multitheftauto.com/index.php?search=marker) are in the same [dimension](mta://reference/misc/dimension.md).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that left the marker.
