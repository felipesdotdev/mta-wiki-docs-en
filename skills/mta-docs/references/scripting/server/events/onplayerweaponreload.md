---
doc_id: "mta-wiki:14535"
title: "OnPlayerWeaponReload"
source_title: "OnPlayerWeaponReload"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerWeaponReload"
revision_id: 81801
language: "en"
...
This event is triggered when a [player](https://wiki.multitheftauto.com/index.php?search=player) is reloading their weapon.
...
- **ammoInClip**: an [int](mta://reference/misc/int.md) amount of ammo left for this [weapon](mta://reference/misc/weapons.md) type in clip.

- **ammo**: an [int](mta://reference/misc/int.md) amount of ammo left for this [weapon](mta://reference/misc/weapons.md) type.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who's reloading their weapon.

### Canceling

If this event is [canceled](mta://reference/misc/event-system.md), then the players will not be able to reload their [weapon](mta://reference/misc/weapons.md) manually by pressing R key. 
The weapons will still reload when the **ammoInClip** reaches zero. Using [quickreload](mta://scripting/server/functions/setglitchenabled.md) will also reload the [weapon](mta://reference/misc/weapons.md).

## Example

This example will output informations when a [player](https://wiki.multitheftauto.com/index.php?search=player)'s weapon is reloading.
