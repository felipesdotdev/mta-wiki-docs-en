---
doc_id: "mta-wiki:1829"
title: "OnPlayerTarget"
source_title: "OnPlayerTarget"
source_url: "https://wiki.multitheftauto.com/wiki/OnPlayerTarget"
revision_id: 59502
language: "en"
...
- **targettedElement**: the [element](mta://reference/misc/element.md) the [player](https://wiki.multitheftauto.com/index.php?search=player) is targetting. *false* if no element is being targetted anymore.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that is targetting the element.
