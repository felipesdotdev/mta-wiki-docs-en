...
This event is triggered every time an explosion is created either by server-side [createExplosion](mta://scripting/shared/functions/createexplosion.md), or when reported by [player](https://wiki.multitheftauto.com/index.php?search=player).
...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who notified server about explosion, or [root](https://wiki.multitheftauto.com/index.php?search=root) if explosion was created server-side along without specifying creator in [createExplosion](mta://scripting/shared/functions/createexplosion.md).
