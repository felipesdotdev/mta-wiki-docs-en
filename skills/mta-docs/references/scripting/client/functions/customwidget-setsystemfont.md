---
doc_id: "mta-wiki:10810"
title: "CustomWidget:setSystemFont"
source_title: "CustomWidget:setSystemFont"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AsetSystemFont"
revision_id: 59268
language: "en"
...
This function sets font for Custom Widget from defaults.

## Syntax

```
nil CustomWidget:setSystemFont(string FontName)
```

### Required Arguments

- **FontName** - String of font. Look for [Standard_GUI_Font_Names](mta://scripting/concepts/standard-gui-font-names.md)

## Example

This example creates label and changing its font to Default Bold.

```
local Window = CustomWindow.create(50, 50, 150, 85, "Example")

local Label = CustomLabel.create(5, 25, 140, 25, "Label", false, Window)
Label:setSystemFont("default-bold-small")
```
