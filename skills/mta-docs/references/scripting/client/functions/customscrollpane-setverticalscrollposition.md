---
doc_id: "mta-wiki:10517"
title: "CustomScrollPane:setVerticalScrollPosition"
source_title: "CustomScrollPane:setVerticalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AsetVerticalScrollPosition"
revision_id: 57205
language: "en"
...
This function sets Custom Scroll Pane vertical scrolling position.

## Syntax

```
nil CustomScrollPane:setVerticalScrollPosition(float Percents)
```

### Required Arguments

- **Percents**  - Percents of scroll pane vertical progress (0-100)
