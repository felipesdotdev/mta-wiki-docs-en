...
This function returns the current move state for the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped).
...
- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose move state you want to know
