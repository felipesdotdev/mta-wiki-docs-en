...
This function gets the speed of a specified [effect](https://wiki.multitheftauto.com/index.php?search=effect).
...
**Method**: *[effect](https://wiki.multitheftauto.com/index.php?search=effect):getSpeed(...)*
...
- **theEffect:** The [effect](https://wiki.multitheftauto.com/index.php?search=effect) to get the speed of.
