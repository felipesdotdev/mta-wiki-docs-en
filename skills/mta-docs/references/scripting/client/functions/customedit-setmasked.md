---
doc_id: "mta-wiki:10428"
title: "CustomEdit:setMasked"
source_title: "CustomEdit:setMasked"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEdit%3AsetMasked"
revision_id: 56898
language: "en"
...
This function sets for Custom Edit masked.

## Syntax

```
nil CustomEdit:setMasked(bool Masked)
```

### Required Arguments

- **Masked** - Boolean value - is edit box masked. It can be used for password edit boxes.

## Example

This example creates window with masked edit box:
