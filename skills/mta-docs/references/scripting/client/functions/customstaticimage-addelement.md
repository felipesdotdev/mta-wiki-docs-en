---
doc_id: "mta-wiki:10820"
title: "CustomStaticImage:addElement"
source_title: "CustomStaticImage:addElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomStaticImage%3AaddElement"
revision_id: 59263
language: "en"
...
This function adding object to Static Image, and adds ColorScheme to this object.

## Syntax

```
nil CustomStaticImage:addElement(cwidget Element)
```
...
This example creates window with Static Images with 2 buttons:

```
local Window = CustomWindow.create(50, 50, 190, 100, "Example")
local Image = CustomStaticImage.create(5, 25, 180, 70, false, Window)

local Button = CustomButton.create(50, 5, 80, 25, "Button", false, Image)

--Its same as this:
local OldVersion = CustomButton.create(50, 35, 80, 25, "Button", false, Image:getMainElement())
Image:addElement(OldVersion)
```
