---
doc_id: "mta-wiki:10404"
title: "CustomProgressBar:getProgress"
source_title: "CustomProgressBar:getProgress"
source_url: "https://wiki.multitheftauto.com/wiki/CustomProgressBar%3AgetProgress"
revision_id: 56779
language: "en"
...
This function sets for Custom Progress Bar progress level (in percents).

## Syntax

```
float CustomProgressBar:getProgress()
```

### Returns

Returns progress level in percents of Custom Progress Bar.
...
This example creates window with Progress Bar, what changing by Scroll Bar, and prints Progress Bar progress level:
...
Scroll:addEvent("onCustomScrollBarScrolled", function(scrollLevel)
	...
	outputChatBox(Progress:getProgress())
end)
```
