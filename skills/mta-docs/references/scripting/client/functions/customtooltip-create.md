---
doc_id: "mta-wiki:10352"
title: "CustomTooltip.create"
source_title: "CustomTooltip.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTooltip.create"
revision_id: 58033
language: "en"
...
This function creates Custom Tooltip for Custom Widget.

## Syntax

```
ctooltip CustomTooltip.create(string Text, cwidget WidgetElement, [float Timeout])
```
...
- **WidgetElement** - Custom Widget Element (buttons, labels, etc)

### Other Arguments

- **Timeout** - Tooltip showing timeout in seconds. Default - *1*.

### Returns

Creates tooltip and returns object of class CustomTooltip.
...
This example creates window with button, when on hover shows tooltip:

```
local Window = CustomWindow.create(50, 50, 100, 60, "Example")

local ButtonWindow = CustomButton.create(5, 25, 90, 25, "Button", false, Window)
CustomTooltip.create("Custom Tooltip\nWith new lines counter\nAnd automatic calculating\nit's size", ButtonWindow, 0.5)
```
