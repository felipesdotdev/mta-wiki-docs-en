---
doc_id: "mta-wiki:10388"
title: "CustomWindow:getMainElement"
source_title: "CustomWindow:getMainElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetMainElement"
revision_id: 59237
language: "en"
...
```
gui-staticimage CustomWindow:getMainElement()
```

### Returns

Returns frame object of Custom Window, where user can locate any object.
...
This example creates window with buttons, connected to it with different types:

```
local Window = CustomWindow.create(50, 50, 100, 85, "Hello World")

local ButtonWithTheme = CustomButton.create(5, 25, 90, 25, "With Theme", false, Window)
local ButtonWithoutTheme = CustomButton.create(5, 55, 90, 25, "Without Theme", false, Window:getMainElement())
