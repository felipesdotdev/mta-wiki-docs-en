---
doc_id: "mta-wiki:10308"
title: "CustomWidget:bringToFront"
source_title: "CustomWidget:bringToFront"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AbringToFront"
revision_id: 57096
language: "en"
...
This function sets layer position of Custom Widget to front on screen.

## Syntax

```
bool CustomWidget:bringToFront()
```

### Returns

Boolean value - is widget changed layer.

## Example

This example creating two windows, and puts first created on front:

```
local WindowBack = CustomWindow.create(50, 50, 100, 100, "Now its front", false)
local WindowFront = CustomWindow.create(25, 25, 100, 100, "Now its back", false)
WindowBack:bringToFront()
```
