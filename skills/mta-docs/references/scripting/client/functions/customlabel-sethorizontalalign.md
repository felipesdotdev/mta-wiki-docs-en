---
doc_id: "mta-wiki:10497"
title: "CustomLabel:setHorizontalAlign"
source_title: "CustomLabel:setHorizontalAlign"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AsetHorizontalAlign"
revision_id: 57074
language: "en"
...
This function sets for Custom Label horizontal align.

## Syntax

```
nil CustomLabel:setHorizontalAlign(string HorizAlign)
```

### Required Arguments

- **HorizAlign** - Horizontal Align. Can be *left*, *center* or *right*.
