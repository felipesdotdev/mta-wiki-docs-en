...
This function is used to change the volume level of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):setVolume(...)*
...
- **theSound:** The [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) which volume you want to modify or a [player](https://wiki.multitheftauto.com/index.php?search=player) element which voice volume you want to modify.
...
Returns *true* if the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) volume was successfully changed, *false* otherwise.
