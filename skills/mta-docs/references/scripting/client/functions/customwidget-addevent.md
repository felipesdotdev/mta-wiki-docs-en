---
doc_id: "mta-wiki:10310"
title: "CustomWidget:addEvent"
source_title: "CustomWidget:addEvent"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AaddEvent"
revision_id: 58849
language: "en"
...
This function adding to Custom Widget event.

## Syntax

```
function CustomWidget:addEvent(string EventName, function EventFunction)
```
...
- **EventFunction** - Function to execute when event happening.

### Returns

Returns updated function for **addEventHandler**, special for removing function ([CustomWidget:removeEvent](mta://scripting/client/functions/customwidget-removeevent.md))
...
This example creating window with button, what sends message in chat on click, and event when window close sends info in chat:
...
Window:addEvent("onCustomWindowClose", function()
