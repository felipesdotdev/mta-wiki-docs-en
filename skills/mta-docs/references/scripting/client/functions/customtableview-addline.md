---
doc_id: "mta-wiki:10590"
title: "CustomTableView:addLine"
source_title: "CustomTableView:addLine"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AaddLine"
revision_id: 57510
language: "en"
...
This function adds line to Custom Table View.

## Syntax

```
cline CustomTableView:addLine([float Height])
```

### Other Arguments

- **Height** - Height of line. Default - *22*.

### Returns

Returns table with parameters of line, called *cline*.
