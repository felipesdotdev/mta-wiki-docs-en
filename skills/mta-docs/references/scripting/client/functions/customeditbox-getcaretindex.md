---
doc_id: "mta-wiki:10435"
title: "CustomEditBox:getCaretIndex"
source_title: "CustomEditBox:getCaretIndex"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AgetCaretIndex"
revision_id: 56906
language: "en"
...
This function gets Custom Edit Box caret index.

## Syntax

```
int CustomEditBox:getCaretIndex()
```

### Returns

Returns index of character, where located caret.

## Example

This example creates window with Edit Box and prints its caret when edit:

```
local Window = CustomWindow.create(50, 50, 200, 55, "Example")
local Edit = CustomEdit.create(5, 25, 190, 25, "Edit Box", false, Window)

Edit:addEvent("onClientGUIChanged", function()
	outputChatBox(Edit:getCaretIndex())
end)
```
