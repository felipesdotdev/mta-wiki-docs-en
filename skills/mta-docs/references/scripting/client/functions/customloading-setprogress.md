---
doc_id: "mta-wiki:10465"
title: "CustomLoading:setProgress"
source_title: "CustomLoading:setProgress"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLoading%3AsetProgress"
revision_id: 57004
language: "en"
...
This function sets for Custom Loading Widget progress level (in percents).

## Syntax

```
nil CustomLoading:setProgress(float Progress)
```

### Required Arguments

- **Progress** - Progress Level in percents
...
This example creates window with Loading Widget, what changing by NumberScroller:
