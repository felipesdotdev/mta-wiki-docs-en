---
doc_id: "mta-wiki:6789"
title: "SetVehicleComponentPosition"
source_title: "SetVehicleComponentPosition"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleComponentPosition"
revision_id: 51582
language: "en"
categories: ["Client_functions", "Changes_in_1.3.1", "Changes_in_1.4.0", "Changes_in_1.6.0"]
---

# SetVehicleComponentPosition

This function sets the component position of a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setComponentPosition(...)*

**Counterpart**: *[getVehicleComponentPosition](mta://scripting/client/functions/getvehiclecomponentposition.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to set component position.
