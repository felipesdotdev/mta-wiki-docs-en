---
doc_id: "mta-wiki:10303"
title: "CustomWidget:setPosition"
source_title: "CustomWidget:setPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AsetPosition"
revision_id: 56279
language: "en"
...
This function set position of Custom Widget on screen.

## Syntax

```
bool CustomWidget:setPosition(float X, float Y, [bool Relative])
```
...
Returns bool value - is position changed.

## Example

This example creating window, and set position to center of screen:

```
local Width, Height = guiGetScreenSize()

local Window = CustomWindow.create(0, 0, 100, 100, "Example", false)
Window:setPosition(Width/2 - 50, Height/2 - 50)
```
