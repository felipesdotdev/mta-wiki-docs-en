---
doc_id: "mta-wiki:10444"
title: "CustomEditBox:putOnSide"
source_title: "CustomEditBox:putOnSide"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AputOnSide"
revision_id: 56916
language: "en"
...
This function sets for Custom Edit sides color (because it's default edit boxes with custom frame - sides).

## Syntax

```
nil CustomEditBox:putOnSide(bool IsSide)
```

### Required Arguments

- **IsSide** - Boolean value - is Edit located on side of window.
