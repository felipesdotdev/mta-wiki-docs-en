---
doc_id: "mta-wiki:10400"
title: "CustomButton:setText"
source_title: "CustomButton:setText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomButton%3AsetText"
revision_id: 56879
language: "en"
...
This function sets Custom Button Widget new text.

## Syntax

```
nil CustomButton:setText(string Text)
```
...
This example creates window button, what changes title on hover:

```
local Window = CustomWindow.create(50, 50, 150, 60, "Example")
local Button = CustomButton.create(10, 25, 130, 25, "Button", false, Window)

Button:addEvent("onClientMouseEnter", function()
