---
doc_id: "mta-wiki:10323"
title: "CustomWindow.create"
source_title: "CustomWindow.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow.create"
revision_id: 56340
language: "en"
...
This function creates Custom Window Widget.

## Syntax

```
cwindow CustomWindow.create(float X, float Y, float Width, float Height, string Title, [bool Relative, gui-element Parent])
```
...
Creates window and returns object of class CustomWindow.
...
This example just creating some windows:

```
local WindowAbs = CustomWindow.create(50, 50, 200, 200, "Example Absolute")
local WindowRel = CustomWindow.create(0.04, 0.33, 0.12, 0.1, "Example Relative", true)
local WindowPar = CustomWindow.create(40, 40, 120, 120, "Example Parent", false, WindowAbs)
```
