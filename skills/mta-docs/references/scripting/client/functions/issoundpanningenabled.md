...
This function checks whether panning is enabled in a [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) or not.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):isPanningEnabled(...)*
...
- **theSound :** A valid [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md).
