---
doc_id: "mta-wiki:10426"
title: "CustomEditBox:setText"
source_title: "CustomEditBox:setText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AsetText"
revision_id: 56896
language: "en"
...
This function sets for Custom Edit Box text.

## Syntax

```
nil CustomEditBox:setText(string Text)
```

### Required Arguments

- **Text** - New text of Edit Box

## Example

This example creates window with Edit Box:
