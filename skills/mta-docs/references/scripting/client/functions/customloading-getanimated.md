---
doc_id: "mta-wiki:10468"
title: "CustomLoading:getAnimated"
source_title: "CustomLoading:getAnimated"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLoading%3AgetAnimated"
revision_id: 57008
language: "en"
...
This function gets Custom Loading Widget animated state.

## Syntax

```
bool CustomLoading:getAnimated()
```

### Returns

Returns boolean value - is circle has rotate animation.

## Example

This example creates window with two Loading Widgets, one is animated, and prints its animated states:

```
local Window = CustomWindow.create(50, 50, 75, 60, "Example")

local LoadingAnimated = CustomLoading.create(5, 25, false, Window)
local LoadingNotAnimated = CustomLoading.create(40, 25, false, Window)

LoadingNotAnimated:setAnimated(false)

outputChatBox(LoadingAnimated:getAnimated())
outputChatBox(LoadingNotAnimated:getAnimated())
```
