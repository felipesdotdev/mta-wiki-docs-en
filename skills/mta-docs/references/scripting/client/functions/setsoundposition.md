...
This function is used to change the seek position of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) element.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):setPlaybackPosition(...)*
...
- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element which seek position you want to modify.

- **pos:** a [float](mta://reference/misc/float.md) value representing the new seek position of the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element in seconds.

### Returns

Returns *true* if the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element's seek position was successfully changed, *false* otherwise.
