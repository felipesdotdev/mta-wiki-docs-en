...
This function gets the left/right level from a [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getLevelData(...)*

### Required Arguments

- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) which level data you want to return.
