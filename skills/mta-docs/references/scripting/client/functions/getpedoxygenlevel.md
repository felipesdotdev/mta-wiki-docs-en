---
doc_id: "mta-wiki:6820"
title: "GetPedOxygenLevel"
source_title: "GetPedOxygenLevel"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedOxygenLevel"
revision_id: 43088
language: "en"
...
This function returns the current oxygen level of the specified [ped](https://wiki.multitheftauto.com/index.php?search=ped).
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getOxygenLevel(...)*

**Variable**: *.oxygenLevel*

**Counterpart**: *[setPedOxygenLevel](mta://scripting/client/functions/setpedoxygenlevel.md)*

### Required Arguments

- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose oxygen level you want to check
