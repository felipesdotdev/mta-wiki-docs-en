...
This function sets the amount of geometric sub-division to use when drawing a [shader](https://wiki.multitheftauto.com/index.php?search=shader) element with [dxDrawImage](mta://scripting/client/functions/dxdrawimage.md).
...
**Method**: *[shader](https://wiki.multitheftauto.com/index.php?search=shader):setTessellation(...)*
