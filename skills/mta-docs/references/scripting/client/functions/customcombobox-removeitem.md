---
doc_id: "mta-wiki:10461"
title: "CustomComboBox:removeItem"
source_title: "CustomComboBox:removeItem"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AremoveItem"
revision_id: 57085
language: "en"
...
This function removes item from Custom Combo Box.

## Syntax

```
nil CustomComboBox:removeItem(string/ccbitem Item)
```

### Required Arguments

- **Item** - String - item text, or Custom Combo Box Item (*ccbitem*), what returns with [CustomComboBox:addItem](mta://scripting/client/functions/customcombobox-additem.md)

## Example

This example creates window with Combo Box, adds some elements and removes with 2 different ways:

```
local Window = CustomWindow.create(50, 50, 120, 60, "Example")

local ComboBox = CustomComboBox.create(5, 25, 110, 30, "Combo Box", false, Window)

local Item = ComboBox:addItem("Hello World")
ComboBox:addItem("Quick Brown Fox")
ComboBox:addItem("Jumps Over")
ComboBox:addItem("The Lazy Dog")
ComboBox:addItem("Over Size...")
ComboBox:addItem("...Items")
ComboBox:setMaxHeight(100)

ComboBox:removeItem(Item)
ComboBox:removeItem("...Items")
```
