---
doc_id: "mta-wiki:12681"
title: "SetVehicleDummyPosition"
source_title: "SetVehicleDummyPosition"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleDummyPosition"
revision_id: 81292
language: "en"
...
This function sets the position of the dummy for the given [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setDummyPosition(...)*

**Counterpart**: *[getVehicleDummyPosition](mta://scripting/client/functions/getvehicledummyposition.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you want to set the dummy position for.
...
|  | Script Example Missing Function SetVehicleDummyPosition needs a script example, help out by writing one. |
| --- | --- |
