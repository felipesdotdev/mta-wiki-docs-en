---
doc_id: "mta-wiki:10378"
title: "CustomWindow:setTitle"
source_title: "CustomWindow:setTitle"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AsetTitle"
revision_id: 56748
language: "en"
...
This function sets title for Custom Window.

## Syntax

```
nil CustomWindow:setTitle(string Title)
```
...
This function same as [CustomWindow:setText](mta://scripting/client/functions/customwindow-settext.md)

## Example

This example creates window with empty title and set it new:
