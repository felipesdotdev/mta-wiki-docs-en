---
doc_id: "mta-wiki:10695"
title: "CustomEditBox:isOnSide"
source_title: "CustomEditBox:isOnSide"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AisOnSide"
revision_id: 58048
language: "en"
...
This function gets - is Custom Edit Box located on side bar (changing by [CustomEditBox:putOnSide](mta://scripting/client/functions/customeditbox-putonside.md).

## Syntax

```
bool CustomEditBox:isOnSide()
```

### Returns

Returns boolean value - is Edit located on side of window.
...
Example when line with *putOnSide* doesn't exists

This example creates window with two edit boxes:

```
local Window = CustomWindow.create(50, 50, 150, 80, "Example")
local EditSide = CustomEdit.create(5, 20, 140, 25, "Edit Box", false, Window)
local EditWin = CustomEdit.create(5, 50, 140, 25, "Edit Box", false, Window)

EditSide:putOnSide(true)

outputChatBox(EditSide:isOnSide())
outputChatBox(EditWin:isOnSide())
