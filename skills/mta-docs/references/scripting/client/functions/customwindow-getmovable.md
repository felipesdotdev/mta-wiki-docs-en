---
doc_id: "mta-wiki:10385"
title: "CustomWindow:getMovable"
source_title: "CustomWindow:getMovable"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetMovable"
revision_id: 56758
language: "en"
...
This function gets movable status of Custom Window.

## Syntax

```
bool CustomWindow:getMovable()
```

### Returns

Returns movable status of Custom Window.

## Example

This example creates two windows and sets for another window movable status from first:

```
local WindowFrom = CustomWindow.create(50, 50, 200, 150, "Hello World")
local WindowTo = CustomWindow.create(50, 255, 200, 150, "Example")

WindowFrom:setMovable(false)
WindowTo:setMovable(WindowFrom:getMovable())
```
