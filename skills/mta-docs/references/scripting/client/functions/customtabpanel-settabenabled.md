---
doc_id: "mta-wiki:10475"
title: "CustomTabPanel:setTabEnabled"
source_title: "CustomTabPanel:setTabEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AsetTabEnabled"
revision_id: 57044
language: "en"
...
This function sets Tab enabled state for Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:setTabEnabled(string/ctab Tab, bool Enabled)
```
...
- **Enabled** - Boolean value - is tab enabled
...
This example creates window with tab panel with 3 tabs, one is disabled:
