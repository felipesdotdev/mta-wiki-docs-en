---
doc_id: "mta-wiki:10771"
title: "CustomEditBox:setSidesColor"
source_title: "CustomEditBox:setSidesColor"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AsetSidesColor"
revision_id: 58857
language: "en"
...
This function sets Custom EditBox's sides color.

## Syntax

```
nil CustomEditBox:setSidesColor(hex6/bool Color)
```

### Required Arguments

- **Color** - Hexademical with 6 chars string of color. Can be *false*, if you need to make color again generated by color scheme or side block.
