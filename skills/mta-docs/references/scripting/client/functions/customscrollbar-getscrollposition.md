---
doc_id: "mta-wiki:10418"
title: "CustomScrollBar:getScrollPosition"
source_title: "CustomScrollBar:getScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar%3AgetScrollPosition"
revision_id: 56881
language: "en"
...
This function sets for Custom Scroll Bar scroll position (progress) in percents.

## Syntax

```
float CustomScrollBar:getScrollPosition()
```

### Returns

Returns progress level in percents of Custom Scroll Bar.
