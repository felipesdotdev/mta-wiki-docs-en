---
doc_id: "mta-wiki:11509"
title: "SetVehicleComponentScale"
source_title: "SetVehicleComponentScale"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleComponentScale"
revision_id: 80102
language: "en"
...
This function sets the component scale of a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setComponentScale(...)*

**Counterpart**: *[getVehicleComponentScale](mta://scripting/client/functions/getvehiclecomponentscale.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to set component scale.
