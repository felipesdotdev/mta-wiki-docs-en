---
doc_id: "mta-wiki:4288"
title: "GetSoundMinDistance"
source_title: "GetSoundMinDistance"
source_url: "https://wiki.multitheftauto.com/wiki/GetSoundMinDistance"
revision_id: 80335
language: "en"
...
Gets a custom [sound](https://wiki.multitheftauto.com/index.php?search=sound) Minimum distance at which the sound stops getting louder.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getMinDistance(...)*

**Variable**: *.minDistance*

**Counterpart**: *[setSoundMinDistance](mta://scripting/client/functions/setsoundmindistance.md)*
