---
doc_id: "mta-wiki:10498"
title: "CustomLabel:setAlign"
source_title: "CustomLabel:setAlign"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AsetAlign"
revision_id: 57075
language: "en"
...
This function sets for Custom Label both aligns in one function.

## Syntax

```
nil CustomLabel:setAlign([string VertAlign, string HorizAlign])
```

### Other Arguments

- **VertAlign** - Vertical Align. Can be *top*, *center* or *bottom*. Default - *top*

- **HorizAlign** - Horizontal Align. Can be *left*, *center* or *right*. Default - *left*

## Example

This example creates label with centered align:

```
local Window = CustomWindow.create(50, 50, 150, 115, "Example")

local Label = CustomLabel.create(5, 25, 140, 25, "Custom Label", false, Window)
