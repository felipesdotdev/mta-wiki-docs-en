---
doc_id: "mta-wiki:10696"
title: "CustomComboBox:setItemText"
source_title: "CustomComboBox:setItemText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AsetItemText"
revision_id: 58049
language: "en"
...
This function sets for Custom Combo Box text for item.

## Syntax

```
nil CustomComboBox:setItemText(string/ccbitem Item, string Text)
```
