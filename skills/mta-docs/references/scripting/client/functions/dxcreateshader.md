---
doc_id: "mta-wiki:5670"
title: "DxCreateShader"
source_title: "DxCreateShader"
source_url: "https://wiki.multitheftauto.com/wiki/DxCreateShader"
revision_id: 76190
language: "en"
...
This function creates a [shader](https://wiki.multitheftauto.com/index.php?search=shader) element that can be used in the dxDraw functions. Successful shader creation is not guaranteed unless the [Effect File](https://wiki.multitheftauto.com/index.php?search=Effect%20File) contains a fallback technique which will work on every existing PC.
...
**Method**: *[DxShader](https://wiki.multitheftauto.com/index.php?search=DxShader)(...)*

### Required Arguments

- **filepath / raw_data:** The filepath of the [shader Effect File](https://wiki.multitheftauto.com/index.php?search=shader%20Effect%20File) (.fx) file or whole data buffer of the shader file
...
- **element:** A [shader](https://wiki.multitheftauto.com/index.php?search=shader) element if successful, *false* if invalid arguments were passed to the function. **You should always check to see if this function has returned false.**
