---
doc_id: "mta-wiki:10472"
title: "CustomTabPanel:setTabVisible"
source_title: "CustomTabPanel:setTabVisible"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AsetTabVisible"
revision_id: 57042
language: "en"
...
This function sets Tab visible state for Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:setTabVisible(string/ctab Tab, bool Visibility)
```
...
- **Visibility** - Boolean value - is tab visible
...
This example creates window with tab panel with 3 tabs, one is not visible:
