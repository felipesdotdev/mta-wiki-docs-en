...
Prints world [sound](https://wiki.multitheftauto.com/index.php?search=sound) IDs in the debug output window to help when writing scripts with [setWorldSoundEnabled](mta://scripting/client/functions/setworldsoundenabled.md).
