---
doc_id: "mta-wiki:10773"
title: "CustomEditBox:getSidesColor"
source_title: "CustomEditBox:getSidesColor"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AgetSidesColor"
revision_id: 58858
language: "en"
...
This function gets Custom EditBox's sides color.

## Syntax

```
hex6/bool CustomEditBox:getSidesColor()
```

### Returns

Returns hexademical with 6 chars string of color. Can be *false*, if color isn't set.
...
This example creating window with EditBoxes with custom colors:

```
local Window = CustomWindow.create(100, 100, 200, 220, "Example", false)
local Image = GuiStaticImage.create(2, 52, 196, 166, pane, false, Window)
local Edit = CustomEdit.create(5, 55, 190, 30, "Edit Box", false, Window)
local Memo = CustomMemo.create(5, 90, 190, 90, "Memo Box\nNew Line", false, Window)
local Spin = CustomSpinner.create(5, 185, 190, 30, false, Window)

Window:setColorScheme(Themes.Dark.Purple)
Window:showBar("top", 50)

Image:setColor("FFDA4242")
Image:setEnabled(false)

Edit:setSidesColor("DA4242")
Memo:setSidesColor("DA4242")
Spin:setSidesColor("DA4242")

outputChatBox(Edit:getSidesColor())
```
