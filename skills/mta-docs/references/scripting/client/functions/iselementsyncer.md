---
doc_id: "mta-wiki:4414"
title: "IsElementSyncer"
source_title: "IsElementSyncer"
source_url: "https://wiki.multitheftauto.com/wiki/IsElementSyncer"
revision_id: 43616
language: "en"
...
This function checks whether an [element](mta://reference/misc/element.md) is synced by the local player or not. Accepted elements are [peds](https://wiki.multitheftauto.com/index.php?search=peds) and [vehicles](https://wiki.multitheftauto.com/index.php?search=vehicles).
...
**Method**: *[element](mta://reference/misc/element.md):isSyncer(...)*
