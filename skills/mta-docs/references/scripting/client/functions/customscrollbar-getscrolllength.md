---
doc_id: "mta-wiki:10421"
title: "CustomScrollBar:getScrollLength"
source_title: "CustomScrollBar:getScrollLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar%3AgetScrollLength"
revision_id: 56884
language: "en"
...
This function gets Custom Scroll Bar length of scroller element (in pixels).

## Syntax

```
float CustomScrollBar:getScrollLength()
```

### Returns

Returns length of scroller element in pixels.

## Example

This example creates window with 2 Scroll Bars with same scroller length:

```
local Window = CustomWindow.create(50, 50, 100, 65, "Example")

local ScrollBarF = CustomScrollBar.create(5, 25, 90, 15, false, Window)
local ScrollBarS = CustomScrollBar.create(5, 45, 90, 15, false, Window)

ScrollBarF:setScrollLength(30)
ScrollBarS:setScrollLength(ScrollBarF:getScrollLength())
```
