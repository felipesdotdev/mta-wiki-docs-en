---
doc_id: "mta-wiki:10563"
title: "CustomTableView:setColumnWidth"
source_title: "CustomTableView:setColumnWidth"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetColumnWidth"
revision_id: 57496
language: "en"
...
This function sets width of column for Custom Table View.

## Syntax

```
nil CustomTableView:setColumnWidth([ccolumn/int Column, int Width])
```
...
- **Width** - Width of Column. Default is *50*.
...
This example creates window with Table View, and sets new width for first column:
