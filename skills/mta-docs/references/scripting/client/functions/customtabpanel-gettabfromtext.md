---
doc_id: "mta-wiki:10485"
title: "CustomTabPanel:getTabFromText"
source_title: "CustomTabPanel:getTabFromText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetTabFromText"
revision_id: 57056
language: "en"
...
This function gets Tab from title of Custom Tab Panel.

## Syntax

```
ctab CustomTabPanel:getTabFromText(string TabTitle)
```

### Required Arguments

- **TabTitle** - String of Tab title

### Returns

Returns *ctab* element - first tab, what's title is equal to what sends in arguments.
...
This example creates window with tab panel with 3 tabs, and in one tab creates image:
...
local Tab = TabPanel:getTabFromText("Second Tab")

local Image = GuiStaticImage.create(5, 5, 40, 40, pane, false, Tab)
Image:setProperty("ImageColours", "tl:FFD26767 tr:FFD26767 bl:FFD26767 br:FFD26767")
```
