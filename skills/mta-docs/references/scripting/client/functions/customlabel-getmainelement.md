---
doc_id: "mta-wiki:10694"
title: "CustomLabel:getMainElement"
source_title: "CustomLabel:getMainElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AgetMainElement"
revision_id: 59255
language: "en"
...
```
gui-staticimage CustomLabel:getMainElement()
```

### Returns

Returns frame object of Custom Label, where user can locate any object.
