---
doc_id: "mta-wiki:10560"
title: "CustomTableView:setIndentation"
source_title: "CustomTableView:setIndentation"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetIndentation"
revision_id: 57489
language: "en"
...
This function sets indentation between lines for Custom Table View.

## Syntax

```
nil CustomTableView:setIndentation([int Length])
```

### Other Arguments

- **Length** - Length of indentation between lines. Default is *5*.
...
Code Example with indentation 7px

This example creates window with Scroll Pane, and set its indentation between lines:
