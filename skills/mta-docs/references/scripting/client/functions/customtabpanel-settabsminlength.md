---
doc_id: "mta-wiki:10479"
title: "CustomTabPanel:setTabsMinLength"
source_title: "CustomTabPanel:setTabsMinLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AsetTabsMinLength"
revision_id: 57060
language: "en"
...
This function sets minimal length of one tab block for Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:setTabsMinLength(float MinLength)
```

### Required Arguments

- **MinLength** - Minimal length of tab block in pixels
...
This example creates window with 3 tab panels with different minimal tab sizes:
