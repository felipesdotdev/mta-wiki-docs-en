---
doc_id: "mta-wiki:5658"
title: "DxCreateFont"
source_title: "DxCreateFont"
source_url: "https://wiki.multitheftauto.com/wiki/DxCreateFont"
revision_id: 78780
language: "en"
...
This function creates a [DX font](https://wiki.multitheftauto.com/index.php?search=DX%20font) element that can be used in [dxDrawText](mta://scripting/client/functions/dxdrawtext.md). Successful font creation is not guaranteed, and may fail due to hardware or memory limitations.
...
**Method**: *[DxFont](https://wiki.multitheftauto.com/index.php?search=DxFont)(...)*
...
Returns a [DX font](https://wiki.multitheftauto.com/index.php?search=DX%20font) element if successful, *false* if invalid arguments were passed to the function, or there is insufficient resources available.
