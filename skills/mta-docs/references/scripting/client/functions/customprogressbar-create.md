---
doc_id: "mta-wiki:10327"
title: "CustomProgressBar.create"
source_title: "CustomProgressBar.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomProgressBar.create"
revision_id: 56370
language: "en"
...
This function creates Custom Progress Bar.

## Syntax

```
cpbar CustomProgressBar.create(float X, float Y, float Width, float Height, [bool Relative, gui-element Parent])
```
...
Creates progress bar and returns object of class CustomProgressBar.

## Information

Vertical or horizontal Progress Bars sets by their size. If Width more then Height, Bar will be horizontal, else it will be vertical.
...
Scroll:addEvent("onCustomScrollBarScrolled", function(scrollLevel)
	Progress:setProgress(scrollLevel)
end)
```
