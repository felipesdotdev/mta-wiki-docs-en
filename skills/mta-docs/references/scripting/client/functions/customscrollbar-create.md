---
doc_id: "mta-wiki:10328"
title: "CustomScrollBar.create"
source_title: "CustomScrollBar.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar.create"
revision_id: 56369
language: "en"
...
This function creates Custom Scroll Bar.

## Syntax

```
csbar CustomScrollBar.create(float X, float Y, float Width, float Height, [bool Relative, gui-element Parent])
```
...
Creates scroll bar and returns object of class CustomScrollBar.

## Information

Vertical or horizontal Scroll Bars sets by their size. If Width more then Height, Bar will be horizontal, else it will be vertical.

On ScrollBars you can use Middle Mouse Scroller to scroll Scroll Bar without dragging scroller.
...
This example creates window with Progress Bar, what changing by Scroll Bar:

```
local Window = CustomWindow.create(50, 50, 200, 65, "Example")
local Progress = CustomProgressBar.create(5, 25, 190, 15, false, Window)
local Scroll = CustomScrollBar.create(5, 45, 190, 15, false, Window)

Scroll:addEvent("onCustomScrollBarScrolled", function()
	Progress:setProgress(Scroll:getScrollPosition())
end)
```
