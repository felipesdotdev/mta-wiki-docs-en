...
This function sets the [pixels](mta://reference/misc/texture-pixels.md) of a [texture](https://wiki.multitheftauto.com/index.php?search=texture) element. It can be used with a standard texture, render target or screen source. Only '**plain'** format pixels please.
...
**Method**: *[texture](https://wiki.multitheftauto.com/index.php?search=texture):setPixels(...)*
