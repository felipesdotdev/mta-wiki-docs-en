---
doc_id: "mta-wiki:10699"
title: "CustomComboBox:getItems"
source_title: "CustomComboBox:getItems"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AgetItems"
revision_id: 58052
language: "en"
...
This function gets Custom Combo Box table of strings - items.

## Syntax

```
table[string] CustomComboBox:getItems()
```

### Returns

Returns table of string of items in combo box
...
for _, item in pairs(ComboBoxOne:getItems()) do
	outputChatBox(item)
end
```
