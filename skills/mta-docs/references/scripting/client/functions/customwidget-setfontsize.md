---
doc_id: "mta-wiki:10702"
title: "CustomWidget:setFontSize"
source_title: "CustomWidget:setFontSize"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AsetFontSize"
revision_id: 59233
language: "en"
...
This function sets font size for Custom Widget.

## Syntax

```
nil CustomWidget:setFontSize([float FontSize])
```
...
Label:setFont(Fonts.RobotoThin)
