...
This function is used to return the current seek position of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) element.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getPlaybackPosition(...)*
...
- **theSound:** The [sound](https://wiki.multitheftauto.com/index.php?search=sound) element which seek position you want to return.

### Returns

Returns a [float](mta://reference/misc/float.md) value indicating the seek position of the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element in seconds.
