---
doc_id: "mta-wiki:10318"
title: "CustomWidget:getVisible"
source_title: "CustomWidget:getVisible"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AgetVisible"
revision_id: 57093
language: "en"
...
This function get visibility of Custom Widget on screen.

## Syntax

```
bool CustomWidget:getVisible()
```

### Returns

Returns bool value - widget visibility.

## Example

This example creating window with buttons, when click on them label changing visibility, and one button with event with checking visibility:

```
local Window = CustomWindow.create(5, 5, 120, 155, "Example", false)
...
local CheckButton = CustomButton.create(10, 100, 100, 25, "Check Visibility", false, Window)
local VLabel = CustomLabel.create(10, 100, 135, 15, "Example Label", false, Window)
...
CheckButton:addEvent("onClientGUIClick", function()
	if VLabel:getVisible() then
		outputChatBox("Label is visible")
	else
		outputChatBox("Label is invisible")
	end
end)
```
