---
doc_id: "mta-wiki:6842"
title: "SetVehicleComponentVisible"
source_title: "SetVehicleComponentVisible"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleComponentVisible"
revision_id: 63311
language: "en"
categories: ["Client_functions", "Changes_in_1.3.1", "Changes_in_1.6.0"]
---

# SetVehicleComponentVisible

This function sets component visibility for [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setComponentVisible(...)*

**Counterpart**: *[getVehicleComponentVisible](mta://scripting/client/functions/getvehiclecomponentvisible.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to set component visibility of.

- **theComponent:** A [vehicle component](mta://reference/misc/vehicle-components.md) (this is the component's frame name (also called 'dummy') from the vehicle model's DFF file of which you want to manipulate components)
