...
This function gets the parameters of a [sound](https://wiki.multitheftauto.com/index.php?search=sound) effect.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getEffectParameters(...)*

### Required Arguments

- **sound**: The [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) to get the sound effect parameters of.
