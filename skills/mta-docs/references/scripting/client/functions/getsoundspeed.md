...
This function is used to return the playback speed of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md).
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getSpeed(...)*
...
- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) which playback speed you want to return.

### Returns

Returns an [float](mta://reference/misc/float.md) value indicating the playback speed of the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md). Default sound playback speed is **1.0**.
