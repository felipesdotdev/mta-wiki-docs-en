---
doc_id: "mta-wiki:10581"
title: "CustomTableView:getColumnsCount"
source_title: "CustomTableView:getColumnsCount"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetColumnsCount"
revision_id: 57508
language: "en"
...
This function gets count of Columns from Custom Table View.

## Syntax

```
int CustomTableView:getColumnsCount()
```

### Returns

Returns count of Columns from Custom Table View.

## Example

This example prints count of columns of Table View:
...
outputChatBox(TabView:getColumnsCount()) --2
```
