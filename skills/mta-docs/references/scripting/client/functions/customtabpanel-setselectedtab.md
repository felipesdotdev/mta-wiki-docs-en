---
doc_id: "mta-wiki:10478"
title: "CustomTabPanel:setSelectedTab"
source_title: "CustomTabPanel:setSelectedTab"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AsetSelectedTab"
revision_id: 57047
language: "en"
...
This function sets Selected Tab for Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:setSelectedTab(string/ctab Tab)
```
...
This example creates window with tab panel with 3 tabs, second sets selected:
