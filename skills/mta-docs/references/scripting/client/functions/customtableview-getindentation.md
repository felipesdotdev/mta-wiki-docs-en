---
doc_id: "mta-wiki:10574"
title: "CustomTableView:getIndentation"
source_title: "CustomTableView:getIndentation"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetIndentation"
revision_id: 57488
language: "en"
...
This function gets indentation between lines of Custom Table View.

## Syntax

```
float CustomTableView:getIndentation()
```

### Returns

Returns size of indentation between lines of Custom Table View.

## Example

 

Code Example with indentation 2px

This example creates window with Scroll Pane, set its indentation between lines, and prints it:
...
TabView:setIndentation(2)
outputChatBox(TabView:getIndentation())
```
