---
doc_id: "mta-wiki:10698"
title: "CustomComboBox:getItemsCount"
source_title: "CustomComboBox:getItemsCount"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AgetItemsCount"
revision_id: 58051
language: "en"
...
This function gets Custom Combo Box counts of items.

## Syntax

```
int CustomComboBox:getItemsCount()
```

### Returns

Returns count of items in combo box
...
outputChatBox(ComboBoxTwo:getItemsCount())
```
