---
doc_id: "mta-wiki:10434"
title: "CustomEditBox:getText"
source_title: "CustomEditBox:getText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AgetText"
revision_id: 56905
language: "en"
...
```
string CustomEditBox:getText()
```

### Returns

Returns Edit Box's text

## Example

This example creates window with Edit Box and prints it string when it's edits:
