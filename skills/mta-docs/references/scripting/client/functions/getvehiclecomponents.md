---
doc_id: "mta-wiki:6843"
title: "GetVehicleComponents"
source_title: "GetVehicleComponents"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleComponents"
revision_id: 50665
language: "en"
...
This function gets a table of the components currently on a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getComponents(...)*

**Variable**: *.components*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to get the [components](mta://reference/misc/vehicle-components.md) of.
