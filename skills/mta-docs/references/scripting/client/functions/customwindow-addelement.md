---
doc_id: "mta-wiki:10395"
title: "CustomWindow:addElement"
source_title: "CustomWindow:addElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AaddElement"
revision_id: 59265
language: "en"
...
This function adding object to Window, and some window parameters were sends to this object.

## Syntax

```
nil CustomWindow:addElement(cwidget Element)
```
...
This example creates window with 2 buttons:

```
local Window = CustomWindow.create(50, 50, 180, 85, "Example")

local Button = CustomButton.create(50, 25, 80, 25, "Button", false, Window)

--Its same as this:
local OldVersion = CustomButton.create(50, 55, 80, 25, "Button", false, Window:getMainElement())
Window:addElement(OldVersion)
```
