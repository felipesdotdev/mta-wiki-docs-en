---
doc_id: "mta-wiki:10458"
title: "CustomComboBox:getSelectedItem"
source_title: "CustomComboBox:getSelectedItem"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AgetSelectedItem"
revision_id: 56996
language: "en"
...
This function gets Custom Combo Box selected item.

## Syntax

```
ccbitem CustomComboBox:getSelectedItem()
```

### Returns

Returns Custom Combo Box selected item as *ccbitem*.

## Information

To get combo box item's text, needs to call attribute *Text* of *ccbitem* object. Look at the example - printing part.

## Example

This example creates window with Combo Box, and prints item when it selects:
...
ComboBox:addItem("Another Item")
ComboBox:addItem("Third Item")
ComboBox:addItem("Fourth Item")
ComboBox:addItem("Fifth Item")
ComboBox:setMaxHeight(100)

ComboBox:addEvent("onCustomComboBoxSelectItem", function()
	outputChatBox("You select item: "..ComboBox:getSelectedItem().Text)
end)
```
