...
This function updates the contents of a screen source [texture](https://wiki.multitheftauto.com/index.php?search=texture) with the screen output from GTA
...
**Method**: *[DxScreenSource](https://wiki.multitheftauto.com/index.php?search=DxScreenSource):update(...)*
