...
Returns an *integer* of the water level if the [localPlayer](https://wiki.multitheftauto.com/index.php?search=localPlayer)/position is near the water (-3 to 20 on the Z coordinate) else *false* if there's no water near the [localPlayer](https://wiki.multitheftauto.com/index.php?search=localPlayer)/position.
