---
doc_id: "mta-wiki:10304"
title: "CustomWidget:setSize"
source_title: "CustomWidget:setSize"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AsetSize"
revision_id: 56280
language: "en"
...
```
bool CustomWidget:setSize(float Width, float Height, [bool Relative])
```
...
Returns bool value - is size changed.

## Example

This example creating window, and set it's size to quarter part of screen:
