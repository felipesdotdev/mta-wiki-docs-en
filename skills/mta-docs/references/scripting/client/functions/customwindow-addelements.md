---
doc_id: "mta-wiki:10396"
title: "CustomWindow:addElements"
source_title: "CustomWindow:addElements"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AaddElements"
revision_id: 59266
language: "en"
...
This function adding object of class, what has function *setColorScheme* to Custom Window color schematic list.

## Syntax

```
nil CustomWindow:addElements(table Elements)
```

### Required Arguments

- **Elements**  - Table of Custom Widget elements.

## Example

This example creates window with some widgets in old coding style:

```
local Window = CustomWindow.create(50, 50, 180, 85, "Example")

local OldButton = CustomButton.create(50, 25, 80, 25, "Button", false, Window:getMainElement())
local OldLabel = CustomLabel.create(50, 55, 80, 25, "Label", false, Window:getMainElement())

Window:addElements({OldButton, OldLabel})
```
