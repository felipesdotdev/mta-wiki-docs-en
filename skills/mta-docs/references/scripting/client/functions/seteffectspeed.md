...
This function sets the speed of a specified [effect](https://wiki.multitheftauto.com/index.php?search=effect).
...
**Method**: *[effect](https://wiki.multitheftauto.com/index.php?search=effect):setSpeed(...)*
