---
doc_id: "mta-wiki:10502"
title: "CustomLabel:getColor"
source_title: "CustomLabel:getColor"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AgetColor"
revision_id: 57080
language: "en"
...
This function gets color of Custom Label.

## Syntax

```
float, float, float CustomLabel:getColor()
```

### Returns

Returns 3 numbers of colors of label - Red, Green and Blue.

## Example

This example creates window with label, and prints its colors:

```
local Window = CustomWindow.create(50, 50, 100, 50, "Example")

local Label = CustomLabel.create(5, 25, 90, 20, "Hello World", false, Window)
local Red, Green, Blue = Label:getColor()
