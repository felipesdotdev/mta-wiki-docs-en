---
doc_id: "mta-wiki:10446"
title: "CustomCheckBox:setChecked"
source_title: "CustomCheckBox:setChecked"
source_url: "https://wiki.multitheftauto.com/wiki/CustomCheckBox%3AsetChecked"
revision_id: 56918
language: "en"
...
This function sets Custom Check Box checked.

## Syntax

```
nil CustomCheckBox:setChecked(bool Checked)
```

### Required Arguments

- **Checked** - Checked state of Check Box

## Example

This example creates window with Check Box:

```
local Window = CustomWindow.create(50, 50, 200, 55, "Example")
local Check = CustomCheckBox.create(5, 25, 190, 25, "Check Box", false, Window)
