---
doc_id: "mta-wiki:10319"
title: "CustomWidget:getEnabled"
source_title: "CustomWidget:getEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AgetEnabled"
revision_id: 57094
language: "en"
...
This function get Custom Widget enabled for cursor.

## Syntax

```
bool CustomWidget:getEnabled()
```

### Returns

Returns bool value - is widget enabled.

## Example

This example creating window with enabled and disabled buttons:
...
```
local Window = CustomWindow.create(50, 50, 160, 60, "Example", false)

local EnabledButton = CustomButton.create(10, 25, 65, 25, "Enabled", false, Window)
local DisabledButton = CustomButton.create(85, 25, 65, 25, "Disabled", false, Window)
DisabledButton:setEnabled(false)  

outputChatBox("Enabled button enabled? "..tostring(EnabledButton:getEnabled()))
outputChatBox("Disabled button enabled? "..tostring(DisabledButton:getEnabled()))
```
