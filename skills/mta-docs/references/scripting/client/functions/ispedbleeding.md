---
doc_id: "mta-wiki:13341"
title: "IsPedBleeding"
source_title: "IsPedBleeding"
source_url: "https://wiki.multitheftauto.com/wiki/IsPedBleeding"
revision_id: 81311
language: "en"
...
This function gets the state of a [player's](https://wiki.multitheftauto.com/index.php?search=player%27s) or [ped's](https://wiki.multitheftauto.com/index.php?search=ped%27s) bleeding effect.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):isBleeding(...)*

**Variable**: *.bleeding*

**Counterpart**: *[setPedBleeding](mta://scripting/client/functions/setpedbleeding.md)*

### Required Arguments

- **thePed:** The [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose bleeding effect state you want to get.

### Returns

Returns *true* if the [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) is bleeding, *false* otherwise.
