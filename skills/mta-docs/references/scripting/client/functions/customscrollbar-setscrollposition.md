---
doc_id: "mta-wiki:10417"
title: "CustomScrollBar:setScrollPosition"
source_title: "CustomScrollBar:setScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar%3AsetScrollPosition"
revision_id: 56880
language: "en"
...
This function sets Custom Scroll Bar scroller position.

## Syntax

```
nil CustomScrollBar:setScrollPosition(float Percents)
```

### Required Arguments

- **Percents**  - Percents of scroll bar progress (0-100)

## Example

This example sets for Custom Scroll Bar progress:

```
local Window = CustomWindow.create(50, 50, 100, 45, "Example")
local Scroll = CustomScrollBar.create(5, 25, 90, 15, false, Window)

Scroll:setScrollPosition(20)
```
