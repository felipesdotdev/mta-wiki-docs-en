...
Returns 8 *[integers](https://wiki.multitheftauto.com/index.php?search=integers)*, of which the first 4 indicate the color (R,G,B,A) of color filter A, and the last 4 indicate the color (R,G,B,A) of  color filter B.
