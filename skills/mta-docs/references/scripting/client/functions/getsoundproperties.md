...
This function gets the properties of a specific [sound](https://wiki.multitheftauto.com/index.php?search=sound).
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getProperties(...)*
