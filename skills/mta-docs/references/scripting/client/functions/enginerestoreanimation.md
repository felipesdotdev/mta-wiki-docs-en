---
doc_id: "mta-wiki:10206"
title: "EngineRestoreAnimation"
source_title: "EngineRestoreAnimation"
source_url: "https://wiki.multitheftauto.com/wiki/EngineRestoreAnimation"
revision_id: 55974
language: "en"
categories: ["Client_functions", "Changes_in_1.5.5", "Utility_templates"]
---

# EngineRestoreAnimation

This function restores internal (default) animations that were replaced using [engineReplaceAnimation](mta://scripting/client/functions/enginereplaceanimation.md) function. This function only affects a specific [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) just like [engineReplaceAnimation](mta://scripting/client/functions/enginereplaceanimation.md).

If only 1st parameter ([ped](https://wiki.multitheftauto.com/index.php?search=ped)) is provided to this function, all replaced animations are restored. 
...
- **thePed:** the [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to restore an animation(s) for.
