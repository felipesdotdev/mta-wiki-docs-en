---
doc_id: "mta-wiki:14456"
title: "GetPedAnimationProgress"
source_title: "GetPedAnimationProgress"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedAnimationProgress"
revision_id: 80800
language: "en"
...
- **thePed:** the [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to get the [animation](mta://reference/misc/animations.md) progress of.
...
|  | Script Example Missing Function GetPedAnimationProgress needs a script example, help out by writing one. |
| --- | --- |
