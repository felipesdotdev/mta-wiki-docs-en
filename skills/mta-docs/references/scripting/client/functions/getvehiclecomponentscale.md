---
doc_id: "mta-wiki:11510"
title: "GetVehicleComponentScale"
source_title: "GetVehicleComponentScale"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleComponentScale"
revision_id: 63165
language: "en"
...
ADDED/UPDATED IN VERSION 1.5.6 [r14489](https://buildinfo.mtasa.com/?Author=&Branch=&Revision=14489):

This function gets the component scale of a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle). 
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getComponentScale(...)*

**Counterpart**: *[setVehicleComponentScale](mta://scripting/client/functions/setvehiclecomponentscale.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to get component scale of.
...
Click to collapse [-]
This example gets the name and the scale of the components and outputs it in the chat.
