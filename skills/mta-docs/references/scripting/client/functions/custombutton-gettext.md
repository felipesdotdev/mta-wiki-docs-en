---
doc_id: "mta-wiki:10402"
title: "CustomButton:getText"
source_title: "CustomButton:getText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomButton%3AgetText"
revision_id: 56776
language: "en"
...
This function gets from Custom Button Widget text.

## Syntax

```
string CustomButton:getText()
```

## Example

This example creates window with button, and prints its text on click:

```
local Window = CustomWindow.create(50, 50, 200, 55, "Example")
local Button = CustomButton.create(20, 25, 160, 25, "Hello World", false, Window)

Window:setColorScheme(Themes.Dark.Red)

Button:addEvent("onClientGUIClick", function()
	outputChatBox(Button:getText())
end)
```
