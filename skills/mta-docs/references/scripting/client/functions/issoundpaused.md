...
This function is used to return the current pause state of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md).

If the element is a [player](https://wiki.multitheftauto.com/index.php?search=player), this function will use the players voice.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):isPaused(...)*
...
- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) which pause state you want to return.

### Returns

Returns *true* if the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) is paused, *false* if unpaused or invalid arguments were passed.
