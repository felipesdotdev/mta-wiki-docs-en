---
doc_id: "mta-wiki:10518"
title: "CustomScrollPane:setHorizontalScrollPosition"
source_title: "CustomScrollPane:setHorizontalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AsetHorizontalScrollPosition"
revision_id: 57206
language: "en"
...
This function sets Custom Scroll Pane horizontal scrolling position.

## Syntax

```
nil CustomScrollPane:setHorizontalScrollPosition(float Percents)
```

### Required Arguments

- **Percents**  - Percents of scroll pane horizontal progress (0-100)
...
This example creates window with Scroll Pane and set its vertical and horizontal scroll position to center:
...
SPane:setVerticalScrollPosition(50)
SPane:setHorizontalScrollPosition(50)
```
