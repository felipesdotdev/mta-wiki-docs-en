---
doc_id: "mta-wiki:7008"
title: "SetVehicleNitroCount"
source_title: "SetVehicleNitroCount"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleNitroCount"
revision_id: 81164
language: "en"
...
This function sets how many times a player can activate the nitro on a specified [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
- **theVehicle**: the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) which you want to modify how many times a player can use its nitro.

- **count**: how many times should the player be able to use the nitro of this [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) (from 0-100 times; 0 means that it can't be used and 101 means that it can be used infinite times).
