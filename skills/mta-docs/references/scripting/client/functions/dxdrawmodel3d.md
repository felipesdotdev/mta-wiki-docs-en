...
- **modelId:** [object](https://wiki.multitheftauto.com/index.php?search=object) you want to draw, must be regular object, you can not draw vehicles and peds. See [Object IDs](mta://reference/misc/object-ids.md) for a list of model IDs.
