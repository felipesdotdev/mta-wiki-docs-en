---
doc_id: "mta-wiki:10384"
title: "CustomWindow:getText"
source_title: "CustomWindow:getText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetText"
revision_id: 58865
language: "en"
...
This function gets title for Custom Window.

## Syntax

```
string CustomWindow:getText()
```

### Returns

Returns title of Custom Window.

## Information

This function same as [CustomWindow:getTitle](mta://scripting/client/functions/customwindow-gettitle.md)

## Example

This example creates window and print his title:

```
local Window = CustomWindow.create(50, 50, 200, 150, "Hello World")
outputChatBox(Window:getText())
```
