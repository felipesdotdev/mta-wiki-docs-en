---
doc_id: "mta-wiki:10467"
title: "CustomLoading:getProgress"
source_title: "CustomLoading:getProgress"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLoading%3AgetProgress"
revision_id: 57006
language: "en"
...
This function gets Custom Loading Widget progress level (in percents).

## Syntax

```
float CustomLoading:getProgress()
```

### Returns

Returns progress Level of Loading Widget in percents

## Example

This example creates window with Loading Widget, what changing by NumberScroller, and prints it's progress:

```
local Window = CustomWindow.create(50, 50, 130, 60, "Example")

local Scroller = CustomNumberScroller.create(5, 25, 85, 30, false, Window)
local Loading = CustomLoading.create(95, 25, false, Window)

Scroller:setMinimal(0)
Scroller:setMaximal(50)
Scroller:setStepSize(2)

Scroller:addEvent("onClientGUIChanged", function()
	Loading:setProgress( tonumber( Scroller:getText() )*2 )
	outputChatBox(Loading:getProgress())
end)
