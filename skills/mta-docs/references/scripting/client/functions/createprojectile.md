...
**Method**: *[Projectile](https://wiki.multitheftauto.com/index.php?search=Projectile)(...)*
...
Returns a *[projectile](https://wiki.multitheftauto.com/index.php?search=projectile)* element if [projectile](https://wiki.multitheftauto.com/index.php?search=projectile) creation was successful. Returns *false* if unable to create a [projectile](https://wiki.multitheftauto.com/index.php?search=projectile) (wrong weapon ID or projectiles limit was reached).
