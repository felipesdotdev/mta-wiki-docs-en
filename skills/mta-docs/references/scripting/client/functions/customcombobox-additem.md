---
doc_id: "mta-wiki:10460"
title: "CustomComboBox:addItem"
source_title: "CustomComboBox:addItem"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AaddItem"
revision_id: 56999
language: "en"
...
This function adds item for Custom Combo Box.

## Syntax

```
ccbitem CustomComboBox:addItem(string Text)
```
...
This example creates window with Combo Box, and adds some items:
