---
doc_id: "mta-wiki:10429"
title: "CustomEdit:setMaxLength"
source_title: "CustomEdit:setMaxLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEdit%3AsetMaxLength"
revision_id: 56899
language: "en"
...
This function sets for Custom Edit maximal length of string.

## Syntax

```
nil CustomEdit:setMaxLength(int Length)
```

### Required Arguments

- **Length** - Maximal length of string in Custom Edit.

## Example

This example creates window with maximal length with 10 characters:
