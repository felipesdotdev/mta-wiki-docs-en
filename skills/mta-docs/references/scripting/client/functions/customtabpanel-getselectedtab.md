---
doc_id: "mta-wiki:10487"
title: "CustomTabPanel:getSelectedTab"
source_title: "CustomTabPanel:getSelectedTab"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetSelectedTab"
revision_id: 57059
language: "en"
...
```
ctab CustomTabPanel:getSelectedTab()
```

### Returns

Returns object of Selected Tab
...
This example creates window with tab panel with 3 tabs, and put on selected tab image:
...
TabPanel:addEvent("onClientGUIClick", function()
	
	local obj = TabPanel:getSelectedTab()
	GuiStaticImage.create(5, 5, 50, 50, pane, false, obj)
end)
```
