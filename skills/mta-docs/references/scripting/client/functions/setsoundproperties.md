...
This function edits the properties of a specific [sound](https://wiki.multitheftauto.com/index.php?search=sound).
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):setProperties(...)*

**Counterpart**: *[getSoundProperties](mta://scripting/client/functions/getsoundproperties.md)*

### Required Arguments

- **sound:** a [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) that is created using [playSound](mta://scripting/client/functions/playsound.md) or [playSound3D](mta://scripting/client/functions/playsound3d.md)
