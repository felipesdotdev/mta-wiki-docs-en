...
This sets a named parameter for a [shader](https://wiki.multitheftauto.com/index.php?search=shader) element
...
**Method**: *[shader](https://wiki.multitheftauto.com/index.php?search=shader):setValue(...)*
...
- **value:** The value to set, which can be a [texture](https://wiki.multitheftauto.com/index.php?search=texture), a bool, a number or a list of numbers(**max 16 floats(numbers)**)
