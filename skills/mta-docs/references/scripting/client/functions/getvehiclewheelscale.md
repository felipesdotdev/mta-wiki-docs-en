---
doc_id: "mta-wiki:12496"
title: "GetVehicleWheelScale"
source_title: "GetVehicleWheelScale"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleWheelScale"
revision_id: 81255
language: "en"
...
This function gets the scale of all the wheels of a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getWheelScale(...)*

**Variable**: *.wheelScale*

**Counterpart**: *[setVehicleWheelScale](mta://scripting/client/functions/setvehiclewheelscale.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) to get its wheel scale of.

### Returns

Returns the wheel scale of the specified vehicle as a decimal number, or an error if the vehicle is invalid. For more information about the returned number, see [setVehicleWheelScale](mta://scripting/client/functions/setvehiclewheelscale.md).
