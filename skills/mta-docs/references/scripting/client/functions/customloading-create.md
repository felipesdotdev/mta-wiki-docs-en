---
doc_id: "mta-wiki:10377"
title: "CustomLoading.create"
source_title: "CustomLoading.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLoading.create"
revision_id: 56747
language: "en"
...
```
cload CustomLoading.create(float X, float Y, [bool Relative, gui-element Parent])
```
...
Creates loading widget and returns object of class CustomLoading.

## Information

Default size of this widget is hardcoded - 30x30 pixels.
...
This example creates window with two Loading Widgets - one is default, not animated, and second is animated and with progress 50%:

```
local Window = CustomWindow.create(50, 50, 75, 60, "Example")

local Loading = CustomLoading.create(5, 25, false, Window)
local Progress = CustomLoading.create(40, 25, false, Window)
