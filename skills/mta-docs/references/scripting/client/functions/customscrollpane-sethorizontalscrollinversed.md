---
doc_id: "mta-wiki:10520"
title: "CustomScrollPane:setHorizontalScrollInversed"
source_title: "CustomScrollPane:setHorizontalScrollInversed"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AsetHorizontalScrollInversed"
revision_id: 57212
language: "en"
...
```
nil CustomScrollPane:setHorizontalScrollInversed([bool Inversed])
```
...
This example sets for Custom Scroll Pane horizontal scroll inversed:
...
SPane:setHorizontalScrollInversed(true)
```
