---
doc_id: "mta-wiki:10689"
title: "CustomButton:getMainElement"
source_title: "CustomButton:getMainElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomButton%3AgetMainElement"
revision_id: 59240
language: "en"
...
```
gui-staticimage CustomButton:getMainElement()
```

### Returns

Returns frame object of Custom Button, where user can locate any object.
