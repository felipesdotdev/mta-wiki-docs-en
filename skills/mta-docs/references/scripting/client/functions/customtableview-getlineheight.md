---
doc_id: "mta-wiki:10576"
title: "CustomTableView:getLineHeight"
source_title: "CustomTableView:getLineHeight"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetLineHeight"
revision_id: 57494
language: "en"
...
This function gets height of line of Custom Table View.

## Syntax

```
float CustomTableView:getLineHeight([cline/int Line])
```
...
Returns height of line of Custom Table View.
...
This example creates window with table view, sets size of one line, and set it selected, and prints some heights:
...
TabView:setLineHeight(line, 30)
TabView:setSelectedLine(line)

outputChatBox(TabView:getLineHeight(line).." "..TabView:getLineHeight(1)) --Prints 31, 22
```
