---
doc_id: "mta-wiki:10331"
title: "CustomMemo.create"
source_title: "CustomMemo.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomMemo.create"
revision_id: 56351
language: "en"
...
This function creates Custom Memo Box.

## Syntax

```
cmemo CustomMemo.create(float X, float Y, float Width, float Height, string Text, [bool Relative, gui-element Parent])
```
...
Creates memo box and returns object of class CustomMemo.
