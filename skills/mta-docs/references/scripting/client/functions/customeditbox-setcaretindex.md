---
doc_id: "mta-wiki:10427"
title: "CustomEditBox:setCaretIndex"
source_title: "CustomEditBox:setCaretIndex"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AsetCaretIndex"
revision_id: 56897
language: "en"
...
This function sets for Custom Edit Box caret index.

## Syntax

```
nil CustomEditBox:setCaretIndex(int Index)
```

### Required Arguments

- **Index** - Index of character, after its sets caret.

## Example

This example creates window with Edit Box and sets caret index after word "Edit":

```
local Window = CustomWindow.create(50, 50, 200, 55, "Example")
local Edit = CustomEdit.create(5, 25, 190, 25, "Edit Box", false, Window)

Edit:setCaretIndex(4)
```
