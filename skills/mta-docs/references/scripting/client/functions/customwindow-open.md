---
doc_id: "mta-wiki:10393"
title: "CustomWindow:open"
source_title: "CustomWindow:open"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3Aopen"
revision_id: 56766
language: "en"
...
This function execute event of opening Custom Window.

## Syntax

```
nil CustomWindow:open()
```

## Example

This example just opens window with command:
...
addCommandHandler("openwin", function()
	Window:open()
end)
```
