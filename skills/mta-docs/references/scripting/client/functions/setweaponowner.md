...
This function sets the owner (which is a [player](https://wiki.multitheftauto.com/index.php?search=player)) of a [custom weapon](mta://reference/misc/element-weapon.md). The owner of a weapon was used for lag compensation, and it was also intended to only allow him to shoot the weapon.
