...
This function gets a property of the specified [object](https://wiki.multitheftauto.com/index.php?search=object).
...
**Method**: *[object](https://wiki.multitheftauto.com/index.php?search=object):getProperty(...)*

**Counterpart**: *[setProperty](https://wiki.multitheftauto.com/index.php?title=SetProperty&action=edit&redlink=1)*

### Required Arguments

- **theObject:** the [object](https://wiki.multitheftauto.com/index.php?search=object) you wish to get a property of.
