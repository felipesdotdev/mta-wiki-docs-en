---
doc_id: "mta-wiki:10582"
title: "CustomTableView:getCell"
source_title: "CustomTableView:getCell"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetCell"
revision_id: 57504
language: "en"
...
This function gets cell (Custom Label element) from Custom Table View.

## Syntax

```
clabel CustomTableView:getCell([cline/int Line, ccolumn/int Column])
```

### Other Arguments

- **Line** - Index of Line in Table View (from 1), **not 0**, or Line Object, returned with [CustomTableView:addLine](mta://scripting/client/functions/customtableview-addline.md). Default is *1*.

- **Column** - Index of Column in Table View (from 1), **not 0**, or Column Object, returned with [CustomTableView:addColumn](mta://scripting/client/functions/customtableview-addcolumn.md). Default is *1*.

### Returns

Returns Custom Label object - cell from Custom Table View.
...
This example creates window with table view, sets new cell text, and prints text of 2 cells:
...
TabView:setCellText(Line, Column, "New Cell Text")
outputChatBox(TabView:getCell(Line, Column):getText().." "..TabView:getCell(Line-1, Column-1):getText())
```
