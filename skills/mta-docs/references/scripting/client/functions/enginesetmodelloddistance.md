...
**Note for low LOD [objects](https://wiki.multitheftauto.com/index.php?search=objects)**:
...
**Note for low LOD [buildings](https://wiki.multitheftauto.com/index.php?search=buildings)**:
