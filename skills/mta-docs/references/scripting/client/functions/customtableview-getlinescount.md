---
doc_id: "mta-wiki:10580"
title: "CustomTableView:getLinesCount"
source_title: "CustomTableView:getLinesCount"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetLinesCount"
revision_id: 57509
language: "en"
...
This function gets count of Lines from Custom Table View.

## Syntax

```
int CustomTableView:getLinesCount()
```

### Returns

Returns count of Lines from Custom Table View.

## Example

This example prints count of lines of Table View:
...
outputChatBox(TabView:getLinesCount()) --10
```
