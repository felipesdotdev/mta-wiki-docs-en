---
doc_id: "mta-wiki:10425"
title: "CustomEditBox:setReadOnly"
source_title: "CustomEditBox:setReadOnly"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEditBox%3AsetReadOnly"
revision_id: 56893
language: "en"
...
This function sets for Custom Edit Box read only state.

## Syntax

```
nil CustomEditBox:setReadOnly(bool ReadOnly)
```

### Required Arguments

- **ReadOnly** - Boolean value - is edit box read only
...
This example creates window with Edit Box and Memo Box with read only state:
