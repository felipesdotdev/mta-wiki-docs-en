...
Stops the sound playback for specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md). The sound element is also destroyed.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):stop(...)*

### Required Arguments

- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) [element](mta://reference/misc/element.md) you want to stop playing.
