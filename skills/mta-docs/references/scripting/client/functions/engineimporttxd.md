---
doc_id: "mta-wiki:2702"
title: "EngineImportTXD"
source_title: "EngineImportTXD"
source_url: "https://wiki.multitheftauto.com/wiki/EngineImportTXD"
revision_id: 81816
language: "en"
...
| [[{{{image}}}\|link=\|]] | Note: CJ clothing component textures can be replaced by using the IDs listed in the Clothing Component IDs article. |
| --- | --- |
|  |  |
...
**Method**: *[txd](https://wiki.multitheftauto.com/index.php?search=txd):import(...)*

### Required Arguments

- **texture:** The [TXD](https://wiki.multitheftauto.com/index.php?search=TXD) that was loaded with [engineLoadTXD](mta://scripting/client/functions/engineloadtxd.md)
