---
doc_id: "mta-wiki:10572"
title: "CustomTableView:setCellText"
source_title: "CustomTableView:setCellText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetCellText"
revision_id: 57502
language: "en"
...
This function sets text for cell of Table View, located in chosen line and chosen column.

## Syntax

```
nil CustomTableView:setCellText([cline/int Line, ccolumn/int Column, int Width, string Text])
```
...
- **Text** - Text for cell. Default is *%Empty%*.
...
This example creates window with table view, and sets new cell text:
