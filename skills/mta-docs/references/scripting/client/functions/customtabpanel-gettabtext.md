---
doc_id: "mta-wiki:10483"
title: "CustomTabPanel:getTabText"
source_title: "CustomTabPanel:getTabText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetTabText"
revision_id: 57054
language: "en"
...
This function gets Tab title of Custom Tab Panel.

## Syntax

```
string CustomTabPanel:getTabText(string/ctab Tab)
```
...
This example creates window with tab panel with 3 tabs, two are renamed, and prints name of one tab:
...
TabPanel:setTabText(Tab, "Second")
TabPanel:setTabText("First Tab", "First")

outputChatBox(TabPanel:getTabText(Tab))
```
