---
doc_id: "mta-wiki:10456"
title: "CustomComboBox:setSelectedItem"
source_title: "CustomComboBox:setSelectedItem"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AsetSelectedItem"
revision_id: 56992
language: "en"
...
This function sets for Custom Combo Box selected item.

## Syntax

```
nil CustomComboBox:setSelectedItem(string/ccbitem Item)
```
...
This example creates window with two Combo Boxes, and makes them selected item with 2 different ways (arguments):
