---
doc_id: "mta-wiki:7763"
title: "IsTrainChainEngine"
source_title: "IsTrainChainEngine"
source_url: "https://wiki.multitheftauto.com/wiki/IsTrainChainEngine"
revision_id: 48659
language: "en"
categories: ["Client_functions", "Changes_in_1.4.1"]
---

# IsTrainChainEngine

This function checks if a [train](mta://reference/misc/element-vehicle.md) is a chain engine (moves the rest of the chain's carriages) or not.
...
**Method**: *[vehicle](mta://reference/misc/element-vehicle.md):isTrainChainEngine(...)*

**Variable**: *.chainEngine*

### Arguments

- **theTrain:** a [train](mta://reference/misc/element-vehicle.md) to check if it's a chain engine or not.

### Returns

- *true* if a [train](mta://reference/misc/element-vehicle.md) was passed to the function and if it's a chain engine.
