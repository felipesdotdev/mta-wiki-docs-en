---
doc_id: "mta-wiki:10577"
title: "CustomTableView:getColumnWidth"
source_title: "CustomTableView:getColumnWidth"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetColumnWidth"
revision_id: 57497
language: "en"
...
This function gets width of column of Custom Table View.

## Syntax

```
float CustomTableView:getColumnWidth([ccolumn/int Column])
```
...
Returns width of column of Custom Table View.
...
This example creates window with Table View, sets new width for first column, and prints widths of 2 columns:
...
TabView:setColumnWidth(Column, 120)
outputChatBox(TabView:getColumnWidth(Column).." "..TabView:getColumnWidth(2))
```
