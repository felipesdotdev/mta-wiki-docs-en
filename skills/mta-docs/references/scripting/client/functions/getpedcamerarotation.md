---
doc_id: "mta-wiki:7002"
title: "GetPedCameraRotation"
source_title: "GetPedCameraRotation"
source_url: "https://wiki.multitheftauto.com/wiki/GetPedCameraRotation"
revision_id: 59666
language: "en"
...
This function gets the current camera rotation of a [ped](https://wiki.multitheftauto.com/index.php?search=ped).
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getCameraRotation(...)*

**Variable**: *.cameraRotation*

**Counterpart**: *[setPedCameraRotation](mta://scripting/client/functions/setpedcamerarotation.md)*

### Required Arguments

- **thePed:** the [ped](https://wiki.multitheftauto.com/index.php?search=ped) to retrieve the camera rotation of.

### Returns

Returns the camera rotation of the [ped](https://wiki.multitheftauto.com/index.php?search=ped) in degrees if successful. Returns *false* if an invalid element was passed.
