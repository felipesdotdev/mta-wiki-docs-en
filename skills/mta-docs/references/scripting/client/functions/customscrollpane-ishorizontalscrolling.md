---
doc_id: "mta-wiki:10541"
title: "CustomScrollPane:isHorizontalScrolling"
source_title: "CustomScrollPane:isHorizontalScrolling"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AisHorizontalScrolling"
revision_id: 57320
language: "en"
...
This function gets Custom Scroll Pane horizontal scrolling with Middle Mouse Button.

## Syntax

```
bool CustomScrollPane:isHorizontalScrolling()
```

### Returns

Returns custom Scroll Pane horizontal scrolling availability.
...
This example creates window with Scroll Pane and changing its horizontal scrolling availability on clicking buttons:
...
for i = 0, 4 do
	for j = 0, 9 do
		local s = CustomButton.create(5 + 75*i, 5 + 30*j, 70, 25, "Button "..(i+1).. " "..(j+1), false, SPane)
		s:addEvent("onClientGUIClick", function()
			SPane:setHorizontalScrolling(not SPane:isHorizontalScrolling())
		end)
	end
end

SPane:setColorScheme(Themes.Dark.Red)
```
