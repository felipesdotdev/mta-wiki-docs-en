---
doc_id: "mta-wiki:10687"
title: "CustomWindow:getSideBarLength"
source_title: "CustomWindow:getSideBarLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetSideBarLength"
revision_id: 58040
language: "en"
...
```
int CustomWindow:getSideBarLength()
```

### Returns

Returns length of side bar of window widget.
...
outputChatBox(WindowLeft:getSideBarLength())
