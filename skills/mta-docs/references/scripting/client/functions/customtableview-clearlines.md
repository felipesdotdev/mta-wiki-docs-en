---
doc_id: "mta-wiki:10709"
title: "CustomTableView:clearLines"
source_title: "CustomTableView:clearLines"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AclearLines"
revision_id: 58084
language: "en"
...
This function removes all lines from Custom Table View.

## Syntax

```
nil CustomTableView:clearLines()
```

## Example

This example creates window with table view, here added some columns and lines (rows), changed indentation between lines, removed line, removed column, set selected line, and filling of cells, and clearing all of this:
