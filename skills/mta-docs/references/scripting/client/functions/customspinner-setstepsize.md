---
doc_id: "mta-wiki:10432"
title: "CustomSpinner:setStepSize"
source_title: "CustomSpinner:setStepSize"
source_url: "https://wiki.multitheftauto.com/wiki/CustomSpinner%3AsetStepSize"
revision_id: 57448
language: "en"
...
This function sets for Custom Spinner step size.

## Syntax

```
nil CustomSpinner:setStepSize(float StepSize)
```

### Required Arguments

- **StepSize** - Step size for Spinner. Used when scroll with Middle Mouse Button and with buttons of this widget.

## Example

This example creates window with ranges of Spinner:

```
local Window = CustomWindow.create(50, 50, 200, 55, "Example")
local Scroller = CustomSpinner.create(5, 25, 190, 25, false, Window)

Scroller:setMinimal(-10)
Scroller:setMaximal(10)
Scroller:setStepSize(0.1)
```
