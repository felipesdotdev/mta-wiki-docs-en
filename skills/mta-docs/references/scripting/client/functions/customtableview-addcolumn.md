---
doc_id: "mta-wiki:10592"
title: "CustomTableView:addColumn"
source_title: "CustomTableView:addColumn"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AaddColumn"
revision_id: 57512
language: "en"
...
This function adds column to Custom Table View.

## Syntax

```
ccolumn CustomTableView:addColumn([string Title, float Width])
```

### Other Arguments

- **Title** - String of column title. Default - *%Empty%*.

- **Width** - Width of column. Default - *50*.

### Returns

Returns table with parameters of column, called *ccolumn*.
