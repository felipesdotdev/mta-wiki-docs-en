...
This function is used to return the playback length of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) element.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getLength(...)*

**Variable**: *.length*

### Required Arguments

- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element which length you want to return.

### Returns

Returns an [float](mta://reference/misc/float.md) value indicating the playback length of the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element in seconds.
