---
doc_id: "mta-wiki:10540"
title: "CustomScrollPane:getHorizontalScrollPosition"
source_title: "CustomScrollPane:getHorizontalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AgetHorizontalScrollPosition"
revision_id: 57318
language: "en"
...
This function gets Custom Scroll Pane horizontal scroll position.

## Syntax

```
float CustomScrollPane:getHorizontalScrollPosition()
```

### Returns

Returns custom Scroll Pane horizontal scroll position.
...
This example creates window with Scroll Pane and prints its scroll position on scrolling:
...
SPane:addEvent("onClientGUIChanged", function()
	outputChatBox(SPane:getHorizontalScrollPosition())
end)
```
