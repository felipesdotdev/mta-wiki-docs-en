---
doc_id: "mta-wiki:6821"
title: "SetPedOxygenLevel"
source_title: "SetPedOxygenLevel"
source_url: "https://wiki.multitheftauto.com/wiki/SetPedOxygenLevel"
revision_id: 43087
language: "en"
...
This function allows you to set the oxygen level of a [ped](https://wiki.multitheftauto.com/index.php?search=ped).
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):setOxygenLevel(...)*

**Variable**: *.oxygenLevel*

**Counterpart**: *[getPedOxygenLevel](mta://scripting/client/functions/getpedoxygenlevel.md)*

### Required Arguments

- **thePed**: the [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose oxygen level you want to modify.

- **oxygen**: the amount of oxygen you want to set on the [ped](https://wiki.multitheftauto.com/index.php?search=ped). Native values are from 0 to 1000. Each of the stamina (22) and underwater stamina (225) [stat](https://wiki.multitheftauto.com/wiki/Template:Stats) maximum adds a bonus of 1500. So the maximum oxygen level is 4000.
