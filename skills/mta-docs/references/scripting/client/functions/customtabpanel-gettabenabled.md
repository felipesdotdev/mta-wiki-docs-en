---
doc_id: "mta-wiki:10482"
title: "CustomTabPanel:getTabEnabled"
source_title: "CustomTabPanel:getTabEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetTabEnabled"
revision_id: 57053
language: "en"
...
This function gets Tab enabled state of Custom Tab Panel.

## Syntax

```
bool CustomTabPanel:getTabEnabled(string/ctab Tab)
```

### Required Arguments

- **Tab** - String of Tab title or object of Tab (what returns with [CustomTabPanel:addTab](mta://scripting/client/functions/customtabpanel-addtab.md))

### Returns

Returns boolean value - is tab enabled
...
This example creates window with tab panel with 3 tabs, one is disabled, then prints them enabled states:

```
local Window = CustomWindow.create(50, 50, 200, 200, "Example")

local TabPanel = CustomTabPanel.create(5, 25, 190, 170, false, Window)

TabPanel:addTab("First Tab")
local Tab = TabPanel:addTab("Second Tab")
TabPanel:addTab("Third Tab")

TabPanel:setTabEnabled(Tab, false)

outputChatBox(TabPanel:getTabEnabled("First Tab"))
outputChatBox(TabPanel:getTabEnabled(Tab))
outputChatBox(TabPanel:getTabEnabled("Third Tab"))
```
