---
doc_id: "mta-wiki:10317"
title: "CustomWidget:getSize"
source_title: "CustomWidget:getSize"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AgetSize"
revision_id: 57092
language: "en"
...
This function returns Custom Widget size on screen.

## Syntax

```
float, float CustomWidget:getSize([bool Relative])
```
...
Window:addEvent("onClientGUIClick", function()
	...
	local rw, rh = Window:getSize(true)
	outputChatBox("The Absolute size is: "..tostring(w).." - "..tostring(h))
	outputChatBox("The Relative size is: "..tostring(rw).." - "..tostring(rh))
end)
```
