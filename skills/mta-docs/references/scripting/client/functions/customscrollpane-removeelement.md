---
doc_id: "mta-wiki:10557"
title: "CustomScrollPane:removeElement"
source_title: "CustomScrollPane:removeElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AremoveElement"
revision_id: 58864
language: "en"
...
This function removing object from Scroll Pane. Removing all parameters. Recommend after this function removing object with destroyElement or [CustomWidget:destroy](mta://scripting/client/functions/customwidget-destroy.md) method.

## Syntax

```
nil CustomScrollPane:removeElement(cwidget Element)
```

### Required Arguments

- **Element**  - Custom Widget element, what connected to Scroll Pane.
