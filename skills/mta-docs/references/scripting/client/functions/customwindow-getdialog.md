---
doc_id: "mta-wiki:10392"
title: "CustomWindow:getDialog"
source_title: "CustomWindow:getDialog"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetDialog"
revision_id: 56765
language: "en"
...
This function gets Dialog gui-element (dialogs background) of Custom Window.

## Syntax

```
gui-staticimage CustomWindow:getDialog()
```

### Returns

Returns dialog object (dialogs background) of Custom Window.
...
Do not recommend use this element as parent of something, except child or dialog windows. Just included this function.

With dialogs background you can move window, when click on dialogs background, it closes.
