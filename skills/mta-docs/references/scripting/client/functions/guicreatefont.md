---
doc_id: "mta-wiki:5688"
title: "GuiCreateFont"
source_title: "GuiCreateFont"
source_url: "https://wiki.multitheftauto.com/wiki/GuiCreateFont"
revision_id: 78466
language: "en"
...
This function creates a [GUI font](https://wiki.multitheftauto.com/index.php?search=GUI%20font) element that can be used in [guiSetFont](mta://scripting/client/functions/guisetfont.md). Successful font creation is not guaranteed, and may fail due to hardware or memory limitations.
...
##### It is highly recommended that [dxSetTestMode](mta://scripting/client/functions/dxsettestmode.md) is used when writing and testing scripts using guiCreateFont .
...
**Method**: *[GuiFont](mta://scripting/concepts/element-gui-font.md)(...)*
...
Returns a [GUI font](https://wiki.multitheftauto.com/index.php?search=GUI%20font) element if successful, *false* if invalid arguments were passed to the function, or there is insufficient resources available.
