...
Used to enable or disable specific [sound](https://wiki.multitheftauto.com/index.php?search=sound) effects.
Use a [player](https://wiki.multitheftauto.com/index.php?search=player) element to control a players voice with this function.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):setEffectEnabled(...)*

### Required Arguments

- **sound:** a [sound](https://wiki.multitheftauto.com/index.php?search=sound) element or a [player](https://wiki.multitheftauto.com/index.php?search=player) element which will affect the [voice](mta://resources/voice.md) broadcast.
