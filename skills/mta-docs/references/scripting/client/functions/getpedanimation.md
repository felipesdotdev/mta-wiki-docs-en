...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getAnimation(...)*

**Counterpart**: *[setPedAnimation](mta://scripting/shared/functions/setpedanimation.md)*

### Required Arguments

- **thePed:** the [player](https://wiki.multitheftauto.com/index.php?search=player) or [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to get the [animation](mta://reference/misc/animations.md) of.
