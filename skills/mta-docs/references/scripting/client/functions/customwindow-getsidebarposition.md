---
doc_id: "mta-wiki:10686"
title: "CustomWindow:getSideBarPosition"
source_title: "CustomWindow:getSideBarPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetSideBarPosition"
revision_id: 58039
language: "en"
...
```
string CustomWindow:getSideBarPosition()
```

### Returns

Returns Side Location of widget. Can be *top*, *bottom*, *left*, *right* and *none*.
...
WindowTop:setSideBarLength(40)
WindowTop:setSideBarPosition("top")
WindowLeft:showBar("left", 55)

outputChatBox(WindowLeft:getSideBarPosition())
