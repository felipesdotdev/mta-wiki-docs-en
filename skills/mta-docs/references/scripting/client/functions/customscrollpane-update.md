---
doc_id: "mta-wiki:10558"
title: "CustomScrollPane:update"
source_title: "CustomScrollPane:update"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3Aupdate"
revision_id: 57421
language: "en"
...
This function updating Custom Scroll Pane. Recommend to use when changing position or size of elements inside.

## Syntax

```
nil CustomScrollPane:update()
```

## Example

This example creates window with scroll pane with buttons. Changing button position and updating pane:

```
local Window = CustomWindow.create(50, 50, 200, 200, "Example")
local SPane = CustomScrollPane.create(5, 25, 190, 170, false, Window)

local Button = CustomButton.create(30, 5, 130, 30, "Button", false, SPane)

Button:setSize(240, 50, false)
SPane:update()
```
