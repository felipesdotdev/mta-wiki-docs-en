---
doc_id: "mta-wiki:10397"
title: "CustomWindow:showDialog"
source_title: "CustomWindow:showDialog"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AshowDialog"
revision_id: 56770
language: "en"
...
This function shows Dialogs background of Custom Window.

## Syntax

```
nil CustomWindow:showDialog(bool Visibility)
```

### Required Arguments

- **Visibility**  - Boolean value of visibility of dialogs background.
...
This example show dialog of window:

```
local Window = CustomWindow.create(50, 50, 260, 100, "Hello World")	
local Button = CustomButton.create(80, 40, 100, 30, "Button", false, Window)
