---
doc_id: "mta-wiki:10386"
title: "CustomWindow:getCloseEnabled"
source_title: "CustomWindow:getCloseEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetCloseEnabled"
revision_id: 56759
language: "en"
...
This function gets status of visibility of close button of Custom Window.

## Syntax

```
bool CustomWindow:getCloseEnabled()
```

### Returns

Returns status of visibility of Close Button of Custom Window.

## Example

This example creates two windows and prints their Close Button status:

```
local Window1 = CustomWindow.create(50, 50, 200, 150, "Hello World")
local Window2 = CustomWindow.create(50, 205, 200, 150, "Hello World")

Window1:setCloseEnabled(true)

outputChatBox(Window1:getCloseEnabled())
outputChatBox(Window2:getCloseEnabled())
```
