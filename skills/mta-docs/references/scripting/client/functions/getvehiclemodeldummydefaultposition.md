---
doc_id: "mta-wiki:12678"
title: "GetVehicleModelDummyDefaultPosition"
source_title: "GetVehicleModelDummyDefaultPosition"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleModelDummyDefaultPosition"
revision_id: 81291
language: "en"
...
This function gets the default position of the dummies contained in a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) model.
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).getVehicleModelDummyDefaultPosition(...)*
...
Returns 3 [floats](mta://reference/misc/float.md) indicating the default position X, Y and Z of the given dummy. It returns *false* otherwise.

## Example

|  | Script Example Missing Function GetVehicleModelDummyDefaultPosition needs a script example, help out by writing one. |
| --- | --- |
