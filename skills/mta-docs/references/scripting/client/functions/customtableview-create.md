---
doc_id: "mta-wiki:10549"
title: "CustomTableView.create"
source_title: "CustomTableView.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView.create"
revision_id: 57376
language: "en"
...
This function creates Custom Table View. Table Views in MTA are named Grid Lists.

## Syntax

```
ctview CustomTableView.create(float X, float Y, float Width, float Height, [bool Relative, gui-element Parent])
```
...
Creates table view and returns object of class CustomTableView.
