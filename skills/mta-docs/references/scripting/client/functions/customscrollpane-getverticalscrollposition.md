---
doc_id: "mta-wiki:10539"
title: "CustomScrollPane:getVerticalScrollPosition"
source_title: "CustomScrollPane:getVerticalScrollPosition"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AgetVerticalScrollPosition"
revision_id: 57317
language: "en"
...
This function gets Custom Scroll Pane vertical scroll position.

## Syntax

```
float CustomScrollPane:getVerticalScrollPosition()
```

### Returns

Returns custom Scroll Pane vertical scroll position.
...
SPane:addEvent("onClientGUIChanged", function()
	outputChatBox(SPane:getVerticalScrollPosition())
end)
```
