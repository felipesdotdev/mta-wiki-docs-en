---
doc_id: "mta-wiki:10708"
title: "CustomLabel:isHoverable"
source_title: "CustomLabel:isHoverable"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AisHoverable"
revision_id: 58063
language: "en"
...
This function gets - is Label has property of availability hover event. More at [CustomLabel:setHoverable](mta://scripting/client/functions/customlabel-sethoverable.md).

## Syntax

```
bool CustomLabel:isHoverable()
```

### Returns

Returns boolean value - is color depends with color scheme when mouse enter on label.
...
outputChatBox(LabelHoverable:isHoverable())
outputChatBox(LabelColored:isHoverable())
```
