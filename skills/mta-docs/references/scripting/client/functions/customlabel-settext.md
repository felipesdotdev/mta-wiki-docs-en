---
doc_id: "mta-wiki:10492"
title: "CustomLabel:setText"
source_title: "CustomLabel:setText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AsetText"
revision_id: 57067
language: "en"
...
This function sets new text Custom Label.

## Syntax

```
nil CustomLabel:setText(string Text)
```
...
This example creates window with label, and changing it's value on hover:
...
Label:addEvent("onClientMouseEnter", function()
	Label:setText("Hover")
end)

Label:addEvent("onClientMouseLeave", function()
