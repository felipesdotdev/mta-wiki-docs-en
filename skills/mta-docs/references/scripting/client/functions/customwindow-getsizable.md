---
doc_id: "mta-wiki:12554"
title: "CustomWindow:getSizable"
source_title: "CustomWindow:getSizable"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetSizable"
revision_id: 67757
language: "en"
...
This function gets sizable status of Custom Window.

## Syntax

```
bool CustomWindow:getSizable()
```

### Returns

Returns sizable status of Custom Window.

## Example

This example creates a window and gets his movable status :

```
local Window = CustomWindow.create(50, 50, 200, 150, "Hello World")

Window:getSizable() -- returns 'false' by default
```
