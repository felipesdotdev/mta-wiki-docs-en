---
doc_id: "mta-wiki:10463"
title: "CustomDialog:close"
source_title: "CustomDialog:close"
source_url: "https://wiki.multitheftauto.com/wiki/CustomDialog%3Aclose"
revision_id: 57002
language: "en"
...
This function execute event of closing Custom Dialog of Custom Window.

## Syntax

```
nil CustomDialog:close()
```

## Example

This example just closes dialog when click on "OK" button:

```
local Window = CustomWindow.create(100, 100, 200, 150, "Example")
local Button = CustomButton.create(50, 60, 100, 25, "Open Dialog", false, Window)

local Dialog = CustomDialog.create(150, "Dialog window", {"OK", "Cancel"}, Window)
...
Dialog:addEvent("onCustomDialogClick", function(button)
	if button == "OK" then
		Dialog:close()
	end
end)
...
This example of closing dialog is useless, because dialog closes automatically when user clicks button on dialog. This is just example.
