...
This function gets the rendering state of a [browser](https://wiki.multitheftauto.com/index.php?search=browser) [element](mta://reference/misc/element.md).
...
**Method**: *[browser](https://wiki.multitheftauto.com/index.php?search=browser):isRenderingPaused(...)*
...
- **webBrowser:** The [browser](https://wiki.multitheftauto.com/index.php?search=browser) [element](mta://reference/misc/element.md) to get the rendering state of.
...
This will create a [browser](https://wiki.multitheftauto.com/index.php?search=browser) [element](mta://reference/misc/element.md) and a command to pause the browser rendering:
