...
- **font:** Either a custom [GUI font](https://wiki.multitheftauto.com/index.php?search=GUI%20font) element or the name of a built-in GUI font. See [Standard GUI Font Names](mta://scripting/concepts/standard-gui-font-names.md)
