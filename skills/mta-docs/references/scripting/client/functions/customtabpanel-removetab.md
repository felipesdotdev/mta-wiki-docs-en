---
doc_id: "mta-wiki:10701"
title: "CustomTabPanel:removeTab"
source_title: "CustomTabPanel:removeTab"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AremoveTab"
revision_id: 58859
language: "en"
...
This function removing Tab from Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:removeTab(string/ctab Tab)
```
...
This example creates window with tab panel with 3 tabs, and removes middle tab:
