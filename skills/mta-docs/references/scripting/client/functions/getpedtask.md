...
This function is used to get any simple or complex [task](https://wiki.multitheftauto.com/index.php?search=task) of a certain type for a ped.
...
**Method**: *[ped](https://wiki.multitheftauto.com/index.php?search=ped):getTask(...)*

### Required Arguments

- **thePed**: The [ped](https://wiki.multitheftauto.com/index.php?search=ped) whose task you want to retrieve.
