---
doc_id: "mta-wiki:10441"
title: "CustomSpinner:getStepSize"
source_title: "CustomSpinner:getStepSize"
source_url: "https://wiki.multitheftauto.com/wiki/CustomSpinner%3AgetStepSize"
revision_id: 57458
language: "en"
...
This function gets Custom Spinner step size.

## Syntax

```
float CustomSpinner:getStepSize()
```

### Returns

Returns step size of Spinner.
...
outputChatBox(Scroller:getStepSize())
```
