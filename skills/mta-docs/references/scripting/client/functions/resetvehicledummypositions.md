---
doc_id: "mta-wiki:12682"
title: "ResetVehicleDummyPositions"
source_title: "ResetVehicleDummyPositions"
source_url: "https://wiki.multitheftauto.com/wiki/ResetVehicleDummyPositions"
revision_id: 81293
language: "en"
...
This function resets the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) dependent dummy positions to the vehicle's current model dummy positions.
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):resetDummyPositions(...)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) to reset the dummy positions.
...
|  | Script Example Missing Function ResetVehicleDummyPositions needs a script example, help out by writing one. |
| --- | --- |
