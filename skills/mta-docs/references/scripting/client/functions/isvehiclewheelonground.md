---
doc_id: "mta-wiki:10035"
title: "IsVehicleWheelOnGround"
source_title: "IsVehicleWheelOnGround"
source_url: "https://wiki.multitheftauto.com/wiki/IsVehicleWheelOnGround"
revision_id: 70956
language: "en"
...
This function returns a [boolean](mta://reference/misc/boolean.md) whether the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle)'s wheel is on ground (true) or in air (false).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):isWheelOnGround(...)*

### Required Arguments

- **theVehicle** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle), which you want to check.
