---
doc_id: "mta-wiki:3964"
title: "IsPedDoingTask"
source_title: "IsPedDoingTask"
source_url: "https://wiki.multitheftauto.com/wiki/IsPedDoingTask"
revision_id: 71977
language: "en"
...
This function checks if the specified ped is carrying out a certain [task](mta://reference/misc/list-of-player-tasks.md).
...
- **thePed**: The [ped](https://wiki.multitheftauto.com/index.php?search=ped) you want to check.
