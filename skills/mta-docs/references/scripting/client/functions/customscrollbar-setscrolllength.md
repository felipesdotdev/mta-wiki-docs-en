---
doc_id: "mta-wiki:10420"
title: "CustomScrollBar:setScrollLength"
source_title: "CustomScrollBar:setScrollLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar%3AsetScrollLength"
revision_id: 56883
language: "en"
...
This function sets for Custom Scroll Bar length of scroller element (in pixels).

## Syntax

```
nil CustomScrollBar:setScrollLength(float Length)
```

### Required Arguments

- **Length** - Length of scroller element (in pixels)
...
This example creates window with 2 Scroll Bars with different scroller length:

```
local Window = CustomWindow.create(50, 50, 100, 65, "Example")

local ScrollBarShort = CustomScrollBar.create(5, 25, 90, 15, false, Window)
local ScrollBarLong = CustomScrollBar.create(5, 45, 90, 15, false, Window)

ScrollBarShort:setScrollLength(20)
ScrollBarLong:setScrollLength(60)
```
