---
doc_id: "mta-wiki:10700"
title: "CustomComboBox:clear"
source_title: "CustomComboBox:clear"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3Aclear"
revision_id: 58053
language: "en"
...
This function removing all items from Custom Combo Box.

## Syntax

```
nil CustomComboBox:clear()
```

## Example

This example creates window with Combo Box, adds some elements and removes all elements:
