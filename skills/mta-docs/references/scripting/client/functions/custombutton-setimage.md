---
doc_id: "mta-wiki:10401"
title: "CustomButton:setImage"
source_title: "CustomButton:setImage"
source_url: "https://wiki.multitheftauto.com/wiki/CustomButton%3AsetImage"
revision_id: 56775
language: "en"
...
This function sets Custom Button Widget image.

## Syntax

```
nil CustomButton:setImage(string Image)
```

### Required Arguments

- **Image** - Location of Image. Can be *nil* to remove image from button.
