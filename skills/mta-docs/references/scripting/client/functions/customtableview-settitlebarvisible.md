---
doc_id: "mta-wiki:10561"
title: "CustomTableView:setTitleBarVisible"
source_title: "CustomTableView:setTitleBarVisible"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetTitleBarVisible"
revision_id: 57490
language: "en"
...
This function sets visibility of Title Bar for Custom Table View.

## Syntax

```
nil CustomTableView:setTitleBarVisible([bool Visible])
```

### Other Arguments

- **Visible** - Visibility of Title Bar for Table View. Default - *false*.
