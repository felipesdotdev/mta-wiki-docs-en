---
doc_id: "mta-wiki:10573"
title: "CustomTableView:getSelectedLine"
source_title: "CustomTableView:getSelectedLine"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetSelectedLine"
revision_id: 57481
language: "en"
...
This function gets selected line of Custom Table View.

## Syntax

```
int CustomTableView:getSelectedLine()
```

### Returns

Returns index of selected line of Custom Table View.
...
This example creates window with Scroll Pane, set selected item, and gets it:
...
outputChatBox(TabView:getSelectedLine())
```
