---
doc_id: "mta-wiki:10439"
title: "CustomSpinner:getMinimal"
source_title: "CustomSpinner:getMinimal"
source_url: "https://wiki.multitheftauto.com/wiki/CustomSpinner%3AgetMinimal"
revision_id: 57452
language: "en"
...
This function gets Custom Spinner minimal value.

## Syntax

```
float CustomSpinner:getMinimal()
```

### Returns

Returns minimal value for Spinner.
...
outputChatBox(Scroller:getMinimal())
```
