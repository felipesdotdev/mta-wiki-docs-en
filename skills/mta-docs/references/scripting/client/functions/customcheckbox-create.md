---
doc_id: "mta-wiki:10334"
title: "CustomCheckBox.create"
source_title: "CustomCheckBox.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomCheckBox.create"
revision_id: 56359
language: "en"
...
This function creates Custom Check Box.

## Syntax

```
ccheck CustomCheckBox.create(float X, float Y, float Width, float Height, string Text, [bool Relative, gui-element Parent])
```
...
Creates check box and returns object of class CustomCheckBox.
...
This example creates 3 Check Boxes with different states:

```
local Window = CustomWindow.create(50, 50, 150, 115, "Example")

local CheckBoxActivated = CustomCheckBox.create(5, 25, 140, 25, "Activated", false, Window)
local CheckBoxDeactivated = CustomCheckBox.create(5, 55, 140, 25, "Deactivated", false, Window)
local CheckBoxDisabled = CustomCheckBox.create(5, 85, 140, 25, "Disabled", false, Window)

CheckBoxActivated:setChecked(true)
CheckBoxDisabled:setEnabled(false)

Window:setColorScheme(Themes.Dark.Purple)
CheckBoxDeactivated:setColorScheme(Themes.Dark.Red)
```
