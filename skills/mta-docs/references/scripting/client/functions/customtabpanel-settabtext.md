---
doc_id: "mta-wiki:10477"
title: "CustomTabPanel:setTabText"
source_title: "CustomTabPanel:setTabText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AsetTabText"
revision_id: 57046
language: "en"
...
This function sets Tab title for Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:setTabText(string/ctab Tab, string Title)
```
...
This example creates window with tab panel with 3 tabs, two are renamed:
