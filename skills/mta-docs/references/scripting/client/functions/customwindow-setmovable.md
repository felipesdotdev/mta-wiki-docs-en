---
doc_id: "mta-wiki:10380"
title: "CustomWindow:setMovable"
source_title: "CustomWindow:setMovable"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AsetMovable"
revision_id: 56754
language: "en"
...
This function set Custom Window available for dragging on screen with mouse (makes window '(not)' movable).

## Syntax

```
nil CustomWindow:setMovable([bool Movable])
```

### Other Arguments

- **Movable** - Boolean value of state for window of movable. Default - *false*.

## Example

This example creates window, and disables its moving:
