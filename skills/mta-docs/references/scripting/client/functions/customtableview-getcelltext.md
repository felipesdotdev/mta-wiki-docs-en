---
doc_id: "mta-wiki:10579"
title: "CustomTableView:getCellText"
source_title: "CustomTableView:getCellText"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetCellText"
revision_id: 57503
language: "en"
...
This function gets text of cell of Custom Table View.

## Syntax

```
string CustomTableView:getCellText([cline/int Line, ccolumn/int Column])
```
...
Returns string - text of cell of Custom Table View.
...
outputChatBox(TabView:getCellText(Line, Column).." "..TabView:getCellText(Line-1, Column-1))
```
