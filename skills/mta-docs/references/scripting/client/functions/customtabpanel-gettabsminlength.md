---
doc_id: "mta-wiki:10488"
title: "CustomTabPanel:getTabsMinLength"
source_title: "CustomTabPanel:getTabsMinLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetTabsMinLength"
revision_id: 57061
language: "en"
...
This function gets minimal length of one tab block of Custom Tab Panel.

## Syntax

```
float CustomTabPanel:setTabsMinLength()
```

### Returns

Returns minimal length of tab block in pixels
...
This example creates window with 3 tab panels with different minimal tab sizes and prints them:

```
local Window = CustomWindow.create(50, 50, 250, 190, "Example")

local TabPanel = {}
TabPanel[1] = CustomTabPanel.create(5, 25, 240, 50, false, Window)
TabPanel[2] = CustomTabPanel.create(5, 80, 240, 50, false, Window)
TabPanel[3] = CustomTabPanel.create(5, 135, 240, 50, false, Window)

for i = 1, 3 do
	TabPanel[i]:addTab("First Tab")
	TabPanel[i]:addTab("Second Tab")
	TabPanel[i]:addTab("Third Tab")
end

TabPanel[1]:setTabsMinLength(50)
TabPanel[2]:setTabsMinLength(90)
TabPanel[3]:setTabsMinLength(120)

outputChatBox(TabPanel[1]:getTabsMinLength())
outputChatBox(TabPanel[2]:getTabsMinLength())
outputChatBox(TabPanel[3]:getTabsMinLength())
```
