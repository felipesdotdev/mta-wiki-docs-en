---
doc_id: "mta-wiki:10330"
title: "CustomEdit.create"
source_title: "CustomEdit.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEdit.create"
revision_id: 56350
language: "en"
...
This function creates Custom Edit Box.

## Syntax

```
cedit CustomEdit.create(float X, float Y, float Width, float Height, string Text, [bool Relative, gui-element Parent])
```
...
Creates edit box and returns object of class CustomEdit.
