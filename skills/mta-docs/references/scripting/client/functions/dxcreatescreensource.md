---
doc_id: "mta-wiki:5680"
title: "DxCreateScreenSource"
source_title: "DxCreateScreenSource"
source_url: "https://wiki.multitheftauto.com/wiki/DxCreateScreenSource"
revision_id: 59894
language: "en"
...
This function creates a screen source, which is a special type of [texture](https://wiki.multitheftauto.com/index.php?search=texture) that contains the screen as rendered by GTA
...
**Method**: *[DxScreenSource](https://wiki.multitheftauto.com/index.php?search=DxScreenSource)(...)*
...
Returns a [texture](https://wiki.multitheftauto.com/index.php?search=texture) [element](mta://reference/misc/element.md) if successful, *false* if invalid arguments were passed to the function.
