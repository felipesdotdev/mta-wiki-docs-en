...
This gets the dimensions of the supplied [material](https://wiki.multitheftauto.com/index.php?search=material) element.
...
**Method**: *[material](https://wiki.multitheftauto.com/index.php?search=material):getSize(...)*
