---
doc_id: "mta-wiki:10422"
title: "CustomScrollBar:setScrollSpeed"
source_title: "CustomScrollBar:setScrollSpeed"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar%3AsetScrollSpeed"
revision_id: 57203
language: "en"
...
```
nil CustomScrollBar:setScrollSpeed(float Speed)
```

### Required Arguments

- **Speed** - Speed of scrolling with Middle Mouse Button in pixels.

## Example

This example creates window with Scroll Bars with different scrolling speed:
