---
doc_id: "mta-wiki:10496"
title: "CustomLabel:setVerticalAlign"
source_title: "CustomLabel:setVerticalAlign"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AsetVerticalAlign"
revision_id: 57073
language: "en"
...
This function sets for Custom Label vertical align.

## Syntax

```
nil CustomLabel:setVerticalAlign(string VertAlign)
```

### Required Arguments

- **VertAlign** - Vertical Align. Can be *top*, *center* or *bottom*.
