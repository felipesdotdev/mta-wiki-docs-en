---
doc_id: "mta-wiki:10382"
title: "CustomWindow:setCloseEnabled"
source_title: "CustomWindow:setCloseEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AsetCloseEnabled"
revision_id: 56752
language: "en"
...
This function makes close button enabled for Custom Window.

## Syntax

```
nil CustomWindow:setCloseEnabled([bool Enabled)
```

### Other Arguments

- **Enabled** - Is close button available for Custom Window. Default - *false*.
...
This example creates two windows - with and without close button:

```
local WindowWith = CustomWindow.create(50, 50, 100, 70, "With")
local WindowWithout = CustomWindow.create(50, 125, 100, 70, "Without")

WindowWith:setCloseEnabled(true)
```
