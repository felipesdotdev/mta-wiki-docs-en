---
doc_id: "mta-wiki:6841"
title: "GetVehicleComponentVisible"
source_title: "GetVehicleComponentVisible"
source_url: "https://wiki.multitheftauto.com/wiki/GetVehicleComponentVisible"
revision_id: 50671
language: "en"
...
ADDED/UPDATED IN VERSION 1.3.1 [r4715](http://code.google.com/p/mtasa-blue/source/detail?r=4715):

This function get component visibility for [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):getComponentVisible(...)*

**Counterpart**: *[setVehicleComponentVisible](mta://scripting/client/functions/setvehiclecomponentvisible.md)*

### Required Arguments

- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) you wish to get component visibility of.
