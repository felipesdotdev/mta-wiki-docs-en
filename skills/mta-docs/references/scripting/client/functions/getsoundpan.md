---
doc_id: "mta-wiki:7407"
title: "GetSoundPan"
source_title: "GetSoundPan"
source_url: "https://wiki.multitheftauto.com/wiki/GetSoundPan"
revision_id: 72766
language: "en"
...
This function is used to get the pan level of the specified [sound](https://wiki.multitheftauto.com/index.php?search=sound) element.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):getPan(...)*

**Variable**: *.pan*

**Counterpart**: *[setSoundPan](mta://scripting/client/functions/setsoundpan.md)*

### Required Arguments

- **theSound:** the [sound](https://wiki.multitheftauto.com/index.php?search=sound) element which pan you want to get.
