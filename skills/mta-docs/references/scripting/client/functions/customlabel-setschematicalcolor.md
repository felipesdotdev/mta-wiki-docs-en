---
doc_id: "mta-wiki:10494"
title: "CustomLabel:setSchematicalColor"
source_title: "CustomLabel:setSchematicalColor"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AsetSchematicalColor"
revision_id: 57071
language: "en"
...
This function sets for Custom Label color, based on color of established scheme, or on scheme of parent.

## Syntax

```
nil CustomLabel:setSchematicalColor(bool Schematical)
```

### Required Arguments

- **Schematical** - Boolean value - is color depends with color scheme.
