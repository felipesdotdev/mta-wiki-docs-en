---
doc_id: "mta-wiki:10438"
title: "CustomEdit:getMaxLength"
source_title: "CustomEdit:getMaxLength"
source_url: "https://wiki.multitheftauto.com/wiki/CustomEdit%3AgetMaxLength"
revision_id: 56910
language: "en"
...
This function gets Custom Edit maximal string length.

## Syntax

```
int CustomEdit:getMasked()
```

### Returns

Returns maximal length of string for Custom Edit.
...
outputChatBox(Edit:getMaxLength())
```
