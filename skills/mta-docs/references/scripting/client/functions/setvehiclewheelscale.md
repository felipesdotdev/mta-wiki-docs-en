---
doc_id: "mta-wiki:12495"
title: "SetVehicleWheelScale"
source_title: "SetVehicleWheelScale"
source_url: "https://wiki.multitheftauto.com/wiki/SetVehicleWheelScale"
revision_id: 81254
language: "en"
...
This function sets the scale of all the wheels of a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle). The wheel scale multiplies the visible height and length (but not width) of all the wheels in a vehicle, without affecting their collisions or the handling, similarly to [setVehicleComponentScale](mta://scripting/client/functions/setvehiclecomponentscale.md). The wheel scale is applied after the [model wheel size](mta://scripting/client/functions/setvehiclemodelwheelsize.md).
...
**Method**: *[vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle):setWheelScale(...)*

**Variable**: *.wheelScale*

**Counterpart**: *[getVehicleWheelScale](mta://scripting/client/functions/getvehiclewheelscale.md)*

### Required Arguments

- **theVehicle**: The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) whose wheel scale you wish to modify.
