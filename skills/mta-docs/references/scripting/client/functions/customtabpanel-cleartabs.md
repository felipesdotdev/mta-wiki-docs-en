---
doc_id: "mta-wiki:10774"
title: "CustomTabPanel:clearTabs"
source_title: "CustomTabPanel:clearTabs"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AclearTabs"
revision_id: 58860
language: "en"
...
This function removing all tabs from Custom Tab Panel.

## Syntax

```
nil CustomTabPanel:clearTabs()
```

## Example

This example creates window with tab panel with 3 tabs, and removes all tabs:
