---
doc_id: "mta-wiki:12557"
title: "CustomMemoBox.create"
source_title: "CustomMemoBox.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomMemoBox.create"
revision_id: 67770
language: "en"
...
This function creates Memo Box.

## Syntax

```
ctbox CustomMemoBox.create(float X, float Y, float Width, float Height,string Title, [bool Relative, cw-element Parent])
```
...
Creates Memo Box and returns object of class CustomMemoBox.
...
```
CustomMemoBox.create(300,300,200,200,"Hello my name is Ridden")
```
