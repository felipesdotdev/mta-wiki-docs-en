...
- **theTarget:** The [element](mta://reference/misc/element.md) to shoot at. It can be a [player](https://wiki.multitheftauto.com/index.php?search=player), [ped](https://wiki.multitheftauto.com/index.php?search=ped), [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) or [object](https://wiki.multitheftauto.com/index.php?search=object).
...
- **[Peds](https://wiki.multitheftauto.com/index.php?search=Peds)** (players **not** included; see [getPedBonePosition](mta://scripting/client/functions/getpedboneposition.md) to know where each bone is located):
