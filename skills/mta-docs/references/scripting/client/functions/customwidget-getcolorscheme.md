---
doc_id: "mta-wiki:10320"
title: "CustomWidget:getColorScheme"
source_title: "CustomWidget:getColorScheme"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AgetColorScheme"
revision_id: 57095
language: "en"
...
This function get custom color scheme from Custom Widgets.

## Syntax

```
colorscheme CustomWidget:getColorScheme()
```

### Returns

Returns Color Scheme of widget, what you can put in method *setColorScheme*.

## Example

This example creating window and button with different color schemes, and then set them to one:

```
local Window = CustomWindow.create(0, 0, 80, 60, "Example", false)
local Button = CustomButton.create(5, 25, 70, 30, "Button", false, Window)
Button:setColorScheme(Themes.Light.Purple)
Window:setColorScheme(Button:getColorScheme())
```
