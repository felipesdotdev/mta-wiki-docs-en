---
doc_id: "mta-wiki:10307"
title: "CustomWidget:setColorScheme"
source_title: "CustomWidget:setColorScheme"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AsetColorScheme"
revision_id: 57090
language: "en"
...
This function set custom widget color scheme.

## Syntax

```
nil CustomWidget:setColorScheme(colorscheme ColorScheme)
```

### Required Arguments

- **ColorScheme** - Color Scheme. You can use default, or make your own using *[proceedColor](mta://scripting/client/functions/proceedcolor.md)*.

## Example

This example creating window with some widgets, and set it's color scheme to default light purple, and using *proceedColor*:

 

Example of code. Before click.

 

Example of code. After click.

```
local Window = CustomWindow.create(0, 0, 100, 110, "Example", false)

local Button = CustomButton.create(5, 25, 90, 25, "Button", false, Window)
local PBar = CustomProgressBar.create(5, 55, 90, 15, false, Window)
local Label = CustomLabel.create(5, 85, 90, 25, "Label", false, Window)

Window:setColorScheme(Themes.Light.Purple)

local PTheme = proceedColor("A53FC5", "200F26", "7E3396", true) --Default creator for Dark Purple Theme
Button:addEvent("onClientGUIClick", function()
	Window:setColorScheme(PTheme)
end)
```
