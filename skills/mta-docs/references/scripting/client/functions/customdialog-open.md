---
doc_id: "mta-wiki:10462"
title: "CustomDialog:open"
source_title: "CustomDialog:open"
source_url: "https://wiki.multitheftauto.com/wiki/CustomDialog%3Aopen"
revision_id: 57001
language: "en"
...
This function execute event of opening Custom Dialog of Custom Window.

## Syntax

```
nil CustomDialog:open()
```

## Example

This example just opens dialog when click on button:
