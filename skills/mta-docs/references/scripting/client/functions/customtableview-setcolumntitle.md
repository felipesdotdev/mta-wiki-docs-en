---
doc_id: "mta-wiki:10564"
title: "CustomTableView:setColumnTitle"
source_title: "CustomTableView:setColumnTitle"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetColumnTitle"
revision_id: 57499
language: "en"
...
This function sets title of column for Custom Table View.

## Syntax

```
nil CustomTableView:setColumnTitle([ccolumn/int Column, string Title])
```

### Other Arguments

- **Line** - Index of Column in Table View (from 1), **not 0**, or Column Object, returned with [CustomTableView:addColumn](mta://scripting/client/functions/customtableview-addcolumn.md). Default is *1*.

- **Title** - String of Title of Column. Default is *%Empty%*.
...
This example creates window with columns, and sets for first column new title:
