---
doc_id: "mta-wiki:10521"
title: "CustomScrollPane:setHorizontalScrolling"
source_title: "CustomScrollPane:setHorizontalScrolling"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AsetHorizontalScrolling"
revision_id: 57213
language: "en"
...
This function sets Custom Scroll Pane horizontal scrolling with Middle Mouse Button. By default it is *vertical*. If this value is *false*, horizontal scrolling available with holding *Shift* + *Middle Mouse Button*

## Syntax

```
nil CustomScrollPane:setHorizontalScrolling([bool IsHorizontal])
```

### Other Arguments

- **IsHorizontal**  - Boolean value - is scroll with Middle Mouse Button horizontal. Default - *false*

## Example

This example sets for Custom Scroll Pane with horizontal scrolling by default with Middle Mouse Button:
...
SPane:setHorizontalScrolling(true)
```
