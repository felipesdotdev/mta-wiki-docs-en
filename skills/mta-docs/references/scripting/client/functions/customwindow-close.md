---
doc_id: "mta-wiki:10394"
title: "CustomWindow:close"
source_title: "CustomWindow:close"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3Aclose"
revision_id: 56767
language: "en"
...
This function execute event of closing Custom Window.

## Syntax

```
nil CustomWindow:close()
```

## Example

This example just closes window with clicking on button:

```
local Window = CustomWindow.create(100, 100, 200, 150, "Example")
local Button = CustomButton.create(50, 40, 100, 50, "Close", false, Window)
