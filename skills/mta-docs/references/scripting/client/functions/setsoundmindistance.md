---
doc_id: "mta-wiki:4287"
title: "SetSoundMinDistance"
source_title: "SetSoundMinDistance"
source_url: "https://wiki.multitheftauto.com/wiki/SetSoundMinDistance"
revision_id: 71901
language: "en"
...
Sets a custom [sound](https://wiki.multitheftauto.com/index.php?search=sound) Minimum distance at which the sound stops getting louder.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):setMinDistance(...)*

**Variable**: *.minDistance*

**Counterpart**: *[getSoundMinDistance](mta://scripting/client/functions/getsoundmindistance.md)*
