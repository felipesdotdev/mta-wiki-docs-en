---
doc_id: "mta-wiki:10306"
title: "CustomWidget:setEnabled"
source_title: "CustomWidget:setEnabled"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AsetEnabled"
revision_id: 57089
language: "en"
...
This function set Custom Widget enabled for cursor.

## Syntax

```
bool CustomWidget:setEnabled(bool Enabled)
```

### Required Arguments

- **Enabled** - Status of widget.

### Returns

Returns bool value - is widget set enabled/disabled.
