---
doc_id: "mta-wiki:10562"
title: "CustomTableView:setLineHeight"
source_title: "CustomTableView:setLineHeight"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetLineHeight"
revision_id: 57493
language: "en"
...
This function sets height of line for Custom Table View.

## Syntax

```
nil CustomTableView:setLineHeight([cline/int Line, int Height])
```
...
- **Height** - Height of Line. Default is *22*.
...
This example creates window with table view, sets size of one line, and set it selected:
