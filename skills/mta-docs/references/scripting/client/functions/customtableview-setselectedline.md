---
doc_id: "mta-wiki:10559"
title: "CustomTableView:setSelectedLine"
source_title: "CustomTableView:setSelectedLine"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AsetSelectedLine"
revision_id: 57482
language: "en"
...
This function sets selected line for Custom Table View.

## Syntax

```
nil CustomTableView:setSelectedLine([cline/int Line])
```

### Other Arguments

- **Line** - Index of Line in Table View (from 1) or Line Object, or *0*, returned with [CustomTableView:addLine](mta://scripting/client/functions/customtableview-addline.md). Default is *0*, which means that nothing selected.
...
This example creates window with Scroll Pane, and set selected item:
