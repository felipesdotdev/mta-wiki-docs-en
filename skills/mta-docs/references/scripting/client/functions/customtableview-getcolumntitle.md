---
doc_id: "mta-wiki:10578"
title: "CustomTableView:getColumnTitle"
source_title: "CustomTableView:getColumnTitle"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AgetColumnTitle"
revision_id: 57500
language: "en"
...
This function gets title of column of Custom Table View.

## Syntax

```
string CustomTableView:getColumnTitle([ccolumn/int Column])
```
...
Returns string - title of column of Custom Table View.
...
This example creates window with columns, sets for first column new title, and prints titles of 2 columns:

```
local Window = CustomWindow.create(50, 50, 250, 220, "Example")
local TabView = CustomTableView.create(5, 25, 240, 190, false, Window)

local Column = TabView:addColumn("Column", 80)
TabView:addColumn("Another Column", 120)
...
TabView:setColumnTitle(Column, "New Name")
outputChatBox(TabView:getColumnTitle(Column).." : "..TabView:getColumnTitle(2))
```
