---
doc_id: "mta-wiki:10347"
title: "CustomLabel.create"
source_title: "CustomLabel.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel.create"
revision_id: 56508
language: "en"
...
This function creates Custom Label.

## Syntax

```
clabel CustomLabel.create(float X, float Y, float Width, float Height, string Text, [bool Relative, gui-element Parent])
```
...
Creates label and returns object of class CustomLabel.
