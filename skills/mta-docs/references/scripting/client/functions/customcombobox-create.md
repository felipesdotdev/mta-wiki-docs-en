---
doc_id: "mta-wiki:10336"
title: "CustomComboBox.create"
source_title: "CustomComboBox.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox.create"
revision_id: 56361
language: "en"
...
This function creates Custom Combo Box Widget.

## Syntax

```
ccbox CustomComboBox.create(float X, float Y, float Width, float Height, string Text, [bool Relative, gui-element Parent])
```
...
Creates combo box and returns object of class CustomComboBox.
...
This example just creating window with 2 comboboxes, and one is empty, another have some items:

```
local Window = CustomWindow.create(50, 50, 120, 95, "Example")

local ComboBox = CustomComboBox.create(5, 25, 110, 30, "Combo Box", false, Window)
local ComboBoxWithItems = CustomComboBox.create(5, 60, 110, 30, "Select", false, Window)

ComboBoxWithItems:addItem("Hello World")
ComboBoxWithItems:addItem("Quick Brown Fox")
ComboBoxWithItems:addItem("Jumps Over")
ComboBoxWithItems:addItem("The Lazy Dog")
ComboBoxWithItems:setMaxHeight(200)
```
