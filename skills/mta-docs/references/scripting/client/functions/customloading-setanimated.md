---
doc_id: "mta-wiki:10466"
title: "CustomLoading:setAnimated"
source_title: "CustomLoading:setAnimated"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLoading%3AsetAnimated"
revision_id: 57007
language: "en"
...
This function sets for Custom Loading Widget animated.

## Syntax

```
nil CustomLoading:setAnimated(bool Animated)
```

### Required Arguments

- **Animated** - Boolean value - is circle has rotate animation.

## Information

By default, when widget creates, it's animated.

## Example

This example creates window with two Loading Widgets, one is animated:
