---
doc_id: "mta-wiki:14539"
title: "PlayPedVoiceLine"
source_title: "PlayPedVoiceLine"
source_url: "https://wiki.multitheftauto.com/wiki/PlayPedVoiceLine"
revision_id: 81839
language: "en"
...
This function allows playing specific voice lines of a [ped](https://wiki.multitheftauto.com/index.php?search=ped). 

| [[{{{image}}}\|link=\|]] | Note: Voice lines are assigned to a specific skin ID, so using setPedVoice might be helpful if you want to play any voice lines regardless of the skin. |
| --- | --- |
|  |  |
...
**Method**: *[element](mta://reference/misc/element.md):playPedVoiceLine(...)*

### Required Arguments

- **thePed:** The [ped](https://wiki.multitheftauto.com/index.php?search=ped) who will speak the lines.

- **lineId:** The ID of the line to be spoken (0-359). See [ID List](https://github.com/gta-reversed/gta-reversed/blob/de0b162385a92e5545058671a787ea43423cfc4d/source/game_sa/Audio/Enums/PedSpeechContexts.h)
