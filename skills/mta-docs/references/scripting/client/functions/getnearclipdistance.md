...
This function gets the distance from the [camera](https://wiki.multitheftauto.com/index.php?search=camera) at which the world starts rendering. For more information about this please refer to [setNearClipDistance](mta://scripting/client/functions/setnearclipdistance.md).
