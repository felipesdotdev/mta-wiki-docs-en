---
doc_id: "mta-wiki:10591"
title: "CustomTableView:removeLine"
source_title: "CustomTableView:removeLine"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTableView%3AremoveLine"
revision_id: 57513
language: "en"
...
This function removes line from Custom Table View.

## Syntax

```
nil CustomTableView:removeLine([cline/int Line])
```

### Other Arguments

- **Line** - Index of Line in Table View (from 1) or Line Object, returned with [CustomTableView:addLine](mta://scripting/client/functions/customtableview-addline.md). Default is *last*.
