---
doc_id: "mta-wiki:10481"
title: "CustomTabPanel:getTabVisible"
source_title: "CustomTabPanel:getTabVisible"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetTabVisible"
revision_id: 57051
language: "en"
...
This function gets Tab visible state of Custom Tab Panel.

## Syntax

```
bool CustomTabPanel:getTabVisible(string/ctab Tab)
```
...
Returns boolean value - is tab visible.
...
This example creates window with tab panel with 3 tabs, one is not visible, then prints tabs visibility:
...
TabPanel:setTabVisible(Tab, false)

outputChatBox(TabPanel:getTabVisible("First Tab"))
outputChatBox(TabPanel:getTabVisible(Tab))
outputChatBox(TabPanel:getTabVisible("Third Tab"))
```
