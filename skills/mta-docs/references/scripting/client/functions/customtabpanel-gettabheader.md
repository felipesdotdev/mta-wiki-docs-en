---
doc_id: "mta-wiki:10490"
title: "CustomTabPanel:getTabHeader"
source_title: "CustomTabPanel:getTabHeader"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTabPanel%3AgetTabHeader"
revision_id: 57064
language: "en"
...
This function gets Header Block of Tab of Custom Tab Panel.

## Syntax

```
ctabhead CustomTabPanel:getTabHeader(string/ctab Tab)
```
...
This example gets Tab Header element (Tab Block) of Custom Tab Panel, and put on it image:

```
local Window = CustomWindow.create(50, 50, 250, 200, "Example")

local TabPanel = CustomTabPanel.create(5, 25, 240, 170, false, Window)

TabPanel:addTab("First Tab")
TabPanel:addTab("Second Tab")
TabPanel:addTab("Third Tab")

local TabHeader = TabPanel:getTabHeader("Second Tab")
GuiStaticImage.create(2, 2, 40, 10, pane, false, TabHeader)

TabPanel:setSelectedTab("Second Tab")
```
