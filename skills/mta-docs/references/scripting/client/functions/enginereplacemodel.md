...
This function replaces the given model ID with the model contained in a DFF file loaded by [engineLoadDFF](mta://scripting/client/functions/engineloaddff.md). This function supports [vehicles](https://wiki.multitheftauto.com/index.php?search=vehicles), [objects](https://wiki.multitheftauto.com/index.php?search=objects), [peds](https://wiki.multitheftauto.com/index.php?search=peds) and [players](https://wiki.multitheftauto.com/index.php?search=players).
...
**Method**: *[dff](https://wiki.multitheftauto.com/index.php?search=dff):replace(...)*
