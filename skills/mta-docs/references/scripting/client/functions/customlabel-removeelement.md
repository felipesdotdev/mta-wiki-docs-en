---
doc_id: "mta-wiki:10776"
title: "CustomLabel:removeElement"
source_title: "CustomLabel:removeElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AremoveElement"
revision_id: 58863
language: "en"
...
This function removing object from Label. Removing all parameters. Recommend after this function removing object with destroyElement or [CustomWidget:destroy](mta://scripting/client/functions/customwidget-destroy.md) method.

## Syntax

```
nil CustomLabel:removeElement(cwidget Element)
```

### Required Arguments

- **Element**  - Custom Widget element, what connected to Label.
...
local Label = CustomLabel.create(5, 25, 180, 70, "Example", false, Window)

local Button = CustomButton.create(50, 5, 80, 25, "Button", false, Label)

Label:removeElement(Button)
Button:destroy()
```
