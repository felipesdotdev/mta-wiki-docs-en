---
doc_id: "mta-wiki:2700"
title: "EngineLoadTXD"
source_title: "EngineLoadTXD"
source_url: "https://wiki.multitheftauto.com/wiki/EngineLoadTXD"
revision_id: 81478
language: "en"
...
**Method**: *[EngineTXD](https://wiki.multitheftauto.com/index.php?search=EngineTXD)(...)*

### Required Arguments

- **txd_file / raw_data:** The [filepath](mta://reference/misc/filepath.md) to the TXD file you want to load or whole data buffer of the TXD file.
...
Returns a [TXD](https://wiki.multitheftauto.com/index.php?search=TXD) if the file was loaded, *false* otherwise.
