---
doc_id: "mta-wiki:6525"
title: "SetPedAnalogControlState"
source_title: "SetPedAnalogControlState"
source_url: "https://wiki.multitheftauto.com/wiki/SetPedAnalogControlState"
revision_id: 81121
language: "en"
...
Sets an analog state of a specified [ped](https://wiki.multitheftauto.com/index.php?search=ped)'s control, as if they pressed or released it.

This function only works on [peds](https://wiki.multitheftauto.com/index.php?search=peds), to change the analog control state for a player, please use [setAnalogControlState](mta://scripting/client/functions/setanalogcontrolstate.md).
...
- **state:** A [float](mta://reference/misc/float.md) between 0 and 1 indicating the amount the control is pressed.
