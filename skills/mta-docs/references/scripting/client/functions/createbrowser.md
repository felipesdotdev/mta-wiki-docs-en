...
Returns a [texture](https://wiki.multitheftauto.com/index.php?search=texture) of the [browser](https://wiki.multitheftauto.com/index.php?search=browser) if it was created successfully, *false* otherwise. Returns also *false*, if the user disabled remote pages and *isLocal* was set to *false*.
