---
doc_id: "mta-wiki:13276"
title: "SetSoundEffectParameter"
source_title: "SetSoundEffectParameter"
source_url: "https://wiki.multitheftauto.com/wiki/SetSoundEffectParameter"
revision_id: 81843
language: "en"
...
This function sets the parameter of a [sound](https://wiki.multitheftauto.com/index.php?search=sound) effect.
...
**Method**: *[sound](https://wiki.multitheftauto.com/index.php?search=sound):setEffectParameter(...)*

### Required Arguments

- **sound:** The [sound](https://wiki.multitheftauto.com/index.php?search=sound) element.
...
- **effectParam:** The parameter [name](#Effects_Parameters).

- **paramValue:** The parameter [value](#Effects_Parameters).
