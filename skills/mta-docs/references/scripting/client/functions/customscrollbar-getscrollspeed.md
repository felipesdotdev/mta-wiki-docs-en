---
doc_id: "mta-wiki:10423"
title: "CustomScrollBar:getScrollSpeed"
source_title: "CustomScrollBar:getScrollSpeed"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollBar%3AgetScrollSpeed"
revision_id: 56887
language: "en"
categories: ["Client_functions"]
---

# CustomScrollBar:getScrollSpeed
...
```
float CustomScrollBar:getScrollSpeed()
```

### Returns

Returns scroller speed with Middle Mouse Button in pixels.

## Example

This example creates window with Scroll Bars with same scrolling speed:

```
local Window = CustomWindow.create(50, 50, 200, 65, "Example")

local ScrollF = CustomScrollBar.create(5, 25, 190, 15, false, Window)
local ScrollS = CustomScrollBar.create(5, 45, 190, 15, false, Window)

ScrollF:setScrollSpeed(5)
ScrollS:setScrollSpeed(ScrollF:getScrollSpeed())
```
