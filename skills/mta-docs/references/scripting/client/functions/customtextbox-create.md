---
doc_id: "mta-wiki:12556"
title: "CustomTextBox.create"
source_title: "CustomTextBox.create"
source_url: "https://wiki.multitheftauto.com/wiki/CustomTextBox.create"
revision_id: 67769
language: "en"
...
This function creates Text Box.

## Syntax

```
ctbox CustomTextBox.create(float X, float Y, float Width, float Height,string Title, [bool Relative, cw-element Parent,bool mlined])
```
...
- **Parent** - CW Element of parent or Window Object. Default - *nil*.

- **mlined** - I don't know xD ;

### Returns

Creates Text Box and returns object of class CustomTextBox.
...
```
CustomTextBox.create(300,300,200,200,"Hello my name is Ridden")
```

Rights : Digital/Ridden
