...
This sets the analog control state of a control for the local player. To change the analog controls for a [ped](https://wiki.multitheftauto.com/index.php?search=ped), please use [setPedAnalogControlState](mta://scripting/client/functions/setpedanalogcontrolstate.md).
...
- **forceOverrideNextFrame:** A [bool](https://wiki.multitheftauto.com/index.php?search=bool) indicating if the player input should force fully overriden for the next frame.
