---
doc_id: "mta-wiki:10769"
title: "CustomWidget:removeEvent"
source_title: "CustomWidget:removeEvent"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWidget%3AremoveEvent"
revision_id: 58851
language: "en"
...
This function removing handled Custom Widget event.

## Syntax

```
nil CustomWidget:removeEvent(string EventName, function EventFunction)
```
...
- **EventFunction** - Function, what returns with function [CustomWidget:addEvent](mta://scripting/client/functions/customwidget-addevent.md).

## Information

Event Function need to be function, what returns with [CustomWidget:addEvent](mta://scripting/client/functions/customwidget-addevent.md), because it needs to be modified, if you need to remove event handler.

## Example

This example creating window with button, what sends message in chat on click, and event when window close sends info in chat, and removing event on close window:

```
local Window = CustomWindow.create(50, 50, 80, 60, "Example", false)
Window:setCloseEnabled(true)

local Button = CustomButton.create(10, 25, 60, 25, "Click Me", false, Window)
Button:addEvent("onClientGUIClick", function()
	outputChatBox("You've clicked the button")
end)

local event = Window:addEvent("onCustomWindowClose", function()
	outputChatBox("You've closed window")
end)

Window:removeEvent("onCustomWindowClose", event)
```
...
- [CustomWidget:setVisible](mta://scripting/client/functions/customwidget-setvisible.md)
...
- [CustomScrollPane:getScrollSpeed](https://wiki.multitheftauto.com/index.php?search=CustomScrollPane%3AgetScrollSpeed)
