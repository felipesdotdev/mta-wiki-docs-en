---
doc_id: "mta-wiki:10775"
title: "CustomLabel:addElement"
source_title: "CustomLabel:addElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AaddElement"
revision_id: 59267
language: "en"
...
This function adding object to Label, and color scheme parameter was sends to this object.

## Syntax

```
nil CustomLabel:addElement(cwidget Element)
```
...
This example creates window with label with button:

```
local Window = CustomWindow.create(50, 50, 180, 85, "Example")
local Label = CustomLabel.create(5, 25, 170, 55, "Label", false, Window)
local Button = CustomButton.create(45, 0, 80, 25, "Button", false, Label)

--Its same as this:
local OldVersion = CustomButton.create(50, 30, 80, 25, "Button", false, Label:getMainElement())
Label:addElement(OldVersion)
```
