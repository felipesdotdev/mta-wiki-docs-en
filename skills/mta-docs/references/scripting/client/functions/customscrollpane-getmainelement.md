---
doc_id: "mta-wiki:10542"
title: "CustomScrollPane:getMainElement"
source_title: "CustomScrollPane:getMainElement"
source_url: "https://wiki.multitheftauto.com/wiki/CustomScrollPane%3AgetMainElement"
revision_id: 59258
language: "en"
...
```
gui-staticimage CustomScrollPane:getMainElement()
```

### Returns

Returns main parent object of Custom Scroll Pane, where user can locate any object.

## Example

This example creates window with Scroll Pane with buttons, connected to SP with different ways:

```
local Window = CustomWindow.create(50, 50, 100, 85, "Hello World")

local SPane = CustomScrollPane.create(5, 25, 90, 55, false, Window)
local ButtonOld = CustomButton.create(1, 1, 25, 25, "Hello World", false, SPane:getMainElement())
local ButtonNew = CustomButton.create(1, 31, 88, 25, "Hello World", false, SPane)
