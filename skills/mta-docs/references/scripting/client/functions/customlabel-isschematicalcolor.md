---
doc_id: "mta-wiki:10707"
title: "CustomLabel:isSchematicalColor"
source_title: "CustomLabel:isSchematicalColor"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AisSchematicalColor"
revision_id: 58062
language: "en"
...
This function gets - is Label has property of color of color scheme. More at [CustomLabel:setSchematicalColor](mta://scripting/client/functions/customlabel-setschematicalcolor.md).

## Syntax

```
bool CustomLabel:isSchematicalColor()
```

### Returns

Returns boolean value - is color depends with color scheme.
...
outputChatBox(LabelHoverable:isSchematicalColor())
outputChatBox(LabelColored:isSchematicalColor())
```
