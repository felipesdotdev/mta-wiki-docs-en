---
doc_id: "mta-wiki:10704"
title: "CustomLabel:getHorizontalAlign"
source_title: "CustomLabel:getHorizontalAlign"
source_url: "https://wiki.multitheftauto.com/wiki/CustomLabel%3AgetHorizontalAlign"
revision_id: 58057
language: "en"
...
This function gets for Custom Label horizontal align.

## Syntax

```
string CustomLabel:getHorizontalAlign()
```

### Returns

Returns string of horizontal align.
...
outputChatBox(Label:getVerticalAlign())
outputChatBox(Label:getHorizontalAlign())
```
