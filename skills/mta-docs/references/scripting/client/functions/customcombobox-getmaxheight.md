---
doc_id: "mta-wiki:10459"
title: "CustomComboBox:getMaxHeight"
source_title: "CustomComboBox:getMaxHeight"
source_url: "https://wiki.multitheftauto.com/wiki/CustomComboBox%3AgetMaxHeight"
revision_id: 56997
language: "en"
...
This function gets Custom Combo Box maximal height of list with items.

## Syntax

```
float CustomComboBox:getMaxHeight()
```

### Returns

Returns maximal height of list with items in pixels

## Example

This example creates window with two Combo Boxes, makes them maximal height, and then prints them:
...
outputChatBox("CB One height is: "..tostring(ComboBoxOne:getMaxHeight()))
outputChatBox("CB Two height is: "..tostring(ComboBoxTwo:getMaxHeight()))
```
