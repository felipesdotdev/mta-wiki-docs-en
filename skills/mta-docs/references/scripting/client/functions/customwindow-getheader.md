---
doc_id: "mta-wiki:10390"
title: "CustomWindow:getHeader"
source_title: "CustomWindow:getHeader"
source_url: "https://wiki.multitheftauto.com/wiki/CustomWindow%3AgetHeader"
revision_id: 56763
language: "en"
...
This function gets header element of Custom Window.

## Syntax

```
gui-staticimage CustomWindow:getHeader()
```
...
local Label = CustomLabel.create(200, 0, 55, 20, "Example", false, Window:getHeader())
Label:setSchematicalColor(true)
Label:setAlign("center", "right")

Window:setColorScheme(Themes.Dark.Red)
Window:setCloseEnabled(true)
Label:setColorScheme(Window:getColorScheme())
```
