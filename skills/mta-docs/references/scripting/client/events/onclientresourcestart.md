...
The [source](mta://reference/misc/event-system.md) of this event is the started resource's [root element](https://wiki.multitheftauto.com/index.php?search=root%20element).
