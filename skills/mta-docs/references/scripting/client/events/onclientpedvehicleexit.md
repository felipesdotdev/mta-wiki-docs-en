---
doc_id: "mta-wiki:12578"
title: "OnClientPedVehicleExit"
source_title: "OnClientPedVehicleExit"
source_url: "https://wiki.multitheftauto.com/wiki/OnClientPedVehicleExit"
revision_id: 81265
language: "en"
...
This event is fired when a [ped](https://wiki.multitheftauto.com/index.php?search=ped) has exited a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
- **theVehicle:** The vehicle that the [ped](https://wiki.multitheftauto.com/index.php?search=ped) exited.

- **seat:** The number of the seat that the [ped](https://wiki.multitheftauto.com/index.php?search=ped) was sitting on.

## Source

The source of this event is the [ped](https://wiki.multitheftauto.com/index.php?search=ped) that exited the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
