...
The [source](mta://reference/misc/event-system.md) of this event is the streamed in [player](https://wiki.multitheftauto.com/index.php?search=player) who fired the weapon.
