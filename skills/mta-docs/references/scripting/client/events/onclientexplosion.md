...
The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) who created the explosion.
If the explosion is from a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) the source is the [player](https://wiki.multitheftauto.com/index.php?search=player) who syncs the vehicle.
