...
The [source](mta://reference/misc/event-system.md) of this event is the [root element](https://wiki.multitheftauto.com/index.php?search=root%20element) of the resource that downloaded file.
