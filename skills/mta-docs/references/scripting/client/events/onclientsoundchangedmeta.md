...
The [source](mta://reference/misc/event-system.md) of this event is the [sound](https://wiki.multitheftauto.com/index.php?search=sound) of which the meta tags have just been modified.
