...
The [source](mta://reference/misc/event-system.md) of this event is the [sound](https://wiki.multitheftauto.com/index.php?search=sound) which either successfully streamed or failed to stream.
