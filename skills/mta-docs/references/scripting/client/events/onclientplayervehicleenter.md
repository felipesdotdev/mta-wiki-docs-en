...
- **theVehicle:** the [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that the player entered

- **seat:** the seat that the player now is on. Driver's seat = 0, higher numbers are passenger seats.

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [player](https://wiki.multitheftauto.com/index.php?search=player) that entered the vehicle.
