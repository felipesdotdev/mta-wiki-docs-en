...
This event is fired when a [ped](https://wiki.multitheftauto.com/index.php?search=ped) has entered a [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle).
...
- **theVehicle:** The [vehicle](https://wiki.multitheftauto.com/index.php?search=vehicle) that the [ped](https://wiki.multitheftauto.com/index.php?search=ped) entered.
