...
- **leftPlayer**: the [player](https://wiki.multitheftauto.com/index.php?search=player) that left the [marker's](https://wiki.multitheftauto.com/index.php?search=marker%27s) area.

- **matchingDimension**: *true* if the [player](https://wiki.multitheftauto.com/index.php?search=player) is in the same [dimension](mta://reference/misc/dimension.md) as the [marker](https://wiki.multitheftauto.com/index.php?search=marker).

## Source

The [source](mta://reference/misc/event-system.md) of this event is the [marker](https://wiki.multitheftauto.com/index.php?search=marker) that the player left.
