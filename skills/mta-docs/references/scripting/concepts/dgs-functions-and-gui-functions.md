...
This page shows the functions between **[DGS](https://wiki.multitheftauto.com/index.php?search=DGS)** and **GUI**. If you want to convert **GUI** to **[DGS](https://wiki.multitheftauto.com/index.php?search=DGS)**, Please read following table.
