...
**Note that this tutorial assumes you are familiar with all the content covered in the [Previous tutorial](https://wiki.multitheftauto.com/index.php?search=Previous%20tutorial).**
...
As covered in the [Previous tutorial](https://wiki.multitheftauto.com/index.php?search=Previous%20tutorial), there are 2 value type options available when creating gui: **relative** and **absolute**.
