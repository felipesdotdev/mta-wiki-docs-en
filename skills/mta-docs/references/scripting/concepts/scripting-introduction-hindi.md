---
doc_id: "mta-wiki:8286"
title: "Scripting Introduction Hindi"
source_title: "Scripting Introduction Hindi"
source_url: "https://wiki.multitheftauto.com/wiki/Scripting_Introduction_Hindi"
revision_id: 44970
language: "en"
categories: []
---
...
| [[{{{image}}}\|link=\|]] | Tip: Lua scripting शुरू करने के लिए आपका पहला कदम एक Lua editor का उपयोग किया जाना चाहिए. यह Scripting बहुत आसान बना देता है. हम अनुशंसा करते हैं Sublime Text , Notepad++ या LuaEdit . यह भी एक unoficial hai MTA Script Editor . |
| --- | --- |
|  |  |
...
अगले हम खिलाड़ियों को अपनी स्थिति के बगल में एक वाहन के अंडे के लिए उपयोग कर सकते हैं कि आपकी स्क्रिप्ट के लिए एक कमांड जोड़ देंगे। आप इसे छोड़ और के साथ और अधिक उन्नत पटकथा बाहर की जाँच कर सकते हैं [Map Manager](https://wiki.multitheftauto.com/index.php?search=Map%20Manager) इस ट्यूटोरियल जारी है, जो। इस ट्यूटोरियल से एक और शाखा, आप एमटीए में यूजर इंटरफेस खींचा और पटकथा है कि कैसे ग्राफिकल यह देखने के लिए अनुसरण कर सकते हैं [Introduction to Scripting GUI](https://wiki.multitheftauto.com/index.php?search=Introduction%20to%20Scripting%20GUI) है।
...
bahki sab aap yaha padh sakthe hai [https://wiki.multitheftauto.com/wiki/Scripting_Introduction](https://wiki.multitheftauto.com/wiki/Scripting_Introduction)
