---
doc_id: "mta-wiki:11402"
title: "Shared Scripting Functions"
source_title: "Shared Scripting Functions"
source_url: "https://wiki.multitheftauto.com/wiki/Shared_Scripting_Functions"
revision_id: 82617
language: "en"
categories: []
---

# Shared Scripting Functions
...
This page lists all the **shared** scripting functions that have been implemented and are available as native functions from the Deathmatch mod. To request a function or event, use [Requested Functions and Events](mta://reference/misc/requested-functions-and-events.md)
