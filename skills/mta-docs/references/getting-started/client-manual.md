...
- TAB - Player List (if [Scoreboard](https://wiki.multitheftauto.com/index.php?search=Scoreboard) resource is running on the server)
...
please read the [Client on Linux Manual](mta://getting-started/client-on-linux-manual.md), [Client on Mac OS X Manual](https://wiki.multitheftauto.com/index.php?search=Client%20on%20Mac%20OS%20X%20Manual) or [Client on Steam Deck Manual](mta://getting-started/client-on-steam-deck-manual.md).
