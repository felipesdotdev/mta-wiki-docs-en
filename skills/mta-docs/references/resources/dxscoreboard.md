...
**Note:** These functions used in [scoreboard](https://wiki.multitheftauto.com/index.php?search=scoreboard) resource do also work in dxscoreboard.
...
**Event *source* is the element was clicked, can be either [player](https://wiki.multitheftauto.com/index.php?search=player) or [team](https://wiki.multitheftauto.com/index.php?search=team).**
