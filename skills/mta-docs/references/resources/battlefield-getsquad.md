...
This command retrieves a [squad](https://wiki.multitheftauto.com/index.php?search=squad) element when given the name or [shortname](https://wiki.multitheftauto.com/index.php?title=Resource:Battlefield/shortname&action=edit&redlink=1) of a squad and the team.
