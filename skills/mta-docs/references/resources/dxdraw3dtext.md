...
- **font :** A [string](mta://reference/misc/string.md) representing the font type, This CAN'T be a [DX font](https://wiki.multitheftauto.com/index.php?search=DX%20font) element, It can ONLY be :
