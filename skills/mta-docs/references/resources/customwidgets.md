---
doc_id: "mta-wiki:10293"
title: "Resource : CustomWidgets"
source_title: "Resource:CustomWidgets"
source_url: "https://wiki.multitheftauto.com/wiki/Resource%3ACustomWidgets"
revision_id: 67761
language: "en"
categories: ["Resource"]
---
...
**Author**: [AriosJentu](https://forum.mtasa.com/profile/39663-ariosjentu/)

**Resource**: [MTA SA Forums](https://forum.mtasa.com/topic/103782-rel-custom-gui-widget-system)

**Resource's GitHub**: [GitHub](https://github.com/AriosJentu/LuaWinSys)

## Information

Any questions about using this resource you can ask on Forums in *Resource's topic*, or in *PM*, or using *Telegram*: *@AriosJentu*.
Now I'm available in ***Discord***: *@AriosJentu#4544*.

## Installation

[***Click here to see Video YouTube explanation***](https://www.youtube.com/watch?v=YwwkFubC2No&feature=youtu.be)
