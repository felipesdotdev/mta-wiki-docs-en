---
doc_id: "mta-wiki:3549"
title: "Resource : Interiors"
source_title: "Resource:Interiors"
source_url: "https://wiki.multitheftauto.com/wiki/Resource%3AInteriors"
revision_id: 21402
language: "en"
categories: ["Resource"]
---
...
By default, the interiors resource offers over 200 of single player's own interior locations.  Coupled with [dimensions](mta://reference/misc/dimension.md), each and every warp point offers a unique location - with a total of over 450 locations.
...
Please remember that [call](mta://scripting/shared/functions/call.md) must be used to call functions of another resource.
...
This function retrieves the [marker](https://wiki.multitheftauto.com/index.php?search=marker) element associated to the interior.  This will allow you to modify the visibility of interior markers using the [setElementVisibleTo](mta://scripting/server/functions/setelementvisibleto.md) function.
...
The [source](mta://reference/misc/event-system.md) of this event is the interior element which was hit.

#### Cancel effect

If this event is [canceled](mta://reference/misc/event-system.md), the player will not be warped to his destination point.
...
The [source](mta://reference/misc/event-system.md) of this event is the interior element which was warped **to**.
...
The [source](mta://reference/misc/event-system.md) of this event is the player who hit the interior element.
...
The [source](mta://reference/misc/event-system.md) of this event is the player who was warped to his destination point.
