---
doc_id: "mta-wiki:7694"
title: "OOP Introduction"
source_title: "OOP Introduction"
source_url: "https://wiki.multitheftauto.com/wiki/OOP_Introduction"
revision_id: 78537
language: "en"
categories: ["OOP", "Incomplete", "Tutorials"]
generated_at: "2026-07-26T16:16:16.188505+00:00"
---
...
This is a scripting tutorial explaining to you what object orientated programming is and teaching you how to use the OOP features of MTA. This was originally created by [qaisjp](https://wiki.multitheftauto.com/wiki/User:Qais) ([talk](https://wiki.multitheftauto.com/wiki/User_talk:Qais)) 22:48, 8 June 2014 (UTC). [Forum post.](http://forum.mtasa.com/viewtopic.php?f=148&t=76388)
...
**Method**: *[ped](mta://reference/misc/ped.md):warpIntoVehicle(...)*
...
- Methods can either start like *[player](mta://reference/misc/player.md):* or *[Player](mta://reference/misc/player.md).* - the former is only for a function on an instance (setPlayerHealth) and the latter is a static method (getRandomPlayer).
...
If you are a contributor to the wiki, please also consider reading [the OOP template](https://wiki.multitheftauto.com/wiki/Template:OOP).
...
- [Vector](mta://reference/misc/vector.md)
