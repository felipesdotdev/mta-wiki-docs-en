---
doc_id: "mta-wiki:6398"
title: "PIMP"
source_title: "PIMP"
source_url: "https://wiki.multitheftauto.com/wiki/PIMP"
revision_id: 54613
language: "en"
categories: ["Tutorials"]
generated_at: "2026-07-26T16:16:27.599650+00:00"
---
...
- Fill in a decent name in the "ID"-box. If you're going to add a boost to it for example, name it "pimp boost 1". Then click on the "OK"-button.
...
Create a text on the screen when you hit the marker.
...
- First, create a **vehicle** (NOT a spawnpoint, just a vehicle):
...
- **iconID**: IconID. Click for a list of ID's: [Radar Blips](mta://reference/misc/radar-blips.md)
