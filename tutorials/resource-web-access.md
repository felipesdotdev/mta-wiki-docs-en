...
generated_at: "2026-07-26T16:16:34.608178+00:00"
---
...
- Return an [integer](mta://reference/misc/integer.md): response will convert the number to an http status code and use an empty body.
...
The [ACL](mta://tutorials/acl.md) has a number of rights that can affect what files can be accessed.
