---
doc_id: "mta-wiki:8418"
title: "Nightly Builds"
source_title: "Nightly Builds"
source_url: "https://wiki.multitheftauto.com/wiki/Nightly_Builds"
revision_id: 64126
language: "en"
categories: []
generated_at: "2026-07-26T16:16:16.044585+00:00"
---
...
For a list of changes for each revision, head over to our [buildinfo page](https://buildinfo.mtasa.com) — each revision is broken down into individual commits.

Our automated build server takes care of building and deploying the latest commit.

## How you can help

You can help the MTA team by communicating with us [on Discord](https://mtasa.com).

- **Bugs and crashes**: please share any bugs and crashes you find [on GitHub](https://github.com/multitheftauto/mtasa-blue/issues/new/choose)
...
- **Suggestions**:  Bugs, suggestions or feedback can go in either [our forums](https://forum.mtasa.com) or GitHub Issues
...
- [Setting up admin on your server](mta://reference/misc/admin.md)
...
You can download any nightly installer from [nightly.mtasa.com](https://nightly.mtasa.com). Just download and run the installer. These usually update once a day at 2AM GMT.
