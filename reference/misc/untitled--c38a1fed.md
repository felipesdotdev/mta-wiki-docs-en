---
doc_id: "mta-wiki:13718"
title: "All Skins Page"
source_title: "Все скины"
source_url: "https://wiki.multitheftauto.com/wiki/%D0%92%D1%81%D0%B5_%D1%81%D0%BA%D0%B8%D0%BD%D1%8B"
revision_id: 82821
language: "en"
categories: ["ID_Lists"]
generated_at: "2026-07-26T16:17:09.141818+00:00"
---

# All Skins Page

Go back to [Character skins](mta://reference/misc/character-skins.md)

**Skins marked with 'Special' are typically skins that were only used in cutscenes/interiors, and were given unique IDs by MTA.**
...
#### Lua table of all the valid skin IDs listed on this page (in range 0-312)
...
#### Lua table of all the valid skin Model Names listed on this page (in range 0-312)

```
-- IDs 74, 149, and 208 are unused (model name "" in this table)
...
#### Lua table of the special skin IDs listed on this page (in range 0-312)

```
specialSkinIDs = {
	  1,   2,   3,   4,   5,   6,   8,  42,  65,  86, 
	119, 265, 266, 267, 268, 269, 270, 272, 273, 
...
#### Lua table of the unused skin IDs not listed on this page (in range 0-312)

```
unusedSkinIds = { 74,149,208 }
```
