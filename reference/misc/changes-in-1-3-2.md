...
generated_at: "2026-07-26T16:11:42.259621+00:00"
---
...
- Added ped vertex [shader](mta://reference/misc/shader.md) support
...
- Fixed [depth buffer](mta://reference/misc/depthbuffer.md) [shaders](mta://reference/misc/shader.md) not working right with mirrors
...
- Fixed [fixdb](mta://reference/misc/fixdb.md) problems
...
- Added [latency_reduction](mta://reference/misc/mtaserver-conf.md) option to [mtaserver.conf](mta://reference/misc/mtaserver-conf.md)
