---
doc_id: "mta-wiki:10863"
title: "Resource : DGS"
source_title: "Dgs"
source_url: "https://wiki.multitheftauto.com/wiki/Dgs"
revision_id: 82740
language: "en"
categories: ["Resource"]
generated_at: "2026-07-26T16:11:21.485324+00:00"
---

# Resource : DGS

DGS Logo By [Allerek](https://wiki.multitheftauto.com/wiki/User:Allerek)
...
**Github Repo**: [https://github.com/thisdp/dgs](https://github.com/thisdp/dgs)

**Resource Download**: [dgs.zip](https://github.com/thisdp/dgs/releases/latest/download/dgs.zip)

**Server Discord**: [https://discord.gg/QEs8q6W](https://discord.gg/QEs8q6W)

**Current Version**: 3.522

**Update Log**: [Changes and Updates Log](https://github.com/thisdp/dgs/releases/tag/3.522)

**Auto Completion & Syntax  Highlight**

Official:

**Latest VSCode Snippets:** [VSCode Snippets (Last Update: Auto every month) By **motar2k**](https://raw.githubusercontent.com/Armisael2k/mtasa-wiki-scrapper/master/functions.json)
...
- [Sublime](https://drive.google.com/file/d/1_07WBEWjriTTucrNGI7jT-4SknALKG6B/view?usp=sharing)

- [VSCode (Old)](https://drive.google.com/file/d/1J4qoSjzmXZz7yxHUZ2fExBu3zvCwRESn/view?usp=sharing)

3rd Party Auto Completion:

- 1. [NotePad++ By **Ahmed Ly**](http://www.mediafire.com/file/m6dm7815d5dihax/lua.zip)

- 2. [Visual Studio Code By **BW~ERAGON >**](https://marketplace.visualstudio.com/items?itemName=ERAGON.mtasa-dgs-lua)
...
- DGS is based on [element](mta://reference/misc/element.md) system, which just likes the cegui system. To make everything easy to use and understand, DGS has almost the same usage as CEGUI.
...
Examples can be found in the [test.lua](https://github.com/thisdp/dgs/blob/master/test.lua) file inside DGS folder.
...
- The latest **Style System** enables developer to define their own style such as changing color, loading images and even loading shaders with dgs elements on the server instead of using a lot of [dgsSetProperty](mta://scripting/client/functions/dgssetproperty.md)/[dgsSetProperties](mta://scripting/client/functions/dgssetproperties.md).
...
- [DGS Functions and GUI Functions](mta://scripting/concepts/dgs-functions-and-gui-functions.md)

- [DGS Grid List](mta://reference/misc/dgs-grid-list.md)

- [DGS OOP Class](mta://reference/misc/dgs-oop-class.md)

- [DGS Custom Plugin](mta://reference/misc/dgs-custom-plugin.md)

- [DGS Style System](mta://reference/misc/dgs-style-system.md)

- [DGS GUI To DGS](mta://reference/misc/g2d.md)
