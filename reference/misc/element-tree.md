...
generated_at: "2026-07-26T16:14:54.340242+00:00"
---
...
This tree consists of a number of resource root elements, the [server console](mta://reference/misc/element-console.md) and two [player](mta://reference/misc/player.md) elements, that are direct children of the **root** element. All these resources have a *dynamic map* as child element (it is just not shown for most of them). These contain the elements that are created dynamically by this resource using scripts, for example a [vehicle](mta://reference/misc/vehicle.md). If the resource has a map file, it is also a child element, itself containing all the elements in the .map file.
