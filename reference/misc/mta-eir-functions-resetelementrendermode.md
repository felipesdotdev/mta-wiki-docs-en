---
doc_id: "mta-wiki:7628"
title: "MTA:Eir/functions/resetElementRenderMode"
source_title: "MTA:Eir/functions/resetElementRenderMode"
source_url: "https://wiki.multitheftauto.com/wiki/MTA%3AEir/functions/resetElementRenderMode"
revision_id: 39312
language: "en"
categories: []
generated_at: "2026-07-26T16:16:06.613384+00:00"
---

# MTA:Eir/functions/resetElementRenderMode

This function resets the value of an internal GTA:SA engine render property.

## Syntax

```
bool string resetElementRenderMode ( element theElement, string propertyName )
```
...
Returns **true** if the property has been successfully reset, **false** and a debug message otherwise.
