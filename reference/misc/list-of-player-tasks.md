---
doc_id: "mta-wiki:2313"
title: "List of player tasks"
source_title: "List of player tasks"
source_url: "https://wiki.multitheftauto.com/wiki/List_of_player_tasks"
revision_id: 27337
language: "en"
categories: []
generated_at: "2026-07-26T16:16:04.830234+00:00"
---

# List of player tasks

This page lists the possible tasks that can be assigned to a ped. Only a subset can be assigned to player. You can use these with [getPedTask](mta://scripting/client/functions/getpedtask.md) and [getPedSimplestTask](mta://scripting/client/functions/getpedsimplesttask.md).
...
See [tasks](mta://reference/misc/tasks.md) for more information about the general workings of the task system.
...
| TASK_COMPLEX_ENTER_CAR_AS_DRIVER | TASK_SIMPLE_CAR_GET_IN TASK_SIMPLE_CAR_CLOSE_DOOR_FROM_INSIDE TASK_SIMPLE_CAR_SHUFFLE |  |
| TASK_COMPLEX_ENTER_CAR_AS_DRIVER_TIMED |  |  |
| TASK_COMPLEX_ENTER_CAR_AS_PASSENGER | TASK_SIMPLE_CAR_GET_IN TASK_SIMPLE_CAR_CLOSE_DOOR_FROM_INSIDE TASK_SIMPLE_CAR_SHUFFLE |  |
...
| TASK_COMPLEX_IN_AIR_AND_LAND | TASK_SIMPLE_IN_AIR TASK_SIMPLE_FALL TASK_SIMPLE_LAND TASK_SIMPLE_GET_UP |  |
| TASK_COMPLEX_IN_WATER | TASK_SIMPLE_SWIM TASK_COMPLEX_DIE TASK_SIMPLE_RUN_ANIM |  |
| TASK_COMPLEX_JUMP | TASK_SIMPLE_JUMP TASK_SIMPLE_HIT_HEAD TASK_COMPLEX_IN_AIR_AND_LAND |  |
