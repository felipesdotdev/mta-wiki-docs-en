...
generated_at: "2026-07-26T16:11:53.677403+00:00"
---
...
- Added [pregFind](mta://scripting/shared/functions/pregfind.md)
...
- Fixed progress spinner not showing when server is using [latency reduction](mta://reference/misc/mtaserver-conf.md)

- Fixed network trouble message causing WSOD when server is using [latency reduction](mta://reference/misc/mtaserver-conf.md)
...
- Made glitches more compatible with [latency_reduction](mta://reference/misc/mtaserver-conf.md) mode
...
- Added option to automatically update [minclientversion](mta://reference/misc/mtaserver-conf.md) - Details: [minclientversion_auto_update](mta://reference/misc/mtaserver-conf.md)
...
- Fixed bug when player could not walk sideways while aiming with [latency_reduction](mta://reference/misc/mtaserver-conf.md) enabled
