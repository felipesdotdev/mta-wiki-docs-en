---
doc_id: "mta-wiki:3839"
title: "Zdarzenia po stronie klienta"
source_title: "Zdarzenia po stronie klienta"
source_url: "https://wiki.multitheftauto.com/wiki/Zdarzenia_po_stronie_klienta"
revision_id: 79539
language: "en"
categories: ["Outdated_Pages"]
generated_at: "2026-07-26T16:16:56.585516+00:00"
---

# Zdarzenia po stronie klienta

|  | Ten artykuł jest (częściowo) przestarzały i niektóre informacje w nim mogą nie być już aktualne. |
| --- | --- |
|  |  |

Ta strona zawiera listę wszystkich [zdarzeń](mta://reference/misc/event.md) **po stronie klienta**, które zostały zaimplementowane i są dostępne w "DM Mod". Jeśli chciałbyś zaproponować stworzenie nowego zdarzenia, napisz w [Requested Functions and Events](mta://reference/misc/requested-functions-and-events.md).

**[Zdarzenia](mta://reference/misc/event.md) po stronie klienta można znaleźć tutaj: [Zdarzenia po stronie serwera](mta://scripting/concepts/server-scripting-events.md)**
