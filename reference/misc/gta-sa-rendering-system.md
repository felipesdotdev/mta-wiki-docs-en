---
doc_id: "mta-wiki:7484"
title: "GTA:SA Rendering System"
source_title: "GTA:SA Rendering System"
source_url: "https://wiki.multitheftauto.com/wiki/GTA%3ASA_Rendering_System"
revision_id: 48472
language: "en"
categories: ["Development"]
generated_at: "2026-07-26T16:15:04.494977+00:00"
---

# GTA:SA Rendering System
...
There is no performant ultimative fix for the whole GTA:SA scene. The issues can be combated in [multiple ways](mta://reference/misc/mta-eir-functions-enginesetworldrendermode.md). The **meshlocal_alphafix** method implements 'alpha fixing' on a per-mesh basis for objects and peds, so that leaves on a tree can be layered without limitation. The **scene_alphafix** method reorders the GTA:SA entity rendering queues so that they conform to **alpha rendering rules**.
