---
doc_id: "mta-wiki:7338"
title: "GTA:SA Streaming Garbage Collection"
source_title: "GTA:SA Streaming Garbage Collection"
source_url: "https://wiki.multitheftauto.com/wiki/GTA%3ASA_Streaming_Garbage_Collection"
revision_id: 67651
language: "en"
categories: ["Development"]
generated_at: "2026-07-26T16:15:04.552087+00:00"
---
...
The MTA developer [ccw](https://wiki.multitheftauto.com/wiki/User:Ccw) is the person who first found the blinking building bug.
...
Multiple options have been added through scripting functions to change the streaming node allocation behavior. The flickering is no longer a bug, but a feature that can be disabled. Using [scripting functions](mta://scripting/concepts/mta-eir-new-scripting-functions.md) Lua scripts can retrieve the amount of nodes allocated and free to be allocated.

## References

- [http://gtaforums.com/topic/573478-iiivcsa-project-2dfx](http://gtaforums.com/topic/573478-iiivcsa-project-2dfx) - pioneers of draw distance fixing
