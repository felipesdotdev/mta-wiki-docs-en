---
doc_id: "mta-wiki:6053"
title: "Multi Theft Auto"
source_title: "Multi Theft Auto"
source_url: "https://wiki.multitheftauto.com/wiki/Multi_Theft_Auto"
revision_id: 54630
language: "en"
categories: ["Historical"]
generated_at: "2026-07-26T16:16:15.789192+00:00"
---
...
Multi Theft Auto (MTA) is the world's first multiplayer add-on for the Grand Theft Auto 3 Trilogy. Starting as a very simple two player system with no on-foot support, has become one of the most active (multiplayer) add-ons for Grand Theft Auto.
...
Main article: [Timeline](mta://reference/misc/timeline.md)

### Milestones since 2006

For releases see: [Version History](mta://reference/misc/version-history.md)
...
### [GTA3:MTA](mta://reference/misc/archive.md)
...
### [MTA:SA Race](mta://reference/misc/archive.md)
...
### [MTA:SA (Deathmatch)](mta://reference/misc/main-page.md)
...
| Screenshots MTA 0.5 Mini mission on GTA3's Shoreside Vale MTA:VC 0.1 MTA 'Blue' Loading screen The 'Blue' look/interface in MTA:SA Race Racing in MTA: SA Race A mid-air race in MTA:SA Race Nyan Cat in MTA:SA Custom map in MTA:SA |
| --- |

## See Also

- [Timeline](mta://reference/misc/timeline.md) (from 2003 to 2006)

- [Version History](mta://reference/misc/version-history.md) (More detailed version history)
...
- [↑](#cite_ref-1) Trilogy: Grand Theft Auto III, Grand Theft Auto: Vice City and Grand Theft Auto: San Andreas

- [↑](#cite_ref-2) [http://hobby.estetiksoft.de/gta3console/html/getgta3console.htm](http://hobby.estetiksoft.de/gta3console/html/getgta3console.htm)

- [↑](#cite_ref-3) [http://www.moddb.com/events/2011-mod-of-the-year-awards/features/moty-players-choice-mod-of-the-year](http://www.moddb.com/events/2011-mod-of-the-year-awards/features/moty-players-choice-mod-of-the-year)

- [↑](#cite_ref-4) [http://forum.mtasa.com/viewtopic.php?f=31&t=51863](http://forum.mtasa.com/viewtopic.php?f=31&t=51863)

- [↑](#cite_ref-5) [http://files.mtasa.com/web/mta_0.5_launch/051.htm](http://files.mtasa.com/web/mta_0.5_launch/051.htm)
