---
doc_id: "mta-wiki:4892"
title: "Modules/bIRC/ircBan"
source_title: "Modules/bIRC/ircBan"
source_url: "https://wiki.multitheftauto.com/wiki/Modules/bIRC/ircBan"
revision_id: 21099
language: "en"
categories: ["Utility_templates"]
generated_at: "2026-07-26T16:16:14.435870+00:00"
---
...
This function can be used to ban-kick user from the specified channel. The specified [ircbot](mta://reference/misc/modules-birc-ircbot.md) often needs to have suitable privileges in order for this to work.
...
- **formatType:** The ban mask type which should be used for banning. A list can be found in [ircFormatHost](mta://reference/misc/modules-birc-ircformathost.md) function
...
**Note:** Does not return *true* if the user was successfully banned or *false* if it failed. You can check if the user was kicked by using callback [event_ircOnKick](https://wiki.multitheftauto.com/index.php?title=Modules/bIRC/event_ircOnKick&action=edit&redlink=1) and if the a channel mode was set by using callback [event_ircOnChannelMode](https://wiki.multitheftauto.com/index.php?title=Modules/bIRC/event_ircOnChannelMode&action=edit&redlink=1).
