...
generated_at: "2026-07-26T16:10:21.097921+00:00"
---

# Account

The account class represents a [player](mta://reference/misc/player.md)'s server account. You can get the account object associated to any client using [getPlayerAccount](mta://scripting/server/functions/getplayeraccount.md).
