---
doc_id: "mta-wiki:3821"
title: "Funkcje po stronie klienta"
source_title: "Funkcje po stronie klienta"
source_url: "https://wiki.multitheftauto.com/wiki/Funkcje_po_stronie_klienta"
revision_id: 80487
language: "en"
categories: ["MTA_Wiki:Delete", "Changes_in_1.6.0"]
generated_at: "2026-07-26T16:15:03.452421+00:00"
---
...
Po więcej funkcji sprawdź [przydatne funkcje](https://wiki.multitheftauto.com/wiki/PL/Useful_Functions).

## Funkcje dźwięków

- [getRadioChannel](https://wiki.multitheftauto.com/wiki/PL/getRadioChannel)

- [getRadioChannelName](https://wiki.multitheftauto.com/wiki/PL/getRadioChannelName)

- [getSFXStatus](https://wiki.multitheftauto.com/wiki/PL/getSFXStatus)

- [getSoundBPM](https://wiki.multitheftauto.com/wiki/PL/getSoundBPM)

- [getSoundBufferLength](https://wiki.multitheftauto.com/wiki/PL/getSoundBufferLength)

- [getSoundEffectParameters](https://wiki.multitheftauto.com/wiki/PL/getSoundEffectParameters)

- [getSoundEffects](https://wiki.multitheftauto.com/wiki/PL/getSoundEffects)

- [getSoundFFTData](https://wiki.multitheftauto.com/wiki/PL/getSoundFFTData)

- [getSoundLength](https://wiki.multitheftauto.com/wiki/PL/getSoundLength)

- [getSoundLevelData](https://wiki.multitheftauto.com/wiki/PL/getSoundLevelData)

- [getSoundMaxDistance](https://wiki.multitheftauto.com/wiki/PL/getSoundMaxDistance)

- [getSoundMetaTags](https://wiki.multitheftauto.com/wiki/PL/getSoundMetaTags)

- [getSoundMinDistance](https://wiki.multitheftauto.com/wiki/PL/getSoundMinDistance)

- [getSoundPan](https://wiki.multitheftauto.com/wiki/PL/getSoundPan)

- [getSoundPosition](https://wiki.multitheftauto.com/wiki/PL/getSoundPosition)

- [getSoundProperties](https://wiki.multitheftauto.com/wiki/PL/getSoundProperties)

- [getSoundSpeed](https://wiki.multitheftauto.com/wiki/PL/getSoundSpeed)

- [getSoundVolume](https://wiki.multitheftauto.com/wiki/PL/getSoundVolume)

- [getSoundWaveData](https://wiki.multitheftauto.com/wiki/PL/getSoundWaveData)

- [isSoundLooped](https://wiki.multitheftauto.com/wiki/PL/isSoundLooped)

- [isSoundPanningEnabled](https://wiki.multitheftauto.com/wiki/PL/isSoundPanningEnabled)

- [isSoundPaused](https://wiki.multitheftauto.com/wiki/PL/isSoundPaused)

- [playSFX3D](https://wiki.multitheftauto.com/wiki/PL/playSFX3D)

- [playSFX](https://wiki.multitheftauto.com/wiki/PL/playSFX)

- [playSound3D](https://wiki.multitheftauto.com/wiki/PL/playSound3D)

- [playSound](https://wiki.multitheftauto.com/wiki/PL/playSound)

- [playSoundFrontEnd](https://wiki.multitheftauto.com/wiki/PL/playSoundFrontEnd)

- [setRadioChannel](https://wiki.multitheftauto.com/wiki/PL/setRadioChannel)

- [setSoundEffectEnabled](https://wiki.multitheftauto.com/wiki/PL/setSoundEffectEnabled)

- [setSoundEffectParameter](https://wiki.multitheftauto.com/wiki/PL/setSoundEffectParameter)

- [setSoundLooped](https://wiki.multitheftauto.com/wiki/PL/setSoundLooped)

- [setSoundMaxDistance](https://wiki.multitheftauto.com/wiki/PL/setSoundMaxDistance)

- [setSoundMinDistance](https://wiki.multitheftauto.com/wiki/PL/setSoundMinDistance)

- [setSoundPan](https://wiki.multitheftauto.com/wiki/PL/setSoundPan)

- [setSoundPanningEnabled](https://wiki.multitheftauto.com/wiki/PL/setSoundPanningEnabled)

- [setSoundPaused](https://wiki.multitheftauto.com/wiki/PL/setSoundPaused)

- [setSoundPosition](https://wiki.multitheftauto.com/wiki/PL/setSoundPosition)

- [setSoundProperties](https://wiki.multitheftauto.com/wiki/PL/setSoundProperties)

- [setSoundSpeed](https://wiki.multitheftauto.com/wiki/PL/setSoundSpeed)

- [setSoundVolume](https://wiki.multitheftauto.com/wiki/PL/setSoundVolume)

- [stopSound](https://wiki.multitheftauto.com/wiki/PL/stopSound)

## Funkcje znaczników (blipów)

- [createBlip](https://wiki.multitheftauto.com/wiki/PL/createBlip)

- [createBlipAttachedTo](https://wiki.multitheftauto.com/wiki/PL/createBlipAttachedTo)

- [getBlipIcon](https://wiki.multitheftauto.com/wiki/PL/getBlipIcon)

- [getBlipSize](https://wiki.multitheftauto.com/wiki/PL/getBlipSize)

- [getBlipColor](https://wiki.multitheftauto.com/wiki/PL/getBlipColor)

- [setBlipIcon](https://wiki.multitheftauto.com/wiki/PL/setBlipIcon)

- [setBlipSize](https://wiki.multitheftauto.com/wiki/PL/setBlipSize)

- [setBlipColor](https://wiki.multitheftauto.com/wiki/PL/setBlipColor)

- [getBlipOrdering](https://wiki.multitheftauto.com/wiki/PL/getBlipOrdering)

- [setBlipOrdering](https://wiki.multitheftauto.com/wiki/PL/setBlipOrdering)

## Funkcje przeglądarki (CEF)

- [canBrowserNavigateBack](https://wiki.multitheftauto.com/wiki/PL/canBrowserNavigateBack)

- [canBrowserNavigateForward](https://wiki.multitheftauto.com/wiki/PL/canBrowserNavigateForward)

- [createBrowser](https://wiki.multitheftauto.com/wiki/PL/createBrowser)

- [executeBrowserJavascript](https://wiki.multitheftauto.com/wiki/PL/executeBrowserJavascript)

- [focusBrowser](https://wiki.multitheftauto.com/wiki/PL/focusBrowser)

- [getBrowserProperty](https://wiki.multitheftauto.com/wiki/PL/getBrowserProperty)

- [getBrowserSettings](https://wiki.multitheftauto.com/wiki/PL/getBrowserSettings)

- [getBrowserSource](https://wiki.multitheftauto.com/wiki/PL/getBrowserSource)

- [getBrowserTitle](https://wiki.multitheftauto.com/wiki/PL/getBrowserTitle)

- [getBrowserURL](https://wiki.multitheftauto.com/wiki/PL/getBrowserURL)

- [injectBrowserMouseDown](https://wiki.multitheftauto.com/wiki/PL/injectBrowserMouseDown)

- [injectBrowserMouseMove](https://wiki.multitheftauto.com/wiki/PL/injectBrowserMouseMove)

- [injectBrowserMouseUp](https://wiki.multitheftauto.com/wiki/PL/injectBrowserMouseUp)

- [injectBrowserMouseWheel](https://wiki.multitheftauto.com/wiki/PL/injectBrowserMouseWheel)

- [isBrowserDomainBlocked](https://wiki.multitheftauto.com/wiki/PL/isBrowserDomainBlocked)

- [isBrowserFocused](https://wiki.multitheftauto.com/wiki/PL/isBrowserFocused)

- [isBrowserLoading](https://wiki.multitheftauto.com/wiki/PL/isBrowserLoading)

- [isBrowserRenderingPaused](https://wiki.multitheftauto.com/wiki/PL/isBrowserRenderingPaused)

- [loadBrowserURL](https://wiki.multitheftauto.com/wiki/PL/loadBrowserURL)

- [navigateBrowserBack](https://wiki.multitheftauto.com/wiki/PL/navigateBrowserBack)

- [navigateBrowserForward](https://wiki.multitheftauto.com/wiki/PL/navigateBrowserForward)

- [reloadBrowserPage](https://wiki.multitheftauto.com/wiki/PL/reloadBrowserPage)

- [requestBrowserDomains](https://wiki.multitheftauto.com/wiki/PL/requestBrowserDomains)

- [resizeBrowser](https://wiki.multitheftauto.com/wiki/PL/resizeBrowser)

- [setBrowserAjaxHandler](https://wiki.multitheftauto.com/wiki/PL/setBrowserAjaxHandler)

- [setBrowserProperty](https://wiki.multitheftauto.com/wiki/PL/setBrowserProperty)

- [setBrowserRenderingPaused](https://wiki.multitheftauto.com/wiki/PL/setBrowserRenderingPaused)

- [setBrowserVolume](https://wiki.multitheftauto.com/wiki/PL/setBrowserVolume)

- [toggleBrowserDevTools](https://wiki.multitheftauto.com/wiki/PL/toggleBrowserDevTools)

### Funkcje GUI

- [guiCreateBrowser](https://wiki.multitheftauto.com/wiki/PL/guiCreateBrowser)

- [guiGetBrowser](https://wiki.multitheftauto.com/wiki/PL/guiGetBrowser)

## Funkcje kamery

- [fadeCamera](https://wiki.multitheftauto.com/wiki/PL/fadeCamera)

- [getCamera](https://wiki.multitheftauto.com/wiki/PL/getCamera)

- [getCameraClip](https://wiki.multitheftauto.com/wiki/PL/getCameraClip)

- [getCameraFieldOfView](https://wiki.multitheftauto.com/wiki/PL/getCameraFieldOfView)

- [getCameraGoggleEffect](https://wiki.multitheftauto.com/wiki/PL/getCameraGoggleEffect)

- [getCameraInterior](https://wiki.multitheftauto.com/wiki/PL/getCameraInterior)

- [getCameraMatrix](https://wiki.multitheftauto.com/wiki/PL/getCameraMatrix)

- [getCameraShakeLevel](https://wiki.multitheftauto.com/wiki/PL/getCameraShakeLevel)

- [getCameraTarget](https://wiki.multitheftauto.com/wiki/PL/getCameraTarget)

- [getCameraViewMode](https://wiki.multitheftauto.com/wiki/PL/getCameraViewMode)

- [setCameraClip](https://wiki.multitheftauto.com/wiki/PL/setCameraClip)

- [setCameraFieldOfView](https://wiki.multitheftauto.com/wiki/PL/setCameraFieldOfView)

- [setCameraGoggleEffect](https://wiki.multitheftauto.com/wiki/PL/setCameraGoggleEffect)

- [setCameraInterior](https://wiki.multitheftauto.com/wiki/PL/setCameraInterior)

- [setCameraMatrix](https://wiki.multitheftauto.com/wiki/PL/setCameraMatrix)

- [setCameraShakeLevel](https://wiki.multitheftauto.com/wiki/PL/setCameraShakeLevel)

- [setCameraTarget](https://wiki.multitheftauto.com/wiki/PL/setCameraTarget)

- [setCameraViewMode](https://wiki.multitheftauto.com/wiki/PL/setCameraViewMode)
...
- [getResourceGUIElement](mta://scripting/client/functions/getresourceguielement.md)
