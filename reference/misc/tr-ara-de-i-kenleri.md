---
doc_id: "mta-wiki:14479"
title: "Tr/Araç değişkenleri"
source_title: "Tr/Araç değişkenleri"
source_url: "https://wiki.multitheftauto.com/wiki/Tr/Ara%C3%A7_de%C4%9Fi%C5%9Fkenleri"
revision_id: 81090
language: "en"
categories: ["ID_Lists"]
generated_at: "2026-07-26T16:16:59.871804+00:00"
---

# Tr/Araç değişkenleri

Araç varyantları, farklı reklamlar veya modelin ek parçaları gibi çeşitli şeyler olabilir.

 

Custom Infernus Variant

## Adding Variants

Varyant eklemek, [DFF](https://gta.fandom.com/wiki/DFF) dosyanızı modelin varyant olmasını istediğiniz bir parçasını ekleyip bu parçaya **extra1**, **extra2**, **extra3**, **extra4** veya **extra5** adını vererek yapılır. Ardından, bu parçanın ana öğesini **chassis_dummy** olarak ayarlamanız gerekir; bu, GTA'ya varyant bilgisi içerdiğini belirtir.

## Spawning Custom Variants

Özel varyantlar oluşturmak için, [createVehicle](mta://scripting/shared/functions/createvehicle.md) içinde istediğiniz varyantları açıkça belirtmeli veya mevcut bir aracın varyantını [setVehicleVariant](mta://scripting/shared/functions/setvehiclevariant.md) kullanarak değiştirmelisiniz. Ayrıca, geçersiz bir varyant seçilirse, araç herhangi bir varyasyon olmadan varsayılan model olarak görünecektir.
...
| Hotring Racer 2 | 502 | Numbers: 0 = 82, 1 = 26, 2 = 65, 3 = 07, 4 = 36, 5 = 60 |
| Hotring Racer 3 | 503 | Numbers: 0 = 96, 1 = 67, 2 = 73, 3 = 52, 4 = 45, 5 = 14 |
...
Yukarıdaki tablo Lua'da serileştirilmiştir:
