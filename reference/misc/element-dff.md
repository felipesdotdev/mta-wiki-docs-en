---
doc_id: "mta-wiki:2787"
title: "Element/DFF"
source_title: "Element/DFF"
source_url: "https://wiki.multitheftauto.com/wiki/Element/DFF"
revision_id: 70514
language: "en"
categories: []
generated_at: "2026-07-26T16:14:52.890985+00:00"
---

# Element/DFF

The [DFF](mta://reference/misc/dff.md) class represents a RenderWare Model File (DFF) loaded by the client, which can be used to replace the model associated to a certain model ID. After this has been done, the custom model is applied to all newly created entities from that ID.
