---
doc_id: "mta-wiki:7532"
title: "MTA:Eir/FileSystem/file/writeFloat"
source_title: "MTA:Eir/FileSystem/file/writeFloat"
source_url: "https://wiki.multitheftauto.com/wiki/MTA%3AEir/FileSystem/file/writeFloat"
revision_id: 73572
language: "en"
categories: []
generated_at: "2026-07-26T16:16:05.842768+00:00"
---

# MTA:Eir/FileSystem/file/writeFloat

This function attempts to write a float into a file/stream and returns how many bytes have actually been written. The amount of bytes written should be four.

## Syntax

```
int file:writeFloat ( float value )
```

## Arguments

- **value:** a number to write into the file/stream using **single floating point precision**
