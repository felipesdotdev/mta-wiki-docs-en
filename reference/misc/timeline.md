---
doc_id: "mta-wiki:6047"
title: "Timeline"
source_title: "Timeline"
source_url: "https://wiki.multitheftauto.com/wiki/Timeline"
revision_id: 76789
language: "en"
categories: ["Historical"]
generated_at: "2026-07-26T16:16:58.202495+00:00"
---
...
*Here's a brief timeline on Multi Theft Auto.*
...
MTA is featured on TV. G4TV is the first show in the world to air footage of MTA and to do a telephone interview at the same time (it was pre-recorded). This marks the start of MTA's maturity entering the big league.
...
MTA:MA is released. MTA:MA is a third party mIRC add-on that allows users to mass-administrate servers and run mIRC scripts. These scripts were often used to create basic game modes, especially with RPG modes being popular.
...
MTA celebrates its first anniversary with a video showcasing the progress of the mod over the past year.
...
The community became divided over the allowance of car kills in GTA3, which would kill a player instantly unlike in VC. Some people deemed it "lame" whereas others stated that it was part of the game. Some server admins went so far as to actually ban players that were doing car-kills.
...
A teaser trailer is released that shows boats and an in-game server browser. The team did not comment on the trailer but the community became intrigued.
...
MTA:VC 0.5 is released. This was originally meant to be a minor upgrade to version 0.4 but progressed much further. This offered many new features such as RC vehicles and nitro in stunt mode. It also unlocked Staunton Island and Shoreside Vale in GTA3, the latter incorporating mini-games to add variety to the gameplay. VC DM players, however, were disappointed that there had not been many changes and that several glitches still existed.

- **25 February 2005**

A preview of MTA:VC 0.5.1 is shown, showcasing many Vice City features requested by disappointed players of MTA 0.5. However, this patch was never released because the team preferred to focus on development of the new core, as the old core was outdated and was starting to show its limitations.

- **1 June 2005**

MTA unveils Multi Theft Auto: San Andreas. This will be the first release to make use of the advanced "Blue" core.
...
A week after the release of Race, Deathmatch is announced. In this short space of time, the team had managed to synchronise walking players in the game.
...
- [Version History](mta://reference/misc/version-history.md)

- [MTA Vault](mta://reference/misc/mta-vault.md) - Screenshots of previous versions

## References

- [↑](#cite_ref-1) [http://web.archive.org/web/20081021112605/http://www.multitheftauto.com/history.html](http://web.archive.org/web/20081021112605/http://www.multitheftauto.com/history.html)

- [↑](#cite_ref-2) [http://files.mtasa.com/web/0.1/](http://files.mtasa.com/web/0.1/)

- [↑](#cite_ref-3) [http://www.youtube.com/watch?v=zQHK8h2XAg0](http://www.youtube.com/watch?v=zQHK8h2XAg0)

- [↑](#cite_ref-4) [MTA:mA](mta://reference/misc/mta-ma.md)

- [↑](#cite_ref-5) [http://files.mtasa.com/media/1yrmta.zip](http://files.mtasa.com/media/1yrmta.zip)

- [↑](#cite_ref-6) [Car-Killers](mta://reference/misc/car-killers.md)

- [↑](#cite_ref-7) [http://www.youtube.com/watch?v=6xA-P3UVNEE](http://www.youtube.com/watch?v=6xA-P3UVNEE)

- [↑](#cite_ref-8) [http://files.mtasa.com/media/blue/](http://files.mtasa.com/media/blue/)

- [↑](#cite_ref-9) [http://files.mtasa.com/web/mta_0.5_launch/](http://files.mtasa.com/web/mta_0.5_launch/)

- [↑](#cite_ref-10) [http://files.mtasa.com/web/mta_0.5_launch/051.htm](http://files.mtasa.com/web/mta_0.5_launch/051.htm)

- [↑](#cite_ref-11) [http://files.mtasa.com/web/mta_sa_launch/](http://files.mtasa.com/web/mta_sa_launch/)

- [↑](#cite_ref-12) [Blue](mta://reference/misc/blue.md)

- [↑](#cite_ref-13) [http://www.youtube.com/watch?v=q54av6_GkOo](http://www.youtube.com/watch?v=q54av6_GkOo)

- [↑](#cite_ref-14) [http://www.youtube.com/watch?v=ays_Kxc1DLA](http://www.youtube.com/watch?v=ays_Kxc1DLA)
