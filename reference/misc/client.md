...
generated_at: "2026-07-26T16:10:36.661585+00:00"
---

# Client

The client class represents any client that is connected to the server. Therefore, clients are created and destroyed automatically by players' connections or disconnections. They usually are the MTA: SA copy that a [player](mta://reference/misc/player.md) is using (so it has more information about the world), but it can also be the [server console](mta://reference/misc/element-console.md).
