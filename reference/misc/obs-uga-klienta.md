---
doc_id: "mta-wiki:7239"
title: "Obsługa Klienta"
source_title: "Obsługa Klienta"
source_url: "https://wiki.multitheftauto.com/wiki/Obs%C5%82uga_Klienta"
revision_id: 79088
language: "en"
categories: []
generated_at: "2026-07-26T16:16:16.875019+00:00"
---
...
| [[{{{image}}}\|link=\|]] | Notatka: MTA:SA działa tylko z GTA:SA v1.0 . Jeśli kupiłeś grę niedawno, jest prawdopodobieństwo, że masz nowszą wersje. (Więcej informacji) Jeżeli masz wersję Steam GTA: San Andreas powinieneś najpierw to przeczytać . |
| --- | --- |
|  |  |
...
- Zanim zgłosisz problem sprawdź czy nie ma go tutaj: [Znane problemy - FAQ](https://wiki.multitheftauto.com/wiki/PL/Known_Issues_-_FAQ). Jeżeli nie znalazłeś problemu w FAQ dołącz do nas na [Discord](https://discord.com/invite/mtasa)

## Instalacja gry

- Jeżeli jeszcze nie masz klienta MTA:SA, pobierz go ze strony [mtasa.com](http://mtasa.com).
...
- F9 - Pomoc (jeżeli [Helpmanager](https://wiki.multitheftauto.com/wiki/PL/Resource:Helpmanager) jest uruchomiony na serwerze)

- Z - Czat głosowy (Jeśli serwer go wspiera)

- TAB - Lista graczy (jeśli [Scoreboard](https://wiki.multitheftauto.com/wiki/PL/Resource:scoreboard) jest uruchomiony na serwerze)
...
Aby sprawdzić listę dostępnych komend, wpisz **help** w konsoli lub na czacie (/help). Niektóre tryby gry mogą dodawać własne niestandardowe komendy, które można sprawdzić wpisując **commands**. Więcej informacji o komendach znajdziesz [tutaj](https://wiki.multitheftauto.com/wiki/PL/Client_Commands).
...
Jeśli chcesz uruchomić klienta MTA na systemie Linux to zapoznaj się z [Obsługą klienta w systemie Linux](https://wiki.multitheftauto.com/index.php?title=PL/Client_on_Linux_Manual&action=edit&redlink=1). Jeśli chcesz uruchomić MTA w systemie MacOS to zapoznaj się z [Obsługą klienta w systemie MacOS X](https://wiki.multitheftauto.com/index.php?title=PL/Client_on_Mac_OS_X_Manual&action=edit&redlink=1).
