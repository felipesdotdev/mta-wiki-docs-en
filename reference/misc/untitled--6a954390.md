---
doc_id: "mta-wiki:12726"
title: "表"
source_title: "表"
source_url: "https://wiki.multitheftauto.com/wiki/%E8%A1%A8"
revision_id: 69284
language: "en"
...
表是一种类似数组的数据存储类型。它们主要用于更大的数据存储.
表不仅可以用数字索引，还可以用其他数据类型索引，例如用字符串和MTA[元素](https://wiki.multitheftauto.com/index.php?title=%E5%85%83%E7%B4%A0&action=edit&redlink=1).  
