---
doc_id: "mta-wiki:11952"
title: "Elemento"
source_title: "Elemento"
source_url: "https://wiki.multitheftauto.com/wiki/Elemento"
revision_id: 65033
language: "en"
categories: ["Changes_in_1.6.0"]
generated_at: "2026-07-26T16:07:02.785933+00:00"
---

# Elemento

Um **element** é uma classe genérica que representa quase todas as [entidades](https://wiki.multitheftauto.com/wiki/PT-BR/Entidade) dentro do jogo. Os tipos de elementos nativos são:

- [Player](mta://reference/misc/elemento-player.md)

- [Ped](mta://reference/misc/elemento-ped.md)

- [Vehicle](mta://reference/misc/elemento-vehicle.md)

- [Object](mta://reference/misc/elemento-object.md)

- [Pickup](mta://reference/misc/elemento-pickup.md)

- [Marker](mta://reference/misc/elemento-marker.md)

- [Collision shape](mta://reference/misc/elemento-collision-shape.md)

- [Blip](mta://reference/misc/elemento-blip.md)

- [Área do Radar](mta://reference/misc/elemento-radar-area.md)

- [Projétil](mta://reference/misc/elemento-proj-til.md)

- [Team](mta://reference/misc/elemento-team.md)

- [Server console](mta://reference/misc/elemento-console.md)

- [GUI widgets](mta://scripting/concepts/gui-widgets.md):

- [Button](mta://scripting/concepts/elemento-gui-button.md)

- [Checkbox](mta://scripting/concepts/element-gui-checkbox.md)

- [Combobox](mta://scripting/concepts/element-gui-combobox.md)

- [Edit field](mta://scripting/concepts/element-gui-edit-field.md)

- [Gridlist](mta://scripting/concepts/element-gui-gridlist.md)

- [Memo](mta://scripting/concepts/element-gui-memo.md)

- [Progress bar](mta://scripting/concepts/element-gui-progress-bar.md)

- [Radio button](mta://scripting/concepts/element-gui-radio-button.md)

- [Scrollbar](mta://scripting/concepts/element-gui-scrollbar.md)

- [Scrollpane](mta://scripting/concepts/element-gui-scrollpane.md)

- [Static image](mta://scripting/concepts/element-gui-static-image.md)

- [Tab panel](mta://scripting/concepts/element-gui-tab-panel.md)

- [Tab](mta://scripting/concepts/element-gui-tab.md)

- [Text label](mta://scripting/concepts/element-gui-text-label.md)

- [Window](mta://scripting/concepts/element-gui-window.md)

- [TXD](mta://reference/misc/elemento-txd.md)

- [DFF](mta://reference/misc/element-dff.md)

- [COL](mta://reference/misc/element-col.md)

- [Sound](mta://reference/misc/element-sound.md)

- [Material](mta://reference/misc/element-material.md)

- [Texture](mta://reference/misc/element-texture.md)

- [Shader](mta://reference/misc/element-shader.md)

- [DX font](mta://reference/misc/element-dx-font.md)

- [GUI font](mta://scripting/concepts/element-gui-font.md)

- [Weapon](mta://reference/misc/element-weapon.md)

- [Camera](mta://scripting/client/functions/element-camera.md)

- [Effect](mta://reference/misc/element-effect.md)

- [Browser](mta://reference/misc/element-browser.md)

- [Light](mta://reference/misc/element-light.md)

- [Searchlight](mta://reference/misc/element-searchlight.md)

- [Water](mta://reference/misc/element-water.md)

Qualquer outro tipo de elemento pode ser criado como elemento abstrat, que não esteja relacionado à qualquer [entidade](https://wiki.multitheftauto.com/wiki/PT-BR/Entidade). Por exemplo, os elementos **resource** e **map** são criados quando resources e mapas são carregados para os grupos de entidades que eles criam como seus filhos.

Os elementos compartilham funções comuns, como recuperação de tipo e lista, uma operação de destruição para remover o elemento e a entidade do jogo ao qual estão vinculados (com exceção de alguns elementos que não podem ser destruídos, por exemplo elementos do cliente), [element data](mta://reference/misc/element-data--975d1ea3.md) armazenando e recuperando dados, e muitas outras operações comuns.

Todos os elementos estão armazenado internamente na [árvore dos elementos](mta://reference/misc/element-tree.md), e, como tal, todos os elementos exceto o elemento **root** tem um elemento pai, que pode ser o elemento **root**, um **resource**, **map** ou outro elemento. Isso é apenas para declarar o escopo das chamadas de função.

## Funções scripting relacionadas
