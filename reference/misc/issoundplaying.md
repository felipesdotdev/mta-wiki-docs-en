---
doc_id: "mta-wiki:12765"
title: "IsSoundPlaying"
source_title: "IsSoundPlaying"
source_url: "https://wiki.multitheftauto.com/wiki/IsSoundPlaying"
revision_id: 79807
language: "en"
categories: ["MTA_Wiki:Delete", "Archived"]
generated_at: "2026-07-26T16:16:00.576938+00:00"
---
...
| --- | --- |
| Reason: Useless function. See isSoundPaused . Actions: Delete (Administrators) - Discuss - What links here - Category |  |

This function check if sound is playing or not.

## Syntax

```
bool isSoundPlaying ( element theSound )
```

### Required Arguments

- **theSound**: The sound element you want to check if is playing or not.
...
**Function created by Hydra.**

Version 2 (without warning)
...
```
function isSoundPlaying(theSound)
    return (isElement(theSound))
end
```

**Function created by -Alii.**

## Example

This example will check and see if the sound is playing or not.

Click to collapse [-]
Client

```
local sound = playSound("yoursound.mp3")

function checkSoundPlaying()
if isSoundPlaying(sound) then
outputChatBox("Yey, the song is playing!")
else
outputChatBox("The song is not playing anymore")
end
end
addCommandHandler("checkPlaying", checkSoundPlaying)
```
