---
doc_id: "mta-wiki:13535"
title: "Modules/FileSystem/file/writeByte"
source_title: "Modules/FileSystem/file/writeByte"
source_url: "https://wiki.multitheftauto.com/wiki/Modules/FileSystem/file/writeByte"
revision_id: 73744
language: "en"
categories: []
generated_at: "2026-07-26T16:16:12.120300+00:00"
---

# Modules/FileSystem/file/writeByte

This function attempts to write a signed byte into a file/stream and returns how many bytes have actually been written. The amount of bytes written should be one.

## Syntax

```
int file:writeByte ( signed_byte value )
```

## Arguments

- **value:** a number in the range of [-128..127] to write into the file/stream
