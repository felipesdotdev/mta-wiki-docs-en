...
generated_at: "2026-07-26T16:16:36.779605+00:00"
---
...
By default, logging output is written to the file **logs/db.log** unless another file is declared in the [<dbfile> section of mtaserver.conf](mta://reference/misc/mtaserver-conf.md)
...
**Only available if enabled in the [mtaserver.conf](mta://reference/misc/mtaserver-conf.md) file.**
