---
doc_id: "mta-wiki:7528"
title: "MTA:Eir/FileSystem/file/writeShort"
source_title: "MTA:Eir/FileSystem/file/writeShort"
source_url: "https://wiki.multitheftauto.com/wiki/MTA%3AEir/FileSystem/file/writeShort"
revision_id: 73568
language: "en"
categories: []
generated_at: "2026-07-26T16:16:05.868512+00:00"
---

# MTA:Eir/FileSystem/file/writeShort

This function attempts to write a short integer into a file/stream and returns how many bytes have actually been written. The amount of bytes written should be two.

## Syntax

```
int file:writeShort ( short value )
```

## Arguments

- **value:** a number in the range of [-32786..32785] to write into the file/stream
